...
[Require("Gradle.Dependency.Implementation","com.android.support:support-v4:27.0.1")]
[Require("Gradle.Dependency.Implementation","com.google.android.gms:play-services-vision:17.0.2")]
[Require("Gradle.Dependency.Implementation","com.android.support:design:27.0.1")]
public class QreaderImpl
{
	...
	@{
		dispatch_async(dispatch_get_main_queue(), ^{
			...
			QRCodeReader *reader = [QRCodeReader readerWithMetadataObjectTypes:@[AVMetadataObjectTypeCode39Code]];
