...
var DateTime = require("Modules/CalendarView/DateTime")
// const { temp_ios_date } = require("Pages/Menu_Customer/c_inq02")
...
exports.monthLabel = date.map( function(v) {
	return DateTime.monthLabels[v.getMonth()] + "월 " + v.getFullYear()
})
