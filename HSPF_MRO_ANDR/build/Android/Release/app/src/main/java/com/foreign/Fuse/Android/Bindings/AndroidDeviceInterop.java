...
public class AndroidDeviceInterop
{
    ...
    public static Object LaunchIntent326(final String action,final String uri,final String packageName,final String className)
    {
    ...
    public static Object MakeBufferInputStream1327(final Object buf)
    {
        return new com.fuse.android.ByteBufferInputStream((com.uno.UnoBackedByteBuffer)buf);
    }
    
    public static Object MakeMediaDataSource1328(final Object buf)
    {
        return new com.fuse.android.ByteBufferMediaDataSource((com.uno.UnoBackedByteBuffer)buf);
    }
    
    public static Object OpenAssetFileDescriptor329(final UnoObject bundle)
    {
        try
        {
        	String uri = ExternedBlockHost.callUno_Uno_IO_BundleFile_BundlePathGet330(bundle);
