...
public class HSMRO extends android.support.v7.app.AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback
{
//#if !#(LIBRARY:Defined)
...
//#endif
    ...
    {
        Log.w("HSMRO", "GetRootActivity() is deprecated -- please use com.fuse.Activity.getRootActivity() instead.");
    ...
    {
        Log.w("HSMRO", "ShowMessageBox() is deprecated.");
        return -1;
    }
    @Deprecated
    public static AssetManager GetAssetManager()
    {
        Log.w("HSMRO", "GetAssetManager() is deprecated.");
