...
public class GraphicsSurface
{
    ...
    public static void BeginImpl313(final Object _context,final int width,final int height,final int glTextureId)
    {
    ...
    public static void EndImpl314(final Object context)
    {
    ...
    public static void LoadBitmap315(final Object context,final int width,final int height)
    {
    ...
    public static Object LoadImage316(final int glTextureId,final int width,final int height)
    {
