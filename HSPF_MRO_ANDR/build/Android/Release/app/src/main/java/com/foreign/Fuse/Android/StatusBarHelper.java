...
public class StatusBarHelper
{
    ...
    public static int GetStatusBarColor368()
    {
    ...
    public static void InstallGlobalListener369()
    {
        Window window = com.fuse.Activity.getRootActivity().getWindow();
        	...
        	new ViewTreeObserver.OnGlobalFocusChangeListener() {
        		...
        		public void onGlobalFocusChanged(View oldFocus, View newFocus) {
        			if (_focusWasEditText)
        				ExternedBlockHost.callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar370();
    ...
    public static boolean SetStatusBarColor371(final int color)
    {
        Window window = com.fuse.Activity.getRootActivity().getWindow();
        if (Build.VERSION.SDK_INT >= 21)
        {
