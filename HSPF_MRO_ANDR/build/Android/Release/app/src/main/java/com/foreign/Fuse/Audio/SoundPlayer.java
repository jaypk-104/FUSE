...
public class SoundPlayer
{
    ...
    public static void PlaySoundFromAFD399(final Object afd)
    {
    ...
    public static void PlaySoundFromByteArrayInner400(final Object unoStream)
    {
    ...
    public static void PlaySoundFromMediaDataSource401(final Object mediaDataSource)
    {
