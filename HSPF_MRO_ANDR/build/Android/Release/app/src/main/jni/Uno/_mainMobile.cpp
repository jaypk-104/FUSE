...
namespace g{namespace Android{uDelegateType* ActivityResultCallback_typeof();}}
...
namespace g{namespace Fuse{namespace Camera{uClassType* AndroidCamera_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* CheckPermissionsCommand_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* requestAndroidPermissions_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* ResizeImageCallback_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* TakePictureCallback_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* TakePictureCommand_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uClassType* AndroidCameraRoll_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uType* AddPicturePermissionCheckCommand_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uType* CheckPermissionsCommand_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uType* requestAndroidPermissions_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uType* SelectPictureClosure_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uType* SelectPicturePermissionCheckCommand_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Native{::g::Fuse::Controls::Panel_type* DatePickerBase_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Native{::g::Fuse::Controls::Panel_type* TimePickerBase_typeof();}}
...
namespace g{namespace Fuse{namespace ImageTools{struct PCommand_type; ::g::Fuse::ImageTools::PCommand_type* CropCommand_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{struct PCommand_type; ::g::Fuse::ImageTools::PCommand_type* ImageTools__GetBase64Command_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{struct PCommand_type; ::g::Fuse::ImageTools::PCommand_type* ImageTools__ImageFromBase64Command_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{struct PCommand_type; ::g::Fuse::ImageTools::PCommand_type* ResizeCommand_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{struct PCommand_type; PCommand_type* PCommand_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{uClassType* AndroidImageUtils_typeof();}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::Android::ActivityResultCallback_typeof,
        ...
        (uType*(*)())&::g::Fuse::Camera::AndroidCamera_typeof,
        (uType*(*)())&::g::Fuse::Camera::Camera_typeof,
        (uType*(*)())&::g::Fuse::Camera::CheckPermissionsCommand_typeof,
        (uType*(*)())&::g::Fuse::Camera::requestAndroidPermissions_typeof,
        (uType*(*)())&::g::Fuse::Camera::ResizeImageCallback_typeof,
        (uType*(*)())&::g::Fuse::Camera::TakePictureCallback_typeof,
        (uType*(*)())&::g::Fuse::Camera::TakePictureCommand_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::AddPicturePermissionCheckCommand_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::AndroidCameraRoll_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::CameraRoll_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::CheckPermissionsCommand_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::requestAndroidPermissions_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::SelectPictureClosure_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::SelectPicturePermissionCheckCommand_typeof,
        ...
        (uType*(*)())&::g::Fuse::ImageTools::AndroidImageUtils_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::BoolPromiseCallback_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::CropCommand_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::Image_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ImagePromiseCallback_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ImageTools__GetBase64Command_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ImageTools__ImageFromBase64Command_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ImageTools_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::PCommand_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::PromiseCallback_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ResizeCommand_typeof,
