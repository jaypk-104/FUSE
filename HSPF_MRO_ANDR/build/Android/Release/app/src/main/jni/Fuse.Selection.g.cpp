...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/ToggleSelection.uno");
...
{
    ::STRINGS[0] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/WhileSelected.uno");
    ::STRINGS[13] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Selection::Selection_typeof());
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Unable to l...*/], __this, ::STRINGS[19/*"/usr/local/...*/], 28, ::STRINGS[13/*"OnRooted"*/], NULL);
        return;
    }
