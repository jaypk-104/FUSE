...
static void HttpStatusReasonPhrase__cctor__fn(uType* __type)
{
    ...
    HttpStatusReasonPhrase::Informational_ = (uObject*)(collection5 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[3/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int32_t>(100), ::STRINGS[22/*"Continue"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int32_t>(101), ::STRINGS[23/*"Switching P...*/]), collection5);
    HttpStatusReasonPhrase::Success_ = (uObject*)(collection4 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[3/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(200), ::STRINGS[24/*"OK"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(201), ::STRINGS[25/*"Created"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(202), ::STRINGS[26/*"Accepted"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(203), ::STRINGS[27/*"Non-Authori...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(204), ::STRINGS[28/*"No Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(205), ::STRINGS[29/*"Reset Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int32_t>(206), ::STRINGS[30/*"Partial Con...*/]), collection4);
    HttpStatusReasonPhrase::Redirection_ = (uObject*)(collection3 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[3/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(300), ::STRINGS[31/*"Multiple Ch...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(301), ::STRINGS[32/*"Moved Perma...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(302), ::STRINGS[33/*"Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(303), ::STRINGS[34/*"See Other"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(304), ::STRINGS[35/*"Not Modified"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(305), ::STRINGS[36/*"Use Proxy"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int32_t>(307), ::STRINGS[37/*"Temporary R...*/]), collection3);
    HttpStatusReasonPhrase::ClientErrors_ = (uObject*)(collection2 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[3/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(400), ::STRINGS[38/*"Bad Request"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(401), ::STRINGS[39/*"Unauthorized"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(402), ::STRINGS[40/*"Payment Req...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(403), ::STRINGS[41/*"Forbidden"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(404), ::STRINGS[42/*"Not Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(405), ::STRINGS[43/*"Method Not ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(406), ::STRINGS[44/*"Not Accepta...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(407), ::STRINGS[45/*"Proxy Authe...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(408), ::STRINGS[46/*"Request Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(409), ::STRINGS[47/*"Conflict"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(410), ::STRINGS[48/*"Gone"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(411), ::STRINGS[49/*"Length Requ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(412), ::STRINGS[50/*"Preconditio...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(413), ::STRINGS[51/*"Request Ent...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(414), ::STRINGS[52/*"Request-URI...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(415), ::STRINGS[53/*"Unsupported...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(416), ::STRINGS[54/*"Requested r...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int32_t>(417), ::STRINGS[55/*"Expectation...*/]), collection2);
    HttpStatusReasonPhrase::ServerErrors_ = (uObject*)(collection1 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[3/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int32_t>(500), ::STRINGS[56/*"Internal Se...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int32_t>(501), ::STRINGS[57/*"Not Impleme...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int32_t>(502), ::STRINGS[58/*"Bad Gateway"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int32_t>(503), ::STRINGS[59/*"Service Una...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int32_t>(504), ::STRINGS[60/*"Gateway Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int32_t>(505), ::STRINGS[61/*"HTTP Versio...*/]), collection1);
}

static void HttpStatusReasonPhrase_build(uType* type)
{
    ::STRINGS[22] = uString::Const("Continue");
    ::STRINGS[23] = uString::Const("Switching Protocols");
    ::STRINGS[24] = uString::Const("OK");
    ::STRINGS[25] = uString::Const("Created");
    ::STRINGS[26] = uString::Const("Accepted");
    ::STRINGS[27] = uString::Const("Non-Authoritative Information");
    ::STRINGS[28] = uString::Const("No Content");
    ::STRINGS[29] = uString::Const("Reset Content");
    ::STRINGS[30] = uString::Const("Partial Content");
    ::STRINGS[31] = uString::Const("Multiple Choices");
    ::STRINGS[32] = uString::Const("Moved Permanently");
    ::STRINGS[33] = uString::Const("Found");
    ::STRINGS[34] = uString::Const("See Other");
    ::STRINGS[35] = uString::Const("Not Modified");
    ::STRINGS[36] = uString::Const("Use Proxy");
    ::STRINGS[37] = uString::Const("Temporary Redirect");
    ::STRINGS[38] = uString::Const("Bad Request");
    ::STRINGS[39] = uString::Const("Unauthorized");
    ::STRINGS[40] = uString::Const("Payment Required");
    ::STRINGS[41] = uString::Const("Forbidden");
    ::STRINGS[42] = uString::Const("Not Found");
    ::STRINGS[43] = uString::Const("Method Not Allowed");
    ::STRINGS[44] = uString::Const("Not Acceptable");
    ::STRINGS[45] = uString::Const("Proxy Authentication Required");
    ::STRINGS[46] = uString::Const("Request Time-out");
    ::STRINGS[47] = uString::Const("Conflict");
    ::STRINGS[48] = uString::Const("Gone");
    ::STRINGS[49] = uString::Const("Length Required");
    ::STRINGS[50] = uString::Const("Precondition Failed");
    ::STRINGS[51] = uString::Const("Request Entity Too Large");
    ::STRINGS[52] = uString::Const("Request-URI Too Large");
    ::STRINGS[53] = uString::Const("Unsupported Media Type");
    ::STRINGS[54] = uString::Const("Requested range not satisfiable");
    ::STRINGS[55] = uString::Const("Expectation Failed");
    ::STRINGS[56] = uString::Const("Internal Server Error");
    ::STRINGS[57] = uString::Const("Not Implemented");
    ::STRINGS[58] = uString::Const("Bad Gateway");
    ::STRINGS[59] = uString::Const("Service Unavailable");
    ::STRINGS[60] = uString::Const("Gateway Time-out");
    ::STRINGS[61] = uString::Const("HTTP Version not supported");
...
{
    ::STRINGS[62] = uString::Const("Response type is invalid.");
    type->SetFields(4);
}
...
{
    ::STRINGS[63] = uString::Const("The object is in an invalid state.");
    type->SetFields(4);
}
...
{
    ::STRINGS[8] = uString::Const(":");
    ::STRINGS[64] = uString::Const("The scheme isn't specified in uriString.");
    ::STRINGS[65] = uString::Const("The scheme specified in uriString is not correctly formed.");
    ::STRINGS[66] = uString::Const("The length of the scheme specified in uriString exceeds 1023 characters.");
    ::STRINGS[19] = uString::Const("There is an invalid character sequence in uriString.");
    type->SetDependencies(
        ::g::Uno::Net::Http::UriScheme_typeof());
}
...
::g::Uno::Net::Http::SchemeParserResult SchemeParser::Parse(uString* uriString, int32_t* idx, bool* hasDoubleSlash)
{
    ...
    if (end < 0)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[64/*"The scheme ...*/]));

    if (((*idx + 2) >= uriString->Length()) || (end == *idx))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[65/*"The scheme ...*/]));

    if ((end - *idx) > 1023)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[66/*"The length ...*/]));
...
{
    ::STRINGS[67] = uString::Const("uriString");
    ::STRINGS[68] = uString::Const("The URI is empty");
    ::STRINGS[69] = uString::Const("The length of uriString exceeds 65519 characters.");
    ::STRINGS[20] = uString::Const("/");
    ::STRINGS[70] = uString::Const("file");
    ::STRINGS[71] = uString::Const("Hostname part required in uriString for scheme ");
    ::STRINGS[72] = uString::Const("{0}:{1}");
    ::STRINGS[73] = uString::Const("//");
    ::STRINGS[74] = uString::Const("{0}{1}@");
    ::STRINGS[75] = uString::Const("{0}{1}{2}{3}");
...
void Uri::ctor_(uString* uriString)
{
    if (::g::Uno::String::op_Equality(uriString, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[67/*"uriString"*/]));

    if (::g::Uno::String::op_Equality(uriString, ::g::Uno::String::Empty()))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[68/*"The URI is ...*/]));
...
uString* Uri::AbsoluteUri()
{
    uString* ind4;
    uString* ind5;
    uString* schemePrefix = ::g::Uno::String::Format(::STRINGS[72/*"{0}:{1}"*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, (uString*)Scheme(), _hasDoubleSlash ? ::STRINGS[73/*"//"*/] : (uString*)::g::Uno::String::Empty()));

    if (!::g::Uno::String::IsNullOrEmpty(UserInfo()))
        schemePrefix = ::g::Uno::String::Format(::STRINGS[74/*"{0}{1}@"*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, schemePrefix, (uString*)UserInfo()));

    return ::g::Uno::String::Format(::STRINGS[75/*"{0}{1}{2}{3}"*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 4, schemePrefix, (ind4 = Authority(), (ind4 != NULL) ? ind4 : (uString*)::g::Uno::String::Empty()), (uString*)PathAndQuery(), (ind5 = Fragment(), (ind5 != NULL) ? ind5 : (uString*)::g::Uno::String::Empty())));
}
...
void Uri::CreateThis(uString* uriString)
{
    ...
    {
        if (::g::Uno::String::op_Inequality(Scheme(), ::STRINGS[70/*"file"*/]))
            U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::g::Uno::String::op_Addition2(::STRINGS[71/*"Hostname pa...*/], Scheme())));
    }
}
...
static void UriScheme__cctor__fn(uType* __type)
{
    ...
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[76/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[77/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[78/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[79/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[80/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[81/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[82/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[70/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[83/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[84/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[85/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[86/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[87/*"news"*/]), collection1);
}

static void UriScheme_build(uType* type)
{
    ::STRINGS[76] = uString::Const("http");
    ::STRINGS[77] = uString::Const("https");
    ::STRINGS[78] = uString::Const("ftp");
    ::STRINGS[79] = uString::Const("gopher");
    ::STRINGS[80] = uString::Const("nntp");
    ::STRINGS[81] = uString::Const("telnet");
    ::STRINGS[82] = uString::Const("wais");
    ::STRINGS[70] = uString::Const("file");
    ::STRINGS[83] = uString::Const("prospero");
    ::STRINGS[84] = uString::Const("ws");
    ::STRINGS[85] = uString::Const("wss");
    ::STRINGS[86] = uString::Const("mailto");
    ::STRINGS[87] = uString::Const("news");
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
...
bool UriScheme::IsHttpScheme(uString* scheme)
{
    UriScheme_typeof()->Init();
    uString* s = ::g::Uno::String::ToLower(uPtr(scheme));
    return ::g::Uno::String::op_Equality(s, ::STRINGS[76/*"http"*/]) || ::g::Uno::String::op_Equality(s, ::STRINGS[77/*"https"*/]);
}
...
::g::Uno::Collections::Dictionary* UriScheme::DefaultPorts()
{
    ...
    if (UriScheme::_defaultPorts_ == NULL)
    {
        ...
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[76/*"http"*/], uCRef<int32_t>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[77/*"https"*/], uCRef<int32_t>(443));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[78/*"ftp"*/], uCRef<int32_t>(21));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[79/*"gopher"*/], uCRef<int32_t>(70));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[81/*"telnet"*/], uCRef<int32_t>(119));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[82/*"wais"*/], uCRef<int32_t>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[70/*"file"*/], uCRef<int32_t>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[83/*"prospero"*/], uCRef<int32_t>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[86/*"mailto"*/], uCRef<int32_t>(25));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[87/*"news"*/], uCRef<int32_t>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[84/*"ws"*/], uCRef<int32_t>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts_), ::STRINGS[85/*"wss"*/], uCRef<int32_t>(443));
    }
...
static void UserInfoParser_build(uType* type)
{
    ...
    ::STRINGS[89] = uString::Const("The user name or password specified in uriString is not valid.");
}
...
uString* UserInfoParser::Parse(uString* uriString, int32_t endIdx, int32_t* idx)
{
    ...
    int32_t end = ::g::Uno::String::IndexOf3(uPtr(uriString), ::STRINGS[88/*"@"*/], *idx);
    ...
    if (!UserInfoParser::IsValid(userInfo))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[89/*"The user na...*/]));
