...
static void CycleState_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.12.0/Cycle.uno");
    ::STRINGS[8] = uString::Const("Seek");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[5] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[13] = ::g::Fuse::Animations::IMixerHandle_typeof();
    type->SetDependencies(
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int32_t* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[6/*"invalid seek"*/], __this, ::STRINGS[7/*"/usr/local/...*/], 277, ::STRINGS[8/*"Seek"*/]);
...
static void MasterProperty_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.12.0/Mixer.uno");
...
static void MixerBase_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[18/*Uno.Collections.Dictionary<object, object>*/], offsetof(MixerBase, Masters), 0,
...
static void Player_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[25/*Fuse.Animations.IPlayerFeedback*/], offsetof(Player, Feedback), 0,
...
static void ResizeAnimatorState_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.12.0/Resize.uno");
    ...
    type->SetFields(6,
        ...
        ::TYPES[27/*Fuse.Animations.IResize*/], offsetof(ResizeAnimatorState, _target), 0,
        ::g::Uno::Bool_typeof(), offsetof(ResizeAnimatorState, _valid), 0,
        ::TYPES[30/*Fuse.Animations.IResizeMode*/], offsetof(ResizeAnimatorState, _relativeTo), 0,
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Resize star...*/], r, ::STRINGS[16/*"/usr/local/...*/], 98, ::STRINGS[17/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Resize star...*/], r, ::STRINGS[16/*"/usr/local/...*/], 106, ::STRINGS[17/*".ctor"*/]);
        _valid = false;
        return;
    }
...
static void SpinState_build(uType* type)
{
    ...
    type->SetFields(5,
        ...
        ::TYPES[31/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/], offsetof(SpinState, mixHandle), 0,
...
{
    ::STRINGS[19] = uString::Const("Unexpected size for attract: ");
    ::STRINGS[20] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.12.0/Attract.uno");
    ::STRINGS[21] = uString::Const("NeedSim");
    ::TYPES[32] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL);
    ::TYPES[33] = ::g::Uno::IDisposable_typeof();
    ::TYPES[34] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float_typeof(), NULL);
    ::TYPES[35] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[36] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float3_typeof(), NULL);
    ::TYPES[37] = ::g::Fuse::Reactive::IListener_typeof();
    ::TYPES[38] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float_typeof(), NULL);
    ::TYPES[39] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[40] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float3_typeof(), NULL);
    ::TYPES[41] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL);
    ::TYPES[42] = type->MakeMethod(0/*OnValueUpdate<float>*/, ::g::Uno::Float_typeof(), NULL);
    ::TYPES[43] = type->MakeMethod(0/*OnValueUpdate<float2>*/, ::g::Uno::Float2_typeof(), NULL);
    ::TYPES[44] = type->MakeMethod(0/*OnValueUpdate<float3>*/, ::g::Uno::Float3_typeof(), NULL);
    ::TYPES[45] = type->MakeMethod(0/*OnValueUpdate<float4>*/, ::g::Uno::Float4_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Marshal_typeof());
    type->SetInterfaces(
        ::TYPES[33/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::InnerListener_type, interface0),
        ::TYPES[37/*Fuse.Reactive.IListener*/], offsetof(::g::Fuse::Reactive::InnerListener_type, interface1));
    type->SetFields(2,
        ::TYPES[37/*Fuse.Reactive.IListener*/], offsetof(Attract__Subscription, _target), 0,
        ::g::Fuse::Animations::Attract_typeof(), offsetof(Attract__Subscription, _attract), 0,
        ::TYPES[33/*Uno.IDisposable*/], offsetof(Attract__Subscription, _sourceSub), 0,
        ::TYPES[32/*Fuse.Animations.DestinationBehavior<float4>*/], offsetof(Attract__Subscription, _simulation4), 0,
        ::TYPES[36/*Fuse.Animations.DestinationBehavior<float3>*/], offsetof(Attract__Subscription, _simulation3), 0,
        ::TYPES[35/*Fuse.Animations.DestinationBehavior<float2>*/], offsetof(Attract__Subscription, _simulation2), 0,
        ::TYPES[34/*Fuse.Animations.DestinationBehavior<float>*/], offsetof(Attract__Subscription, _simulation1), 0,
...
void Attract__Subscription__Dispose_fn(Attract__Subscription* __this)
{
    ...
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_sourceSub), ::TYPES[33/*Uno.IDisposable*/]));
...
void Attract__Subscription__OnLostData_fn(Attract__Subscription* __this, uObject* source)
{
    ...
    if (__this->_target != NULL)
        ::g::Fuse::Reactive::IListener::OnLostData(uInterface(uPtr(__this->_target), ::TYPES[37/*Fuse.Reactive.IListener*/]), (uObject*)__this->_attract);
}
...
void Attract__Subscription__OnNewData_fn(Attract__Subscription* __this, uObject* source, uObject* oValue)
{
    ...
    if (__this->_simulation1 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation1), uCRef(value.X), uDelegate::New(::TYPES[38/*Fuse.Animations.DestinationBehavior<float>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate1_fn, __this));

    if (__this->_simulation2 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation2), uCRef(::g::Uno::Float2__New2(value.X, value.Y)), uDelegate::New(::TYPES[39/*Fuse.Animations.DestinationBehavior<float2>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate2_fn, __this));

    if (__this->_simulation3 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation3), uCRef(::g::Uno::Float3__New2(value.X, value.Y, value.Z)), uDelegate::New(::TYPES[40/*Fuse.Animations.DestinationBehavior<float3>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate3_fn, __this));

    if (__this->_simulation4 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation4), uCRef(value), uDelegate::New(::TYPES[41/*Fuse.Animations.DestinationBehavior<float4>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate4_fn, __this));
}
...
void Attract__Subscription__OnValueUpdate_fn(Attract__Subscription* __this, uType* __type, void* value)
{
    ...
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(__this->_target), ::TYPES[37/*Fuse.Reactive.IListener*/]), (uObject*)__this->_attract, uBoxPtr(__type->U(0), value));
}
...
void Attract__Subscription::ctor_1(::g::Fuse::Animations::Attract* attract, uObject* context, uObject* target)
{
    ...
    _target = target;
    _attract = attract;
    _simulation4 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[32/*Fuse.Animations.DestinationBehavior<float4>*/]));
...
void Attract__Subscription::NeedSim(int32_t size)
{
    ...
    if ((size < 0) || (size > 4))
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[19/*"Unexpected ...*/], uBox<int32_t>(::g::Uno::Int_typeof(), size)), this, ::STRINGS[20/*"/usr/local/...*/], 150, ::STRINGS[21/*"NeedSim"*/]);
        return;
    }

    if ((size == 1) && (_simulation1 == NULL))
    {
        _simulation1 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[34/*Fuse.Animations.DestinationBehavior<float>*/]));
        uPtr(_simulation1)->Motion = uPtr(_attract)->_config;
    }
    else if ((size == 2) && (_simulation2 == NULL))
    {
        _simulation2 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[35/*Fuse.Animations.DestinationBehavior<float2>*/]));
        uPtr(_simulation2)->Motion = uPtr(_attract)->_config;
    }
    else if ((size == 3) && (_simulation3 == NULL))
    {
        _simulation3 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[36/*Fuse.Animations.DestinationBehavior<float3>*/]));
...
{
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[42/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float>*/], uCRef(value));
}

// private void OnValueUpdate2(float2 value) [instance]
void Attract__Subscription::OnValueUpdate2(::g::Uno::Float2 value)
{
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[43/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float2>*/], uCRef(value));
}

// private void OnValueUpdate3(float3 value) [instance]
void Attract__Subscription::OnValueUpdate3(::g::Uno::Float3 value)
{
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[44/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float3>*/], uCRef(value));
}

// private void OnValueUpdate4(float4 value) [instance]
void Attract__Subscription::OnValueUpdate4(::g::Uno::Float4 value)
{
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[45/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float4>*/], uCRef(value));
}
...
static void TrackAnimator_build(uType* type)
{
    ...
    type->SetFields(4,
        ::TYPES[46/*Fuse.Animations.TrackProvider*/], offsetof(TrackAnimator, _discreteProvider), 0,
        ::g::Uno::Bool_typeof(), offsetof(TrackAnimator, _isDiscrete), 0,
        ::TYPES[46/*Fuse.Animations.TrackProvider*/], offsetof(TrackAnimator, _continuousProvider), 0,
...
static void TrackAnimatorState_build(uType* type)
{
    ...
    type->SetFields(3,
        ...
        ::TYPES[16/*Fuse.Animations.ContinuousTrackProvider*/], offsetof(TrackAnimatorState, _continuousProvider), 0,
        ::TYPES[47/*Fuse.Animations.DiscreteTrackProvider*/], offsetof(TrackAnimatorState, _discreteProvider), 0);
}
...
void TrackAnimatorState__SeekProgress_fn(TrackAnimatorState* __this, double* progress, double* interval, int32_t* dir, double* strength, int32_t* __retval)
{
    ...
    if (__this->_continuousProvider != NULL)
    {
        double oStrength;
        ::g::Uno::Float4 oValue;
        int32_t r = ::g::Fuse::Animations::ContinuousTrackProvider::GetSeekProgress(uInterface(uPtr(__this->_continuousProvider), ::TYPES[16/*Fuse.Animations.ContinuousTrackProvider*/]), __this, progress_, interval_, dir_, &oValue, &oStrength);
    ...
    if (__this->_discreteProvider != NULL)
    {
        double oStrength1;
        uObject* oValue1;
        int32_t r1 = ::g::Fuse::Animations::DiscreteTrackProvider::GetSeekProgress(uInterface(uPtr(__this->_discreteProvider), ::TYPES[47/*Fuse.Animations.DiscreteTrackProvider*/]), __this, progress_, interval_, dir_, &oValue1, &oStrength1);
...
void TrackAnimatorState__SeekTime_fn(TrackAnimatorState* __this, double* elapsed, double* interval, int32_t* dir, double* strength, int32_t* __retval)
{
    ...
    if (__this->_continuousProvider != NULL)
    {
        double oStrength;
        ::g::Uno::Float4 oValue;
        int32_t r = ::g::Fuse::Animations::ContinuousTrackProvider::GetSeekTime(uInterface(uPtr(__this->_continuousProvider), ::TYPES[16/*Fuse.Animations.ContinuousTrackProvider*/]), __this, relTime, interval_, dir_, &oValue, &oStrength);
        __this->SeekValue(oValue, (float)((oStrength * strength_) * uPtr(__this->Animator)->Weight()));
        return *__retval = r, void();
    }
    ...
    if (__this->_discreteProvider != NULL)
    {
        double oStrength1;
        uObject* oValue1;
        int32_t r1 = ::g::Fuse::Animations::DiscreteTrackProvider::GetSeekTime(uInterface(uPtr(__this->_discreteProvider), ::TYPES[47/*Fuse.Animations.DiscreteTrackProvider*/]), __this, relTime, interval_, dir_, &oValue1, &oStrength1);
        __this->SeekObjectValue(oValue1, (float)((oStrength1 * strength_) * uPtr(__this->Animator)->Weight()));
        return *__retval = r1, void();
    }
...
{
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[49] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof(), NULL);
    ::TYPES[50] = ::g::Fuse::Transform_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::IMixerHandle_typeof()->MakeType(::TYPES[50/*Fuse.Transform*/], NULL);
    type->SetDependencies(
        ::g::Fuse::Node_typeof());
    type->SetFields(6,
        ::g::Fuse::Animations::TransformAnimator_typeof()->MakeType(type->T(0), NULL), offsetof(TransformAnimatorState, Animator1), 0,
        ::TYPES[31/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/], offsetof(TransformAnimatorState, mixHandle), 0,
        type->T(0), offsetof(TransformAnimatorState, transform), 0,
        ::TYPES[49/*Uno.Action<Fuse.Transform>*/], offsetof(TransformAnimatorState, _matAct), 0,
...
void TransformAnimatorState__Disable_fn(TransformAnimatorState* __this)
{
    ...
    ::g::Fuse::Animations::IMixerHandle::Unregister(uInterface(uPtr(__this->mixHandle), ::TYPES[31/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/]));
    __this->mixHandle = NULL;
    uPtr(uAs< ::g::Fuse::Transform*>(__this->transform, ::TYPES[50/*Fuse.Transform*/]))->remove_MatrixChanged(__this->_matAct);
...
void TransformAnimatorState::ctor_2(::g::Fuse::Animations::TransformAnimator* animator, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    uPtr(uAs< ::g::Fuse::Transform*>(transform, ::TYPES[50/*Fuse.Transform*/]))->add_MatrixChanged(_matAct);
...
{
    ::TYPES[51] = ::g::Fuse::Animations::AnimatorState_typeof()->Array();
    ::TYPES[52] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[2] = ::g::Uno::Action_typeof();
    type->SetDependencies(
        ::g::Uno::Math_typeof());
    type->SetFields(0,
        ::TYPES[52/*Uno.Collections.List<Fuse.Animations.Animator>*/], offsetof(TriggerAnimation, _animators), 0,
...
{
    if (_animators == NULL)
        _animators = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[52/*Uno.Collections.List<Fuse.Animations.Animator>*/]));
...
uArray* TriggerAnimation::CreateAnimatorsState(int32_t variant, ::g::Fuse::Visual* elm)
{
    ...
    if (_animators == NULL)
        return uArray::New(::TYPES[51/*Fuse.Animations.AnimatorState[]*/], 0);

    uArray* state = uArray::New(::TYPES[51/*Fuse.Animations.AnimatorState[]*/], uPtr(_animators)->Count());
