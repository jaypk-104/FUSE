...
::g::Uno::Threading::Future1* Bundle::Extract(uArray* args)
{
    ...
    uString* ret5;
    bool ret6;
    uString* searchPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int32_t>(0), ::STRINGS[23/*""*/], &ret4), ret4);
    uString* destinationPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int32_t>(1), ::STRINGS[23/*""*/], &ret5), ret5);
    bool overwrite = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<bool>*/, ::g::Uno::Bool_typeof(), NULL), args, uCRef<int32_t>(2), uCRef(false), &ret6), ret6);
...
{
    uString* ret8;
    uString* searchPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int32_t>(0), ::STRINGS[23/*""*/], &ret8), ret8);
