...
{
    ::STRINGS[22] = uString::Const("(Object Freeze)");
    ::STRINGS[23] = uString::Const("Object.freeze");
    ::TYPES[14] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[10] = uObject_typeof()->Array();
...
{
    ::g::Fuse::Scripting::Function* freeze = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(::STRINGS[22/*"(Object Fre...*/], ::STRINGS[23/*"Object.freeze"*/]), ::TYPES[14/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[24] = uString::Const("exports");
    ::STRINGS[25] = uString::Const("disposed");
    ::STRINGS[26] = uString::Const("id");
    ::TYPES[10] = uObject_typeof()->Array();
    ::TYPES[9] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetDependencies(
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[24/*"exports"*/], CreateExportsObject(c));
    module->Item(::STRINGS[25/*"disposed"*/], c->NewArray(uArray::New(::TYPES[10/*object[]*/], 0)));
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[26/*"id"*/], id);
...
static void ModuleResult_build(uType* type)
{
    ::STRINGS[24] = uString::Const("exports");
    ::STRINGS[25] = uString::Const("disposed");
    ::STRINGS[27] = uString::Const("(unknown module)");
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[27/*"(unknown mo...*/], void();
}
...
{
    return uPtr(_object)->Item(::STRINGS[24/*"exports"*/]);
}
...
{
    if (uPtr(_object)->ContainsKey(::STRINGS[25/*"disposed"*/]))
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(_object)->Item(::STRINGS[25/*"disposed"*/]), ::TYPES[16/*Fuse.Scripting.Array*/]);
...
{
    ::STRINGS[28] = uString::Const("obj");
    ::STRINGS[29] = uString::Const("context");
    type->SetFields(0,
...
{
    if (obj == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[28/*"obj"*/]));

    if (context == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[29/*"context"*/]));
...
{
    ::STRINGS[30] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[24] = uString::Const("exports");
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (module != NULL)
    {
        ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[24/*"exports"*/]), ::TYPES[17/*Fuse.Scripting.Object*/]);
...
{
    if (IsEvaluated())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[30/*"NativeModul...*/]));
...
{
    uPtr(o)->CallMethod(c, ::STRINGS[31/*"on"*/], uArray::Init<uObject*>(::TYPES[10/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
{
    ::STRINGS[32] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[33] = uString::Const(" provided");
    ::STRINGS[34] = uString::Const("require(): argument must be a string");
    ::STRINGS[35] = uString::Const("ux:");
    ::STRINGS[36] = uString::Const("require(): unable to resolve ux: prefixes: ");
    ::STRINGS[37] = uString::Const("require(): ux name not found: ");
    ::STRINGS[38] = uString::Const("require(): module not found: ");
    ::STRINGS[39] = uString::Const("JavaScript error in ");
    ::STRINGS[40] = uString::Const(" was fixed!");
    ::STRINGS[41] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.12.0/ScriptModule.Require.uno");
    ::STRINGS[42] = uString::Const("Require");
    ::STRINGS[43] = uString::Const(" line ");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[32/*"require(): ...*/], uBox<int32_t>(::TYPES[31/*int*/], uPtr(args)->Length())), ::STRINGS[33/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[36/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[34/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(::g::Fuse::Scripting::Context* context, uString* id)
{
    ...
    if (module == NULL)
    {
        uString* uxPrefix = ::STRINGS[35/*"ux:"*/];

        if (::g::Uno::String::StartsWith(uPtr(id), ::STRINGS[35/*"ux:"*/]))
        {
            if (_rt == NULL)
            ...
            if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_rt), ::g::Uno::String::Substring(uPtr(id), uPtr<uString*>(::STRINGS[35/*"ux:"*/])->Length()), &res, &ret2), ret2))
                return res.Value;

            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[37/*"require(): ...*/], id)));
        }
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[39/*"JavaScript ...*/], path), ::STRINGS[40/*" was fixed!"*/]), this, ::STRINGS[41/*"/usr/local/...*/], 73, ::STRINGS[42/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[39/*"JavaScript ...*/], path), ::STRINGS[43/*" line "*/]), uBox<int32_t>(::TYPES[31/*int*/], uPtr(e)->LineNumber())), ::STRINGS[44/*". "*/]), uPtr(e)->Message()), this, ::STRINGS[41/*"/usr/local/...*/], 83, ::STRINGS[42/*"Require"*/], NULL);
...
static void ScriptException_build(uType* type)
{
    ...
    ::STRINGS[46] = uString::Const("File name: ");
    ::STRINGS[47] = uString::Const("Line number: ");
    ::STRINGS[48] = uString::Const("Script stack trace: ");
...
void ScriptException__ToString_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[48/*"Script stac...*/]);
        stringBuilder->AppendLine(__this->ScriptStackTrace());
    }

    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((::g::Uno::Exception__ToString_fn(__this, &ret2), ret2), ::STRINGS[49/*"\n"*/]), stringBuilder->ToString()), void();
}
...
void ScriptMember::ctor_(uString* name)
{
    if (::g::Uno::String::op_Equality(name, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[50/*"name"*/]));

    if (uPtr(name)->Length() == 0)
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[50/*"name"*/]));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[24/*"exports"*/]));
...
{
    ::STRINGS[51] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    if (!uIs(owner, __this->__type->T(0)))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[51/*"ScriptPrope...*/]));
