...
static void Navigation_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/Navigation.Locators.uno");
...
static void PageData_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/PageData.uno");
...
static void RouterCancelNavigation_build(uType* type)
{
    ...
    ::STRINGS[35] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/RouterCancelNavigation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Navigation::Router_typeof());
    type->SetInterfaces(
...
void RouterModify::ctor_2()
{
    ...
    ctor_1();
    ::g::Fuse::Diagnostics::UserWarning(uString::Const("RouterModify is deprecated. Use one of `ModifyRoute`, `GotoRoute` or `PushRoute` instead."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/RouterModify.uno"), 94, ::STRINGS[49/*".ctor"*/]);
}
...
void RouterModify::PerformRoute(::g::Fuse::Node* n, ::g::Fuse::Navigation::RouterPageRoute* route)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[34/*"Router not ...*/], this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/RouterModify.uno"), 216, uString::Const("PerformRoute"), NULL);
        return;
    }
...
static void RouterPageRoute_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/RouterPage.uno");
...
static void FindRouter__Subscription_build(uType* type)
{
    ...
    ::STRINGS[48] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/FindRouter.uno");
...
static void SwipeNavigate_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/SwipeNavigate.uno");
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::STRINGS[56] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/VisualNavigation.uno");
...
static void WhileNavigating_build(uType* type)
{
    ...
    ::STRINGS[59] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/WhileNavigating.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[49] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
...
{
    ::TYPES[50] = ::g::Fuse::Navigation::RoutePageProxy__ProgressUpdated_typeof();
    type->SetInterfaces(
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_proxy = ::g::Fuse::Navigation::RoutePageProxy::New2(__this->Parent(), uDelegate::New(::TYPES[50/*Fuse.Navigation.RoutePageProxy.ProgressUpdated*/], (void*)WhileNavigationTrigger__ProgressUpdated_fn, __this));
    uPtr(__this->_proxy)->Path(__this->Path());
    uPtr(__this->_proxy)->Init();
}
...
{
    ::STRINGS[60] = uString::Const("Must be used within a navigation context");
    ::STRINGS[61] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/WhilePageActive.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[20] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    type->SetDependencies(
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface8));
    type->SetFields(39,
        ::TYPES[0/*Fuse.Navigation.INavigation*/], offsetof(WhilePageActive, _navigation), 0,
...
void WhilePageActive__OnRooted_fn(WhilePageActive* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"Must be use...*/], __this, ::STRINGS[61/*"/usr/local/...*/], 61, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }

    ::g::Fuse::Navigation::INavigation::add_PageProgressChanged(uInterface(uPtr(__this->_navigation), ::TYPES[0/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[20/*Fuse.Navigation.NavigationHandler*/], (void*)WhilePageActive__OnStateChanged_fn, __this));
    __this->Update();
}
...
void WhilePageActive__OnUnrooted_fn(WhilePageActive* __this)
{
    ...
    if (__this->_navigation != NULL)
    {
        ::g::Fuse::Navigation::INavigation::remove_PageProgressChanged(uInterface(uPtr(__this->_navigation), ::TYPES[0/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[20/*Fuse.Navigation.NavigationHandler*/], (void*)WhilePageActive__OnStateChanged_fn, __this));
...
{
    ::g::Fuse::Visual* active = ::g::Fuse::Navigation::INavigation::ActivePage(uInterface(uPtr(_navigation), ::TYPES[0/*Fuse.Navigation.INavigation*/]));
    ...
    float progress = 1.0f - ::g::Uno::Math::Abs1(::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(_navigation), ::TYPES[0/*Fuse.Navigation.INavigation*/]), active).Progress);
