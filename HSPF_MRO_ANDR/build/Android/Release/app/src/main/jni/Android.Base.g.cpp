...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Targets/Android/Uno/Base/JNI.uno
// -----------------------------------------------------------------------------
...
// public static Android.Base.Primitives.jfieldID GetStaticFieldID(Android.Base.Primitives.ujclass cls, string fieldName, string fieldSig)
...
// public static Android.Base.Primitives.jfieldID GetStaticFieldID(Android.Base.Primitives.ujclass cls, string fieldName, string fieldSig) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Targets/Android/Uno/Base/Versions.uno
// ----------------------------------------------------------------------------------

// public static extern class Versions
// {
// static generated Versions()
static void Versions__cctor__fn(uType* __type)
{
    Versions::_api_ = -1;
    Versions::_release_ = ::STRINGS[0/*"<unknown>"*/];
}

static void Versions_build(uType* type)
{
    ::STRINGS[0] = uString::Const("<unknown>");
    ::STRINGS[1] = uString::Const("android/os/Build$VERSION");
    ::STRINGS[2] = uString::Const("SDK_INT");
...
// private static void Initialize() [static]
void Versions::Initialize()
{
    ...
    if (Versions::_api_ == -1)
    {
        ...
        jfieldID sdk = ::g::Android::Base::JNI::GetStaticFieldID(tmpCls, ::STRINGS[2/*"SDK_INT"*/], ::STRINGS[3/*"I"*/]);
        jfieldID release = ::g::Android::Base::JNI::GetStaticFieldID(tmpCls, ::STRINGS[4/*"RELEASE"*/], ::STRINGS[5/*"Ljava/lang/...*/]);
        Versions::_api_ = ::g::Android::Base::JNI::GetEnvPtr()->GetStaticIntField(tmpCls,sdk);
        Versions::_release_ = ::g::Android::Base::Types::String::JavaToUno1(::g::Android::Base::JNI::GetEnvPtr()->GetStaticObjectField(tmpCls,release));
    }
}
