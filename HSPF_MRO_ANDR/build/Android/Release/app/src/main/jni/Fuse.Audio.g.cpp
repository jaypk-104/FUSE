...
// /usr/local/share/uno/Packages/Fuse.Audio/1.12.0/Android/AndroidAudio.uno
// ------------------------------------------------------------------------
...
// private static void PlaySoundFromAFD(Java.Object afd)
void SoundPlayer__PlaySoundFromAFD_fn(::g::Java::Object* afd)
{
    SoundPlayer::PlaySoundFromAFD(afd);
}

// public static void PlaySoundFromBundle(Uno.UX.BundleFileSource fileSource)
...
// private static void PlaySoundFromByteArrayInner(Java.Object unoStream)
...
// private static void PlaySoundFromMediaDataSource(Java.Object mediaDataSource)
...
// private static void PlaySoundFromAFD(Java.Object afd) [static]
void SoundPlayer::PlaySoundFromAFD(::g::Java::Object* afd)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PlaySoundFromAFD399", "(Ljava/lang/Object;)V");
...
// public static void PlaySoundFromBundle(Uno.UX.BundleFileSource fileSource) [static]
...
// private static void PlaySoundFromByteArrayInner(Java.Object unoStream) [static]
void SoundPlayer::PlaySoundFromByteArrayInner(::g::Java::Object* unoStream)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PlaySoundFromByteArrayInner400", "(Ljava/lang/Object;)V");
...
// private static void PlaySoundFromMediaDataSource(Java.Object mediaDataSource) [static]
void SoundPlayer::PlaySoundFromMediaDataSource(::g::Java::Object* mediaDataSource)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PlaySoundFromMediaDataSource401", "(Ljava/lang/Object;)V");
