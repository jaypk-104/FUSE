...
// /usr/local/share/uno/Packages/Fuse.Common/1.12.0/Internal/AndroidSystemFont.uno
// -------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.12.0/Internal/ImageContainer.uno");
