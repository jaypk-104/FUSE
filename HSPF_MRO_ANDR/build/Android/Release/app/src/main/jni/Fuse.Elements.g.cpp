...
{
    InteractiveTransform::_zoomFactorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[11/*"ZoomFactor"*/]);
    InteractiveTransform::_rotationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[12/*"Rotation"*/]);
    InteractiveTransform::_translationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[13/*"Translation"*/]);
}

static void InteractiveTransform_build(uType* type)
{
    ::STRINGS[11] = uString::Const("ZoomFactor");
    ::STRINGS[12] = uString::Const("Rotation");
    ::STRINGS[13] = uString::Const("Translation");
    type->SetInterfaces(
...
{
    ::STRINGS[14] = uString::Const("Invalid value for LayoutFunction: ");
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.12.0/LayoutFunctions.uno");
    ::STRINGS[16] = uString::Const("OnNewData");
...
void LayoutFunction__Subscription__OnNewData_fn(LayoutFunction__Subscription* __this, uObject* source, uObject* elmObj)
{
    ...
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[14/*"Invalid val...*/], elmObj), __this, ::STRINGS[15/*"/usr/local/...*/], 75, ::STRINGS[16/*"OnNewData"*/], NULL);
    ::g::Fuse::Reactive::IListener::OnLostData(uInterface(uPtr(__this->_listener), ::TYPES[29/*Fuse.Reactive.IListener*/]), (uObject*)__this->_lf);
}
