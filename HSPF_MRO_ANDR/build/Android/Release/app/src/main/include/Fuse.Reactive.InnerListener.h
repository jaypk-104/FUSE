// This file was generated based on /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.12.0/Subscription.uno.
...
struct InnerListener_type : uType
{
    ...
    void(*fp_OnLostData)(::g::Fuse::Reactive::InnerListener*, uObject*);
...
struct InnerListener : uObject
{
    ...
    void OnLostData(uObject* source) { (((InnerListener_type*)__type)->fp_OnLostData)(this, source); }
