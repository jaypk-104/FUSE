...
struct Gesture : uObject
{
    ...
    int32_t _captureType;
    uStrong< ::g::Uno::Collections::List*> _down;

    void ctor_(uObject* handler, int32_t type, ::g::Fuse::Visual* target);
    void Cancel();
    void Capture(::g::Fuse::Input::PointerEventArgs* args);
    void Dispose();
    void HandleRequest(int32_t req, ::g::Fuse::Input::PointerEventArgs* args);
    bool IsHardCapture();
    ...
    void OnRequestChanged(::g::Fuse::Input::PointerEventArgs* args, int32_t captureType);
    static Gesture* New1(uObject* handler, int32_t type, ::g::Fuse::Visual* target);
