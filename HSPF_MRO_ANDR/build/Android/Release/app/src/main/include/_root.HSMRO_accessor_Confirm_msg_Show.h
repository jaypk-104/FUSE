...
namespace g{struct HSMRO_accessor_Confirm_msg_Show;}
...
struct HSMRO_accessor_Confirm_msg_Show : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return HSMRO_accessor_Confirm_msg_Show_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return HSMRO_accessor_Confirm_msg_Show_typeof()->Init(), _name_; }

    void ctor_1();
    static HSMRO_accessor_Confirm_msg_Show* New1();
};
// }
