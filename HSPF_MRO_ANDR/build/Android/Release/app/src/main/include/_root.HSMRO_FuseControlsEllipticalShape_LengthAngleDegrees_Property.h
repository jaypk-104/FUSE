...
namespace g{struct HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property;}
...
struct HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::EllipticalShape*> _obj;

    void ctor_3(::g::Fuse::Controls::EllipticalShape* obj, ::g::Uno::UX::Selector name);
    static HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property* New1(::g::Fuse::Controls::EllipticalShape* obj, ::g::Uno::UX::Selector name);
};
// }
