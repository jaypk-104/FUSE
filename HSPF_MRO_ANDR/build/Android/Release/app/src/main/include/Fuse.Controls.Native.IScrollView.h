...
struct IScrollView
{
    void(*fp_set_AllowedScrollDirections)(uObject*, int32_t*);
    void(*fp_set_ScrollPosition)(uObject*, ::g::Uno::Float2*);
    static void AllowedScrollDirections(const uInterface& __this, int32_t value) { __this.VTable<IScrollView>()->fp_set_AllowedScrollDirections(__this, &value); }
