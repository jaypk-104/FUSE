// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/Framebuffer.uno.
...
struct Framebuffer : uObject
{
    ...
    void ctor_(::g::Uno::Int2 size, int32_t format, int32_t flags);
    ...
    ::g::Uno::Int2 Size();
    static Framebuffer* New1(::g::Uno::Int2 size, int32_t format, int32_t flags);
};
// }
