...
namespace g{struct HSMRO_FuseAnimationsChangebool_Value_Property;}
...
struct HSMRO_FuseAnimationsChangebool_Value_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Animations::Change*> _obj;

    void ctor_3(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name);
    static HSMRO_FuseAnimationsChangebool_Value_Property* New1(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name);
};
// }
