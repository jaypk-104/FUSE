// This file was generated based on /usr/local/share/uno/Packages/Uno.Net.Http/1.12.0/Implementation/IHttpRequest.uno.
...
struct IHttpRequest
{
    ...
    void(*fp_GetResponseStatus)(uObject*, int32_t*);
    ...
    void(*fp_SetTimeout)(uObject*, int32_t*);
    ...
    static int32_t GetResponseStatus(const uInterface& __this) { int32_t __retval; return __this.VTable<IHttpRequest>()->fp_GetResponseStatus(__this, &__retval), __retval; }
    ...
    static void SetTimeout(const uInterface& __this, int32_t timeoutInMilliseconds) { __this.VTable<IHttpRequest>()->fp_SetTimeout(__this, &timeoutInMilliseconds); }
};
// }
