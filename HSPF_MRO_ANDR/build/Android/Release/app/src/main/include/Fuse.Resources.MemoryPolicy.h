// This file was generated based on /usr/local/share/uno/Packages/Fuse.Common/1.12.0/Resources/MemoryPolicy.uno.
...
struct MemoryPolicy : uObject
{
    ...
    bool ShouldSoftDispose(int32_t dr, uObject* resource);
