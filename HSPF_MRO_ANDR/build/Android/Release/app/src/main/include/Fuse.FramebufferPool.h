// This file was generated based on /usr/local/share/uno/Packages/Fuse.Common/1.12.0/FramebufferPool.uno.
...
struct FramebufferPool : uObject
{
    ...
    static ::g::Uno::Graphics::Framebuffer* Lock(int32_t width, int32_t height, int32_t format, bool depth);
    static ::g::Uno::Graphics::Framebuffer* Lock1(::g::Uno::Int2 size, int32_t format, bool depth);
