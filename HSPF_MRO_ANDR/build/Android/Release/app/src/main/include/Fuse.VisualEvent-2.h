// This file was generated based on /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Event.uno.
...
struct VisualEvent : uObject
{
    ...
    void Raise(::g::Fuse::VisualEventArgs* args, int32_t type, bool bubble, uDelegate* PostBubbleAction);
    void RaiseWithBubble(::g::Fuse::VisualEventArgs* args, int32_t type);
    void RaiseWithBubble1(::g::Fuse::VisualEventArgs* args, int32_t type, uDelegate* PostBubbleAction);
    void RaiseWithoutBubble(::g::Fuse::VisualEventArgs* args, int32_t type);
    template<class THandler>
