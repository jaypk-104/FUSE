// This file was generated based on /usr/local/share/uno/Packages/Fuse.Triggers/1.12.0/BusyTaskModule.uno.
...
struct BusyTaskModule__ConstructorClosure : uObject
{
    ...
    uObject* Construct(::g::Fuse::Scripting::Context* context, uArray* args);
