...
namespace g{struct LoginPage__Template4;}
...
struct LoginPage__Template4 : ::g::Uno::UX::Template
{
    uWeak< ::g::LoginPage*> __parent1;
    uWeak< ::g::LoginPage*> __parentInstance1;
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return LoginPage__Template4_typeof()->Init(), __selector0_; }

    void ctor_1(::g::LoginPage* parent, ::g::LoginPage* parentInstance);
    static LoginPage__Template4* New2(::g::LoginPage* parent, ::g::LoginPage* parentInstance);
};
// }
