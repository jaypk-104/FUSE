...
namespace g{struct SubPage_appr_inq__Template;}
...
struct SubPage_appr_inq__Template : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return SubPage_appr_inq__Template_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return SubPage_appr_inq__Template_typeof()->Init(), __selector1_; }

    void ctor_1(::g::SubPage_appr_inq* parent, ::g::SubPage_appr_inq* parentInstance);
    static SubPage_appr_inq__Template* New2(::g::SubPage_appr_inq* parent, ::g::SubPage_appr_inq* parentInstance);
};
// }
