// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoContainer.uno.
...
struct IVideoService
{
    ...
    void(*fp_get_RotationDegrees)(uObject*, int32_t*);
    ...
    static int32_t RotationDegrees(const uInterface& __this) { int32_t __retval; return __this.VTable<IVideoService>()->fp_get_RotationDegrees(__this, &__retval), __retval; }
