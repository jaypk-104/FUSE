// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/ICollection.uno.
...
struct ICollection
{
    ...
    void(*fp_get_Count)(uObject*, int32_t*);
    ...
    static int32_t Count(const uInterface& __this) { int32_t __retval; return __this.VTable<ICollection>()->fp_get_Count(__this, &__retval), __retval; }
    template<class T>
