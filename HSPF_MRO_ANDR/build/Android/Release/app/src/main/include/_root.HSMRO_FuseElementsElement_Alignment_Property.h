...
namespace g{struct HSMRO_FuseElementsElement_Alignment_Property;}
...
struct HSMRO_FuseElementsElement_Alignment_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Elements::Element*> _obj;

    void ctor_3(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
    static HSMRO_FuseElementsElement_Alignment_Property* New1(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
};
// }
