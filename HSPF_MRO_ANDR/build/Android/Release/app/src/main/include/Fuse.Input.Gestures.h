// This file was generated based on /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Gesture.uno.
...
struct Gestures : uObject
{
    ...
    static ::g::Fuse::Input::Gesture* Add(uObject* handler, ::g::Fuse::Visual* target, int32_t type);
    static void AddActive(::g::Fuse::Input::Gesture* g);
    static int32_t GetActiveGestureIndex(::g::Fuse::Input::Gesture* g);
    static int32_t PriorityOrder(Gestures__ActiveGesture* a, Gestures__ActiveGesture* b);
    ...
    static void RequestCaptureChange(::g::Fuse::Input::Gesture* gesture, ::g::Fuse::Input::PointerEventArgs* args, int32_t captureType);
