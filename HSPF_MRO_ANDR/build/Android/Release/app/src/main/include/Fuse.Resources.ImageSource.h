// This file was generated based on /usr/local/share/uno/Packages/Fuse.Elements/1.12.0/Resources/ImageSource.uno.
...
struct ImageSource_type : uType
{
    ...
    void(*fp_get_Orientation)(::g::Fuse::Resources::ImageSource*, int32_t*);
    ...
    void(*fp_get_State)(::g::Fuse::Resources::ImageSource*, int32_t*);
};
...
struct ImageSource : ::g::Uno::UX::PropertyObject
{
    ...
    int32_t Orientation() { int32_t __retval; return (((ImageSource_type*)__type)->fp_get_Orientation)(this, &__retval), __retval; }
    void Pin();
    ...
    int32_t State() { int32_t __retval; return (((ImageSource_type*)__type)->fp_get_State)(this, &__retval), __retval; }
    void Unpin();
