// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Builtins.uno.
...
struct Builtins : uObject
{
    ...
    bool UpdateModules(::g::Fuse::Scripting::Context* context);
