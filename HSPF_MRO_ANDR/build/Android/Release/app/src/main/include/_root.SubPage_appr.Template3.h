...
namespace g{struct SubPage_appr__Template3;}
...
struct SubPage_appr__Template3 : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return SubPage_appr__Template3_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return SubPage_appr__Template3_typeof()->Init(), __selector1_; }

    void ctor_1(::g::SubPage_appr* parent, ::g::SubPage_appr* parentInstance);
    static SubPage_appr__Template3* New2(::g::SubPage_appr* parent, ::g::SubPage_appr* parentInstance);
};
// }
