// This file was generated based on /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/Harfbuzz.uno.
...
struct Harfbuzz : uObject
{
    ...
    static void* buffer_create_Raw(void* font, uString* text, int32_t offset, int32_t length, bool ltr);
    ...
    static void font_set_scale(void* hbFont, int32_t x_scale, int32_t y_scale);
