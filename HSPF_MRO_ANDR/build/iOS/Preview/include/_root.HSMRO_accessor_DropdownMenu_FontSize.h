...
namespace g{struct HSMRO_accessor_DropdownMenu_FontSize;}
...
struct HSMRO_accessor_DropdownMenu_FontSize : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return HSMRO_accessor_DropdownMenu_FontSize_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return HSMRO_accessor_DropdownMenu_FontSize_typeof()->Init(), _name_; }

    void ctor_1();
    static HSMRO_accessor_DropdownMenu_FontSize* New1();
};
// }
