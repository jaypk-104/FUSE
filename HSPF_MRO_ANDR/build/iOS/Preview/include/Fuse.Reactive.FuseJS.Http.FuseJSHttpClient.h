// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Http.uno.
...
struct Http__FuseJSHttpClient : uObject
{
    ...
    uObject* CreateRequest(::g::Fuse::Scripting::Context* context, uArray* args);
