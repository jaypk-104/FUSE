...
struct CoreGraphicsSurface : ::g::Fuse::Drawing::Surface
{
    ...
    void FillPathImpl(void* path, ::g::Fuse::Drawing::Brush* fill, int32_t fillRule);
    ...
    static void* CGFloatNewArray(int32_t size);
    static void CGFloatSet(void* a, int32_t index, double value);
    static void ConcatTransform(void* cp, float m11, float m12, float m21, float m22, float m31, float m32);
    static void* CreateLinearGradient(void* cp, void* colors, void* stops, int32_t count);
    static void* CreateStrokedPath(void* path, float width, int32_t fjoin, int32_t fcap, float miterLimit);
