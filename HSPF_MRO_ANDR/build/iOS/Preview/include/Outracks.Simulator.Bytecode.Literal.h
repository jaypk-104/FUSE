// This file was generated based on /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Bytecode/Literal.cs.
...
{
    void(*fp_get_LiteralId)(::g::Outracks::Simulator::Bytecode::Literal*, char16_t*);
...
{
    void ctor_2();
    char16_t LiteralId() { char16_t __retval; return (((Literal_type*)__type)->fp_get_LiteralId)(this, &__retval), __retval; }
