// This file was generated based on /usr/local/share/uno/Packages/Fuse.ImageTools/1.12.0/ImageTools.uno.
...
struct ImageTools : ::g::Fuse::Scripting::NativeModule
{
    ...
    static ::g::Uno::Threading::Future1* Crop(::g::Fuse::ImageTools::Image* img, int32_t width, int32_t height, int32_t x, int32_t y, bool inPlace);
    ...
    static ::g::Uno::Threading::Future1* Resize(::g::Fuse::ImageTools::Image* img, int32_t desiredWidth, int32_t desiredHeight, int32_t mode, bool inPlace);
};
// }
