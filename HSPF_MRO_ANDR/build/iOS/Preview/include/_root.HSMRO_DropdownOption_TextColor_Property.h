...
namespace g{struct HSMRO_DropdownOption_TextColor_Property;}
...
struct HSMRO_DropdownOption_TextColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::DropdownOption*> _obj;

    void ctor_3(::g::DropdownOption* obj, ::g::Uno::UX::Selector name);
    static HSMRO_DropdownOption_TextColor_Property* New1(::g::DropdownOption* obj, ::g::Uno::UX::Selector name);
};
// }
