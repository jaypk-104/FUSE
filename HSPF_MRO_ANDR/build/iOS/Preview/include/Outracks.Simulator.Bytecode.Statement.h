// This file was generated based on /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Bytecode/Statement.cs.
...
{
    void(*fp_get_StatementId)(::g::Outracks::Simulator::Bytecode::Statement*, char16_t*);
...
struct Statement : uObject
{
    ...
    char16_t StatementId() { char16_t __retval; return (((Statement_type*)__type)->fp_get_StatementId)(this, &__retval), __retval; }
