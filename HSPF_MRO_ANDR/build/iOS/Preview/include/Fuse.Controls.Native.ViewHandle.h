// This file was generated based on /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/ViewHandle.iOS.uno.
...
struct ViewHandle : uObject
{
    ...
    void ctor_(::g::ObjC::Object* nativeHandle, int32_t inputMode);
    void ctor_1(::g::ObjC::Object* nativeHandle, bool isLeafView, int32_t inputMode, int32_t invalidation);
    void BringToFront();
    ...
    static ViewHandle* New1(::g::ObjC::Object* nativeHandle, int32_t inputMode);
    static ViewHandle* New2(::g::ObjC::Object* nativeHandle, bool isLeafView, int32_t inputMode, int32_t invalidation);
