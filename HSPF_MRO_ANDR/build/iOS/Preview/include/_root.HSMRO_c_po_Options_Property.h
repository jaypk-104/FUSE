...
namespace g{struct HSMRO_c_po_Options_Property;}
...
struct HSMRO_c_po_Options_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::c_po*> _obj;

    void ctor_3(::g::c_po* obj, ::g::Uno::UX::Selector name);
    static HSMRO_c_po_Options_Property* New1(::g::c_po* obj, ::g::Uno::UX::Selector name);
};
// }
