// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting/1.12.0/JSCallback.uno.
...
struct JSCallback__NumberConverter : uObject
{
    ...
    static uObject* Convert2(int32_t value, uType* targetType);
