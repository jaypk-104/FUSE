...
namespace g{struct HSMRO_accessor_ListType_USR_NM;}
...
struct HSMRO_accessor_ListType_USR_NM : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return HSMRO_accessor_ListType_USR_NM_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return HSMRO_accessor_ListType_USR_NM_typeof()->Init(), _name_; }

    void ctor_1();
    static HSMRO_accessor_ListType_USR_NM* New1();
};
// }
