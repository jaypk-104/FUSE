// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/Queue.uno.
...
struct Queue : uObject
{
    ...
    static Queue* New2(uType* __type, int32_t capacity);
};
