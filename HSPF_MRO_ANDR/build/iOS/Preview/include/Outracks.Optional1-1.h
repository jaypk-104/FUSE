...
struct Optional1
{
    ...
    void ctor_1(uType* __type, bool hasValue, T value) { Optional1__ctor_1_fn(this, __type, &hasValue, uConstrain(__type->T(0), value)); }
...
template<class T>
Optional1<T> Optional1__op_Implicit(uType* __type, ::g::Outracks::None* value) { Optional1<T> __retval; return Optional1__op_Implicit_fn(__type, value, &__retval), __retval; }
template<class T>
