...
struct Pointer : uObject
{
    ...
    static ::g::Fuse::Input::Capture* GetFirstCapture(int32_t type, int32_t pointIndex, uObject* identity);
    ...
    static bool IsCaptured(int32_t type, int32_t pointIndex, uObject* identity);
    static bool IsCaptured1(int32_t pointIndex, uObject* identity);
    static bool IsPressed();
    static bool IsPressed1(int32_t pointIndex);
    static void LoseCapture(int32_t pointIndex);
