// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.12.0/DockPanel.uno.
...
struct DockPanel : ::g::Fuse::Controls::Panel
{
    ...
    void ctor_7();
    static int32_t GetDock(::g::Fuse::Elements::Element* elm);
