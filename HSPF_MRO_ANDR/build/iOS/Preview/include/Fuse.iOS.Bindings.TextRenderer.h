// This file was generated based on /usr/local/share/uno/Packages/Fuse.iOS.TextRenderer/1.12.0/TextRenderer.uno.
...
struct TextRenderer : uObject
{
    ...
    void SoftDispose();
    static ::CGContextRef CGBitmapContextCreate(void* textureBuffer, int32_t width, int32_t height, ::CGColorSpaceRef colorSpace);
    ...
    static void DrawGlyphs(::CGContextRef context, float x, float y, int32_t width, int32_t height, ::g::ObjC::Object* layoutManager, ::g::ObjC::Object* textContainer);
