// This file was generated based on /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Stroke.uno.
...
struct Stroke : ::g::Uno::UX::PropertyObject
{
    ...
    void ctor_1();
    void ctor_2(::g::Fuse::Drawing::Brush* brush, float width, int32_t lineCap, int32_t lineJoin);
    ...
    static Stroke* New2();
    static Stroke* New3(::g::Fuse::Drawing::Brush* brush, float width, int32_t lineCap, int32_t lineJoin);
};
// }
