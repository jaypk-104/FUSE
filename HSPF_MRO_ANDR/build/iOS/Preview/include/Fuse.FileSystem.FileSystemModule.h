// This file was generated based on /usr/local/share/uno/Packages/Fuse.FileSystem/1.12.0/FileSystemModule.uno.
...
struct FileSystemModule : ::g::Fuse::Scripting::NativeModule
{
    ...
    ::g::Uno::Threading::Future1* Remove(uArray* args);
    uObject* RemoveSync(::g::Fuse::Scripting::Context* context, uArray* args);
