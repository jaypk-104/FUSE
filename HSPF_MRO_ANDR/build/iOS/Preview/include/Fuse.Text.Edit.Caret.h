// This file was generated based on /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Edit.uno.
...
struct Caret
{
    ...
    void ctor_1(int32_t cluster, int32_t lineIndex, int32_t runIndex, ::g::Uno::Float2 visualPos);
};
