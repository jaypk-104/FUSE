// This file was generated based on /usr/local/share/uno/Packages/Fuse.Animations/1.12.0/Attract.uno.
...
struct Attract__Subscription : ::g::Fuse::Reactive::InnerListener
{
    ...
    bool BadValue(::g::Uno::Float4 value);
    void CleanSimulation();
    void Init(uObject* context);
    void NeedSim(int32_t size);
    template<class T>
