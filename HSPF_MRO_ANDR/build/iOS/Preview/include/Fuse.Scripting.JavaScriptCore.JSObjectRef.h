...
struct JSObjectRef
{
    ...
    static ::JSValueRef GetPropertyAtIndex(::JSObjectRef __this, ::JSContextRef ctx, int32_t index, ::JSValueRef* exception);
    static ::JSValueRef GetPropertyAtIndex1(::JSObjectRef __this, ::JSContextRef ctx, int32_t index, uDelegate* onException);
    ...
    static void SetPropertyAtIndex(::JSObjectRef __this, ::JSContextRef ctx, int32_t index, ::JSValueRef value, ::JSValueRef* exception);
    static void SetPropertyAtIndex1(::JSObjectRef __this, ::JSContextRef ctx, int32_t index, ::JSValueRef value, uDelegate* onException);
