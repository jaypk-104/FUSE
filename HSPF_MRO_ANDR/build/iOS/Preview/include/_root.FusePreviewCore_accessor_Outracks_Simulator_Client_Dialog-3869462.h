...
// internal sealed class FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_LoadingScreen_Header
// {
...
struct FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_LoadingScreen_Header : ::g::Uno::UX::PropertyAccessor
{
    ...
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_LoadingScreen_Header_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_LoadingScreen_Header_typeof()->Init(), _name_; }
