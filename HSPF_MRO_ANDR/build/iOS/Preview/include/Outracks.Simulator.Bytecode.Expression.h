// This file was generated based on /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Bytecode/Expression.cs.
...
{
    void(*fp_get_ExpressionId)(::g::Outracks::Simulator::Bytecode::Expression*, char16_t*);
...
struct Expression : ::g::Outracks::Simulator::Bytecode::Statement
{
    ...
    void ctor_1();
    char16_t ExpressionId() { char16_t __retval; return (((Expression_type*)__type)->fp_get_ExpressionId)(this, &__retval), __retval; }
