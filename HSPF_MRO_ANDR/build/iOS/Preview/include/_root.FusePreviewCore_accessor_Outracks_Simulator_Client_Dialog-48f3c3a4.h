...
// internal sealed class FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body
// {
...
struct FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body : ::g::Uno::UX::PropertyAccessor
{
    ...
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body_typeof()->Init(), _name_; }
