// This file was generated based on /usr/local/share/uno/Packages/Fuse.Elements/1.12.0/Caching/ElementBatcher.uno.
...
struct ElementBatcher : uObject
{
    ...
    static bool ShouldBatchElementWithCachingMode(int32_t mode);
    static bool ShouldBatchElementWithSize(::g::Uno::Int2 size);
    static int32_t MaxElementPixels();
