// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Platform/Window.uno.
...
struct Window : ::g::Uno::Platform::OSFrame
{
    ...
    int32_t PointerCursor();
    void PointerCursor(int32_t value);
