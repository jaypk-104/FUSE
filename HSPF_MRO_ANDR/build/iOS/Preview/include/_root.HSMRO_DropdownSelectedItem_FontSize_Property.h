...
namespace g{struct HSMRO_DropdownSelectedItem_FontSize_Property;}
...
struct HSMRO_DropdownSelectedItem_FontSize_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::DropdownSelectedItem*> _obj;

    void ctor_3(::g::DropdownSelectedItem* obj, ::g::Uno::UX::Selector name);
    static HSMRO_DropdownSelectedItem_FontSize_Property* New1(::g::DropdownSelectedItem* obj, ::g::Uno::UX::Selector name);
};
// }
