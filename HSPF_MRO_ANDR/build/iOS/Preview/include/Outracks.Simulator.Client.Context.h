// This file was generated based on /usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/Context.uno.
...
struct Context : uObject
{
    ...
    static int32_t _InputMode_;
    static int32_t& _InputMode() { return _InputMode_; }
    ...
    static int32_t InputMode();
    static void InputMode(int32_t value);
