// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/IO/TextWriter.uno.
...
struct TextWriter_type : uType
{
    ...
    void(*fp_Write1)(::g::Uno::IO::TextWriter*, char16_t*);
    void(*fp_Write3)(::g::Uno::IO::TextWriter*, uArray*, int32_t*, int32_t*);
...
struct TextWriter : uObject
{
    ...
    uString* NewLine();
    void NewLine(uString* value);
    void Write(bool value);
    void Write1(char16_t value) { (((TextWriter_type*)__type)->fp_Write1)(this, &value); }
    void Write2(uArray* buffer);
    void Write3(uArray* buffer, int32_t index, int32_t count) { (((TextWriter_type*)__type)->fp_Write3)(this, buffer, &index, &count); }
    void Write4(double value);
    void Write5(float value);
    void Write6(int32_t value);
    ...
    void WriteLine2(char16_t value);
    void WriteLine3(uArray* buffer);
    void WriteLine4(uArray* buffer, int32_t index, int32_t count);
    void WriteLine5(double value);
    void WriteLine6(float value);
    void WriteLine7(int32_t value);
    ...
    static void Write1(TextWriter* __this, char16_t value) { TextWriter__Write1_fn(__this, &value); }
    static void Write3(TextWriter* __this, uArray* buffer, int32_t index, int32_t count) { TextWriter__Write3_fn(__this, buffer, &index, &count); }
