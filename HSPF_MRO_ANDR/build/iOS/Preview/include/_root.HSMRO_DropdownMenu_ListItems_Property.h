...
namespace g{struct HSMRO_DropdownMenu_ListItems_Property;}
...
struct HSMRO_DropdownMenu_ListItems_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::DropdownMenu*> _obj;

    void ctor_3(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name);
    static HSMRO_DropdownMenu_ListItems_Property* New1(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name);
};
// }
