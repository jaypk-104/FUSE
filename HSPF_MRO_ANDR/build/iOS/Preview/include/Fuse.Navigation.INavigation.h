// This file was generated based on /usr/local/share/uno/Packages/Fuse.Navigation/1.12.0/INavigation.uno.
...
struct INavigation
{
    ...
    void(*fp_GetPage)(uObject*, int32_t*, ::g::Fuse::Visual**);
    ...
    void(*fp_get_PageCount)(uObject*, int32_t*);
    ...
    static ::g::Fuse::Visual* GetPage(const uInterface& __this, int32_t index) { ::g::Fuse::Visual* __retval; return __this.VTable<INavigation>()->fp_GetPage(__this, &index, &__retval), __retval; }
    ...
    static int32_t PageCount(const uInterface& __this) { int32_t __retval; return __this.VTable<INavigation>()->fp_get_PageCount(__this, &__retval), __retval; }
