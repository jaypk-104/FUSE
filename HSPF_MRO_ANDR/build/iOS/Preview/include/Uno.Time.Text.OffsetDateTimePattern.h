// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/Text/OffsetDateTimePattern.uno.
...
struct OffsetDateTimePattern : uObject
{
    ...
    int32_t GetDay(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetHour(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetMillisecond(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetMinute(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetMonth(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    ::g::Uno::Time::Offset GetOffset(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetSecond(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetSign(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    int32_t GetYear(OffsetDateTimePattern__OffsetDateTimeBucket* value);
    ::g::Uno::Time::Text::ParseResult* Parse(uString* text);
    void SetDay(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t day);
    void SetHour(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t hour);
    void SetMillisecond(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t millisecond);
    void SetMinute(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t minute);
    void SetMonth(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t month);
    void SetOffset(OffsetDateTimePattern__OffsetDateTimeBucket* value, ::g::Uno::Time::Offset offset);
    void SetSecond(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t second);
    void SetSign(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t sign);
    void SetYear(OffsetDateTimePattern__OffsetDateTimeBucket* value, int32_t year);
