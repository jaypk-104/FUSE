// This file was generated based on /usr/local/share/uno/Packages/Fuse.Common/1.12.0/Internal/RectPacker.uno.
...
struct RectPacker : uObject
{
    ...
    bool TryFit(::g::Uno::Collections::LinkedListNode* node, ::g::Uno::Int2 size, int32_t* height);
