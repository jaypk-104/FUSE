// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/iOS/VideoImpl.uno.
...
struct VideoPlayerImpl : uObject
{
    ...
    static int32_t GetHeight(void* videoState);
    static double GetPosition(void* videoState);
    static int32_t GetRotation(void* videoState);
    static float GetVolume(void* videoState);
    static int32_t GetWidth(void* videoState);
