// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/IO/Directory.uno.
...
struct Directory : uObject
{
    ...
    static uString* GetBaseDirectory();
    static uString* GetCurrentDirectory();
    static uString* GetUserDirectory(int32_t dir);
    static uString* GetUserDirectoryApple(int32_t directory);
