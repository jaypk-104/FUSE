// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Timer.uno.
...
struct TimerModule : ::g::Fuse::Scripting::NativeModule
{
    ...
    uObject* Destroy(::g::Fuse::Scripting::Context* context, uArray* args);
    double MinTimeout();
