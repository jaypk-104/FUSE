// This file was generated based on /usr/local/share/uno/Packages/Fuse.Elements/1.12.0/Caching/ElementAtlas.uno.
...
struct ElementAtlas : uObject
{
    ...
    int32_t _invalidElements;
    int32_t _spilledPixels;
