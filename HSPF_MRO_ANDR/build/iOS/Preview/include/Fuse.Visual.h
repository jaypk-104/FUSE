...
struct Visual_type : ::g::Fuse::Node_type
{
    ...
    void(*fp_get_HitTestTransform)(::g::Fuse::Visual*, int32_t*);
...
void Visual__GetVisualChild_fn(Visual* __this, int32_t* index, Visual** __retval);
void Visual__GetZOrderChild_fn(Visual* __this, int32_t* index, Visual** __retval);
...
void Visual__SubtreeToString1_fn(Visual* __this, ::g::Uno::Text::StringBuilder* sb, int32_t* indent);
...
void Visual__get_ZOrderChildCount_fn(Visual* __this, int32_t* __retval);
...
struct Visual : ::g::Fuse::Node
{
    ...
    Visual* GetVisualChild(int32_t index);
    Visual* GetZOrderChild(int32_t index);
    ...
    int32_t HitTestTransform() { int32_t __retval; return (((Visual_type*)__type)->fp_get_HitTestTransform)(this, &__retval), __retval; }
    ...
    static int32_t HitTestTransform(Visual* __this) { int32_t __retval; return Visual__get_HitTestTransform_fn(__this, &__retval), __retval; }
