...
namespace g{struct HSMRO_FuseControlsDatePickerBase_MinValue_Property;}
...
struct HSMRO_FuseControlsDatePickerBase_MinValue_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::DatePickerBase*> _obj;

    void ctor_3(::g::Fuse::Controls::DatePickerBase* obj, ::g::Uno::UX::Selector name);
    static HSMRO_FuseControlsDatePickerBase_MinValue_Property* New1(::g::Fuse::Controls::DatePickerBase* obj, ::g::Uno::UX::Selector name);
};
// }
