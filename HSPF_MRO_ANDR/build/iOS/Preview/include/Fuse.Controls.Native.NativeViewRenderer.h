// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.12.0/NativeRenderer.uno.
...
struct NativeViewRenderer : uObject
{
    ...
    static void* AllocPixelBuffer(int32_t width, int32_t height);
    static void FreePixelBuffer(void* buffer);
    static NativeViewRenderer* New1();
    static void Upload(::g::ObjC::Object* viewHandle, int32_t textureName, void* pixelBufferHandle, int32_t width, int32_t height, float density, bool reuse);
};
// }
