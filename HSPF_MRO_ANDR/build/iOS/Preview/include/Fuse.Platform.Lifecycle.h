// This file was generated based on /usr/local/share/uno/Packages/Fuse.Platform/1.12.0/Lifecycle.uno.
...
struct Lifecycle : uObject
{
    ...
    static void OnEnteringBackground(int32_t newState);
    static void OnEnteringForeground(int32_t newState);
    static void OnEnteringInteractive(int32_t newState);
    static void OnExitedInteractive(int32_t newState);
    static void OnStarted(int32_t newState);
