// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/RangeControls/CircularRangeBehavior.uno.
...
struct double2
{
    ...
    void ctor_1(double x, double y);
    void ctor_2(::g::Uno::Float2 v);
