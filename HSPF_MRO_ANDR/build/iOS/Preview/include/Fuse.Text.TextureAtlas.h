...
struct TextureAtlas : uObject
{
    ...
    void ctor_(::g::Uno::Int2 minimumTextureSize, int32_t format, ::g::Uno::Collections::List* textures);
    ...
    static TextureAtlas* New1(::g::Uno::Int2 minimumTextureSize, int32_t format, ::g::Uno::Collections::List* textures);
};
// }
