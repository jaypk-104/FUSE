...
// public Application(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines)
...
// public Application New(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines)
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args)
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args)
...
void Application__OnUpdate_fn(Application* __this)
{
    ...
    while ((::g::Outracks::Simulator::ConcurrentQueue__TryDequeue_fn(uPtr(__this->_exception), (void**)(&t), &ret4), ret4))
        exception = t;
    ...
    while ((::g::Outracks::Simulator::ConcurrentQueue__TryDequeue_fn(uPtr(__this->_dispatcher), (void**)(&action), &ret5), ret5))
...
// public generated Outracks.Simulator.Runtime.IReflection get_Reflection()
void Application__get_Reflection_fn(Application* __this, uObject** __retval)
{
    *__retval = __this->Reflection();
}

// public generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value)
void Application__set_Reflection_fn(Application* __this, uObject* value)
{
    __this->Reflection(value);
}

// public void ResetEverything(bool initial, [object overlay])
...
// private void SetState(Outracks.Simulator.Client.State nextState)
...
// public Application(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines) [instance]
...
// private void DoNothing() [instance]
...
void Application::OnPointerReleased(::g::Fuse::Input::PointerReleasedArgs* args)
{
    ...
    ::g::Fuse::Input::PointerPressedArgs* ret3;

    for (int32_t i = 0; i < uPtr(pointers)->Count(); i++)
        if (uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int32_t>(i), &ret3), ret3))->PointIndex() == uPtr(args)->PointIndex())
        {
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) [instance]
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) [instance]
...
// public generated Outracks.Simulator.Runtime.IReflection get_Reflection() [instance]
uObject* Application::Reflection()
{
    return _Reflection;
}

// public generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) [instance]
void Application::Reflection(uObject* value)
{
    _Reflection = value;
}

// public void ResetEverything(bool initial, [object overlay]) [instance]
void Application::ResetEverything(bool initial, uObject* overlay)
{
                ...
                {
                    {
                        ...
                        {
                            ::g::Fuse::Node* panel = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[10/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret6), ret6);
    ...
    ::g::Fuse::Controls::Panel* p = ::g::Fuse::Controls::Panel::New3();

    if (overlay != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), uCast< ::g::Fuse::Node*>(overlay, ::TYPES[14/*Fuse.Node*/]));
    else if ((::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/])) > 0) && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(uCast< ::g::Fuse::Controls::Panel*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[15/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int32_t>(0), &ret7), ret7), ::TYPES[12/*Fuse.Controls.Panel*/]))->Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/])) > 0))
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(uCast< ::g::Fuse::Controls::Panel*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[15/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int32_t>(0), &ret9), ret9), ::TYPES[12/*Fuse.Controls.Panel*/]))->Children()), ::TYPES[15/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int32_t>(0), &ret8), ret8));

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(p->Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), fakeApp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), p);
}

// private void SetState(Outracks.Simulator.Client.State nextState) [instance]
...
// private void ShowDeveloperMenu() [instance]
void Application::ShowDeveloperMenu()
{
    ...
    for (int32_t i = 0; i < uPtr(pointers)->Count(); i++)
        if (uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int32_t>(i), &ret10), ret10))->TryHardCapture(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Application__DoNothing_fn, this), NULL))
            uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int32_t>(i), &ret11), ret11))->ReleaseCapture(this);

    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), _developerMenu, &ret12), ret12))
...
// public Application New(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines) [static]
Application* Application::New2(uArray* proxyEndpoints, uString* project, uArray* defines)
{
    ...
    obj2->ctor_4(proxyEndpoints, project, defines);
    return obj2;
}
// }
...
// internal sealed class ChangeIp
// {
...
// public ChangeIp New([string body])
void ChangeIp__New1_fn(uString* body, ChangeIp** __retval)
{
    *__retval = ChangeIp::New1(body);
}

// protected override sealed Outracks.Simulator.Client.State OnCancel()
...
// public override sealed Outracks.Simulator.Client.State OnException(Uno.Exception e)
...
// protected override sealed Outracks.Simulator.Client.State OnOk(string input)
...
// protected Connected(Outracks.Simulator.ISimulatorClient client)
...
// private Outracks.Simulator.Client.State NextState(Outracks.IBinaryMessage message)
...
// protected Outracks.Simulator.Client.State OnConnectionError(Outracks.Simulator.Protocol.Error error)
...
// public override Outracks.Simulator.Client.State OnEnterState()
...
// protected Outracks.Simulator.Client.State OnExecute(Outracks.Simulator.Protocol.BytecodeUpdated args)
...
// protected Outracks.Simulator.Client.State OnReify(Outracks.Simulator.Protocol.BytecodeGenerated reify)
...
// public override Outracks.Simulator.Client.State OnUpdate()
...
// protected Connected(Outracks.Simulator.ISimulatorClient client) [instance]
...
// public void DismissAllActiveDiagnostics() [instance]
...
// private Outracks.Simulator.Client.State NextState(Outracks.IBinaryMessage message) [instance]
...
// protected Outracks.Simulator.Client.State OnConnectionError(Outracks.Simulator.Protocol.Error error) [instance]
...
// private void OnDiagnosticDismissed(Fuse.Diagnostic d) [instance]
...
// private void OnDiagnosticReported(Fuse.Diagnostic d) [instance]
...
// protected Outracks.Simulator.Client.State OnExecute(Outracks.Simulator.Protocol.BytecodeUpdated args) [instance]
...
// protected Outracks.Simulator.Client.State OnReify(Outracks.Simulator.Protocol.BytecodeGenerated reify) [instance]
...
// private void SendDebugLog(string text, Uno.Diagnostics.DebugMessageType type) [instance]
...
// internal abstract class Connecting
// {
...
// protected generated Connecting()
...
// protected generated Connecting() [instance]
...
// internal sealed class ConnectingToHost
// {
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints)
void ConnectingToHost__ctor_2_fn(ConnectingToHost* __this, uObject* simulatorEndpoints)
{
    __this->ctor_2(simulatorEndpoints);
}

// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints)
...
// public override sealed Outracks.Simulator.Client.State OnEnterState()
...
// public override sealed Outracks.Simulator.Client.State OnUpdate()
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [instance]
...
// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static]
...
// internal sealed class ConnectingToProxy
// {
...
// public ConnectingToProxy() [instance]
...
// public ConnectingToProxy(Uno.Net.IPEndPoint[] proxyEndpoints) [instance]
...
// public ConnectingToProxy New() [static]
...
// public ConnectingToProxy New(Uno.Net.IPEndPoint[] proxyEndpoints) [static]
...
// internal sealed class ConnectionLost
// {
...
// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception)
...
// public ConnectionLost(Uno.Exception exception)
void ConnectionLost__ctor_3_fn(ConnectionLost* __this, ::g::Uno::Exception* exception)
{
    __this->ctor_3(exception);
}

// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception)
...
// public ConnectionLost New(Uno.Exception exception)
void ConnectionLost__New3_fn(::g::Uno::Exception* exception, ConnectionLost** __retval)
{
    *__retval = ConnectionLost::New3(exception);
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) [instance]
...
// public ConnectionLost(Uno.Exception exception) [instance]
...
// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) [static]
...
// public ConnectionLost New(Uno.Exception exception) [static]
...
// public static generated Outracks.Simulator.Client.FakeApp get_App()
void Context__get_App_fn(::g::Outracks::Simulator::Client::FakeApp** __retval)
{
    *__retval = Context::App();
}

// private static generated void set_App(Outracks.Simulator.Client.FakeApp value)
void Context__set_App_fn(::g::Outracks::Simulator::Client::FakeApp* value)
{
    Context::App(value);
}

// public static generated string[] get_Defines()
void Context__get_Defines_fn(uArray** __retval)
{
    *__retval = Context::Defines();
}

// private static generated void set_Defines(string[] value)
void Context__set_Defines_fn(uArray* value)
{
    Context::Defines(value);
}

// public static generated Outracks.Simulator.Client.InputMode get_InputMode()
void Context__get_InputMode_fn(int32_t* __retval)
{
    *__retval = Context::InputMode();
}

// private static generated void set_InputMode(Outracks.Simulator.Client.InputMode value)
void Context__set_InputMode_fn(int32_t* value)
{
    Context::InputMode(*value);
}

// public static generated string get_Project()
void Context__get_Project_fn(uString** __retval)
{
    *__retval = Context::Project();
}

// private static generated void set_Project(string value)
void Context__set_Project_fn(uString* value)
{
    Context::Project(value);
}

// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints()
void Context__get_ProxyEndpoints_fn(uArray** __retval)
{
    *__retval = Context::ProxyEndpoints();
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value)
void Context__set_ProxyEndpoints_fn(uArray* value)
{
    Context::ProxyEndpoints(value);
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection()
void Context__get_Reflection_fn(uObject** __retval)
{
    *__retval = Context::Reflection();
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value)
void Context__set_Reflection_fn(uObject* value)
{
    Context::Reflection(value);
}

// public static void SetApp(Outracks.Simulator.Client.FakeApp app)
void Context__SetApp_fn(::g::Outracks::Simulator::Client::FakeApp* app)
{
    Context::SetApp(app);
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines)
...
// public static void SetApp(Outracks.Simulator.Client.FakeApp app) [static]
void Context::SetApp(::g::Outracks::Simulator::Client::FakeApp* app)
{
    Context::App(app);
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines) [static]
...
// public static generated Outracks.Simulator.Client.FakeApp get_App() [static]
::g::Outracks::Simulator::Client::FakeApp* Context::App()
{
    return Context::_App_;
}

// private static generated void set_App(Outracks.Simulator.Client.FakeApp value) [static]
void Context::App(::g::Outracks::Simulator::Client::FakeApp* value)
{
    Context::_App_ = value;
}

// public static generated string[] get_Defines() [static]
uArray* Context::Defines()
{
    return Context::_Defines_;
}

// private static generated void set_Defines(string[] value) [static]
void Context::Defines(uArray* value)
{
    Context::_Defines_ = value;
}

// public static generated Outracks.Simulator.Client.InputMode get_InputMode() [static]
int32_t Context::InputMode()
{
    return Context::_InputMode_;
}

// private static generated void set_InputMode(Outracks.Simulator.Client.InputMode value) [static]
void Context::InputMode(int32_t value)
{
    Context::_InputMode_ = value;
}

// public static generated string get_Project() [static]
uString* Context::Project()
{
    return Context::_Project_;
}

// private static generated void set_Project(string value) [static]
void Context::Project(uString* value)
{
    Context::_Project_ = value;
}

// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() [static]
uArray* Context::ProxyEndpoints()
{
    return Context::_ProxyEndpoints_;
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) [static]
void Context::ProxyEndpoints(uArray* value)
{
    Context::_ProxyEndpoints_ = value;
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() [static]
uObject* Context::Reflection()
{
    return Context::_Reflection_;
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) [static]
...
// internal sealed extern class CppEvent
// {
...
// public Uno.Reflection.IFunction get_RemoveMethod()
void CppEvent__get_RemoveMethod_fn(CppEvent* __this, uObject** __retval)
{
    *__retval = __this->RemoveMethod();
}

// public CppEvent(Uno.Type declaringType, Uno.Type type, string name) [instance]
...
// public Uno.Reflection.IFunction get_AddMethod() [instance]
...
// public Uno.Type get_DeclaringType() [instance]
uType* CppEvent::DeclaringType()
{
    return _declaringType;
}

// public Uno.Reflection.IFunction get_RemoveMethod() [instance]
...
// public CppEvent New(Uno.Type declaringType, Uno.Type type, string name) [static]
...
// internal sealed extern class CppProperty
// {
...
// public CppProperty(Uno.Type declaringType, Uno.Type type, string name)
...
// public Uno.Reflection.IFunction get_GetMethod()
void CppProperty__get_GetMethod_fn(CppProperty* __this, uObject** __retval)
{
    *__retval = __this->GetMethod();
}

// public CppProperty New(Uno.Type declaringType, Uno.Type type, string name)
...
// public Uno.Reflection.IFunction get_SetMethod()
void CppProperty__get_SetMethod_fn(CppProperty* __this, uObject** __retval)
{
    *__retval = __this->SetMethod();
}

// public CppProperty(Uno.Type declaringType, Uno.Type type, string name) [instance]
...
// public Uno.Reflection.IFunction get_GetMethod() [instance]
...
// public Uno.Reflection.IFunction get_SetMethod() [instance]
...
// public CppProperty New(Uno.Type declaringType, Uno.Type type, string name) [static]
...
// internal sealed class DesignerNotRunning
// {
...
// public DesignerNotRunning New() [static]
...
// public DialogButton(string text, Outracks.Simulator.Client.State destination)
...
// public DialogButton New(string text, Outracks.Simulator.Client.State destination)
...
// public DialogButton(string text, Outracks.Simulator.Client.State destination) [instance]
...
// public DialogButton New(string text, Outracks.Simulator.Client.State destination) [static]
...
// public sealed class DotNetReflection
// {
...
// public generated DotNetReflection()
...
// public object CallDynamic(object instance, string methodName, object[] arguments)
...
// public object CallStatic(string typeName, string methodName, object[] arguments)
...
// public object Instantiate(string typeName, object[] args)
...
// public static Outracks.Simulator.Client.DotNetReflection Load(string outputDir)
void DotNetReflection__Load_fn(uString* outputDir, DotNetReflection** __retval)
{
    *__retval = DotNetReflection::Load(outputDir);
}

// public generated DotNetReflection New()
...
// public generated DotNetReflection() [instance]
void DotNetReflection::ctor_()
{
}

// public void AddEventHandler(object instance, string member, object handlerDelegate) [instance]
...
// public object CallDynamic(object instance, string methodName, object[] arguments) [instance]
...
// public object CallStatic(string typeName, string methodName, object[] arguments) [instance]
...
// public object CreateDelegate(object instance, string methodName, string[] methodArgumentTypes, string delegateTypeName) [instance]
...
// public object GetEnumValue(string enumType, string valueName) [instance]
...
// public object GetPropertyValue(object instance, string propertyName) [instance]
...
// public object GetStaticPropertyOrFieldValue(string typeName, string memberName) [instance]
...
// public object Instantiate(string typeName, object[] args) [instance]
...
// public bool IsSubtype(object obj, string typeName) [instance]
...
// public bool IsType(object obj, string typeName) [instance]
...
// public void RemoveEventHandler(object instance, string member, object handlerDelegate) [instance]
...
// public void SetPropertyValue(object instance, string propertyName, object value) [instance]
...
// public static Outracks.Simulator.Client.DotNetReflection Load(string outputDir) [static]
...
// public generated DotNetReflection New() [static]
...
// public sealed class DotNetReflectionWrapper
// {
...
// public DotNetReflectionWrapper(Outracks.Simulator.Client.DotNetReflection reflection)
...
// public generated Outracks.Simulator.Client.DotNetReflection get__reflection()
...
// public generated void set__reflection(Outracks.Simulator.Client.DotNetReflection value)
...
// public DotNetReflectionWrapper New(Outracks.Simulator.Client.DotNetReflection reflection)
...
// public DotNetReflectionWrapper(Outracks.Simulator.Client.DotNetReflection reflection) [instance]
void DotNetReflectionWrapper::ctor_(::g::Outracks::Simulator::Client::DotNetReflection* reflection)
{
    _reflection(reflection);
}

// public generated Outracks.Simulator.Client.DotNetReflection get__reflection() [instance]
::g::Outracks::Simulator::Client::DotNetReflection* DotNetReflectionWrapper::_reflection()
{
    return __reflection1;
}

// public generated void set__reflection(Outracks.Simulator.Client.DotNetReflection value) [instance]
...
// public DotNetReflectionWrapper New(Outracks.Simulator.Client.DotNetReflection reflection) [static]
...
// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions)
void Exceptions__Send_fn(uObject* client, ::g::Uno::Collections::List* exceptions)
{
    Exceptions::Send(client, exceptions);
}

// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e)
void Exceptions__Unpack_fn(::g::Uno::Exception* e, ::g::Uno::Collections::List** __retval)
{
    *__retval = Exceptions::Unpack(e);
}

// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) [static]
...
// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) [static]
...
// internal sealed class FailedToConnect
// {
...
// public FailedToConnect New(Uno.Exception exception) [static]
...
// public Fuse.AppBase get_App() [instance]
::g::Fuse::AppBase* FakeApp::App()
{
    return _app;
}

// public new float4 get_Background() [instance]
...
// public new void set_Background(float4 value) [instance]
...
// public float4 get_ClearColor() [instance]
...
// public void set_ClearColor(float4 value) [instance]
...
// public new Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance]
...
// public Fuse.RootViewport get_RootViewport() [instance]
...
// public FakeApp New(Fuse.App app) [static]
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.Client.DialogButton[] buttons)
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.Client.DialogButton[] buttons)
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.Client.DialogButton[] buttons) [instance]
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.Client.DialogButton[] buttons) [static]
...
// public Idle(Outracks.Simulator.ISimulatorClient client)
void Idle__ctor_2_fn(Idle* __this, uObject* client)
{
    __this->ctor_2(client);
}

// public Idle New(Outracks.Simulator.ISimulatorClient client)
...
// protected override sealed Outracks.Simulator.Client.State OnFaulted(Uno.Exception e)
...
// public Idle(Outracks.Simulator.ISimulatorClient client) [instance]
void Idle::ctor_2(uObject* client)
{
    ctor_1(client);
}

// public Idle New(Outracks.Simulator.ISimulatorClient client) [static]
...
// internal abstract interface IEvent
// {
...
// internal abstract interface IProperty
// {
...
// public abstract interface ITypeMap
// {
...
// public generated LoadingScreen()
void LoadingScreen__ctor__fn(LoadingScreen* __this)
{
    __this->ctor_();
}

// public generated LoadingScreen New()
void LoadingScreen__New1_fn(LoadingScreen** __retval)
{
    *__retval = LoadingScreen::New1();
}

// public static void Show(Outracks.Simulator.Client.FakeApp app, string header, string message)
...
// public generated LoadingScreen() [instance]
void LoadingScreen::ctor_()
{
}

// public generated LoadingScreen New() [static]
...
// public static void Show(Outracks.Simulator.Client.FakeApp app, string header, string message) [static]
...
// public generated ModalDialog()
void ModalDialog__ctor__fn(ModalDialog* __this)
{
    __this->ctor_();
}

// public generated ModalDialog New()
void ModalDialog__New1_fn(ModalDialog** __retval)
{
    *__retval = ModalDialog::New1();
}

// public static void Show(Outracks.Simulator.Client.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons)
...
// public static void ShowPrompt(Outracks.Simulator.Client.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons)
...
// public generated ModalDialog() [instance]
void ModalDialog::ctor_()
{
}

// public generated ModalDialog New() [static]
...
// public static void Show(Outracks.Simulator.Client.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static]
...
// public static void ShowPrompt(Outracks.Simulator.Client.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static]
...
// public sealed extern class NativeReflection
// {
...
// public NativeReflection(Outracks.Simulator.Client.ITypeMap typeMap)
...
// public object CallDynamic(object obj, string methodName, object[] arguments)
...
// public NativeReflection New(Outracks.Simulator.Client.ITypeMap typeMap)
...
// private Outracks.Simulator.Client.IProperty ResolveProperty(object obj, string propertyName, Uno.Type propertyType)
...
// public NativeReflection(Outracks.Simulator.Client.ITypeMap typeMap) [instance]
...
// public object CallDynamic(object obj, string methodName, object[] arguments) [instance]
...
// public object GetPropertyValue(object obj, string propertyName) [instance]
...
// private Outracks.Simulator.Client.IProperty ResolveProperty(object obj, string propertyName, Uno.Type propertyType) [instance]
...
// public void SetPropertyValue(object obj, string propertyName, object value) [instance]
...
// public void SetStaticField(string typeName, string fieldName, object value) [instance]
...
// public NativeReflection New(Outracks.Simulator.Client.ITypeMap typeMap) [static]
...
// internal static extern class ReflectionCache
// {
...
// public static void AddToTypeCache(Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type> typeDictionary)
...
// public static void AddToTypeCache(Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type> typeDictionary) [static]
...
// public static Uno.Reflection.CppField[] GetFields(Uno.Type type) [static]
...
// public static Uno.Reflection.CppFunction[] GetFunctions(Uno.Type type) [static]
...
// public static Uno.Type GetType(Outracks.Simulator.Bytecode.TypeName typeName) [static]
...
// internal static extern class ReflectionExtensions
// {
// static generated ReflectionExtensions()
...
// private static bool CheckArgumentTypes(Uno.Type[] paramTypes, Uno.Type[] argumentTypes)
...
// public static Uno.Reflection.CppFunction FindConstructor(Uno.Type type, Uno.Type[] paramTypes)
...
// public static Uno.Reflection.CppFunction FindEventAddFunction(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName, object delegateObj)
...
// public static Uno.Reflection.CppFunction FindEventRemoveFunction(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName, object delegateObj)
...
// public static Uno.Reflection.CppField FindField(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName fieldName)
...
// public static Uno.Reflection.CppFunction FindFunction(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName memberName, Uno.Type[] paramTypes)
...
// private static Uno.Reflection.CppFunction FindFunctionOverload(Uno.Reflection.CppFunction[] functions, Uno.Type[] paramTypes)
...
// private static Uno.Reflection.CppFunction[] FindFunctionsByName(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName memberName)
...
// public static Uno.Reflection.CppFunction FindPropertyGetter(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName)
...
// public static Uno.Reflection.CppFunction FindPropertySetter(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName, Uno.Type argType)
...
// public static Uno.Type FindType(Outracks.Simulator.Bytecode.TypeName typeName)
...
// public static Uno.Type[] FindTypes(Outracks.Simulator.Bytecode.TypeName[] typeName)
void ReflectionExtensions__FindTypes_fn(uArray* typeName, uArray** __retval)
{
    *__retval = ReflectionExtensions::FindTypes(typeName);
}

// public static Uno.Type[] GetParameterTypes(Outracks.Simulator.Bytecode.Signature methodSignature)
...
// public static Uno.Type[] GetTypes(object[] objects)
...
// private static bool CheckArgumentTypes(Uno.Type[] paramTypes, Uno.Type[] argumentTypes) [static]
...
// public static Uno.Reflection.CppFunction FindConstructor(Uno.Type type, Uno.Type[] paramTypes) [static]
...
// public static Uno.Reflection.CppFunction FindEventAddFunction(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName, object delegateObj) [static]
...
// public static Uno.Reflection.CppFunction FindEventRemoveFunction(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName, object delegateObj) [static]
...
// public static Uno.Reflection.CppField FindField(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName fieldName) [static]
...
// public static Uno.Reflection.CppFunction FindFunction(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName memberName, Uno.Type[] paramTypes) [static]
...
// private static Uno.Reflection.CppFunction FindFunctionOverload(Uno.Reflection.CppFunction[] functions, Uno.Type[] paramTypes) [static]
...
// private static Uno.Reflection.CppFunction[] FindFunctionsByName(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName memberName) [static]
...
// public static Uno.Reflection.CppFunction FindPropertyGetter(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName) [static]
...
// public static Uno.Reflection.CppFunction FindPropertySetter(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName typeMemberName, Uno.Type argType) [static]
...
// public static Uno.Type FindType(Outracks.Simulator.Bytecode.TypeName typeName) [static]
...
// public static Uno.Type[] FindTypes(Outracks.Simulator.Bytecode.TypeName[] typeName) [static]
...
// public static Uno.Type[] GetParameterTypes(Outracks.Simulator.Bytecode.Signature methodSignature) [static]
...
// public static Uno.Type[] GetTypes(object[] objects) [static]
...
// internal sealed class Reifying
// {
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.BytecodeGenerated reify)
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.BytecodeGenerated reify)
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.BytecodeGenerated reify) [instance]
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.BytecodeGenerated reify) [static]
...
// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Client.UserAppState userApp, Outracks.Simulator.Protocol.BytecodeGenerated runningReify)
...
// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Client.UserAppState userApp, Outracks.Simulator.Protocol.BytecodeGenerated runningReify)
...
// public override sealed void OnLeaveState()
...
// private static float QueryDensity()
void Running__QueryDensity_fn(float* __retval)
{
    *__retval = Running::QueryDensity();
}

// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Client.UserAppState userApp, Outracks.Simulator.Protocol.BytecodeGenerated runningReify) [instance]
...
// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Client.UserAppState userApp, Outracks.Simulator.Protocol.BytecodeGenerated runningReify) [static]
...
// private static float QueryDensity() [static]
...
// internal class ShowingModalDialog
// {
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.Client.DialogButton[] buttons)
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.Client.DialogButton[] buttons)
...
// private void OnButtonClicked(Outracks.Simulator.Client.DialogButton button)
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.Client.DialogButton[] buttons) [instance]
...
// private void OnButtonClicked(Outracks.Simulator.Client.DialogButton button) [instance]
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.Client.DialogButton[] buttons) [static]
...
// internal abstract class ShowingPrompt
// {
...
// protected ShowingPrompt(string header, string body)
void ShowingPrompt__ctor_1_fn(ShowingPrompt* __this, uString* header, uString* body)
{
    __this->ctor_1(header, body);
}

// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args)
...
// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args)
...
// protected ShowingPrompt(string header, string body) [instance]
...
// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) [instance]
void ShowingPrompt::OnCancelClicked(uObject* s, ::g::Fuse::Gestures::ClickedArgs* args)
{
    _cancelClicked = true;
}

// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) [instance]
...
// public sealed extern class SimpleTypeMap
// {
...
// public generated SimpleTypeMap()
void SimpleTypeMap__ctor__fn(SimpleTypeMap* __this)
{
    __this->ctor_();
}

// public generated SimpleTypeMap New()
void SimpleTypeMap__New1_fn(SimpleTypeMap** __retval)
{
    *__retval = SimpleTypeMap::New1();
}

// private Uno.Type ResolveType(Outracks.Simulator.Bytecode.TypeName typeName)
...
// public Uno.Type ResolveType(string typeName)
...
// public generated SimpleTypeMap() [instance]
...
// private Uno.Type ResolveType(Outracks.Simulator.Bytecode.TypeName typeName) [instance]
...
// public Uno.Type ResolveType(string typeName) [instance]
...
// public generated SimpleTypeMap New() [static]
...
// public virtual Outracks.Simulator.Client.State OnEnterState()
...
// public virtual Outracks.Simulator.Client.State OnUpdate()
void State__OnUpdate_fn(State* __this, State** __retval)
{
    return *__retval = __this, void();
}

// protected generated State() [instance]
void State::ctor_()
{
}
// }
...
// internal static extern class TryInvokeExtension
// {
...
// public static Uno.Reflection.IFunction FindUnambiguousMethod(Uno.Type type, string methodName, object[] arguments)
...
// public static Outracks.Simulator.Client.IEvent GetEvent(Uno.Type type, string name, Uno.Type propertyType)
...
// public static Uno.Reflection.IField GetField(Uno.Type type, string name)
...
// public static Uno.Reflection.IFunction GetMethod(Uno.Type type, string name, Uno.Type[] parameterTypes)
...
// public static Uno.Reflection.CppFunction[] GetMethods(Uno.Type type)
void TryInvokeExtension__GetMethods_fn(uType* type, uArray** __retval)
{
    *__retval = TryInvokeExtension::GetMethods(type);
}

// public static Outracks.Simulator.Client.IProperty GetProperty(Uno.Type type, string name, Uno.Type propertyType)
...
// public static bool IsInstanceOfType(Uno.Type type, object obj)
...
// public static bool ParametersMatch(Uno.Reflection.IFunction m, object[] arguments)
...
// public static object TryInvoke(Uno.Reflection.IFunction mi, object obj, object[] value)
...
// public static Uno.Reflection.IFunction FindUnambiguousMethod(Uno.Type type, string methodName, object[] arguments) [static]
...
// public static Outracks.Simulator.Client.IEvent GetEvent(Uno.Type type, string name, Uno.Type propertyType) [static]
...
// public static Uno.Reflection.IField GetField(Uno.Type type, string name) [static]
...
// public static Uno.Reflection.IFunction GetMethod(Uno.Type type, string name, Uno.Type[] parameterTypes) [static]
...
// public static Uno.Reflection.CppFunction[] GetMethods(Uno.Type type) [static]
uArray* TryInvokeExtension::GetMethods(uType* type)
{
    return ::g::Uno::Reflection::CppReflection::GetFunctions(type);
}

// public static Outracks.Simulator.Client.IProperty GetProperty(Uno.Type type, string name, Uno.Type propertyType) [static]
...
// public static bool IsInstanceOfType(Uno.Type type, object obj) [static]
...
// public static bool ParametersMatch(Uno.Reflection.IFunction m, object[] arguments) [static]
...
// public static object TryInvoke(Uno.Reflection.IFunction mi, object obj, object[] value) [static]
...
// internal sealed class Uninitialized
// {
...
// public generated Uninitialized()
void Uninitialized__ctor_1_fn(Uninitialized* __this)
{
    __this->ctor_1();
}

// public generated Uninitialized New()
...
// public generated Uninitialized() [instance]
void Uninitialized::ctor_1()
{
    ctor_();
}

// public generated Uninitialized New() [static]
...
// internal sealed class UserAppState
// {
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor)
...
// public void ApplyTo(Outracks.Simulator.Client.FakeApp app)
void UserAppState__ApplyTo_fn(UserAppState* __this, ::g::Outracks::Simulator::Client::FakeApp* app)
{
    __this->ApplyTo(app);
}

// public static generated Outracks.Simulator.Client.UserAppState get_Default()
void UserAppState__get_Default_fn(UserAppState** __retval)
{
    *__retval = UserAppState::Default();
}

// public static generated void set_Default(Outracks.Simulator.Client.UserAppState value)
void UserAppState__set_Default_fn(UserAppState* value)
{
    UserAppState::Default(value);
}

// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor)
...
// public static Outracks.Simulator.Client.UserAppState Save(Outracks.Simulator.Client.FakeApp app)
void UserAppState__Save_fn(::g::Outracks::Simulator::Client::FakeApp* app, UserAppState** __retval)
{
    *__retval = UserAppState::Save(app);
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right)
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements)
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements)
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor) [instance]
...
// public void ApplyTo(Outracks.Simulator.Client.FakeApp app) [instance]
...
// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor) [static]
...
// public static Outracks.Simulator.Client.UserAppState Save(Outracks.Simulator.Client.FakeApp app) [static]
...
// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) [static]
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) [static]
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) [static]
...
// public static generated Outracks.Simulator.Client.UserAppState get_Default() [static]
UserAppState* UserAppState::Default()
{
    return UserAppState::_Default_;
}

// public static generated void set_Default(Outracks.Simulator.Client.UserAppState value) [static]
...
// public static object Execute(Outracks.Simulator.Bytecode.Lambda lambda, object[] arguments)
...
// public static object Execute(Outracks.Simulator.Runtime.IReflection reflection, Outracks.Simulator.Bytecode.Lambda lambda, object[] arguments)
...
// public static object Execute(Outracks.Simulator.Bytecode.Lambda lambda, object[] arguments) [static]
...
// public static object Execute(Outracks.Simulator.Runtime.IReflection reflection, Outracks.Simulator.Bytecode.Lambda lambda, object[] arguments) [static]
