...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Edit.uno
// -------------------------------------------------------
...
// public Caret New(int cluster, int lineIndex, int runIndex, float2 visualPos)
...
// public Caret(int cluster, int lineIndex, int runIndex, float2 visualPos) [instance]
...
// public Caret New(int cluster, int lineIndex, int runIndex, float2 visualPos) [static]
...
// public CaretContext(Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> pruns, string source)
void CaretContext__ctor_1_fn(CaretContext* __this, ::g::Uno::Collections::List* pruns, uString* source)
{
    __this->ctor_1(pruns, source);
}

// public string Backspace(Fuse.Text.Edit.CaretIndex& i)
void CaretContext__Backspace_fn(CaretContext* __this, int32_t* i, uString** __retval)
{
    *__retval = __this->Backspace(i);
}

// private Fuse.Text.Edit.CaretIndex Clamp(Fuse.Text.Edit.CaretIndex i)
void CaretContext__Clamp_fn(CaretContext* __this, int32_t* i, int32_t* __retval)
{
    *__retval = __this->Clamp(*i);
}

// private Fuse.Text.Edit.CaretIndex ClosestCaretOnLine(float2 pos, int desiredLine, Fuse.Text.Edit.CaretIndex def)
...
// public string Delete(Fuse.Text.Edit.CaretIndex& i)
void CaretContext__Delete_fn(CaretContext* __this, int32_t* i, uString** __retval)
{
    *__retval = __this->Delete(i);
}

// public string DeleteSpan(Fuse.Text.Edit.CaretIndex start, Fuse.Text.Edit.CaretIndex& caret)
...
// public Fuse.Text.Edit.CaretIndex GetClosest(float2 pos, float lineHeight)
...
// public float2 GetVisualPosition(Fuse.Text.Edit.CaretIndex i)
...
// public Uno.Collections.List<Uno.Rect> GetVisualRects(Fuse.Text.Edit.CaretIndex i1, Fuse.Text.Edit.CaretIndex i2, float lineHeight)
...
// public string Insert(char c, Fuse.Text.Edit.CaretIndex& i)
void CaretContext__Insert_fn(CaretContext* __this, char16_t* c, int32_t* i, uString** __retval)
{
    *__retval = __this->Insert(*c, i);
}

// public Fuse.Text.Edit.CaretIndex LeftMost()
void CaretContext__LeftMost_fn(CaretContext* __this, int32_t* __retval)
{
    *__retval = __this->LeftMost();
}

// private bool LeftToRight(Fuse.Text.Edit.CaretIndex i)
void CaretContext__LeftToRight_fn(CaretContext* __this, int32_t* i, bool* __retval)
{
    *__retval = __this->LeftToRight(*i);
}

// private static void LerpClustersLTR(string source, int cluster1, float2 pos1, int cluster2, float2 pos2, int lineIndex, int runIndex, Uno.Collections.List<Fuse.Text.Edit.Caret> result)
...
// private static void LerpClustersRTL(string source, int cluster1, float2 pos1, int cluster2, float2 pos2, int lineIndex, int runIndex, Uno.Collections.List<Fuse.Text.Edit.Caret> result)
...
// public Fuse.Text.Edit.CaretIndex MoveDown(Fuse.Text.Edit.CaretIndex currentIndex)
...
// public Fuse.Text.Edit.CaretIndex MoveLeft(Fuse.Text.Edit.CaretIndex i)
void CaretContext__MoveLeft_fn(CaretContext* __this, int32_t* i, int32_t* __retval)
{
    *__retval = __this->MoveLeft(*i);
}

// public Fuse.Text.Edit.CaretIndex MoveRight(Fuse.Text.Edit.CaretIndex i)
void CaretContext__MoveRight_fn(CaretContext* __this, int32_t* i, int32_t* __retval)
{
    *__retval = __this->MoveRight(*i);
}

// public Fuse.Text.Edit.CaretIndex MoveUp(Fuse.Text.Edit.CaretIndex currentIndex)
...
// public CaretContext New(Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> pruns, string source)
...
// private static Uno.Collections.List<Fuse.Text.Edit.Caret> PossibleCaretPositions(Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> lines, string source)
...
// private static float WeightedSquaredDist(float2 p, float2 q, float yweight)
...
// public CaretContext(Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> pruns, string source) [instance]
...
// public string Backspace(Fuse.Text.Edit.CaretIndex& i) [instance]
...
// private Fuse.Text.Edit.CaretIndex Clamp(Fuse.Text.Edit.CaretIndex i) [instance]
...
// private Fuse.Text.Edit.CaretIndex ClosestCaretOnLine(float2 pos, int desiredLine, Fuse.Text.Edit.CaretIndex def) [instance]
...
// public string Delete(Fuse.Text.Edit.CaretIndex& i) [instance]
...
// public string DeleteSpan(Fuse.Text.Edit.CaretIndex start, Fuse.Text.Edit.CaretIndex& caret) [instance]
...
// public Fuse.Text.Edit.CaretIndex GetClosest(float2 pos, float lineHeight) [instance]
...
// public float2 GetVisualPosition(Fuse.Text.Edit.CaretIndex i) [instance]
...
// public Uno.Collections.List<Uno.Rect> GetVisualRects(Fuse.Text.Edit.CaretIndex i1, Fuse.Text.Edit.CaretIndex i2, float lineHeight) [instance]
...
// public string Insert(char c, Fuse.Text.Edit.CaretIndex& i) [instance]
...
// public Fuse.Text.Edit.CaretIndex LeftMost() [instance]
int32_t CaretContext::LeftMost()
{
    return 0;
}

// private bool LeftToRight(Fuse.Text.Edit.CaretIndex i) [instance]
...
// public Fuse.Text.Edit.CaretIndex MoveDown(Fuse.Text.Edit.CaretIndex currentIndex) [instance]
...
// public Fuse.Text.Edit.CaretIndex MoveLeft(Fuse.Text.Edit.CaretIndex i) [instance]
...
// public Fuse.Text.Edit.CaretIndex MoveRight(Fuse.Text.Edit.CaretIndex i) [instance]
...
// public Fuse.Text.Edit.CaretIndex MoveUp(Fuse.Text.Edit.CaretIndex currentIndex) [instance]
...
// public Fuse.Text.Edit.CaretIndex RightMost() [instance]
...
// private static Uno.Collections.List<Fuse.Text.Edit.Caret> PossibleCaretPositions(Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> lines, string source) [static]
...
// private static int StringRangeLength(string source, int cluster1, int cluster2) [static]
...
// private static void LerpClustersLTR(string source, int cluster1, float2 pos1, int cluster2, float2 pos2, int lineIndex, int runIndex, Uno.Collections.List<Fuse.Text.Edit.Caret> result) [static]
...
// private static void LerpClustersRTL(string source, int cluster1, float2 pos1, int cluster2, float2 pos2, int lineIndex, int runIndex, Uno.Collections.List<Fuse.Text.Edit.Caret> result) [static]
...
// public CaretContext New(Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> pruns, string source) [static]
...
// private static float SquaredDist(float2 p, float2 q) [static]
...
// private static float WeightedSquaredDist(float2 p, float2 q, float yweight) [static]
