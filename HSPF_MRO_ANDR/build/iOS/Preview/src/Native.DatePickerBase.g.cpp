...
{
    uStackFrame __("Native.DatePickerBase.CurrentDateProperty", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Native.DatePickerBase.CurrentDateProperty", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
static void DatePickerBase_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(DatePickerBase_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(DatePickerBase_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(DatePickerBase_type, interface2),
        ::g::Fuse::INotifyUnrooted_typeof(), offsetof(DatePickerBase_type, interface3),
        ::g::Fuse::ISourceLocation_typeof(), offsetof(DatePickerBase_type, interface4),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(DatePickerBase_type, interface5),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(DatePickerBase_type, interface6),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(DatePickerBase_type, interface7),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(DatePickerBase_type, interface8),
        ::g::Fuse::ITemplateSource_typeof(), offsetof(DatePickerBase_type, interface9),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(DatePickerBase_type, interface10),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(DatePickerBase_type, interface11),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(DatePickerBase_type, interface12),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(DatePickerBase_type, interface13),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(DatePickerBase_type, interface14),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(DatePickerBase_type, interface15),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(DatePickerBase_type, interface16),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(DatePickerBase_type, interface17),
        ::g::Fuse::Drawing::ISurfaceDrawable_typeof(), offsetof(DatePickerBase_type, interface18),
        ::g::Native::IDatePickerHost_typeof(), offsetof(DatePickerBase_type, interface19));
    type->SetFields(120,
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_CurrentDate", NULL, (void*)DatePickerBase__get_CurrentDate_fn, 0, false, ::g::Uno::Time::LocalDate_typeof(), 0),
        new uFunction("set_CurrentDate", NULL, (void*)DatePickerBase__set_CurrentDate_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Time::LocalDate_typeof()),
        new uFunction("set_MaxDate", NULL, (void*)DatePickerBase__set_MaxDate_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Time::LocalDate_typeof()),
        new uFunction("set_MinDate", NULL, (void*)DatePickerBase__set_MinDate_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Time::LocalDate_typeof()));
}

DatePickerBase_type* DatePickerBase_typeof()
{
    static uSStrong<DatePickerBase_type*> type;
    if (type != NULL) return type;
    ...
    options.TypeSize = sizeof(DatePickerBase_type);
    type = (DatePickerBase_type*)uClassType::New("Native.DatePickerBase", options);
    ...
    type->interface19.fp_OnDateChanged = (void(*)(uObject*))DatePickerBase__NativeIDatePickerHostOnDateChanged_fn;
...
// protected generated DatePickerBase()
...
// private void Native.IDatePickerHost.OnDateChanged()
void DatePickerBase__NativeIDatePickerHostOnDateChanged_fn(DatePickerBase* __this)
{
    uStackFrame __("Native.DatePickerBase", "Native.IDatePickerHost.OnDateChanged()");
...
{
    uStackFrame __("Native.DatePickerBase", "OnRooted()");
...
// protected generated DatePickerBase() [instance]
void DatePickerBase::ctor_7()
{
    uStackFrame __("Native.DatePickerBase", ".ctor()");
    _out = uPtr(::g::Uno::Time::ZonedDateTime::Now())->Date();
    _in = uPtr(::g::Uno::Time::ZonedDateTime::Now())->Date();
    ctor_6();
}
...
{
    uStackFrame __("Native.DatePickerBase", "get_CurrentDate()");
...
{
    uStackFrame __("Native.DatePickerBase", "set_CurrentDate(Uno.Time.LocalDate)");
    uObject* dpv = DatePickerView();
...
{
    uStackFrame __("Native.DatePickerBase", "set_MaxDate(Uno.Time.LocalDate)");
    uObject* dpv = DatePickerView();
...
{
    uStackFrame __("Native.DatePickerBase", "set_MinDate(Uno.Time.LocalDate)");
    uObject* dpv = DatePickerView();
...
{
    uStackFrame __("Native.DatePickerBase", "OnDateChanged()");
...
{
    uStackFrame __("Native.DatePickerBase", "UpdateCurrentDate()");
    ::g::Uno::Threading::Monitor::Enter(this);
...
{
    uStackFrame __("Native.DatePickerBase", "ArgsToLocalDate(object[])");
...
{
    uStackFrame __("Native.DatePickerBase", "getCurrentDateProperty(Native.DatePickerBase)");
    DatePickerBase_typeof()->Init();
...
{
    uStackFrame __("Native.DatePickerBase", "setDate(Fuse.Scripting.Context,Native.DatePickerBase,object[])");
    DatePickerBase_typeof()->Init();
...
{
    uStackFrame __("Native.DatePickerBase", "setMaxDate(Fuse.Scripting.Context,Native.DatePickerBase,object[])");
    DatePickerBase_typeof()->Init();
...
{
    uStackFrame __("Native.DatePickerBase", "setMinDate(Fuse.Scripting.Context,Native.DatePickerBase,object[])");
    DatePickerBase_typeof()->Init();
