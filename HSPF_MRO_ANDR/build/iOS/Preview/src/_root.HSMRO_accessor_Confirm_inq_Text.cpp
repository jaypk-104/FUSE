...
{
    uStackFrame __("HSMRO_accessor_Confirm_inq_Text", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_accessor_Confirm_inq_Text", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
