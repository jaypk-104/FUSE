...
// /usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/DeviceInfo.uno
// --------------------------------------------------------------------

// public static extern class DeviceInfo
// {
...
// public static extern string GetGUID()
...
// public static extern string GetGUID() [static]
...
// public static extern string GetName() [static]
...
// public static string get_GUID() [static]
uString* DeviceInfo::GUID()
{
    return DeviceInfo::GetGUID();
}

// public static string get_Name() [static]
