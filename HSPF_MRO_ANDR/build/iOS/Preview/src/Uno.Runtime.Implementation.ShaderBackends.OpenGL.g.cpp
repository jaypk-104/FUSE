...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/GLCompiledProgram.uno
// --------------------------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/GLDrawCall.uno
// -------------------------------------------------------------------------------------------------------------------
...
static void GLDrawCall_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(62,
        ...
        new uFunction("Uniform", NULL, (void*)GLDrawCall__Uniform8_fn, 0, false, uVoid_typeof(), 2, ::TYPES[3/*int*/], ::g::Uno::Float3x3_typeof()),
...
{
    uStackFrame __("Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLDrawCall", "Uniform(int,float3x3)");
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/GLException.uno
// --------------------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/GLHelpers.uno
// ------------------------------------------------------------------------------------------------------------------
...
static void GLHelpers_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        ...
        new uFunction("TexImage2DFromBytes", NULL, (void*)GLHelpers__TexImage2DFromBytes_fn, 0, true, uVoid_typeof(), 6, ::g::OpenGL::GLTextureTarget_typeof(), ::TYPES[3/*int*/], ::TYPES[3/*int*/], ::TYPES[3/*int*/], ::g::Uno::Graphics::Format_typeof(), ::g::Uno::Byte_typeof()->Array()),
        new uFunction("TexImage2DFromIntPtr", NULL, (void*)GLHelpers__TexImage2DFromIntPtr_fn, 0, true, uVoid_typeof(), 6, ::g::OpenGL::GLTextureTarget_typeof(), ::TYPES[3/*int*/], ::TYPES[3/*int*/], ::TYPES[3/*int*/], ::g::Uno::Graphics::Format_typeof(), ::g::Uno::IntPtr_typeof()));
}
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/GLInterop.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/GLProgram.uno
// ------------------------------------------------------------------------------------------------------------------
...
static void GLProgram_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("# ifdef GL_FRAGMENT_PRECISION_HIGH\n"
        ...
        "#endif\n"
        "");
    ::STRINGS[24] = uString::Const("#define ");
...
::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLCompiledProgram* GLProgram::GetCompiledProgramInternal(uArray* constStrings)
{
    ...
    fsPrefix->Append2(::STRINGS[23/*"# ifdef GL_...*/]);
    ::g::Uno::Text::StringBuilder* definesBuilder = ::g::Uno::Text::StringBuilder::New1();

    for (int32_t i = 0; i < uPtr(constStrings)->Length(); i++)
        uPtr(definesBuilder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[24/*"#define "*/], uPtr(_constAttribAndUniformNames)->Strong<uString*>(i)), ::STRINGS[25/*" "*/]), uPtr(constStrings)->Strong<uString*>(i)), ::STRINGS[26/*"\n"*/]));
