...
{
    uStackFrame __("Native.TimePickerBase.CurrentTimeProperty", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Native.TimePickerBase.CurrentTimeProperty", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
static void TimePickerBase_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(TimePickerBase_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(TimePickerBase_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(TimePickerBase_type, interface2),
        ::g::Fuse::INotifyUnrooted_typeof(), offsetof(TimePickerBase_type, interface3),
        ::g::Fuse::ISourceLocation_typeof(), offsetof(TimePickerBase_type, interface4),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(TimePickerBase_type, interface5),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(TimePickerBase_type, interface6),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(TimePickerBase_type, interface7),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(TimePickerBase_type, interface8),
        ::g::Fuse::ITemplateSource_typeof(), offsetof(TimePickerBase_type, interface9),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(TimePickerBase_type, interface10),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(TimePickerBase_type, interface11),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(TimePickerBase_type, interface12),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(TimePickerBase_type, interface13),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(TimePickerBase_type, interface14),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(TimePickerBase_type, interface15),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(TimePickerBase_type, interface16),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(TimePickerBase_type, interface17),
        ::g::Fuse::Drawing::ISurfaceDrawable_typeof(), offsetof(TimePickerBase_type, interface18),
        ::g::Native::ITimePickerHost_typeof(), offsetof(TimePickerBase_type, interface19));
    type->SetFields(120,
    ...
    type->Reflection.SetFunctions(2,
        new uFunction("get_CurrentTime", NULL, (void*)TimePickerBase__get_CurrentTime_fn, 0, false, ::g::Uno::Time::LocalTime_typeof(), 0),
        new uFunction("set_CurrentTime", NULL, (void*)TimePickerBase__set_CurrentTime_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Time::LocalTime_typeof()));
}

TimePickerBase_type* TimePickerBase_typeof()
{
    static uSStrong<TimePickerBase_type*> type;
    if (type != NULL) return type;
    ...
    options.TypeSize = sizeof(TimePickerBase_type);
    type = (TimePickerBase_type*)uClassType::New("Native.TimePickerBase", options);
    ...
    type->interface19.fp_OnTimeChanged = (void(*)(uObject*))TimePickerBase__NativeITimePickerHostOnTimeChanged_fn;
...
// protected generated TimePickerBase()
...
// private void Native.ITimePickerHost.OnTimeChanged()
void TimePickerBase__NativeITimePickerHostOnTimeChanged_fn(TimePickerBase* __this)
{
    uStackFrame __("Native.TimePickerBase", "Native.ITimePickerHost.OnTimeChanged()");
...
{
    uStackFrame __("Native.TimePickerBase", "OnRooted()");
...
// protected generated TimePickerBase() [instance]
void TimePickerBase::ctor_7()
{
    uStackFrame __("Native.TimePickerBase", ".ctor()");
    _out = uPtr(::g::Uno::Time::ZonedDateTime::Now())->TimeOfDay();
    _in = uPtr(::g::Uno::Time::ZonedDateTime::Now())->TimeOfDay();
    ctor_6();
}
...
{
    uStackFrame __("Native.TimePickerBase", "get_CurrentTime()");
...
{
    uStackFrame __("Native.TimePickerBase", "set_CurrentTime(Uno.Time.LocalTime)");
    uObject* tpv = TimePickerView();
...
{
    uStackFrame __("Native.TimePickerBase", "OnTimeChanged()");
...
{
    uStackFrame __("Native.TimePickerBase", "UpdateCurrentTime()");
    ::g::Uno::Threading::Monitor::Enter(this);
...
{
    uStackFrame __("Native.TimePickerBase", "FromJSON(Uno.Data.Json.JsonReader)");
...
{
    uStackFrame __("Native.TimePickerBase", "getCurrentTimeProperty(Native.TimePickerBase)");
    TimePickerBase_typeof()->Init();
...
{
    uStackFrame __("Native.TimePickerBase", "setTime(Fuse.Scripting.Context,Native.TimePickerBase,object[])");
    TimePickerBase_typeof()->Init();
...
{
    uStackFrame __("Native.TimePickerBase", "ToJSON(Uno.Time.LocalTime)");
    TimePickerBase_typeof()->Init();
