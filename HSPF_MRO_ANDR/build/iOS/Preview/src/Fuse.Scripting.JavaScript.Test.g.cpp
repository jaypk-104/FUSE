...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/JSTest.uno
// -------------------------------------------------------------------------

// public sealed class JSTest
// {
...
// private JSTest(Uno.Action<Fuse.Scripting.Context> test)
void JSTest__ctor__fn(JSTest* __this, uDelegate* test)
{
    __this->ctor_(test);
}

// private void AddTestToJSContext(Fuse.Scripting.Context context)
void JSTest__AddTestToJSContext_fn(JSTest* __this, ::g::Fuse::Scripting::Context* context)
{
    __this->AddTestToJSContext(context);
}

// private object JSAssertCallback(Fuse.Scripting.Context context, object[] args)
...
// private JSTest New(Uno.Action<Fuse.Scripting.Context> test)
void JSTest__New1_fn(uDelegate* test, JSTest** __retval)
{
    *__retval = JSTest::New1(test);
}

// public static void RunTest(Uno.Action<Fuse.Scripting.Context> method)
void JSTest__RunTest_fn(uDelegate* method)
{
    JSTest::RunTest(method);
}

// private void TestBodyWrapper(Fuse.Scripting.Context context)
...
// private JSTest(Uno.Action<Fuse.Scripting.Context> test) [instance]
...
// private void AddTestToJSContext(Fuse.Scripting.Context context) [instance]
...
// private object JSAssertCallback(Fuse.Scripting.Context context, object[] args) [instance]
...
// private void TestBodyWrapper(Fuse.Scripting.Context context) [instance]
...
// private void WaitOnResults() [instance]
...
// private JSTest New(Uno.Action<Fuse.Scripting.Context> test) [static]
...
// public static void RunTest(Uno.Action<Fuse.Scripting.Context> method) [static]
