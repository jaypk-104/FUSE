...
{
    uStackFrame __("HSMRO_DropdownOption_BackgroundColor_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_DropdownOption_BackgroundColor_Property", "Set(Uno.UX.PropertyObject,Fuse.Drawing.Brush,Uno.UX.IPropertyListener)");
