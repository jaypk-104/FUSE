...
// /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/LoginPage.g.uno
// ------------------------------------------------------------------------------
...
static void LoginPage__Template_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template", "New()");
...
static void LoginPage__Template1_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template1__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template1", "New()");
...
static void LoginPage__Template2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template2__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template2", "New()");
...
static void LoginPage__Template3_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template3__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template3", "New()");
...
static void LoginPage__Template4_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template4__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template4", "New()");
...
static void LoginPage__Template5_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template5__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template5", "New()");
...
static void LoginPage__Template6_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoginPage__Template6__New2_fn, 0, true, type, 2, ::g::LoginPage_typeof(), ::g::LoginPage_typeof()));
}
...
{
    uStackFrame __("LoginPage.Template6", "New()");
