...
{
    uStackFrame __("HSMRO_accessor_MyLoadingIndicator1_ThemeColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_accessor_MyLoadingIndicator1_ThemeColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
