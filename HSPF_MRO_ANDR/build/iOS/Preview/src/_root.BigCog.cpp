// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/BigCog.g.uno.
...
// public partial sealed class BigCog
// {
// static BigCog()
...
static void BigCog_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BigCog__New5_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* BigCog_typeof()
{
    ...
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("BigCog", options);
    type->fp_build_ = BigCog_build;
    type->fp_ctor_ = (void*)BigCog__New5_fn;
...
// public BigCog()
void BigCog__ctor_8_fn(BigCog* __this)
{
    __this->ctor_8();
}

// private void InitializeUX()
void BigCog__InitializeUX1_fn(BigCog* __this)
{
    __this->InitializeUX1();
}

// public BigCog New()
void BigCog__New5_fn(BigCog** __retval)
{
    *__retval = BigCog::New5();
}

// public BigCog() [instance]
void BigCog::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void BigCog::InitializeUX1()
{
    uStackFrame __("BigCog", "InitializeUX()");
    Color(::g::Uno::Float4__New2(0.9058824f, 0.8823529f, 0.945098f, 1.0f));
    Width(::g::Uno::UX::Size__New1(120.0f, 1));
    Height(::g::Uno::UX::Size__New1(120.0f, 1));
    SourceLineNumber(6);
    SourceFileName(::STRINGS[0/*"Modules/Cog...*/]);
    File(::g::Uno::UX::BundleFileSource::New1(::g::HSMRO_bundle::cog2_whitee3555e3b()));
}

// public BigCog New() [static]
BigCog* BigCog::New5()
{
