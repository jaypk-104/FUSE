// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/Confirm_msg.g.uno.
...
static void Confirm_msg_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("Handler_msg");
    ...
    type->SetFields(120,
        ...
        uObject_typeof(), offsetof(Confirm_msg, _field_Handler_msg), 0,
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_Handler_msg", NULL, (void*)Confirm_msg__get_Handler_msg_fn, 0, false, uObject_typeof(), 0),
        new uFunction("set_Handler_msg", NULL, (void*)Confirm_msg__set_Handler_msg_fn, 0, false, uVoid_typeof(), 1, uObject_typeof()),
        new uFunction(".ctor", NULL, (void*)Confirm_msg__New4_fn, 0, true, type, 0),
        new uFunction("SetHandler_msg", NULL, (void*)Confirm_msg__SetHandler_msg_fn, 0, false, uVoid_typeof(), 2, uObject_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetShow", NULL, (void*)Confirm_msg__SetShow_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetText", NULL, (void*)Confirm_msg__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Show", NULL, (void*)Confirm_msg__get_Show_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_Show", NULL, (void*)Confirm_msg__set_Show_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction("get_Text", NULL, (void*)Confirm_msg__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)Confirm_msg__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
// public object get_Handler_msg()
void Confirm_msg__get_Handler_msg_fn(Confirm_msg* __this, uObject** __retval)
{
    *__retval = __this->Handler_msg();
}

// public void set_Handler_msg(object value)
void Confirm_msg__set_Handler_msg_fn(Confirm_msg* __this, uObject* value)
{
    __this->Handler_msg(value);
}
...
// public void SetHandler_msg(object value, Uno.UX.IPropertyListener origin)
void Confirm_msg__SetHandler_msg_fn(Confirm_msg* __this, uObject* value, uObject* origin)
{
    __this->SetHandler_msg(value, origin);
}
...
{
    uStackFrame __("Confirm_msg", ".ctor()");
    ctor_6();
    InitializeUX();
}

// public object get_Handler_msg() [instance]
uObject* Confirm_msg::Handler_msg()
{
    return _field_Handler_msg;
}

// public void set_Handler_msg(object value) [instance]
void Confirm_msg::Handler_msg(uObject* value)
{
    uStackFrame __("Confirm_msg", "set_Handler_msg(object)");
    SetHandler_msg(value, NULL);
}

// private void InitializeUX() [instance]
void Confirm_msg::InitializeUX()
{
    uStackFrame __("Confirm_msg", "InitializeUX()");
...
// public void SetHandler_msg(object value, Uno.UX.IPropertyListener origin) [instance]
void Confirm_msg::SetHandler_msg(uObject* value, uObject* origin)
{
    uStackFrame __("Confirm_msg", "SetHandler_msg(object,Uno.UX.IPropertyListener)");

    if (value != _field_Handler_msg)
    {
        _field_Handler_msg = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[18/*"Handler_msg"*/]), origin);
    }
}
...
{
    uStackFrame __("Confirm_msg", "SetShow(bool,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Confirm_msg", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Confirm_msg", "set_Show(bool)");
    SetShow(value, NULL);
}
...
{
    uStackFrame __("Confirm_msg", "set_Text(string)");
    SetText(value, NULL);
}
