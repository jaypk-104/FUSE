// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Backends/CPlusPlus/Uno/Reflection.cpp.
...
{
    uArray* result = uArray::New(::g::Uno::Type_typeof()->Array(), _Types->size());
    int32_t i = 0;
