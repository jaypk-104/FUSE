// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Backends/CPlusPlus/Uno/_mainMobile.cpp.
// WARNING: Changes might be lost if you edit this file directly.

#include <Uno/ObjectModel.h>

namespace g{namespace Alive{uClassType* ColorFunctions_typeof();}}
...
namespace g{namespace Fuse{namespace Alerts{uType* NativeAlerts__DialogCallback_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uDelegateType* EasingFunction_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* KeyframeInterpolation_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* TransformPriority_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uInterfaceType* ITrackProvider_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IUnwrappedPlayerFeedback_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* KeyframeTrack_typeof();}}}
...
namespace g{namespace Fuse{namespace Audio{uType* SoundPlayer_typeof();}}}
namespace g{namespace Fuse{namespace BackgroundDownload{uClassType* BackgroundDownload_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* iOSCamera_typeof();}}}
namespace g{namespace Fuse{namespace Camera{uType* ResizeImageCallback_typeof();}}}
namespace g{namespace Fuse{namespace CameraRoll{uType* iOSCameraRoll_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct DataSeries_type; DataSeries_type* DataSeries_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct FilterObservable_type; ::g::Fuse::Charting::FilterObservable_type* LabelFilterObservable_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct FilterObservable_type; FilterObservable_type* FilterObservable_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct IPlotDataItem_type; ::g::Fuse::Charting::IPlotDataItem_type* AxisEntry_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct IPlotDataItem_type; ::g::Fuse::Charting::IPlotDataItem_type* PlotDataPoint_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct IPlotDataItem_type; IPlotDataItem_type* IPlotDataItem_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObjectWrapper_type; ObjectWrapper_type* ObjectWrapper_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObservableData__Subscription_type; ObservableData__Subscription_type* ObservableData__Subscription_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObservableData_type; ::g::Fuse::Charting::ObservableData_type* ObservableAxisItems_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObservableData_type; ::g::Fuse::Charting::ObservableData_type* ObservableDataItems_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObservableData_type; ::g::Fuse::Charting::ObservableData_type* ReadOnlyObservableData_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObservableData_type; ::g::Fuse::Charting::ObservableData_type* ReadOnlyObservableList_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct ObservableData_type; ObservableData_type* ObservableData_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotAxisData_type; PlotAxisData_type* PlotAxisData_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotCurvePoint_type; PlotCurvePoint_type* PlotCurvePoint_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotData_type; PlotData_type* PlotData_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotDataItemWatcher_type; PlotDataItemWatcher_type* PlotDataItemWatcher_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotElement_type; ::g::Fuse::Charting::PlotElement_type* PlotBar_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotElement_type; ::g::Fuse::Charting::PlotElement_type* PlotPoint_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotElement_type; PlotElement_type* PlotElement_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotExpression__PlotDataSubscription_type; PlotExpression__PlotDataSubscription_type* PlotExpression__PlotDataSubscription_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotExpression__PlotSubscription_type; PlotExpression__PlotSubscription_type* PlotExpression__PlotSubscription_typeof();}}}
namespace g{namespace Fuse{namespace Charting{struct PlotWedge_type; PlotWedge_type* PlotWedge_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uClassType* DataUtils_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uClassType* TypeUtils_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uDelegateType* DataChangedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uDelegateType* IPlotDataItem__ChangedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* DataSeriesMetric_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotAxisLayoutAxis_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotAxisLayoutPosition_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotAxisMetric_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotBarStyle_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotExpression__Field_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotOrientation_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotPointAnchor_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotPointStyle_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotTickAxis_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uEnumType* PlotTickStyle_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uInterfaceType* IPlotDataItemListener_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uInterfaceType* IPlotDataItemProvider_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uStructType* AxisEntryData_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uStructType* PlotAxisLayout__CellSizing_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uStructType* PointCalculator_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* AxisFilter_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* Data_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* DataChangedArgs_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* DataSpec_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* DataStats_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* FilterObservable__SourceItem_typeof();}}}
namespace g{namespace Fuse{namespace Charting{uType* PlotExpression__PlotSubscription__UndefinedObject_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{namespace FallbackTextEdit{uInterfaceType* LineCacheTransform_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace Android{uType* DatePickerView_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace Android{uType* TimePickerView_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{struct DatePickerView_type; DatePickerView_type* DatePickerView_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{struct TimePickerView_type; TimePickerView_type* TimePickerView_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{uClassType* DateTimeConverterHelpers_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{uEnumType* iOSDevice__ScreenOrientation_typeof();}}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{uEnumType* TouchPhase_typeof();}}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace iOS{uInterfaceType* INativeFocusListener_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{uEnumType* OffscreenRendering_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uEnumType* ViewHandle__InputMode_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uEnumType* ViewHandle__Invalidation_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* ICircleView_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* ILeafView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* INativeViewRenderer_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IOffscreenRenderer_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IOffscreenRendererHost_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IRectangleView_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IViewGroup_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{struct Image_type;}} ::g::Fuse::Controls::Image_type* BigCog_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Image_type;}} ::g::Fuse::Controls::Image_type* Cog_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Image_type;}} ::g::Fuse::Controls::Image_type* SmallCog_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type; ::g::Fuse::Controls::Panel_type* DatePicker_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type; ::g::Fuse::Controls::Panel_type* DatePickerBase_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type; ::g::Fuse::Controls::Panel_type* SafeEdgePanel_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type; ::g::Fuse::Controls::Panel_type* StackPanel_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type; ::g::Fuse::Controls::Panel_type* TimePicker_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type; ::g::Fuse::Controls::Panel_type* TimePickerBase_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* c_appr_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* c_gr_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* c_inq_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* c_menu_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* c_po_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* CalendarView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* CogWheelReload_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* ColorPalette_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Confirm_inq_appr_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Confirm_inq_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Confirm_msg_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Confirm_return_inq_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Confirm_return_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Confirm_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* DayView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* DropdownMenu_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* DropdownOption_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* DropdownSelectedItem_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* ListType_inq_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* ListType_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* LoginPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* MonthView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* MyLoadingIndicator_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* MyLoadingIndicator1_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* MyToggle_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* PagePlaceholder_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* s_inq01_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* SubPage_appr_inq_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* SubPage_appr_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* SubPage_po_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* SubPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Tab_1_inq_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Tab_1_po_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Tab_1_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Tab_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* ActionButton_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* BackButton_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* Bubbles_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* CardBody_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* Carousel_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* CarouselPage_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* Drawer_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* DrawerButtonBackground_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* FlatCarousel_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* FlatCarouselPage_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* IconLabel_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* ListView_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* MediaScroller_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* NavBar_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* Page_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* PartialTabPage_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* RadarPlot_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* SwipeActionPanel_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* TabBar_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* TabPage_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* TabPageControl_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* TextStyles_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* TitlePanel_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Alive{::g::Fuse::Controls::Panel_type* UnderlineTitle_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fuse{namespace Charting{::g::Fuse::Controls::Panel_type* Plot_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fuse{namespace Charting{::g::Fuse::Controls::Panel_type* PlotAxis_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace HS{::g::Fuse::Controls::Panel_type* Button_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace HS{::g::Fuse::Controls::Panel_type* MenuButton_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace HS{::g::Fuse::Controls::Panel_type* Rectangle_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct RangeControl_type;}} namespace Alive{::g::Fuse::Controls::RangeControl_type* Slider_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} ::g::Fuse::Controls::Shape_type* CycleButton_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} ::g::Fuse::Controls::Shape_type* CycleButton2_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} ::g::Fuse::Controls::Shape_type* ModeIndicator_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} ::g::Fuse::Controls::Shape_type* SelectableRectangle_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} ::g::Fuse::Controls::Shape_type* TypeIndicator_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* Bubble_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* CallToActionButton_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* Card_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* CardMedia_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* ColorBadge_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* ContentGradient_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* Donut_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* ListViewHeader_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* Switch__InnerSwitch_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Alive{::g::Fuse::Controls::Shape_type* ThemedCard_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} namespace Fuse{namespace Charting{::g::Fuse::Controls::Shape_type* PlotTicks_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* Body_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* BodyBold_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* ButtonText_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* Icon_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* NavBarTitle_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* Subtitle_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace Alive{::g::Fuse::Controls::TextControl_type* Title_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace HS{::g::Fuse::Controls::TextControl_type* Text_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct TextInput_type;}} namespace HS{::g::Fuse::Controls::TextInput_type* TextBox_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct ToggleControl_type;}} namespace Alive{::g::Fuse::Controls::ToggleControl_type* Switch_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* PageFreeze_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* PagePrepareBusy_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* SafeEdgePanelEdges_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* ScrollDirections_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* ScrollViewBase__DistanceFromViewTarget_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uInterfaceType* IDatePickerView_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uInterfaceType* ITimePickerView_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{struct ImageFill_type;}} namespace Alive{::g::Fuse::Drawing::ImageFill_type* ImageFill_typeof();}}
...
namespace g{namespace Fuse{namespace Drawing{uClassType* DotNetUtil_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* Antialiasing_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{struct XYBaseLayoutFunction_type; ::g::Fuse::Elements::XYBaseLayoutFunction_type* XFunction_typeof();}}}
namespace g{namespace Fuse{namespace Elements{struct XYBaseLayoutFunction_type; ::g::Fuse::Elements::XYBaseLayoutFunction_type* YFunction_typeof();}}}
namespace g{namespace Fuse{namespace Elements{struct XYBaseLayoutFunction_type; XYBaseLayoutFunction_type* XYBaseLayoutFunction_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* Element__BoxSizingMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* PerspectiveRelativeToMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* ViewportMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{namespace Internal{uDelegateType* TwoFingerEventHandler_typeof();}}}}
namespace g{namespace Fuse{namespace Gestures{namespace Internal{uDelegateType* TwoFingerRotateHandler_typeof();}}}}
namespace g{namespace Fuse{namespace Gestures{namespace Internal{uDelegateType* TwoFingerTranslateHandler_typeof();}}}}
namespace g{namespace Fuse{namespace Gestures{namespace Internal{uDelegateType* TwoFingerZoomHandler_typeof();}}}}
...
namespace g{namespace Fuse{namespace Gestures{uDelegateType* DoubleTappedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Gestures{uDelegateType* LongPressedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uEnumType* PointerCaptureOn_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uInterfaceType* ISizeConstraint_typeof();}}}
...
namespace g{namespace Fuse{namespace ImageTools{uClassType* iOSImageUtils_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{uEnumType* ResizeMode_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{uType* BoolPromiseCallback_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{uType* Image_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{uType* ImagePromiseCallback_typeof();}}}
namespace g{namespace Fuse{namespace ImageTools{uType* PromiseCallback_typeof();}}}
...
namespace g{namespace Fuse{namespace Internal{uDelegateType* Curves__PointInterpolater_typeof();}}}
...
namespace g{namespace Fuse{namespace Layouts{struct Layout_type;}} namespace Fuse{namespace Charting{::g::Fuse::Layouts::Layout_type* PlotAxisLayout_typeof();}}}
...
namespace g{namespace Fuse{namespace Models{struct ModelJavaScript_type; ModelJavaScript_type* ModelJavaScript_typeof();}}}
namespace g{namespace Fuse{namespace Models{struct ZoneJS_type; ZoneJS_type* ZoneJS_typeof();}}}
namespace g{namespace Fuse{namespace Models{uType* ModelJavaScript__ModelData_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uDelegateType* ActivatedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uDelegateType* NavigationPageProgressHandler_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uDelegateType* NavigationPageProxy__StatusChangedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uDelegateType* NavigationStateChangedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uEnumType* NavigationDirection_typeof();}}}
...
namespace g{namespace Fuse{namespace Physics{uDelegateType* ForceFieldEventHandler_typeof();}}}
namespace g{namespace Fuse{namespace Physics{uEnumType* Axis2D_typeof();}}}
namespace g{namespace Fuse{namespace Physics{uInterfaceType* IRule_typeof();}}}
...
namespace g{namespace Fuse{namespace Platform{uEnumType* StatusBarAnimation_typeof();}}}
namespace g{namespace Fuse{namespace Platform{uEnumType* StatusBarStyle_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* AdjustHueFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* DarkenFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* DesaturateFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* LightenFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* SaturateFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* ScaleLightnessFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; ::g::Fuse::Reactive::BinaryColorFunction_type* ScaleSaturationFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryColorFunction_type; BinaryColorFunction_type* BinaryColorFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* Add_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* Concat_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* Divide_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* Equal_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* GreaterOrEqual_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* GreaterThan_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* InfixOperator_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* LessOrEqual_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* LessThan_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* LogicalAnd_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* LogicalOr_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* NotEqual_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* Pow_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; ::g::Fuse::Reactive::BinaryOperator_type* Subtract_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type; BinaryOperator_type* BinaryOperator_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type;}} namespace Alive{::g::Fuse::Reactive::BinaryOperator_type* TransparentizeFunction_typeof();}}
namespace g{namespace Fuse{namespace Reactive{struct BinaryOperator_type;}} namespace Alive{::g::Fuse::Reactive::BinaryOperator_type* WithOpacityFunction_typeof();}}
...
namespace g{namespace Fuse{namespace Reactive{struct Expression_type;}} namespace Fuse{namespace Charting{::g::Fuse::Reactive::Expression_type* PlotExpression_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct Let_type; Let_type* Let_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetBool_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetFloat_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetFloat2_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetFloat3_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetFloat4_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetSize_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetSize2_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetString_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; ::g::Fuse::Reactive::LetBase_type* LetType_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetBase_type; LetBase_type* LetBase_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetObservable__Subscription_type; LetObservable__Subscription_type* LetObservable__Subscription_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct LetObservable_type; LetObservable_type* LetObservable_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct SimpleVarArgFunction_type; ::g::Fuse::Reactive::SimpleVarArgFunction_type* NamedFunctionCall_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct TernaryOperator_type;}} namespace Alive{::g::Fuse::Reactive::TernaryOperator_type* MixFunction_typeof();}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* AtanVector_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* HslaToRgbaFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* IsNull_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* LogicalNot_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* RgbaToHslaFunction_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* ToFloat_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* ToSize_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* ToString_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* VectorW_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct UnaryOperator_type; ::g::Fuse::Reactive::UnaryOperator_type* VectorZ_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{uClassType* ColorModel_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{uDelegateType* BinaryFloatOperator__FloatOp_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uDelegateType* ClosureHandler_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uDelegateType* UnaryFloatOperator__FloatOp_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{uEnumType* WhileCount__Range_typeof();}}}
...
namespace g{namespace Fuse{namespace Resources{namespace Exif{uClassType* ExifIOSImpl_typeof();}}}}
...
namespace g{namespace Fuse{namespace Resources{uInterfaceType* IDeferredDisposable_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{namespace Test{uType* JSTest_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct JSContext_type;}}} namespace Fuse{namespace Scripting{namespace JavaScriptCore{::g::Fuse::Scripting::JavaScript::JSContext_type* Context_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ThreadWorker__Fence_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScriptCore{struct Context__EnterVM_type; Context__EnterVM_type* Context__EnterVM_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScriptCore{uDelegateType* JSClassRef__RawCallback_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScriptCore{uEnumType* JSType_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} ::g::Fuse::Scripting::NativeModule_type* deviceToast_typeof();}
...
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace Alerts{::g::Fuse::Scripting::NativeModule_type* NativeAlerts_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace BackgroundDownload{::g::Fuse::Scripting::NativeModule_type* BackgroundDownloadModule_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace Camera{::g::Fuse::Scripting::NativeModule_type* Camera_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace CameraRoll{::g::Fuse::Scripting::NativeModule_type* CameraRoll_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace ImageTools{::g::Fuse::Scripting::NativeModule_type* ImageTools_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace Vibration{::g::Fuse::Scripting::NativeModule_type* VibrationModule_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* ScriptMethod1__LegacyMethodClosure_typeof();}}}
...
namespace g{namespace Fuse{namespace Testing{uEnumType* TestRootPanel__StepFlags_typeof();}}}
...
namespace g{namespace Fuse{namespace Text{namespace Edit{uEnumType* CaretIndex_typeof();}}}}
...
namespace g{namespace Fuse{namespace Text{namespace Implementation{uEnumType* ICU__ErrorCode_typeof();}}}}
...
namespace g{namespace Fuse{namespace Text{uEnumType* TextDirection_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{namespace Actions{struct TriggerAction_type;}}} namespace Fuse{::g::Fuse::Triggers::Actions::TriggerAction_type* PlaySound_typeof();}}
...
namespace g{namespace Fuse{namespace Triggers{struct ScrollingAnimation_type;}} namespace Alive{::g::Fuse::Triggers::ScrollingAnimation_type* StickingAnimation_typeof();}}
...
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} ::g::Fuse::Triggers::Trigger_type* Handler_inq_appr_typeof();}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} ::g::Fuse::Triggers::Trigger_type* Handler_inq_typeof();}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} ::g::Fuse::Triggers::Trigger_type* Handler_msg_typeof();}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} ::g::Fuse::Triggers::Trigger_type* Handler_return_inq_typeof();}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} ::g::Fuse::Triggers::Trigger_type* Handler_return_typeof();}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} ::g::Fuse::Triggers::Trigger_type* Handler_typeof();}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} namespace Alive{::g::Fuse::Triggers::Trigger_type* SwipeActionConfirmed_typeof();}}
...
namespace g{namespace Fuse{namespace Triggers{struct WhileBool_type;}} namespace Alive{::g::Fuse::Triggers::WhileBool_type* DarkTheme_typeof();}}
namespace g{namespace Fuse{namespace Triggers{struct WhileBool_type;}} namespace Alive{::g::Fuse::Triggers::WhileBool_type* FallbackTheme_typeof();}}
namespace g{namespace Fuse{namespace Triggers{struct WhileBool_type;}} namespace Alive{::g::Fuse::Triggers::WhileBool_type* LightTheme_typeof();}}
namespace g{namespace Fuse{namespace Triggers{struct WhileBool_type;}} namespace Alive{::g::Fuse::Triggers::WhileBool_type* ThemeBase_typeof();}}
...
namespace g{namespace Fuse{namespace Triggers{uDelegateType* KeyPressHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* LayoutAnimationType_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* OnUserEventFilter_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* ScrolledWhere_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* ScrollingAnimationRange_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* WhileVisibleInScrollViewMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IVisibility_typeof();}}}
...
namespace g{namespace Fuse{namespace Vibration{uType* AndroidVibrator_typeof();}}}
...
namespace g{namespace Fuse{struct Computer1_type; ::g::Fuse::Computer1_type* BoolComputer_typeof();}}
...
namespace g{namespace Fuse{struct Node_type; namespace Charting{::g::Fuse::Node_type* PlotArea_typeof();}}}
namespace g{namespace Fuse{struct Node_type; namespace Charting{::g::Fuse::Node_type* PlotBehavior_typeof();}}}
...
namespace g{namespace Fuse{struct NodeGroup_type;} ::g::Fuse::NodeGroup_type* Resources_typeof();}
...
namespace g{namespace Fuse{uEnumType* Computer__BoolOp_typeof();}}
namespace g{namespace Fuse{uEnumType* Computer__TypeOp_typeof();}}
...
namespace g{namespace Fuse{uEnumType* iOSDevice__ScreenOrientation_typeof();}}
...
namespace g{namespace Fuse{uEnumType* MarginBoxDependent_typeof();}}
...
namespace g{namespace Fuse{uInterfaceType* IRootVisualProvider_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IScalingMode_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IScriptException_typeof();}}
...
namespace g{namespace Native{namespace Android{uType* DatePickerView_typeof();}}}
namespace g{namespace Native{namespace Android{uType* TimePickerView_typeof();}}}
namespace g{namespace Native{namespace iOS{struct DatePickerView_type; DatePickerView_type* DatePickerView_typeof();}}}
namespace g{namespace Native{namespace iOS{struct TimePickerView_type; TimePickerView_type* TimePickerView_typeof();}}}
namespace g{namespace Native{namespace iOS{struct UIControlEvent_type; UIControlEvent_type* UIControlEvent_typeof();}}}
namespace g{namespace Native{namespace iOS{uClassType* DateExtensions_typeof();}}}
namespace g{namespace Native{struct DatePickerBase_type; ::g::Native::DatePickerBase_type* DatePicker_typeof();}}
namespace g{namespace Native{struct DatePickerBase_type; DatePickerBase_type* DatePickerBase_typeof();}}
namespace g{namespace Native{struct TimePickerBase_type; ::g::Native::TimePickerBase_type* TimePicker_typeof();}}
namespace g{namespace Native{struct TimePickerBase_type; TimePickerBase_type* TimePickerBase_typeof();}}
namespace g{namespace Native{uClassType* DateExtensions_typeof();}}
namespace g{namespace Native{uInterfaceType* IDatePickerHost_typeof();}}
namespace g{namespace Native{uInterfaceType* IDatePickerView_typeof();}}
namespace g{namespace Native{uInterfaceType* ITimePickerHost_typeof();}}
namespace g{namespace Native{uInterfaceType* ITimePickerView_typeof();}}
...
namespace g{namespace OpenGL{uEnumType* GLPixelStoreParameter_typeof();}}
...
namespace g{namespace Outracks{namespace Simulator{namespace Bytecode{uEnumType* NumberType_typeof();}}}}
...
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct CppEvent_type; CppEvent_type* CppEvent_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct CppProperty_type; CppProperty_type* CppProperty_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct DotNetReflection_type; DotNetReflection_type* DotNetReflection_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct DotNetReflectionWrapper_type; DotNetReflectionWrapper_type* DotNetReflectionWrapper_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct FakeApp_type; FakeApp_type* FakeApp_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct NativeReflection_type; NativeReflection_type* NativeReflection_typeof();}}}}
...
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct SimpleTypeMap_type; SimpleTypeMap_type* SimpleTypeMap_typeof();}}}}
...
namespace g{namespace Outracks{namespace Simulator{namespace Client{uClassType* ReflectionCache_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uClassType* ReflectionExtensions_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uClassType* TryInvokeExtension_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uClassType* VirtualMachine_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uEnumType* InputMode_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uInterfaceType* IEvent_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uInterfaceType* IProperty_typeof();}}}}
namespace g{namespace Outracks{namespace Simulator{namespace Client{uInterfaceType* ITypeMap_typeof();}}}}
...
namespace g{namespace Outracks{namespace Simulator{namespace Protocol{uEnumType* DiagnosticType_typeof();}}}}
...
namespace g{namespace Outracks{namespace Simulator{namespace Runtime{uInterfaceType* IReflection_typeof();}}}}
...
namespace g{namespace Outracks{namespace Simulator{uInterfaceType* ISimulatorClient_typeof();}}}
...
namespace g{namespace Outracks{struct Optional1_type; Optional1_type* Optional1_typeof();}}
...
namespace g{namespace Outracks{uClassType* Optional_typeof();}}
namespace g{namespace Outracks{uInterfaceType* IBinaryMessage_typeof();}}
namespace g{namespace Outracks{uType* BinaryMessage__WriteClosure_typeof();}}
namespace g{namespace Outracks{uType* None_typeof();}}
...
namespace g{namespace Uno{namespace Diagnostics{uEnumType* EventType_typeof();}}}
...
namespace g{namespace Uno{namespace Graphics{uEnumType* CubeFace_typeof();}}}
...
namespace g{namespace Uno{namespace Net{namespace Http{uEnumType* UriSchemeType_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Http{uStructType* SchemeParserResult_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Http{uType* FragmentParser_typeof();}}}}
...
namespace g{namespace Uno{namespace Net{namespace Http{uType* SegmentsParser_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Http{uType* Uri_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Http{uType* UriHelper_typeof();}}}}
...
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* AddressFamily_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* ProtocolType_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* SelectMode_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* SocketFlags_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* SocketShutdown_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* SocketType_typeof();}}}}
...
namespace g{namespace Uno{namespace Platform{uEnumType* PointerCursor_typeof();}}}
namespace g{namespace Uno{namespace Platform{uEnumType* PointerType_typeof();}}}
namespace g{namespace Uno{namespace Platform{uEnumType* WheelDeltaMode_typeof();}}}
...
namespace g{namespace Uno{namespace Reflection{uInterfaceType* IField_typeof();}}}
namespace g{namespace Uno{namespace Reflection{uInterfaceType* IFunction_typeof();}}}
...
namespace g{namespace Uno{namespace Time{uStructType* LocalDate_typeof();}}}
...
namespace g{namespace Uno{namespace Time{uStructType* OffsetDateTime_typeof();}}}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_AliveDrawer_HideButton_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_AliveIcon_Size_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_AliveListView_IsAnimated_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_AliveListView_Items_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_AliveSwitchInnerSwitch_Progress_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseAnimationsAttractorfloat4_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseAnimationsMove_X_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseAnimationsMove_Y_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseAnimationsScale_Factor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsPanel_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsShadow_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsShadow_Distance_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsShadow_Size_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsShape_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsShape_StrokeColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsTextControl_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsTextControl_FontSize_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseDrawingGradientStop_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseElementsElement_ElementLayoutMaster_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseElementsElement_Height_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseElementsElement_Opacity_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseElementsElement_Width_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseGesturesSetSwipeActive_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseGesturesSwipeGesture_IsActive_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseNavigationNavigateTo_Target_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseReactiveEach_Items_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseReactiveWith_Data_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseResourcesResourceFloat4_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseResourcesResourceString_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseScaling_Factor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseTriggersActionsSetdouble_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseTriggersScrollingAnimation_From_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseTriggersScrollingAnimation_To_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseTriggersTimeline_TargetProgress_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseTriggersWhileBool_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseTriggersWhileString_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseUXKitsAlive_FuseVisual_ZOffset_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_c_po_Options_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_c_po_Options2_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_c_po_Selected_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_c_po_Selected2_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Confirm_inq_appr_Show_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Confirm_inq_Show_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Confirm_msg_Show_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Confirm_return_inq_Show_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Confirm_return_Show_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Confirm_Show_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_CycleButton_CurrentMode_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_CycleButton_Modes_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_CycleButton2_CurrentType_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_CycleButton2_Types_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownMenu_BackgroundColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownMenu_BorderColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownMenu_FontSize_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownMenu_ListItems_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownMenu_Selected_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownMenu_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownOption_BackgroundColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownOption_BorderColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownOption_FontSize_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownOption_Text_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownOption_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownSelectedItem_BackgroundColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownSelectedItem_BorderColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownSelectedItem_FontSize_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownSelectedItem_Text_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_DropdownSelectedItem_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseAnimationsAttractorfloat4_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseAnimationsChangebool_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseAnimationsChangefloat4_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseAnimationsChangestring_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsControl_Background_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsDatePickerBase_MaxValue_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsDatePickerBase_MinValue_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsDatePickerBase_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsImage_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsNavigationControl_Active_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsNavigator_DefaultPath_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsNavigatorSwipe_IsEnabled_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsPageControl_Interaction_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsPanel_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsShape_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsShape_Fill_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsTextControl_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsTextControl_FontSize_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsTextControl_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseControlsTextInputControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseDrawingStroke_Brush_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseDrawingStroke_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_Alignment_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_ElementLayoutMaster_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_Height_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_HitTestMode_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_MinHeight_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_Offset_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_Opacity_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_Visibility_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsElement_Width_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsInteractiveTransform_Rotation_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsInteractiveTransform_Translation_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseElementsInteractiveTransform_ZoomFactor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseGesturesSwipeGesture_IsActive_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseLayoutsColumn_Width_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseReactiveEach_Items_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseReactiveWhileCount_Items_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseResourcesHttpImageSource_Url_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseRotation_Degrees_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseScaling_Factor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseSelectionSelectable_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseTranslation_Y_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseTriggersActionsSetstring_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseTriggersBusy_IsActive_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseTriggersPullToReload_IsLoading_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseTriggersTimeline_TargetProgress_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_FuseTriggersWhileBool_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_ListType_inq_USR_ID_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_ListType_inq_USR_NM_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_ListType_USR_ID_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_ListType_USR_NM_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_ModeIndicator_IsActive_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_MyToggle_IsActive_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_SelectableRectangle_ID_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_SelectableRectangle_SelectionColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_Tab_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* HSMRO_TypeIndicator_IsActive_Property_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} namespace Native{::g::Uno::UX::Property1_type* DatePickerBase__CurrentDateProperty_typeof();}}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} namespace Native{::g::Uno::UX::Property1_type* TimePickerBase__CurrentTimeProperty_typeof();}}
...
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_CallToActionButton_Glow_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_CallToActionButton_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_Drawer_HideButton_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_FlatCarouselPage_Subtitle_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_FlatCarouselPage_Title_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_Icon_Size_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_IconLabel_Icon_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_IconLabel_IconSize_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_IconLabel_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_ListView_IsAnimated_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_ListViewHeader_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_MediaScroller_TopBarColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_StickingAnimation_Distance_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_ButtonText_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_ConfirmationText_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_GradientEndColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_GradientStartColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_StayOpen_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_TabPage_Label_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_TitlePanel_Subtitle_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_TitlePanel_Title_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Alive_UnderlineTitle_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Fuse_Controls_Shape_Color_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Fuse_Controls_ToggleControl_Value_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_Fuse_Node_Parent_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* FuseUXKitsAlive_accessor_InnerSwitch_Progress_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_inq_appr_Show_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_inq_appr_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_inq_Show_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_inq_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_msg_Show_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_msg_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_return_inq_Show_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_return_inq_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_return_Show_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_return_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_Show_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Confirm_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_CycleButton_Modes_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_CycleButton2_Types_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownMenu_BackgroundColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownMenu_BorderColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownMenu_FontSize_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownMenu_ListItems_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownMenu_TextColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownOption_BackgroundColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownOption_BorderColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownOption_FontSize_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownOption_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownOption_TextColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownSelectedItem_BackgroundColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownSelectedItem_FontSize_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownSelectedItem_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_DropdownSelectedItem_TextColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_HS_Button_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_HS_MenuButton_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_HS_Rectangle_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_ListType_inq_USR_ID_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_ListType_inq_USR_NM_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_ListType_USR_ID_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_ListType_USR_NM_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_ModeIndicator_IsActive_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_MyLoadingIndicator_ThemeColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_MyLoadingIndicator1_ThemeColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_MyToggle_IsActive_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_MyToggle_PrimaryColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_MyToggle_SecondaryColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_SelectableRectangle_ID_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_SelectableRectangle_SelectionColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_1_Color_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_1_inq_Color_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_1_inq_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_1_po_Color_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_1_po_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_1_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_Color_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_Tab_Text_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* HSMRO_accessor_TypeIndicator_IsActive_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type; Template_type* Template_typeof();}}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template2__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template2__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template2__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_appr__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_gr__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_gr__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_gr__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_gr__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_gr__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_gr__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template1__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template1__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template1__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template1__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template1__Template6_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_inq__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template1__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template1__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template1__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template10_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template11_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template12_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template13_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template14_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template6_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template7_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template8_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2__Template9_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* c_po__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* CalendarView__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* CalendarView__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* CycleButton__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* CycleButton2__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* DropdownMenu__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* LoginPage__Template6_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* MonthView__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* MonthView__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* MonthView__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template4_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template5_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template6__Template7_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template6__Template8_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template6__Template9_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template6_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template7_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template8__Template10_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template8__Template11_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template8__Template9_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template8_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* s_inq01__Template9_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr__Template3_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr_inq__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr_inq__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* SubPage_appr_inq__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* Carousel__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* FlatCarousel__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* FlatCarouselPage__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* ListView__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* MediaScroller__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* RadarPlot__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* RadarPlot__Template1_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* RadarPlot__Template2_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Alive{::g::Uno::UX::Template_type* TabBar__Template_typeof();}}
...
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Native{::g::Uno::UX::Template_type* DatePicker__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Native{::g::Uno::UX::Template_type* DatePicker__Template1_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Native{::g::Uno::UX::Template_type* DatePicker__Template2_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Native{::g::Uno::UX::Template_type* TimePicker__Template_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Native{::g::Uno::UX::Template_type* TimePicker__Template1_typeof();}}
namespace g{namespace Uno{namespace UX{struct Template_type;}} namespace Native{::g::Uno::UX::Template_type* TimePicker__Template2_typeof();}}
...
namespace g{namespace Uno{struct Exception_type;} namespace Outracks{namespace Simulator{namespace Bytecode{::g::Uno::Exception_type* InvalidDataException_typeof();}}}}
namespace g{namespace Uno{struct Exception_type;} namespace Outracks{namespace Simulator{namespace Bytecode{::g::Uno::Exception_type* NonExhaustiveMatch_typeof();}}}}
...
namespace g{namespace Uno{uDelegateType* Action10_typeof();}}
namespace g{namespace Uno{uDelegateType* Action11_typeof();}}
namespace g{namespace Uno{uDelegateType* Action12_typeof();}}
namespace g{namespace Uno{uDelegateType* Action13_typeof();}}
namespace g{namespace Uno{uDelegateType* Action14_typeof();}}
namespace g{namespace Uno{uDelegateType* Action15_typeof();}}
namespace g{namespace Uno{uDelegateType* Action16_typeof();}}
...
namespace g{namespace Uno{uDelegateType* Action5_typeof();}}
namespace g{namespace Uno{uDelegateType* Action6_typeof();}}
namespace g{namespace Uno{uDelegateType* Action7_typeof();}}
namespace g{namespace Uno{uDelegateType* Action8_typeof();}}
namespace g{namespace Uno{uDelegateType* Action9_typeof();}}
...
namespace g{namespace Uno{uDelegateType* Func10_typeof();}}
namespace g{namespace Uno{uDelegateType* Func11_typeof();}}
namespace g{namespace Uno{uDelegateType* Func12_typeof();}}
namespace g{namespace Uno{uDelegateType* Func13_typeof();}}
namespace g{namespace Uno{uDelegateType* Func14_typeof();}}
namespace g{namespace Uno{uDelegateType* Func15_typeof();}}
namespace g{namespace Uno{uDelegateType* Func16_typeof();}}
namespace g{namespace Uno{uDelegateType* Func2_typeof();}}
namespace g{namespace Uno{uDelegateType* Func3_typeof();}}
namespace g{namespace Uno{uDelegateType* Func4_typeof();}}
namespace g{namespace Uno{uDelegateType* Func5_typeof();}}
namespace g{namespace Uno{uDelegateType* Func6_typeof();}}
namespace g{namespace Uno{uDelegateType* Func7_typeof();}}
namespace g{namespace Uno{uDelegateType* Func8_typeof();}}
namespace g{namespace Uno{uDelegateType* Func9_typeof();}}
...
namespace g{uClassType* FuseModels_bundle_typeof();}
...
namespace g{uClassType* FuseUXKitsAlive_bundle_typeof();}
namespace g{uClassType* HSMRO_bundle_typeof();}
namespace g{uClassType* UnoCore_bundle_typeof();}
namespace g{uEnumType* HomeScreenType_typeof();}
namespace g{uType* FuseUXKitsAlive_ColorPalette_res_typeof();}
namespace g{uType* FuseUXKitsAlive_ColorThemes_res_typeof();}
namespace g{uType* FuseUXKitsAlive_IconFont_res_typeof();}
...
void uInitRtti()
{
    ...
    {
        (uType*(*)())&::g::Alive::ActionButton_typeof,
        (uType*(*)())&::g::Alive::BackButton_typeof,
        (uType*(*)())&::g::Alive::Body_typeof,
        (uType*(*)())&::g::Alive::BodyBold_typeof,
        (uType*(*)())&::g::Alive::Bubble_typeof,
        (uType*(*)())&::g::Alive::Bubbles_typeof,
        (uType*(*)())&::g::Alive::ButtonText_typeof,
        (uType*(*)())&::g::Alive::CallToActionButton_typeof,
        (uType*(*)())&::g::Alive::Card_typeof,
        (uType*(*)())&::g::Alive::CardBody_typeof,
        (uType*(*)())&::g::Alive::CardMedia_typeof,
        (uType*(*)())&::g::Alive::Carousel__Template_typeof,
        (uType*(*)())&::g::Alive::Carousel_typeof,
        (uType*(*)())&::g::Alive::CarouselPage_typeof,
        (uType*(*)())&::g::Alive::ColorBadge_typeof,
        (uType*(*)())&::g::Alive::ColorFunctions_typeof,
        (uType*(*)())&::g::Alive::ContentGradient_typeof,
        (uType*(*)())&::g::Alive::DarkTheme_typeof,
        (uType*(*)())&::g::Alive::Donut_typeof,
        (uType*(*)())&::g::Alive::Drawer_typeof,
        (uType*(*)())&::g::Alive::DrawerButtonBackground_typeof,
        (uType*(*)())&::g::Alive::FallbackTheme_typeof,
        (uType*(*)())&::g::Alive::FlatCarousel__Template_typeof,
        (uType*(*)())&::g::Alive::FlatCarousel_typeof,
        (uType*(*)())&::g::Alive::FlatCarouselPage__Template_typeof,
        (uType*(*)())&::g::Alive::FlatCarouselPage_typeof,
        (uType*(*)())&::g::Alive::Icon_typeof,
        (uType*(*)())&::g::Alive::IconLabel_typeof,
        (uType*(*)())&::g::Alive::ImageFill_typeof,
        (uType*(*)())&::g::Alive::LightTheme_typeof,
        (uType*(*)())&::g::Alive::ListView__Template_typeof,
        (uType*(*)())&::g::Alive::ListView_typeof,
        (uType*(*)())&::g::Alive::ListViewHeader_typeof,
        (uType*(*)())&::g::Alive::MediaScroller__Template_typeof,
        (uType*(*)())&::g::Alive::MediaScroller_typeof,
        (uType*(*)())&::g::Alive::MixFunction_typeof,
        (uType*(*)())&::g::Alive::NavBar_typeof,
        (uType*(*)())&::g::Alive::NavBarTitle_typeof,
        (uType*(*)())&::g::Alive::Page_typeof,
        (uType*(*)())&::g::Alive::PartialTabPage_typeof,
        (uType*(*)())&::g::Alive::RadarPlot__Template_typeof,
        (uType*(*)())&::g::Alive::RadarPlot__Template1_typeof,
        (uType*(*)())&::g::Alive::RadarPlot__Template2_typeof,
        (uType*(*)())&::g::Alive::RadarPlot_typeof,
        (uType*(*)())&::g::Alive::Slider_typeof,
        (uType*(*)())&::g::Alive::StickingAnimation_typeof,
        (uType*(*)())&::g::Alive::Subtitle_typeof,
        (uType*(*)())&::g::Alive::SwipeActionConfirmed_typeof,
        (uType*(*)())&::g::Alive::SwipeActionPanel_typeof,
        (uType*(*)())&::g::Alive::Switch__InnerSwitch_typeof,
        (uType*(*)())&::g::Alive::Switch_typeof,
        (uType*(*)())&::g::Alive::TabBar__Template_typeof,
        (uType*(*)())&::g::Alive::TabBar_typeof,
        (uType*(*)())&::g::Alive::TabPage_typeof,
        (uType*(*)())&::g::Alive::TabPageControl_typeof,
        (uType*(*)())&::g::Alive::TextStyles_typeof,
        (uType*(*)())&::g::Alive::ThemeBase_typeof,
        (uType*(*)())&::g::Alive::ThemedCard_typeof,
        (uType*(*)())&::g::Alive::Title_typeof,
        (uType*(*)())&::g::Alive::TitlePanel_typeof,
        (uType*(*)())&::g::Alive::TransparentizeFunction_typeof,
        (uType*(*)())&::g::Alive::UnderlineTitle_typeof,
        (uType*(*)())&::g::Alive::WithOpacityFunction_typeof,
        (uType*(*)())&::g::BigCog_typeof,
        (uType*(*)())&::g::c_appr__Template__Template1_typeof,
        (uType*(*)())&::g::c_appr__Template__Template2_typeof,
        (uType*(*)())&::g::c_appr__Template__Template3_typeof,
        (uType*(*)())&::g::c_appr__Template_typeof,
        (uType*(*)())&::g::c_appr__Template1_typeof,
        (uType*(*)())&::g::c_appr__Template2__Template3_typeof,
        (uType*(*)())&::g::c_appr__Template2__Template4_typeof,
        (uType*(*)())&::g::c_appr__Template2__Template5_typeof,
        (uType*(*)())&::g::c_appr__Template2_typeof,
        (uType*(*)())&::g::c_appr__Template3_typeof,
        (uType*(*)())&::g::c_appr_typeof,
        (uType*(*)())&::g::c_gr__Template_typeof,
        (uType*(*)())&::g::c_gr__Template1_typeof,
        (uType*(*)())&::g::c_gr__Template2_typeof,
        (uType*(*)())&::g::c_gr__Template3_typeof,
        (uType*(*)())&::g::c_gr__Template4_typeof,
        (uType*(*)())&::g::c_gr__Template5_typeof,
        (uType*(*)())&::g::c_gr_typeof,
        (uType*(*)())&::g::c_inq__Template__Template1_typeof,
        (uType*(*)())&::g::c_inq__Template__Template2_typeof,
        (uType*(*)())&::g::c_inq__Template_typeof,
        (uType*(*)())&::g::c_inq__Template1__Template2_typeof,
        (uType*(*)())&::g::c_inq__Template1__Template3_typeof,
        (uType*(*)())&::g::c_inq__Template1__Template4_typeof,
        (uType*(*)())&::g::c_inq__Template1__Template5_typeof,
        (uType*(*)())&::g::c_inq__Template1__Template6_typeof,
        (uType*(*)())&::g::c_inq__Template1_typeof,
        (uType*(*)())&::g::c_inq_typeof,
        (uType*(*)())&::g::c_menu_typeof,
        (uType*(*)())&::g::c_po__Template__Template1_typeof,
        (uType*(*)())&::g::c_po__Template__Template2_typeof,
        (uType*(*)())&::g::c_po__Template__Template3_typeof,
        (uType*(*)())&::g::c_po__Template_typeof,
        (uType*(*)())&::g::c_po__Template1__Template2_typeof,
        (uType*(*)())&::g::c_po__Template1__Template3_typeof,
        (uType*(*)())&::g::c_po__Template1__Template4_typeof,
        (uType*(*)())&::g::c_po__Template1_typeof,
        (uType*(*)())&::g::c_po__Template2__Template10_typeof,
        (uType*(*)())&::g::c_po__Template2__Template11_typeof,
        (uType*(*)())&::g::c_po__Template2__Template12_typeof,
        (uType*(*)())&::g::c_po__Template2__Template13_typeof,
        (uType*(*)())&::g::c_po__Template2__Template14_typeof,
        (uType*(*)())&::g::c_po__Template2__Template3_typeof,
        (uType*(*)())&::g::c_po__Template2__Template4_typeof,
        (uType*(*)())&::g::c_po__Template2__Template5_typeof,
        (uType*(*)())&::g::c_po__Template2__Template6_typeof,
        (uType*(*)())&::g::c_po__Template2__Template7_typeof,
        (uType*(*)())&::g::c_po__Template2__Template8_typeof,
        (uType*(*)())&::g::c_po__Template2__Template9_typeof,
        (uType*(*)())&::g::c_po__Template2_typeof,
        (uType*(*)())&::g::c_po_typeof,
        (uType*(*)())&::g::CalendarView__Template_typeof,
        (uType*(*)())&::g::CalendarView__Template1_typeof,
        (uType*(*)())&::g::CalendarView_typeof,
        (uType*(*)())&::g::Cog_typeof,
        (uType*(*)())&::g::CogWheelReload_typeof,
        (uType*(*)())&::g::ColorPalette_typeof,
        (uType*(*)())&::g::Confirm_inq_appr_typeof,
        (uType*(*)())&::g::Confirm_inq_typeof,
        (uType*(*)())&::g::Confirm_msg_typeof,
        (uType*(*)())&::g::Confirm_return_inq_typeof,
        (uType*(*)())&::g::Confirm_return_typeof,
        (uType*(*)())&::g::Confirm_typeof,
        (uType*(*)())&::g::CycleButton__Template_typeof,
        (uType*(*)())&::g::CycleButton_typeof,
        (uType*(*)())&::g::CycleButton2__Template_typeof,
        (uType*(*)())&::g::CycleButton2_typeof,
        (uType*(*)())&::g::DashedSolidColor_typeof,
        (uType*(*)())&::g::DayView_typeof,
        (uType*(*)())&::g::deviceToast_typeof,
        (uType*(*)())&::g::DropdownMenu__Template_typeof,
        (uType*(*)())&::g::DropdownMenu_typeof,
        (uType*(*)())&::g::DropdownOption_typeof,
        (uType*(*)())&::g::DropdownSelectedItem_typeof,
        ...
        (uType*(*)())&::g::Fuse::Alerts::NativeAlerts__DialogCallback_typeof,
        (uType*(*)())&::g::Fuse::Alerts::NativeAlerts_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::EasingFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::ITrackProvider_typeof,
        (uType*(*)())&::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof,
        (uType*(*)())&::g::Fuse::Animations::Keyframe_typeof,
        (uType*(*)())&::g::Fuse::Animations::KeyframeInterpolation_typeof,
        (uType*(*)())&::g::Fuse::Animations::KeyframeTrack_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::TransformPriority_typeof,
        ...
        (uType*(*)())&::g::Fuse::Audio::SoundPlayer_typeof,
        (uType*(*)())&::g::Fuse::BackgroundDownload::BackgroundDownload_typeof,
        (uType*(*)())&::g::Fuse::BackgroundDownload::BackgroundDownloadModule_typeof,
        ...
        (uType*(*)())&::g::Fuse::Camera::iOSCamera_typeof,
        (uType*(*)())&::g::Fuse::Camera::ResizeImageCallback_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::CameraRoll_typeof,
        (uType*(*)())&::g::Fuse::CameraRoll::iOSCameraRoll_typeof,
        (uType*(*)())&::g::Fuse::Charting::AxisEntry_typeof,
        (uType*(*)())&::g::Fuse::Charting::AxisEntryData_typeof,
        (uType*(*)())&::g::Fuse::Charting::AxisFilter_typeof,
        (uType*(*)())&::g::Fuse::Charting::Data_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataChangedArgs_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataChangedHandler_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataSeries_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataSeriesMetric_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataSpec_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataStats_typeof,
        (uType*(*)())&::g::Fuse::Charting::DataUtils_typeof,
        (uType*(*)())&::g::Fuse::Charting::FilterObservable__SourceItem_typeof,
        (uType*(*)())&::g::Fuse::Charting::FilterObservable_typeof,
        (uType*(*)())&::g::Fuse::Charting::IPlotDataItem__ChangedHandler_typeof,
        (uType*(*)())&::g::Fuse::Charting::IPlotDataItem_typeof,
        (uType*(*)())&::g::Fuse::Charting::IPlotDataItemListener_typeof,
        (uType*(*)())&::g::Fuse::Charting::IPlotDataItemProvider_typeof,
        (uType*(*)())&::g::Fuse::Charting::LabelFilterObservable_typeof,
        (uType*(*)())&::g::Fuse::Charting::ObjectWrapper_typeof,
        (uType*(*)())&::g::Fuse::Charting::ObservableAxisItems_typeof,
        (uType*(*)())&::g::Fuse::Charting::ObservableData__Subscription_typeof,
        (uType*(*)())&::g::Fuse::Charting::ObservableData_typeof,
        (uType*(*)())&::g::Fuse::Charting::ObservableDataItems_typeof,
        (uType*(*)())&::g::Fuse::Charting::Plot_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotArea_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxis_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxisData_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxisLayout__CellSizing_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxisLayout_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxisLayoutAxis_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxisLayoutPosition_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotAxisMetric_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotBar_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotBarStyle_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotBehavior_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotCurvePoint_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotData_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotDataItemWatcher_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotDataPoint_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotElement_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotExpression__Field_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotExpression__PlotDataSubscription_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotExpression__PlotSubscription__UndefinedObject_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotExpression__PlotSubscription_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotExpression_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotOrientation_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotPoint_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotPointAnchor_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotPointStyle_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotTickAxis_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotTicks_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotTickStyle_typeof,
        (uType*(*)())&::g::Fuse::Charting::PlotWedge_typeof,
        (uType*(*)())&::g::Fuse::Charting::PointCalculator_typeof,
        (uType*(*)())&::g::Fuse::Charting::ReadOnlyObservableData_typeof,
        (uType*(*)())&::g::Fuse::Charting::ReadOnlyObservableList_typeof,
        (uType*(*)())&::g::Fuse::Charting::TypeUtils_typeof,
        (uType*(*)())&::g::Fuse::Collision_typeof,
        (uType*(*)())&::g::Fuse::Common::Blitter_typeof,
        (uType*(*)())&::g::Fuse::ComputeException_typeof,
        (uType*(*)())&::g::Fuse::Computer__BoolOp_typeof,
        (uType*(*)())&::g::Fuse::Computer__TypeOp_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::FallbackTextEdit::LineCacheTransform_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::IDatePickerView_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::ITimePickerView_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::ICircleView_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::ILeafView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ImageHandle_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ImageLoader_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::INativeViewRenderer_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IOffscreenRenderer_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IOffscreenRendererHost_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::DateTimeConverterHelpers_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::INativeFocusListener_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::InputDispatch__RootInfo_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::InputDispatch_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::iOSDevice__ScreenOrientation_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::iOS::TouchPhase_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::IRectangleView_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::IViewGroup_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::OffscreenRendering_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ViewExtensions_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ViewFactory_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ViewHandle__InputMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::PageFreeze_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::PagePrepareBusy_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::SafeEdgePanel_typeof,
        (uType*(*)())&::g::Fuse::Controls::SafeEdgePanelEdges_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::ScrollViewBase__DistanceFromViewTarget_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::Antialiasing_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::DotNetUtil_typeof,
        ...
        (uType*(*)())&::g::Fuse::Elements::Element__BoxSizingMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Elements::PerspectiveRelativeToMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Gestures::DoubleTappedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Gestures::Internal::TwoFingerEventHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::Internal::TwoFingerRotateHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::Internal::TwoFingerTranslateHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::Internal::TwoFingerZoomHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::ISizeConstraint_typeof,
        ...
        (uType*(*)())&::g::Fuse::Gestures::LongPressedHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::PanGesture_typeof,
        (uType*(*)())&::g::Fuse::Gestures::PointerCapture_typeof,
        (uType*(*)())&::g::Fuse::Gestures::PointerCaptureOn_typeof,
        ...
        (uType*(*)())&::g::Fuse::ImageTools::BoolPromiseCallback_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::Image_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ImagePromiseCallback_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ImageTools_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::iOSImageUtils_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::PromiseCallback_typeof,
        (uType*(*)())&::g::Fuse::ImageTools::ResizeMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Internal::Curves__PointInterpolater_typeof,
        ...
        (uType*(*)())&::g::Fuse::iOSDevice__ScreenOrientation_typeof,
        ...
        (uType*(*)())&::g::Fuse::IRootVisualProvider_typeof,
        (uType*(*)())&::g::Fuse::IScalingMode_typeof,
        (uType*(*)())&::g::Fuse::IScriptException_typeof,
        ...
        (uType*(*)())&::g::Fuse::MarginBoxDependent_typeof,
        ...
        (uType*(*)())&::g::Fuse::Models::ModelJavaScript__ModelData_typeof,
        (uType*(*)())&::g::Fuse::Models::ModelJavaScript_typeof,
        (uType*(*)())&::g::Fuse::Models::ZoneJS_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::ActivatedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::NavigationDirection_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::NavigationPageProgressHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::NavigationStateChangedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Physics::Axis2D_typeof,
        ...
        (uType*(*)())&::g::Fuse::Physics::ForceFieldEventHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Physics::IRule_typeof,
        ...
        (uType*(*)())&::g::Fuse::Platform::StatusBarAnimation_typeof,
        (uType*(*)())&::g::Fuse::Platform::StatusBarStyle_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::AdjustHueFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::AtanVector_typeof,
        (uType*(*)())&::g::Fuse::Reactive::BinaryColorFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::BinaryFloatOperator__FloatOp_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::ClosureHandler_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ColorModel_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::Concat_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::DarkenFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::DesaturateFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::HslaToRgbaFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::IsNull_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::Let_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetBase_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetBool_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetFloat_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetFloat2_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetFloat3_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetFloat4_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetObservable__Subscription_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetObservable_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetSize_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetSize2_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetString_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LetType_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LightenFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Log_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Log2_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LogicalAnd_typeof,
        (uType*(*)())&::g::Fuse::Reactive::LogicalNot_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::NamedFunctionCall_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::RgbaToHslaFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Round_typeof,
        (uType*(*)())&::g::Fuse::Reactive::SaturateFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ScaleLightnessFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ScaleSaturationFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::ToFloat_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ToLower_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ToSize_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ToString_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ToUpper_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Trunc_typeof,
        (uType*(*)())&::g::Fuse::Reactive::UnaryFloatOperator__FloatOp_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::VectorW_typeof,
        (uType*(*)())&::g::Fuse::Reactive::VectorZ_typeof,
        (uType*(*)())&::g::Fuse::Reactive::WhileCount__Range_typeof,
        ...
        (uType*(*)())&::g::Fuse::Resources::Exif::ExifIOSImpl_typeof,
        ...
        (uType*(*)())&::g::Fuse::Resources::IDeferredDisposable_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Test::JSTest_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ThreadWorker__Fence_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::Context__EnterVM_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::Context_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::Function_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::JSClassRef__RawCallback_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::JavaScriptCore::JSType_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::ScriptMethod1__LegacyMethodClosure_typeof,
        ...
        (uType*(*)())&::g::Fuse::Testing::TestRootPanel__StepFlags_typeof,
        ...
        (uType*(*)())&::g::Fuse::Text::Edit::CaretIndex_typeof,
        ...
        (uType*(*)())&::g::Fuse::Text::Implementation::ICU__ErrorCode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Text::TextDirection_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::IVisibility_typeof,
        (uType*(*)())&::g::Fuse::Triggers::KeyPressHandler_typeof,
        (uType*(*)())&::g::Fuse::Triggers::LayoutAnimation_typeof,
        (uType*(*)())&::g::Fuse::Triggers::LayoutAnimationType_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::OnUserEventFilter_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::ScrollingAnimationRange_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::WhileVisibleInScrollViewMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Vibration::AndroidVibrator_typeof,
        (uType*(*)())&::g::Fuse::Vibration::Vibrate_typeof,
        (uType*(*)())&::g::Fuse::Vibration::Vibration_typeof,
        (uType*(*)())&::g::Fuse::Vibration::VibrationModule_typeof,
        ...
        (uType*(*)())&::g::FuseModels_bundle_typeof,
        ...
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_CallToActionButton_Glow_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_CallToActionButton_Text_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_Drawer_HideButton_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_FlatCarouselPage_Subtitle_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_FlatCarouselPage_Title_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_Icon_Size_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_IconLabel_Icon_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_IconLabel_IconSize_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_IconLabel_Text_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_ListView_IsAnimated_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_ListViewHeader_Text_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_MediaScroller_TopBarColor_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_StickingAnimation_Distance_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_ButtonText_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_ConfirmationText_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_GradientEndColor_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_GradientStartColor_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_SwipeActionPanel_StayOpen_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_TabPage_Label_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_TitlePanel_Subtitle_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_TitlePanel_Title_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Alive_UnderlineTitle_Text_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Fuse_Controls_Shape_Color_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Fuse_Controls_ToggleControl_Value_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_Fuse_Node_Parent_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_accessor_InnerSwitch_Progress_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_AliveDrawer_HideButton_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_AliveIcon_Size_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_AliveListView_IsAnimated_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_AliveListView_Items_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_AliveSwitchInnerSwitch_Progress_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_bundle_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_ColorPalette_res_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_ColorThemes_res_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseAnimationsAttractorfloat4_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseAnimationsMove_X_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseAnimationsMove_Y_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseAnimationsScale_Factor_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsPanel_Color_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsShadow_Color_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsShadow_Distance_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsShadow_Size_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsShape_Color_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsShape_StrokeColor_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsTextControl_Color_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsTextControl_FontSize_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseDrawingGradientStop_Color_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseElementsElement_ElementLayoutMaster_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseElementsElement_Height_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseElementsElement_Opacity_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseElementsElement_Width_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseGesturesSetSwipeActive_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseGesturesSwipeGesture_IsActive_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseNavigationNavigateTo_Target_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseReactiveEach_Items_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseReactiveWith_Data_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseResourcesResourceFloat4_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseResourcesResourceString_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseScaling_Factor_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseTriggersActionsSetdouble_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseTriggersScrollingAnimation_From_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseTriggersScrollingAnimation_To_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseTriggersTimeline_TargetProgress_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseTriggersWhileBool_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseTriggersWhileString_Value_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_FuseVisual_ZOffset_Property_typeof,
        (uType*(*)())&::g::FuseUXKitsAlive_IconFont_res_typeof,
        (uType*(*)())&::g::Handler_inq_appr_typeof,
        (uType*(*)())&::g::Handler_inq_typeof,
        (uType*(*)())&::g::Handler_msg_typeof,
        (uType*(*)())&::g::Handler_return_inq_typeof,
        (uType*(*)())&::g::Handler_return_typeof,
        (uType*(*)())&::g::Handler_typeof,
        (uType*(*)())&::g::HomeScreen_typeof,
        (uType*(*)())&::g::HomeScreenType_typeof,
        (uType*(*)())&::g::HS::Button_typeof,
        (uType*(*)())&::g::HS::MenuButton_typeof,
        (uType*(*)())&::g::HS::Rectangle_typeof,
        (uType*(*)())&::g::HS::Text_typeof,
        (uType*(*)())&::g::HS::TextBox_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_inq_appr_Show_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_inq_appr_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_inq_Show_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_inq_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_msg_Show_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_msg_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_return_inq_Show_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_return_inq_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_return_Show_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_return_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_Show_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Confirm_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_CycleButton_Modes_typeof,
        (uType*(*)())&::g::HSMRO_accessor_CycleButton2_Types_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownMenu_BackgroundColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownMenu_BorderColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownMenu_FontSize_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownMenu_ListItems_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownMenu_TextColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownOption_BackgroundColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownOption_BorderColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownOption_FontSize_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownOption_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownOption_TextColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownSelectedItem_BackgroundColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownSelectedItem_FontSize_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownSelectedItem_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_DropdownSelectedItem_TextColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_HS_Button_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_HS_MenuButton_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_HS_Rectangle_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_ListType_inq_USR_ID_typeof,
        (uType*(*)())&::g::HSMRO_accessor_ListType_inq_USR_NM_typeof,
        (uType*(*)())&::g::HSMRO_accessor_ListType_USR_ID_typeof,
        (uType*(*)())&::g::HSMRO_accessor_ListType_USR_NM_typeof,
        (uType*(*)())&::g::HSMRO_accessor_ModeIndicator_IsActive_typeof,
        (uType*(*)())&::g::HSMRO_accessor_MyLoadingIndicator_ThemeColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_MyLoadingIndicator1_ThemeColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_MyToggle_IsActive_typeof,
        (uType*(*)())&::g::HSMRO_accessor_MyToggle_PrimaryColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_MyToggle_SecondaryColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_SelectableRectangle_ID_typeof,
        (uType*(*)())&::g::HSMRO_accessor_SelectableRectangle_SelectionColor_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_1_Color_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_1_inq_Color_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_1_inq_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_1_po_Color_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_1_po_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_1_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_Color_typeof,
        (uType*(*)())&::g::HSMRO_accessor_Tab_Text_typeof,
        (uType*(*)())&::g::HSMRO_accessor_TypeIndicator_IsActive_typeof,
        (uType*(*)())&::g::HSMRO_bundle_typeof,
        (uType*(*)())&::g::HSMRO_c_po_Options_Property_typeof,
        (uType*(*)())&::g::HSMRO_c_po_Options2_Property_typeof,
        (uType*(*)())&::g::HSMRO_c_po_Selected_Property_typeof,
        (uType*(*)())&::g::HSMRO_c_po_Selected2_Property_typeof,
        (uType*(*)())&::g::HSMRO_Confirm_inq_appr_Show_Property_typeof,
        (uType*(*)())&::g::HSMRO_Confirm_inq_Show_Property_typeof,
        (uType*(*)())&::g::HSMRO_Confirm_msg_Show_Property_typeof,
        (uType*(*)())&::g::HSMRO_Confirm_return_inq_Show_Property_typeof,
        (uType*(*)())&::g::HSMRO_Confirm_return_Show_Property_typeof,
        (uType*(*)())&::g::HSMRO_Confirm_Show_Property_typeof,
        (uType*(*)())&::g::HSMRO_CycleButton_CurrentMode_Property_typeof,
        (uType*(*)())&::g::HSMRO_CycleButton_Modes_Property_typeof,
        (uType*(*)())&::g::HSMRO_CycleButton2_CurrentType_Property_typeof,
        (uType*(*)())&::g::HSMRO_CycleButton2_Types_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownMenu_BackgroundColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownMenu_BorderColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownMenu_FontSize_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownMenu_ListItems_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownMenu_Selected_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownMenu_TextColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownOption_BackgroundColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownOption_BorderColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownOption_FontSize_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownOption_Text_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownOption_TextColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownSelectedItem_BackgroundColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownSelectedItem_BorderColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownSelectedItem_FontSize_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownSelectedItem_Text_Property_typeof,
        (uType*(*)())&::g::HSMRO_DropdownSelectedItem_TextColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseAnimationsAttractorfloat4_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseAnimationsChangebool_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseAnimationsChangefloat4_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseAnimationsChangestring_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsControl_Background_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsDatePickerBase_MaxValue_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsDatePickerBase_MinValue_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsDatePickerBase_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsImage_Color_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsNavigationControl_Active_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsNavigator_DefaultPath_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsNavigatorSwipe_IsEnabled_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsPageControl_Interaction_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsPanel_Color_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsShape_Color_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsShape_Fill_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsTextControl_Color_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsTextControl_FontSize_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsTextControl_TextColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseControlsTextInputControl_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseDrawingStroke_Brush_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseDrawingStroke_Color_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_Alignment_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_ElementLayoutMaster_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_Height_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_HitTestMode_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_MinHeight_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_Offset_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_Opacity_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_Visibility_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsElement_Width_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsInteractiveTransform_Rotation_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsInteractiveTransform_Translation_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseElementsInteractiveTransform_ZoomFactor_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseGesturesSwipeGesture_IsActive_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseLayoutsColumn_Width_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseReactiveEach_Items_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseReactiveWhileCount_Items_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseResourcesHttpImageSource_Url_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseRotation_Degrees_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseScaling_Factor_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseSelectionSelectable_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseTranslation_Y_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseTriggersActionsSetstring_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseTriggersBusy_IsActive_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseTriggersPullToReload_IsLoading_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseTriggersTimeline_TargetProgress_Property_typeof,
        (uType*(*)())&::g::HSMRO_FuseTriggersWhileBool_Value_Property_typeof,
        (uType*(*)())&::g::HSMRO_ListType_inq_USR_ID_Property_typeof,
        (uType*(*)())&::g::HSMRO_ListType_inq_USR_NM_Property_typeof,
        (uType*(*)())&::g::HSMRO_ListType_USR_ID_Property_typeof,
        (uType*(*)())&::g::HSMRO_ListType_USR_NM_Property_typeof,
        (uType*(*)())&::g::HSMRO_ModeIndicator_IsActive_Property_typeof,
        (uType*(*)())&::g::HSMRO_MyToggle_IsActive_Property_typeof,
        (uType*(*)())&::g::HSMRO_SelectableRectangle_ID_Property_typeof,
        (uType*(*)())&::g::HSMRO_SelectableRectangle_SelectionColor_Property_typeof,
        (uType*(*)())&::g::HSMRO_Tab_Color_Property_typeof,
        (uType*(*)())&::g::HSMRO_TypeIndicator_IsActive_Property_typeof,
        (uType*(*)())&::g::ListType_inq_typeof,
        (uType*(*)())&::g::ListType_typeof,
        (uType*(*)())&::g::LoginPage__Template_typeof,
        (uType*(*)())&::g::LoginPage__Template1_typeof,
        (uType*(*)())&::g::LoginPage__Template2_typeof,
        (uType*(*)())&::g::LoginPage__Template3_typeof,
        (uType*(*)())&::g::LoginPage__Template4_typeof,
        (uType*(*)())&::g::LoginPage__Template5_typeof,
        (uType*(*)())&::g::LoginPage__Template6_typeof,
        ...
        (uType*(*)())&::g::ModeIndicator_typeof,
        (uType*(*)())&::g::MonthView__Template_typeof,
        (uType*(*)())&::g::MonthView__Template1_typeof,
        (uType*(*)())&::g::MonthView__Template2_typeof,
        (uType*(*)())&::g::MonthView_typeof,
        (uType*(*)())&::g::MyLoadingIndicator_typeof,
        (uType*(*)())&::g::MyLoadingIndicator1_typeof,
        (uType*(*)())&::g::MyToggle_typeof,
        (uType*(*)())&::g::Native::Android::DatePickerView_typeof,
        (uType*(*)())&::g::Native::Android::TimePickerView_typeof,
        (uType*(*)())&::g::Native::DateExtensions_typeof,
        (uType*(*)())&::g::Native::DatePicker__Template_typeof,
        (uType*(*)())&::g::Native::DatePicker__Template1_typeof,
        (uType*(*)())&::g::Native::DatePicker__Template2_typeof,
        (uType*(*)())&::g::Native::DatePicker_typeof,
        (uType*(*)())&::g::Native::DatePickerBase__CurrentDateProperty_typeof,
        (uType*(*)())&::g::Native::DatePickerBase_typeof,
        (uType*(*)())&::g::Native::IDatePickerHost_typeof,
        (uType*(*)())&::g::Native::IDatePickerView_typeof,
        (uType*(*)())&::g::Native::iOS::DateExtensions_typeof,
        (uType*(*)())&::g::Native::iOS::DatePickerView_typeof,
        (uType*(*)())&::g::Native::iOS::TimePickerView_typeof,
        (uType*(*)())&::g::Native::iOS::UIControlEvent_typeof,
        (uType*(*)())&::g::Native::ITimePickerHost_typeof,
        (uType*(*)())&::g::Native::ITimePickerView_typeof,
        (uType*(*)())&::g::Native::TimePicker__Template_typeof,
        (uType*(*)())&::g::Native::TimePicker__Template1_typeof,
        (uType*(*)())&::g::Native::TimePicker__Template2_typeof,
        (uType*(*)())&::g::Native::TimePicker_typeof,
        (uType*(*)())&::g::Native::TimePickerBase__CurrentTimeProperty_typeof,
        (uType*(*)())&::g::Native::TimePickerBase_typeof,
        ...
        (uType*(*)())&::g::OpenGL::GLPixelStoreParameter_typeof,
        ...
        (uType*(*)())&::g::Outracks::IBinaryMessage_typeof,
        (uType*(*)())&::g::Outracks::None_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Bytecode::InvalidDataException_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Bytecode::NonExhaustiveMatch_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Bytecode::NoOperation_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Bytecode::NumberLiteral_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Bytecode::NumberType_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Client::CppEvent_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::CppProperty_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Client::DotNetReflection_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::DotNetReflectionWrapper_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Client::IEvent_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::InputMode_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::IProperty_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::ITypeMap_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::LoadingScreen_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::ModalDialog_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::NativeReflection_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::ReflectionCache_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::ReflectionExtensions_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Client::SimpleTypeMap_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::State_typeof,
        (uType*(*)())&::g::Outracks::Simulator::Client::TryInvokeExtension_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::ISimulatorClient_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Protocol::DiagnosticType_typeof,
        ...
        (uType*(*)())&::g::Outracks::Simulator::Runtime::IReflection_typeof,
        ...
        (uType*(*)())&::g::Resources_typeof,
        (uType*(*)())&::g::s_inq01__Template_typeof,
        (uType*(*)())&::g::s_inq01__Template1_typeof,
        (uType*(*)())&::g::s_inq01__Template2_typeof,
        (uType*(*)())&::g::s_inq01__Template3_typeof,
        (uType*(*)())&::g::s_inq01__Template4_typeof,
        (uType*(*)())&::g::s_inq01__Template5_typeof,
        (uType*(*)())&::g::s_inq01__Template6__Template7_typeof,
        (uType*(*)())&::g::s_inq01__Template6__Template8_typeof,
        (uType*(*)())&::g::s_inq01__Template6__Template9_typeof,
        (uType*(*)())&::g::s_inq01__Template6_typeof,
        (uType*(*)())&::g::s_inq01__Template7_typeof,
        (uType*(*)())&::g::s_inq01__Template8__Template10_typeof,
        (uType*(*)())&::g::s_inq01__Template8__Template11_typeof,
        (uType*(*)())&::g::s_inq01__Template8__Template9_typeof,
        (uType*(*)())&::g::s_inq01__Template8_typeof,
        (uType*(*)())&::g::s_inq01__Template9_typeof,
        (uType*(*)())&::g::s_inq01_typeof,
        (uType*(*)())&::g::SelectableRectangle_typeof,
        (uType*(*)())&::g::SmallCog_typeof,
        (uType*(*)())&::g::SocketRocket::WebSocketClient_typeof,
        (uType*(*)())&::g::SubPage_appr__Template_typeof,
        (uType*(*)())&::g::SubPage_appr__Template1_typeof,
        (uType*(*)())&::g::SubPage_appr__Template2_typeof,
        (uType*(*)())&::g::SubPage_appr__Template3_typeof,
        (uType*(*)())&::g::SubPage_appr_inq__Template_typeof,
        (uType*(*)())&::g::SubPage_appr_inq__Template1_typeof,
        (uType*(*)())&::g::SubPage_appr_inq__Template2_typeof,
        (uType*(*)())&::g::SubPage_appr_inq_typeof,
        (uType*(*)())&::g::SubPage_appr_typeof,
        (uType*(*)())&::g::SubPage_po_typeof,
        (uType*(*)())&::g::SubPage_typeof,
        (uType*(*)())&::g::System::IO::BinaryReader_typeof,
        (uType*(*)())&::g::System::IO::BinaryWriter_typeof,
        (uType*(*)())&::g::Tab_1_inq_typeof,
        (uType*(*)())&::g::Tab_1_po_typeof,
        (uType*(*)())&::g::Tab_1_typeof,
        (uType*(*)())&::g::Tab_typeof,
        (uType*(*)())&::g::TabHeader_typeof,
        (uType*(*)())&::g::TabIcon_typeof,
        (uType*(*)())&::g::TypeIndicator_typeof,
        (uType*(*)())&::g::Uno::Action_typeof,
        (uType*(*)())&::g::Uno::Action1_typeof,
        (uType*(*)())&::g::Uno::Action10_typeof,
        (uType*(*)())&::g::Uno::Action11_typeof,
        (uType*(*)())&::g::Uno::Action12_typeof,
        (uType*(*)())&::g::Uno::Action13_typeof,
        (uType*(*)())&::g::Uno::Action14_typeof,
        (uType*(*)())&::g::Uno::Action15_typeof,
        (uType*(*)())&::g::Uno::Action16_typeof,
        (uType*(*)())&::g::Uno::Action2_typeof,
        (uType*(*)())&::g::Uno::Action3_typeof,
        (uType*(*)())&::g::Uno::Action4_typeof,
        (uType*(*)())&::g::Uno::Action5_typeof,
        (uType*(*)())&::g::Uno::Action6_typeof,
        (uType*(*)())&::g::Uno::Action7_typeof,
        (uType*(*)())&::g::Uno::Action8_typeof,
        (uType*(*)())&::g::Uno::Action9_typeof,
        ...
        (uType*(*)())&::g::Uno::Diagnostics::EventType_typeof,
        ...
        (uType*(*)())&::g::Uno::Func10_typeof,
        (uType*(*)())&::g::Uno::Func11_typeof,
        (uType*(*)())&::g::Uno::Func12_typeof,
        (uType*(*)())&::g::Uno::Func13_typeof,
        (uType*(*)())&::g::Uno::Func14_typeof,
        (uType*(*)())&::g::Uno::Func15_typeof,
        (uType*(*)())&::g::Uno::Func16_typeof,
        (uType*(*)())&::g::Uno::Func2_typeof,
        (uType*(*)())&::g::Uno::Func3_typeof,
        (uType*(*)())&::g::Uno::Func4_typeof,
        (uType*(*)())&::g::Uno::Func5_typeof,
        (uType*(*)())&::g::Uno::Func6_typeof,
        (uType*(*)())&::g::Uno::Func7_typeof,
        (uType*(*)())&::g::Uno::Func8_typeof,
        (uType*(*)())&::g::Uno::Func9_typeof,
        ...
        (uType*(*)())&::g::Uno::Graphics::CubeFace_typeof,
        ...
        (uType*(*)())&::g::Uno::Net::Http::FragmentParser_typeof,
        ...
        (uType*(*)())&::g::Uno::Net::Http::SegmentsParser_typeof,
        (uType*(*)())&::g::Uno::Net::Http::Uri_typeof,
        (uType*(*)())&::g::Uno::Net::Http::UriFormatException_typeof,
        (uType*(*)())&::g::Uno::Net::Http::UriHelper_typeof,
        (uType*(*)())&::g::Uno::Net::Http::UriScheme_typeof,
        (uType*(*)())&::g::Uno::Net::Http::UriSchemeType_typeof,
        ...
        (uType*(*)())&::g::Uno::Net::Sockets::AddressFamily_typeof,
        (uType*(*)())&::g::Uno::Net::Sockets::NetworkStream_typeof,
        (uType*(*)())&::g::Uno::Net::Sockets::ProtocolType_typeof,
        (uType*(*)())&::g::Uno::Net::Sockets::SelectMode_typeof,
        ...
        (uType*(*)())&::g::Uno::Net::Sockets::SocketShutdown_typeof,
        (uType*(*)())&::g::Uno::Net::Sockets::SocketType_typeof,
        ...
        (uType*(*)())&::g::Uno::Platform::PointerCursor_typeof,
        ...
        (uType*(*)())&::g::Uno::Platform::WheelDeltaMode_typeof,
        ...
        (uType*(*)())&::g::Uno::Reflection::IField_typeof,
        (uType*(*)())&::g::Uno::Reflection::IFunction_typeof,
