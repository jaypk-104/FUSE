// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Backends/CPlusPlus/Uno/Support.cpp.
...
void uLogv(int level, const char* format, va_list args)
{
    ...
    __android_log_vprint(logs[level], "HS MRO", format, args);
#else
