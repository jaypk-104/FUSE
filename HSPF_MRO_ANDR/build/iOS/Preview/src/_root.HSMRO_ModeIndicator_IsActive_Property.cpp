...
{
    uStackFrame __("HSMRO_ModeIndicator_IsActive_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_ModeIndicator_IsActive_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
