...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selected.uno
// ----------------------------------------------------------------

// public sealed class Deselected
// {
...
// public generated Deselected()
void Deselected__ctor_7_fn(Deselected* __this)
{
    __this->ctor_7();
}

// protected override sealed bool IsTriggered(bool on)
...
// public generated Deselected New()
void Deselected__New2_fn(Deselected** __retval)
{
    *__retval = Deselected::New2();
}

// public generated Deselected() [instance]
void Deselected::ctor_7()
{
    ctor_6();
}

// public generated Deselected New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/IsSelected.uno
// ------------------------------------------------------------------
...
// public IsSelectedFunction() [instance]
void IsSelectedFunction::ctor_2()
{
    ctor_1();
}

// public IsSelectedFunction New() [static]
...
static void IsSelectedFunction__OuterSubscription_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/IsSelected.uno");
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selectable.ScriptClass.uno
// ------------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selectable.uno");
...
// public generated Selectable New()
...
// public generated Selectable() [instance]
...
// public generated Selectable New() [static]
...
// public generated Selected New()
void Selected__New2_fn(Selected** __retval)
{
    *__retval = Selected::New2();
}

// public generated Selected() [instance]
void Selected::ctor_7()
{
    ctor_6();
}

// public generated Selected New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.ScriptClass.uno
// -----------------------------------------------------------------------------
...
// public void ForceAdd(Fuse.Selection.Selectable b)
...
// public void ForceRemove(Fuse.Selection.Selectable b)
...
void Selection__FuseReactiveIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 495, uString::Const("Fuse.Reactive.IObserver.OnFailed"));
}
...
void Selection__FuseReactiveIObserverOnInsertAt_fn(Selection* __this, int32_t* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 485, uString::Const("Fuse.Reactive.IObserver.OnInsertAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnNewAt_fn(Selection* __this, int32_t* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 450, uString::Const("Fuse.Reactive.IObserver.OnNewAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnRemoveAt_fn(Selection* __this, int32_t* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 474, uString::Const("Fuse.Reactive.IObserver.OnRemoveAt"));
        return;
    }
...
// public generated Selection New()
...
// public generated Selection() [instance]
...
// public void ForceAdd(Fuse.Selection.Selectable b) [instance]
...
// public void ForceRemove(Fuse.Selection.Selectable b) [instance]
...
void Selection::MaxCount(int32_t value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("MaxCount must >= 1"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 138, uString::Const("set_MaxCount"), NULL);
        return;
    }
...
void Selection::OnSelectionChanged(int32_t how)
{
    ...
    if ((how == 0) && (_subscription != NULL))
    {
        ...
        if (sub != NULL)
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Selection changed, but the bound collection is not writeable."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 356, uString::Const("OnSelectionChanged"));
    }
...
// public int get_SelectedCount() [instance]
...
// public object get_Values() [instance]
uObject* Selection::Values()
{
    return _observableValues;
}

// public void set_Values(object value) [instance]
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Values` must be an IObservableArray"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.uno"), 394, uString::Const("set_Values"), NULL);
        return;
    }
...
void Selection::add(Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("add requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.ScriptClass.uno"), 43, ::STRINGS[6/*"add"*/], NULL);
        return;
    }
...
void Selection::forceAdd(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceAdd requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.ScriptClass.uno"), 75, uString::Const("forceAdd"), NULL);
        return;
    }
...
void Selection::forceRemove(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceRemove requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.ScriptClass.uno"), 89, uString::Const("forceRemove"), NULL);
        return;
    }
...
// public generated Selection New() [static]
...
void Selection::remove(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("remove requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.ScriptClass.uno"), 61, ::STRINGS[7/*"remove"*/], NULL);
        return;
    }
...
void Selection::toggle(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("toggle requires 1 argument, the value of them item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selection.ScriptClass.uno"), 105, ::STRINGS[8/*"toggle"*/], NULL);
        return;
    }
...
{
    ::STRINGS[0] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/Selected.uno");
    ::STRINGS[13] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::EventHandler_typeof();
...
// internal SelectionEvent() [instance]
...
// public generated string get_Value() [instance]
uString* SelectionEventArgs::Value()
{
    return _Value;
}

// private generated void set_Value(string value) [instance]
void SelectionEventArgs::Value(uString* value)
{
    _Value = value;
}

// public SelectionEventArgs New(string value) [static]
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/ToggleSelection.uno
// -----------------------------------------------------------------------
...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/ToggleSelection.uno");
...
// public generated ToggleSelection()
...
// public generated ToggleSelection New()
...
// public generated ToggleSelection() [instance]
...
// public generated ToggleSelection New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.12.0/WhileSelected.uno
// ---------------------------------------------------------------------

// public sealed class WhileSelected
// {
static void WhileSelected_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.12.0/WhileSelected.uno");
    ::STRINGS[13] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Selection::Selection_typeof());
...
// public generated WhileSelected()
void WhileSelected__ctor_6_fn(WhileSelected* __this)
{
    __this->ctor_6();
}

// public generated WhileSelected New()
...
// public generated WhileSelected() [instance]
...
// public generated WhileSelected New() [static]
