...
{
    uStackFrame __("HSMRO_FuseTriggersActionsSetstring_Value_Property", "Get(Uno.UX.PropertyObject)");
    uString* ret2;
...
{
    uStackFrame __("HSMRO_FuseTriggersActionsSetstring_Value_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
