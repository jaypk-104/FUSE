...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/Calendars/Era.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/Calendars/GregorianYearMonthDayCalculator.uno
// ----------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/Calendars/TimeOfDayCalculator.uno
// ----------------------------------------------------------------------------------------------
...
// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant)
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond)
...
// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) [static]
int32_t TimeOfDayCalculator::GetMillisecondOfSecond(::g::Uno::Time::Instant instant)
{
    return TimeOfDayCalculator::GetMillisecondOfSecondFromTickOfDay(TimeOfDayCalculator::GetTickOfDay(instant));
}

// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) [static]
int32_t TimeOfDayCalculator::GetMillisecondOfSecondFromTickOfDay(int64_t tickOfDay)
{
    int64_t milliSecondOfDay = tickOfDay / 10000LL;
    return (int32_t)(milliSecondOfDay % 1000LL);
}
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) [static]
int64_t TimeOfDayCalculator::GetTicks1(int32_t hourOfDay, int32_t minuteOfHour, int32_t secondOfMinute)
{
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) [static]
int64_t TimeOfDayCalculator::GetTicks2(int32_t hourOfDay, int32_t minuteOfHour, int32_t secondOfMinute, int32_t millisecondOfSecond, int32_t tickOfMillisecond)
{
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/Calendars/WeekYearCalculator.uno
// ---------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/Calendars/YearMonthDayCalculator.uno
// -------------------------------------------------------------------------------------------------
