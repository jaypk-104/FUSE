...
{
    uStackFrame __("HSMRO_CycleButton_Modes_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_CycleButton_Modes_Property", "Set(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
