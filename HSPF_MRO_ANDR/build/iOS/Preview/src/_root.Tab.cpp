// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/Tab.g.uno.
...
static void Tab_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        new uFunction("get_Color", NULL, (void*)Tab__get_Color1_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Color", NULL, (void*)Tab__set_Color1_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction(".ctor", NULL, (void*)Tab__New4_fn, 0, true, type, 0),
        new uFunction("SetColor", NULL, (void*)Tab__SetColor1_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
...
{
    uStackFrame __("Tab", "set_Color(string)");
...
{
    uStackFrame __("Tab", "SetColor(string,Uno.UX.IPropertyListener)");
