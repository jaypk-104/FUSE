...
{
    uStackFrame __("HSMRO_accessor_DropdownMenu_FontSize", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_accessor_DropdownMenu_FontSize", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
