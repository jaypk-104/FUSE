...
#include <Fuse.Reactive.FuseJS.Http.HttpJSDispatcher.ActionClosure.h>
#include <Fuse.Reactive.FuseJS.Http.HttpJSDispatcher.h>
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Http.uno
// ------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.HttpJSDispatcher.ActionClosure", "Run(Fuse.Scripting.Context)");
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Builtins.uno
// ----------------------------------------------------------------------------------
...
static void Builtins_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("FuseJS/TreeObservable");
    ::STRINGS[10] = uString::Const("Date");
    ::STRINGS[11] = uString::Const("(function(ticks) { return new Date(ticks); })");
    ::STRINGS[12] = uString::Const("Polyfills/Window");
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeoutce9e235b())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promiseminf26f7f63())->ReadAllText());
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], ::STRINGS[6/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnostics556f0c1e()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observableae97a3a3()))->EvaluateExports(context, ::STRINGS[8/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    TreeObservable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::TreeObservable599a573d()))->EvaluateExports(context, ::STRINGS[9/*"FuseJS/Tree...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    EventEmitter = ::g::Fuse::Scripting::EventEmitterModule::GetConstructor(context);
    Date = uCast< ::g::Fuse::Scripting::Function*>(context->Evaluate(::STRINGS[3/*"fuse-builtins"*/], ::STRINGS[10/*"Date"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    DateCtor = uCast< ::g::Fuse::Scripting::Function*>(context->Evaluate(::STRINGS[3/*"fuse-builtins"*/], ::STRINGS[11/*"(function(t...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    res = NULL;

    if (::g::Uno::UX::Resource::TryFindGlobal(::STRINGS[12/*"Polyfills/W...*/], uDelegate::New(::TYPES[0/*Uno.Predicate<object>*/], (void*)Builtins__IsModule_fn), &res))
        uPtr(uCast< ::g::Fuse::Scripting::Module*>(res, ::TYPES[4/*Fuse.Scripting.Module*/]))->Evaluate1(context, ::STRINGS[12/*"Polyfills/W...*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Timer.uno
// -------------------------------------------------------------------------------
...
{
    ::STRINGS[13] = uString::Const("func");
    ::STRINGS[14] = uString::Const("args");
    type->SetFields(0,
...
void TimerModule__CallbackClosure::ctor_(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Function* func, uArray* args)
{
    ...
    if (func == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[13/*"func"*/]));

    if (args == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[14/*"args"*/]));
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.TimerModule.CallbackClosure", "Callback(Fuse.Scripting.Context)");
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/DiagnosticsImpl.uno
// -----------------------------------------------------------------------------------------
...
{
    ::STRINGS[15] = uString::Const("FuseJS/DiagnosticsImpl");
    ::STRINGS[16] = uString::Const("report");
    ::STRINGS[17] = uString::Const("Report requires 2 arguments");
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/DiagnosticsImpl.uno");
    ::STRINGS[19] = uString::Const("Report");
...
void DiagnosticsImplModule::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(DiagnosticsImplModule::_instance_ = this, ::STRINGS[15/*"FuseJS/Diag...*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[16/*"report"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)DiagnosticsImplModule__Report_fn, this)));
}
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Report requ...*/], this, ::STRINGS[18/*"/usr/local/...*/], 30, ::STRINGS[19/*"Report"*/]);
        return NULL;
    }
...
{
    ::STRINGS[20] = uString::Const("createRequest");
...
void Http__FuseJSHttpClient::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Obj())->Item(::STRINGS[20/*"createRequest"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpClient__CreateRequest_fn, this));
}
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpClient", "CreateRequest(Fuse.Scripting.Context,object[])");
...
{
    ::STRINGS[21] = uString::Const("enableCache");
    ::STRINGS[22] = uString::Const("setTimeout");
    ::STRINGS[23] = uString::Const("setResponseType");
    ::STRINGS[24] = uString::Const("getResponseType");
    ::STRINGS[25] = uString::Const("sendAsync");
    ::STRINGS[26] = uString::Const("abort");
    ::STRINGS[27] = uString::Const("setHeader");
    ::STRINGS[28] = uString::Const("getResponseHeader");
    ::STRINGS[29] = uString::Const("getResponseHeaders");
    ::STRINGS[30] = uString::Const("getState");
    ::STRINGS[31] = uString::Const("getResponseStatus");
    ::STRINGS[32] = uString::Const("getResponseReasonPhrase");
    ::STRINGS[33] = uString::Const("getResponseContentString");
    ::STRINGS[34] = uString::Const("getResponseContentByteArray");
    ::STRINGS[35] = uString::Const("This operation is illegal after request has finished");
    ::STRINGS[36] = uString::Const("Unable to get header.");
    ::STRINGS[37] = uString::Const("onabort");
    ::STRINGS[38] = uString::Const("ondone");
    ::STRINGS[39] = uString::Const("onerror");
    ::STRINGS[40] = uString::Const("onprogress");
    ::STRINGS[41] = uString::Const("onstatechanged");
    ::STRINGS[42] = uString::Const("ontimeout");
    ::STRINGS[43] = uString::Const("buffer");
...
void Http__FuseJSHttpRequest::ctor_(::g::Fuse::Scripting::Context* context, ::g::Uno::Net::Http::HttpMessageHandlerRequest* req)
{
    ...
    uPtr(Obj())->Item(::STRINGS[21/*"enableCache"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__EnableCache_fn, this));
    uPtr(Obj())->Item(::STRINGS[22/*"setTimeout"*/], ::g::Fuse::Scripting::JSCallback::FromAction1(::TYPES[13/*Fuse.Scripting.JSCallback.FromAction<int>*/], uDelegate::New(::TYPES[14/*Uno.Action<int>*/], (void*)Http__FuseJSHttpRequest__SetTimeout_fn, this)));
    uPtr(Obj())->Item(::STRINGS[23/*"setResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[24/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[25/*"sendAsync"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SendAsync_fn, this));
    uPtr(Obj())->Item(::STRINGS[26/*"abort"*/], ::g::Fuse::Scripting::JSCallback::FromAction(uDelegate::New(::TYPES[15/*Uno.Action*/], (void*)Http__FuseJSHttpRequest__Abort_fn, this)));
    uPtr(Obj())->Item(::STRINGS[27/*"setHeader"*/], ::g::Fuse::Scripting::JSCallback::FromAction2(::TYPES[16/*Fuse.Scripting.JSCallback.FromAction<string, string>*/], uDelegate::New(::TYPES[17/*Uno.Action<string, string>*/], (void*)Http__FuseJSHttpRequest__SetHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[28/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc1(::TYPES[18/*Fuse.Scripting.JSCallback.FromFunc<string, string>*/], uDelegate::New(::TYPES[19/*Uno.Func<string, string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[29/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[20/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[21/*Uno.Func<string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeaders_fn, this)));
    uPtr(Obj())->Item(::STRINGS[30/*"getState"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetState_fn, this));
    uPtr(Obj())->Item(::STRINGS[31/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[22/*Fuse.Scripting.JSCallback.FromFunc<int>*/], uDelegate::New(::TYPES[23/*Uno.Func<int>*/], (void*)Http__FuseJSHttpRequest__GetResponseStatus_fn, this)));
    uPtr(Obj())->Item(::STRINGS[32/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseReasonPhrase_fn, this));
    uPtr(Obj())->Item(::STRINGS[33/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentString_fn, this));
    uPtr(Obj())->Item(::STRINGS[34/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentByteArray_fn, this));
}
...
void Http__FuseJSHttpRequest::CheckIsAttached()
{
    ...
    if (_req == NULL)
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[35/*"This operat...*/]));
}
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "EnableCache(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "GetResponseContentByteArray(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "GetResponseContentString(Fuse.Scripting.Context,object[])");
...
uString* Http__FuseJSHttpRequest::GetResponseHeader(uString* key)
{
    ...
    if (::g::Uno::String::op_Equality(_cachedResponseHeaders, NULL))
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[36/*"Unable to g...*/]));
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "GetResponseReasonPhrase(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "GetResponseType(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "GetState(Fuse.Scripting.Context,object[])");
...
void Http__FuseJSHttpRequest::OnAbort(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[37/*"onabort"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
void Http__FuseJSHttpRequest::OnDone(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[38/*"ondone"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
void Http__FuseJSHttpRequest::OnError(::g::Uno::Net::Http::HttpMessageHandlerRequest* res, uString* error)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[39/*"onerror"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
void Http__FuseJSHttpRequest::OnProgress(::g::Uno::Net::Http::HttpMessageHandlerRequest* res, int32_t current, int32_t total, bool hastotal)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[40/*"onprogress"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
void Http__FuseJSHttpRequest::OnStateChanged(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[41/*"onstatechan...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
void Http__FuseJSHttpRequest::OnTimeout(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[42/*"ontimeout"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "SendAsync(Fuse.Scripting.Context,object[])");
    ...
    if ((args != NULL) && (uPtr(args)->Length() > 0))
    {
        ...
        else
        {
            ...
            if ((obj != NULL) && (uPtr(obj)->Item(::STRINGS[43/*"buffer"*/]) != NULL))
            {
                uArray* b1 = uAs<uArray*>(uPtr(obj)->Item(::STRINGS[43/*"buffer"*/]), ::TYPES[25/*byte[]*/]);
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.FuseJSHttpRequest", "SetResponseType(Fuse.Scripting.Context,object[])");
    CheckIsAttached();
...
uString* HttpHeaders::GetValue(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_headers), ::g::Uno::String::ToLower(uPtr(key)), (void**)(&list), &ret6), ret6))
        return ::g::Uno::String::Join1(::STRINGS[44/*", "*/], (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[30/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], list));
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.Http.HttpJSDispatcher", "Invoke(Uno.Action)");
...
// /usr/local/share/uno/Packages/Fuse.Launcher.InterApp/1.12.0/InterApp/JS.uno
// ---------------------------------------------------------------------------

// public sealed class InterApp
// {
static void InterApp_build(uType* type)
{
    ::STRINGS[46] = uString::Const("receivedUri");
    ::STRINGS[47] = uString::Const("FuseJS/InterApp");
    ::STRINGS[48] = uString::Const("onReceivedUri");
    ::STRINGS[49] = uString::Const("launchUri");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[35] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::String_typeof();
    type->SetDependencies(
        ::g::Fuse::Platform::InterApp_typeof(),
        ::g::Uno::UX::Resource_typeof());
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
        ::g::Fuse::Scripting::IModuleProvider_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface1));
...
// public static object LaunchUri(Fuse.Scripting.Context context, object[] args)
...
// private void OnReceivedUri(string uri)
...
// public InterApp() [instance]
void InterApp::ctor_3()
{
    uStackFrame __("Fuse.Reactive.FuseJS.InterApp", ".ctor()");
    ctor_2(true, uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, ::STRINGS[46/*"receivedUri"*/]));

    if (InterApp::_instance_ != NULL)
        return;

    ::g::Uno::UX::Resource::SetGlobalKey(InterApp::_instance_ = this, ::STRINGS[47/*"FuseJS/Inte...*/]);
    ::g::Fuse::Scripting::NativeEvent* onReceivedUri = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[48/*"onReceivedUri"*/], true);
    On1(::STRINGS[46/*"receivedUri"*/], onReceivedUri);
    AddMember(onReceivedUri);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[49/*"launchUri"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)InterApp__LaunchUri_fn)));
    ::g::Fuse::Platform::InterApp::add_ReceivedURI(uDelegate::New(::TYPES[35/*Uno.Action<string>*/], (void*)InterApp__OnReceivedUri_fn, this));
}

// private void OnReceivedUri(string uri) [instance]
void InterApp::OnReceivedUri(uString* uri)
{
    uStackFrame __("Fuse.Reactive.FuseJS.InterApp", "OnReceivedUri(string)");
    Emit(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, ::STRINGS[46/*"receivedUri"*/], uri));
}

// public static object LaunchUri(Fuse.Scripting.Context context, object[] args) [static]
uObject* InterApp::LaunchUri(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    ::g::Fuse::LauncherImpl::InterAppLauncher::LaunchUri(::g::Uno::Net::Http::Uri::New1(uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[9/*string*/])));
    return NULL;
}

// public InterApp New() [static]
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.TimerManager.Timer", "Update(Fuse.Scripting.Context)");
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.TimerManager", "AddTimer(double,Uno.Action<Fuse.Scripting.Context>,[bool])");
...
// public double GetMinTimeout() [instance]
double TimerManager::GetMinTimeout()
{
    ...
    {
        TimerManager__Timer* timer = (::g::Uno::Collections::List__get_Item_fn(uPtr(_timers), uCRef<int32_t>(i), &ret3), ret3);
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.TimerManager", "Tick(Fuse.Scripting.Context)");
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.TimerModule", "Destroy(Fuse.Scripting.Context,object[])");
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.destroy(): The parameter is not a valid timer handle"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/FuseJS/Timer.uno"), 136, uString::Const("Destroy"));
        }
        else         throw __t;
    }
...
// public double get_MinTimeout() [instance]
...
{
    uStackFrame __("Fuse.Reactive.FuseJS.TimerModule", "UpdateModule(Fuse.Scripting.Context)");
