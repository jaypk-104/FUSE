...
// private extern uint ToUint(string str)
...
// private void ValidatePart(string part, int expectedLength)
...
// public Guid(string g) [instance]
void Guid::ctor_4(uString* g)
{
...
// private extern uint ToUint(string str) [instance]
...
// private string[] ValidateGuid(string guid) [instance]
...
// private void ValidatePart(string part, int expectedLength) [instance]
...
// public Guid New(string g) [static]
