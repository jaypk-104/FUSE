...
{
    uStackFrame __("HSMRO_FuseControlsNavigator_DefaultPath_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseControlsNavigator_DefaultPath_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
