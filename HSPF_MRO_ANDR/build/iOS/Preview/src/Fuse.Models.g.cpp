...
// /usr/local/share/uno/Packages/Fuse.Models/1.12.0/ModelJavaScript.uno
// --------------------------------------------------------------------

// private sealed class ModelJavaScript.ModelData
// {
...
// public sealed class ModelJavaScript
// {
// static generated ModelJavaScript()
...
// private ModelJavaScript(Fuse.Models.ModelJavaScript.ModelData md, [string previewStateId])
...
// public static Fuse.Models.ModelJavaScript CreateFromPreviewState(Fuse.Visual where, string modulePath)
...
// private void Fuse.IPreviewStateSaver.Save(Fuse.PreviewStateData data)
...
// private string GenerateArgsStringAndPopulateDependencies()
...
// private static Fuse.Models.ModelJavaScript.ModelData GetOrCreateModelData(Fuse.Visual v)
...
// private ModelJavaScript New(Fuse.Models.ModelJavaScript.ModelData md, [string previewStateId])
...
// protected override sealed void OnBeforeSubscribeToDependenciesAndDispatchEvaluate()
...
// private static void OnModelDataChanged(Fuse.Models.ModelJavaScript.ModelData md, Fuse.Visual v)
...
// public static void SetAppModel(Fuse.IRootVisualProvider rootVisualProvider, string modulePath)
...
// private static Fuse.Reactive.IExpression[] UnpackArgs(Fuse.Reactive.IExpression argsExpr)
...
// private ModelJavaScript(Fuse.Models.ModelJavaScript.ModelData md, [string previewStateId]) [instance]
...
// private string GenerateArgsStringAndPopulateDependencies() [instance]
...
// private void SetupModel() [instance]
...
// public static Fuse.Models.ModelJavaScript CreateFromPreviewState(Fuse.Visual where, string modulePath) [static]
...
// public static string GetModel(Fuse.Visual v) [static]
...
// public static Fuse.Reactive.IExpression GetModelArgs(Fuse.Visual v) [static]
...
// public static Uno.UX.NameTable GetModelNameTable(Fuse.Visual v) [static]
...
// private static Fuse.Models.ModelJavaScript.ModelData GetOrCreateModelData(Fuse.Visual v) [static]
...
// private ModelJavaScript New(Fuse.Models.ModelJavaScript.ModelData md, [string previewStateId]) [static]
...
// private static void OnModelDataChanged(Fuse.Models.ModelJavaScript.ModelData md, Fuse.Visual v) [static]
...
// public static void SetAppModel(Fuse.IRootVisualProvider rootVisualProvider, string modulePath) [static]
...
// public static void SetModel(Fuse.Visual v, string modulePath) [static]
...
// public static void SetModelArgs(Fuse.Visual v, Fuse.Reactive.IExpression args) [static]
...
// public static void SetModelNameTable(Fuse.Visual v, Uno.UX.NameTable nt) [static]
...
// private static Fuse.Reactive.IExpression[] UnpackArgs(Fuse.Reactive.IExpression argsExpr) [static]
...
// /usr/local/share/uno/Packages/Fuse.Models/1.12.0/ZoneJS.uno
// -----------------------------------------------------------

// internal sealed class ZoneJS
// {
...
// private static Fuse.Scripting.Module LoadModule()
...
// private static Fuse.Scripting.Module LoadModule() [static]
::g::Fuse::Scripting::Module* ZoneJS::LoadModule()
{
    uStackFrame __("Fuse.Models.ZoneJS", "LoadModule()");
    return ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseModels_bundle::zonec6e5a622()));
}

// internal ZoneJS New() [static]
ZoneJS* ZoneJS::New1()
{
