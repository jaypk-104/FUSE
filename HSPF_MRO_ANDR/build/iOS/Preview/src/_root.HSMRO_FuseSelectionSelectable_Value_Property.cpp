...
{
    uStackFrame __("HSMRO_FuseSelectionSelectable_Value_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseSelectionSelectable_Value_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
