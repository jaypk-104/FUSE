...
// internal abstract extern interface INativeFocusListener
// {
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.12.0/iOS/LeafView.uno
// --------------------------------------------------------------------------
...
// protected LeafView(ObjC.Object handle)
void LeafView__ctor_4_fn(LeafView* __this, ::g::ObjC::Object* handle)
{
    __this->ctor_4(handle);
}

// protected LeafView(ObjC.Object handle) [instance]
...
// internal static extern class NativeFocus
// {
// static generated NativeFocus()
...
// public static void AddListener(ObjC.Object handle, Fuse.Controls.Native.iOS.INativeFocusListener listener)
...
// public static void AddListener(ObjC.Object handle, Fuse.Controls.Native.iOS.INativeFocusListener listener) [static]
...
// public static void RaiseFocusGained(ObjC.Object handle) [static]
...
// public static void RaiseFocusLost(ObjC.Object handle) [static]
...
// public static void RemoveListener(ObjC.Object handle) [static]
...
// public sealed extern class OSVersion
// {
...
// public OSVersion New(int major, int minor, int patch)
...
// public OSVersion(int major, int minor, int patch) [instance]
...
// public OSVersion New(int major, int minor, int patch) [static]
...
// private sealed class FocusHelpers.PerformBecomeFirstResponder
// {
...
// public PerformBecomeFirstResponder New(ObjC.Object target)
...
// public PerformBecomeFirstResponder(ObjC.Object target) [instance]
void FocusHelpers__PerformBecomeFirstResponder::ctor_(::g::ObjC::Object* target)
{
    _target = target;
}

// public void BecomeFirstResponder() [instance]
...
// public PerformBecomeFirstResponder New(ObjC.Object target) [static]
...
// internal sealed extern class PointerCaptureAdapter
// {
...
// public PointerCaptureAdapter(Fuse.Visual visual, ObjC.Object control)
...
// private void LostCallback()
void PointerCaptureAdapter__LostCallback_fn(PointerCaptureAdapter* __this)
{
    __this->LostCallback();
}

// public PointerCaptureAdapter New(Fuse.Visual visual, ObjC.Object control)
...
// private void OnTouchEvent(ObjC.Object sender, ObjC.Object uiEvent)
...
// public PointerCaptureAdapter(Fuse.Visual visual, ObjC.Object control) [instance]
...
// private void LostCallback() [instance]
void PointerCaptureAdapter::LostCallback()
{
}

// private void OnTouchEvent(ObjC.Object sender, ObjC.Object uiEvent) [instance]
...
// public PointerCaptureAdapter New(Fuse.Visual visual, ObjC.Object control) [static]
...
// private struct InputDispatch.RootInfo
// {
...
// public RootInfo(Fuse.Visual rootVisual, ObjC.Object rootView)
...
// public RootInfo New(Fuse.Visual rootVisual, ObjC.Object rootView)
...
// public RootInfo(Fuse.Visual rootVisual, ObjC.Object rootView) [instance]
...
// public RootInfo New(Fuse.Visual rootVisual, ObjC.Object rootView) [static]
...
// public enum iOSDevice.ScreenOrientation
