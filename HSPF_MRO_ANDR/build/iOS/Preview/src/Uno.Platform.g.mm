...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Platform/iOS/iOSDisplay.uno
// -----------------------------------------------------------------------------------

// public sealed extern class iOSDisplay
// {
// ~iOSDisplay()
...
static void iOSDisplay_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Platform/iOS/iOSDisplay.uno");
...
// private iOSDisplay(ObjC.Object handle)
void iOSDisplay__ctor_1_fn(iOSDisplay* __this, ::g::ObjC::Object* handle)
{
    __this->ctor_1(handle);
}

// private static void Destroy(ObjC.Object handle, ObjC.Object displayLink)
...
// private static double GetDensityOfScreen(ObjC.Object screen)
void iOSDisplay__GetDensityOfScreen_fn(::g::ObjC::Object* screen, double* __retval)
{
    *__retval = iOSDisplay::GetDensityOfScreen(screen);
}

// private static double GetDensityOfScreenFromWindow(ObjC.Object window)
...
// protected override sealed void SetTicksPerSecond(uint fps)
...
// internal static extern Uno.Platform.Display WrapMainDisplay()
void iOSDisplay__WrapMainDisplay_fn(::g::Uno::Platform::Display** __retval)
{
    *__retval = iOSDisplay::WrapMainDisplay();
}

// private iOSDisplay(ObjC.Object handle) [instance]
...
// public Uno.Rect get_Frame() [instance]
...
// public generated void add_FrameChanged(Uno.EventHandler value) [instance]
...
// public generated void remove_FrameChanged(Uno.EventHandler value) [instance]
...
// private Uno.Rect GetFrame() [instance]
...
// private void OnFrameChanged() [instance]
...
// private static void Destroy(ObjC.Object handle, ObjC.Object displayLink) [static]
...
// private static double GetDensityOfScreen(ObjC.Object screen) [static]
...
// private static double GetDensityOfScreenFromWindow(ObjC.Object window) [static]
...
// private iOSDisplay New(ObjC.Object handle) [static]
...
// internal static extern Uno.Platform.Display WrapMainDisplay() [static]
