...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Renderer.uno
// -----------------------------------------------------------
...
// public Batch(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount)
...
// public Batch New(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount)
...
// public Batch(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount) [instance]
...
// public Batch New(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Substring.uno
// ------------------------------------------------------------

// private sealed class Substring.CharEnumerator
// {
...
// public CharEnumerator(Fuse.Text.Substring text)
...
// public CharEnumerator New(Fuse.Text.Substring text)
...
// public CharEnumerator(Fuse.Text.Substring text) [instance]
...
// public CharEnumerator New(Fuse.Text.Substring text) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/SinglyLinkedList.uno
// ----------------------------------------------------------------------------------

// private sealed class SinglyLinkedList<T>.Enumerator
// {
...
// public Enumerator(Fuse.Text.SinglyLinkedList<T> list)
...
// public Enumerator New(Fuse.Text.SinglyLinkedList<T> list)
...
// public Enumerator(Fuse.Text.SinglyLinkedList<T> list) [instance]
...
// public Enumerator New(Fuse.Text.SinglyLinkedList<T> list) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Fallback.uno
// -----------------------------------------------------------

// public sealed class FallingBackFont
// {
static void FallingBackFont_build(uType* type)
{
    ::STRINGS[0] = uString::Const("fonts.Length > 0");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/Fallback.uno");
...
// public FallingBackFont(Fuse.Internal.CacheItem<int, Fuse.Text.Font>[] fonts)
...
// public override sealed Fuse.Text.GlyphTexture GetCachedGlyphTexture(Fuse.Text.Glyph glyph, Fuse.Text.GlyphAtlas atlas, int version)
...
// public FallingBackFont New(Fuse.Internal.CacheItem<int, Fuse.Text.Font>[] fonts)
...
// public override sealed Fuse.Text.PositionedGlyph[] Shape(Fuse.Text.Substring text, int fontIndex, Fuse.Text.TextDirection dir)
...
// private Fuse.Text.PositionedGlyph[] ShapeInner(Fuse.Text.Substring text, int fontIndex, Fuse.Text.TextDirection dir)
...
// private bool TryFindUnhandledSegment(Fuse.Text.PositionedGlyph[] glyphs, int startIndex, int& start, int& end)
...
// public FallingBackFont(Fuse.Internal.CacheItem<int, Fuse.Text.Font>[] fonts) [instance]
...
// private Fuse.Text.PositionedGlyph[] ShapeInner(Fuse.Text.Substring text, int fontIndex, Fuse.Text.TextDirection dir) [instance]
...
// private bool TryFindUnhandledSegment(Fuse.Text.PositionedGlyph[] glyphs, int startIndex, int& start, int& end) [instance]
...
// public FallingBackFont New(Fuse.Internal.CacheItem<int, Fuse.Text.Font>[] fonts) [static]
...
// public sealed class FallingBackFontFace
// {
...
// public FallingBackFontFace(Fuse.Internal.CacheItem<Fuse.Internal.FontFaceDescriptor, Fuse.Text.FontFace>[] fontFaces)
...
// private override sealed Fuse.Text.Font GetOfPixelSizeInternal(int size)
...
// public FallingBackFontFace New(Fuse.Internal.CacheItem<Fuse.Internal.FontFaceDescriptor, Fuse.Text.FontFace>[] fontFaces)
...
// public FallingBackFontFace(Fuse.Internal.CacheItem<Fuse.Internal.FontFaceDescriptor, Fuse.Text.FontFace>[] fontFaces) [instance]
...
// public FallingBackFontFace New(Fuse.Internal.CacheItem<Fuse.Internal.FontFaceDescriptor, Fuse.Text.FontFace>[] fontFaces) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/FontFace.uno
// -----------------------------------------------------------
...
static void Font_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/FontFace.uno");
...
// public virtual Fuse.Text.GlyphTexture GetCachedGlyphTexture(Fuse.Text.Glyph glyph, Fuse.Text.GlyphAtlas atlas, int currentVersion)
...
// protected generated Font() [instance]
void Font::ctor_()
{
}

// public float2 Measure(Fuse.Text.PositionedGlyph[] shapedRun) [instance]
...
// public Fuse.Text.PositionedGlyph[] Shape(string text, Fuse.Text.TextDirection dir) [instance]
...
// public Fuse.Text.PositionedGlyph[] get_ShapedTruncation() [instance]
...
// public float2 get_TruncationMeasurements() [instance]
...
// public Fuse.Internal.CacheItem<int, Fuse.Text.Font> GetOfPixelSize(int size)
...
// public static Fuse.Text.FontFace Load(byte[] data, [int index], [Uno.Predicate<string> stylePredicate])
...
// internal static Fuse.Text.FontFace Load(Fuse.Internal.FontFaceDescriptor descriptor)
...
// public static Fuse.Text.FontFace Load(string fileName, [int index], [Uno.Predicate<string> stylePredicate])
...
// public Fuse.Internal.CacheItem<int, Fuse.Text.Font> GetOfPixelSize(int size) [instance]
...
// public static Fuse.Text.FontFace Load(byte[] data, [int index], [Uno.Predicate<string> stylePredicate]) [static]
...
// internal static Fuse.Text.FontFace Load(Fuse.Internal.FontFaceDescriptor descriptor) [static]
...
// public static Fuse.Text.FontFace Load(string fileName, [int index], [Uno.Predicate<string> stylePredicate]) [static]
...
// internal Glyph New(int fontIndex, uint index) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/GlyphAtlas.uno
// -------------------------------------------------------------
...
static void GlyphAtlas_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/GlyphAtlas.uno");
...
// public Fuse.Text.SubTexture Add(Uno.Content.Images.Bitmap bitmap)
...
// public Fuse.Text.SubTexture Add(Uno.Content.Images.Bitmap bitmap) [instance]
...
// public GlyphAtlas New(int2 size) [static]
...
// internal GlyphTexture(Fuse.Text.SubTexture subTexture, float2 offset, float scale)
...
// internal GlyphTexture New(Fuse.Text.SubTexture subTexture, float2 offset, float scale)
...
// public generated Fuse.Text.SubTexture get_SubTexture()
void GlyphTexture__get_SubTexture_fn(GlyphTexture* __this, ::g::Fuse::Text::SubTexture* __retval)
{
    *__retval = __this->SubTexture();
}

// private generated void set_SubTexture(Fuse.Text.SubTexture value)
...
// internal GlyphTexture(Fuse.Text.SubTexture subTexture, float2 offset, float scale) [instance]
...
// internal bool get_IsValid() [instance]
bool GlyphTexture::IsValid()
{
    return Scale != 0.0f;
}

// public generated Fuse.Text.SubTexture get_SubTexture() [instance]
::g::Fuse::Text::SubTexture GlyphTexture::SubTexture()
{
    return _SubTexture;
}

// private generated void set_SubTexture(Fuse.Text.SubTexture value) [instance]
void GlyphTexture::SubTexture(::g::Fuse::Text::SubTexture value)
{
    _SubTexture = value;
}

// internal GlyphTexture New(Fuse.Text.SubTexture subTexture, float2 offset, float scale) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/LazyFontFace.uno
// ---------------------------------------------------------------

// public sealed class LazyFont
// {
...
// internal LazyFont(Fuse.Text.LazyFontFace fontFace, int pixelSize)
...
// internal LazyFont New(Fuse.Text.LazyFontFace fontFace, int pixelSize)
...
// internal LazyFont(Fuse.Text.LazyFontFace fontFace, int pixelSize) [instance]
...
// private Fuse.Text.Font Force() [instance]
...
// internal LazyFont New(Fuse.Text.LazyFontFace fontFace, int pixelSize) [static]
...
// public sealed class LazyFontFace
// {
...
// internal LazyFontFace(Fuse.Internal.FontFaceDescriptor descriptor)
...
// internal Fuse.Text.FontFace Force()
...
// internal LazyFontFace New(Fuse.Internal.FontFaceDescriptor descriptor)
...
// internal LazyFontFace(Fuse.Internal.FontFaceDescriptor descriptor) [instance]
...
// internal Fuse.Text.FontFace Force() [instance]
...
// internal LazyFontFace New(Fuse.Internal.FontFaceDescriptor descriptor) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/LineBreaks.uno
// -------------------------------------------------------------
...
// public static Fuse.Text.Implementation.BitArray Get(Fuse.Text.Substring text)
...
// public static Fuse.Text.Implementation.BitArray Get(Fuse.Text.Substring text) [static]
...
// private sealed class Substring.LineEnumerable
// {
...
// public LineEnumerable(Fuse.Text.Substring text) [instance]
void Substring__LineEnumerable::ctor_(::g::Fuse::Text::Substring* text)
{
    _text = text;
}

// public Uno.Collections.IEnumerator<Fuse.Text.Substring> GetEnumerator() [instance]
...
// public LineEnumerable New(Fuse.Text.Substring text) [static]
...
// private sealed class Substring.LineEnumerator
// {
...
// public LineEnumerator New(Fuse.Text.Substring text)
...
// public LineEnumerator(Fuse.Text.Substring text) [instance]
...
// public Fuse.Text.Substring get_Current() [instance]
...
// public LineEnumerator New(Fuse.Text.Substring text) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Measure.uno
// ----------------------------------------------------------
...
// public static Uno.Rect AlignedRectForSize(float2 size, float pixelWidth, float alignment)
...
// public static float2 Lines(Fuse.Text.Font font, float lineSpacing, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines)
...
// public static Uno.Rect AlignedRectForSize(float2 size, float pixelWidth, float alignment) [static]
...
// public static float2 Lines(Fuse.Text.Font font, float lineSpacing, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/ShapedRun.uno
// ------------------------------------------------------------

// private sealed class ShapedRun.PGEnumerator
// {
...
// public PGEnumerator(Fuse.Text.ShapedRun shapedRun)
...
// public Fuse.Text.PositionedGlyph get_Current()
...
// public PGEnumerator New(Fuse.Text.ShapedRun shapedRun)
...
// public PGEnumerator(Fuse.Text.ShapedRun shapedRun) [instance]
...
// public Fuse.Text.PositionedGlyph get_Current() [instance]
...
// public PGEnumerator New(Fuse.Text.ShapedRun shapedRun) [static]
...
// internal PositionedGlyph(Fuse.Text.Glyph glyph, float2 advance, float2 offset, int cluster)
...
// internal PositionedGlyph(Fuse.Text.Glyph glyph, float2 advance, float2 offset, int cluster) [instance]
...
// public generated float2 get_Advance() [instance]
::g::Uno::Float2 PositionedGlyph::Advance()
{
    return _Advance;
}

// private generated void set_Advance(float2 value) [instance]
void PositionedGlyph::Advance(::g::Uno::Float2 value)
{
    _Advance = value;
}

// public generated Fuse.Text.Glyph get_Glyph() [instance]
::g::Fuse::Text::Glyph PositionedGlyph::Glyph()
{
    return _Glyph;
}

// private generated void set_Glyph(Fuse.Text.Glyph value) [instance]
void PositionedGlyph::Glyph(::g::Fuse::Text::Glyph value)
{
    _Glyph = value;
}

// internal PositionedGlyph New(Fuse.Text.Glyph glyph, float2 advance, float2 offset, int cluster) [static]
...
// public sealed class PositionedRun
// {
static void PositionedRun_build(uType* type)
{
    ...
    type->Reflection.SetFields(3,
        new uField("Measurements", 2),
        new uField("Position", 1),
        new uField("ShapedRun", 0));
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)PositionedRun__New1_fn, 0, true, type, 3, ::g::Fuse::Text::ShapedRun_typeof(), ::g::Uno::Float2_typeof(), ::g::Uno::Float2_typeof()),
        new uFunction("get_Run", NULL, (void*)PositionedRun__get_Run_fn, 0, false, ::g::Fuse::Text::Bidirectional::Run_typeof(), 0),
        new uFunction("Translate", NULL, (void*)PositionedRun__Translate_fn, 0, true, type, 2, type, ::g::Uno::Float2_typeof()));
}
...
// public PositionedRun(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements)
...
// public PositionedRun New(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements)
...
// public Fuse.Text.Bidirectional.Run get_Run()
void PositionedRun__get_Run_fn(PositionedRun* __this, ::g::Fuse::Text::Bidirectional::Run* __retval)
{
    *__retval = __this->Run();
}

// public static Fuse.Text.PositionedRun Translate(Fuse.Text.PositionedRun positionedRun, float2 translation)
...
// public PositionedRun(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements) [instance]
...
// public Fuse.Text.Bidirectional.Run get_Run() [instance]
...
// public PositionedRun New(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements) [static]
...
// public static Fuse.Text.PositionedRun Translate(Fuse.Text.PositionedRun positionedRun, float2 translation) [static]
...
// public Quad(float2 position, Uno.Recti texCoords, float scale)
...
// public Quad New(float2 position, Uno.Recti texCoords, float scale)
...
// public Quad(float2 position, Uno.Recti texCoords, float scale) [instance]
...
// public Quad New(float2 position, Uno.Recti texCoords, float scale) [static]
...
// internal RenderedGlyph(Uno.Content.Images.Bitmap bitmap, float2 offset, float scale)
...
// internal RenderedGlyph New(Uno.Content.Images.Bitmap bitmap, float2 offset, float scale)
...
// internal RenderedGlyph(Uno.Content.Images.Bitmap bitmap, float2 offset, float scale) [instance]
...
// internal RenderedGlyph New(Uno.Content.Images.Bitmap bitmap, float2 offset, float scale) [static]
...
// public Renderer(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount)
...
// private static byte[] CreateIndexBufferData(int length)
void Renderer__CreateIndexBufferData_fn(int32_t* length, uArray** __retval)
{
    *__retval = Renderer::CreateIndexBufferData(*length);
}

// private static byte[] CreateVertexBufferData(Uno.Collections.List<Fuse.Text.Quad> quads, int2 texSize)
...
// private Uno.Collections.List<Fuse.Text.Batch> GetBatches()
void Renderer__GetBatches_fn(Renderer* __this, ::g::Uno::Collections::List** __retval)
{
    *__retval = __this->GetBatches();
}

// private Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> GetTexturedQuads()
...
// public Renderer New(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount)
...
// private static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> TexturedQuads(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount)
...
// public Renderer(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount) [instance]
...
// private void DisposeBatches() [instance]
...
// public void Draw(float4 color, float4x4 pixelToClipSpaceMatrix) [instance]
...
// private Uno.Collections.List<Fuse.Text.Batch> GetBatches() [instance]
...
// private Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> GetTexturedQuads() [instance]
...
// private static byte[] CreateIndexBufferData(int length) [static]
...
// private static byte[] CreateVertexBufferData(Uno.Collections.List<Fuse.Text.Quad> quads, int2 texSize) [static]
...
// public Renderer New(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount) [static]
...
// internal static void RecreateGlyphAtlas(int version) [static]
...
// private static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> TexturedQuads(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Shape.uno
// --------------------------------------------------------
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> PositionLines(Fuse.Text.Font font, float pixelWidth, float lineSpacing, float alignment, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines)
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> ShapeLines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> lines)
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> PositionLines(Fuse.Text.Font font, float pixelWidth, float lineSpacing, float alignment, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) [static]
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> ShapeLines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> lines) [static]
...
// public ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent)
void ShapedRun__ctor__fn(ShapedRun* __this, ::g::Fuse::Text::Bidirectional::Run* run, uArray* parent)
{
    __this->ctor_(*run, parent);
}

// private ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset)
...
// public Uno.Collections.IEnumerator<Fuse.Text.PositionedGlyph> GetEnumerator()
void ShapedRun__GetEnumerator_fn(ShapedRun* __this, uObject** __retval)
{
    *__retval = __this->GetEnumerator();
}

// public Fuse.Text.PositionedGlyph get_Item(int index)
...
// public ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent)
...
// private ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset)
...
// public ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent) [instance]
...
// private ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset) [instance]
...
// public void CacheLineBreaks() [instance]
...
// public bool CanLineBreak(int cluster) [instance]
...
// public Uno.Collections.IEnumerator<Fuse.Text.PositionedGlyph> GetEnumerator() [instance]
...
// public Fuse.Text.PositionedGlyph get_Item(int index) [instance]
...
// public float2 Measure() [instance]
...
// public Fuse.Text.ShapedRun SubShapedRun(int start) [instance]
...
// public Fuse.Text.ShapedRun SubShapedRun(int start, int count) [instance]
...
// public ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent) [static]
...
// private ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset) [static]
...
// internal static class Renderer.SharedIndexBuffer
// {
...
// public static void EnsureSize(int length) [static]
...
// public static void Retain() [static]
...
// public SinglyLinkedList(T value, [Fuse.Text.SinglyLinkedList<T> next])
...
// public static Fuse.Text.SinglyLinkedList<T> FromEnumerable(Uno.Collections.IEnumerable<T> xs)
...
// public SinglyLinkedList New(T value, [Fuse.Text.SinglyLinkedList<T> next])
...
// public static Fuse.Text.SinglyLinkedList<T> FromEnumerable(Uno.Collections.IEnumerable<T> xs) [static]
...
// public bool Equals(Fuse.Text.Substring s)
...
// public Substring(string parent, int start) [instance]
...
// public Substring(string parent, int start, int length) [instance]
...
// public bool Equals(Fuse.Text.Substring s) [instance]
...
// public Fuse.Text.Substring GetSubstring(int start) [instance]
...
// public Fuse.Text.Substring GetSubstring(int start, int length) [instance]
...
// public char get_Item(int index) [instance]
...
// public Uno.Collections.IEnumerable<Fuse.Text.Substring> get_Lines() [instance]
...
// public Fuse.Text.Substring TrimLeadingNewline() [instance]
...
// public Fuse.Text.Substring TrimTrailingNewline() [instance]
...
// public Substring New(string parent) [static]
...
// public Substring New(string parent, int start) [static]
...
// public Substring New(string parent, int start, int length) [static]
...
static void SubstringExtensions_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/Substring.uno");
...
// public static int CharStart(Fuse.Text.Substring s, int i)
...
// public static string DeleteSpan(string s, int start, int end)
...
// public static Fuse.Text.Substring InclusiveRange(Fuse.Text.Substring s, int start, int end)
...
// public static int NextCharIndex(string s, int i)
...
// public static int PrevCharIndex(string s, int i)
...
// public static string SafeInsert(string s, int index, string insert)
...
// private static Fuse.Text.Substring TrimLine(Fuse.Text.Substring line)
...
// public static Uno.Collections.IEnumerable<Fuse.Text.Substring> TrimmedLines(Fuse.Text.Substring str)
...
// public static int CharStart(Fuse.Text.Substring s, int i) [static]
...
// public static int CharStart(string s, int i) [static]
...
// public static string DeleteAt(string s, int& index) [static]
...
// public static string DeleteSpan(string s, int start, int end) [static]
...
// public static Fuse.Text.Substring InclusiveRange(Fuse.Text.Substring s, int start, int end) [static]
...
// private static bool IsLeadingSurrogate(char c) [static]
...
// private static bool IsTrailingSurrogate(char c) [static]
...
// public static int NextCharIndex(string s, int i) [static]
...
// public static int PrevCharIndex(string s, int i) [static]
...
// public static string SafeInsert(string s, int index, string insert) [static]
...
// public static string SafeSubstring(string s, int start) [static]
...
// public static string SafeSubstring(string s, int start, int length) [static]
...
// private static Fuse.Text.Substring TrimLine(Fuse.Text.Substring line) [static]
...
// public static Uno.Collections.IEnumerable<Fuse.Text.Substring> TrimmedLines(Fuse.Text.Substring str) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/TextureAtlas.uno
// ---------------------------------------------------------------
...
// public SubTexture(int textureIndex, Uno.Recti rect) [instance]
...
// public SubTexture New(int textureIndex, Uno.Recti rect) [static]
...
static void TextureAtlas_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/TextureAtlas.uno");
...
// public TextureAtlas(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures)
...
// private static void Blit(Uno.Content.Images.Bitmap dst, Uno.Content.Images.Bitmap src, int2 dstPos)
...
// public TextureAtlas New(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures)
...
// private void NewTexture(int2 size)
void TextureAtlas__NewTexture_fn(TextureAtlas* __this, ::g::Uno::Int2* size)
{
    __this->NewTexture(*size);
}

// public TextureAtlas(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures) [instance]
...
// private void NewTexture(int2 size) [instance]
...
// private static void Blit(Uno.Content.Images.Bitmap dst, Uno.Content.Images.Bitmap src, int2 dstPos) [static]
...
// public TextureAtlas New(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Truncate.uno
// -----------------------------------------------------------
...
// public static Uno.Collections.List<Fuse.Text.ShapedRun> Line(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance)
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines, float maxPixelWidth, float& minTolerance, float& maxTolerance)
...
// private static Uno.Collections.List<Fuse.Text.ShapedRun> TruncatedLine(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance, float2 pos, int runIndex, int i)
...
// public static Uno.Collections.List<Fuse.Text.ShapedRun> Line(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance) [static]
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines, float maxPixelWidth, float& minTolerance, float& maxTolerance) [static]
...
// private static Uno.Collections.List<Fuse.Text.ShapedRun> TruncatedLine(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance, float2 pos, int runIndex, int i) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Wrap.uno
// -------------------------------------------------------
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> ActualLineBreaks(Uno.Collections.List<Fuse.Text.Bidirectional.Run> logicalRuns)
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> logicalLineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance)
...
// private static void WrapLine(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Uno.Collections.List<Fuse.Text.ShapedRun> line, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result)
...
// private static void WrapRun(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Fuse.Text.ShapedRun srun, float2& pos, Uno.Collections.List<Fuse.Text.ShapedRun>& currentLine, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result)
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> ActualLineBreaks(Uno.Collections.List<Fuse.Text.Bidirectional.Run> logicalRuns) [static]
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> logicalLineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance) [static]
...
// private static void WrapLine(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Uno.Collections.List<Fuse.Text.ShapedRun> line, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result) [static]
...
// private static void WrapRun(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Fuse.Text.ShapedRun srun, float2& pos, Uno.Collections.List<Fuse.Text.ShapedRun>& currentLine, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result) [static]
