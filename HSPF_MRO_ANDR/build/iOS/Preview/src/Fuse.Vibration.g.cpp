...
static void Vibrate_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", NULL, (void*)Vibrate__New2_fn, 0, true, type, 0));
}
...
::g::Fuse::Triggers::Actions::TriggerAction_type* Vibrate_typeof()
{
    ...
    type->fp_ctor_ = (void*)Vibrate__New2_fn;
...
// public generated Vibrate New()
void Vibrate__New2_fn(Vibrate** __retval)
{
    *__retval = Vibrate::New2();
}
...
// public generated Vibrate() [instance]
void Vibrate::ctor_2()
{
    ctor_1();
}
...
// public generated Vibrate New() [static]
Vibrate* Vibrate::New2()
{
...
static void VibrationModule_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)VibrationModule__New2_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("Fuse.Vibration.VibrationModule", ".ctor()");
    ctor_1();
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[1/*"vibrate"*/], uDelegate::New(::TYPES[0/*Fuse.Scripting.NativeCallback*/], (void*)VibrationModule__Vibrate_fn)));
}
...
{
    uStackFrame __("Fuse.Vibration.VibrationModule", "Vibrate(Fuse.Scripting.Context,object[])");
