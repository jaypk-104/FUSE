...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Reflection/CppReflection.uno
// ------------------------------------------------------------------------------------

// public extern struct CppField
// {
// public object GetValue(object obj) [adapter]
...
// public void SetValue(object obj, object value) [adapter]
...
// public static Uno.Reflection.CppField get_Null()
...
// public object GetValue(object obj) [instance]
...
// public void SetValue(object obj, object value) [instance]
void CppField::SetValue(uField* __this, uObject* obj, uObject* value)
{
    uPtr(*&__this)->SetValue(obj, value);
}

// public static Uno.Reflection.CppField get_Null() [static]
...
// {
// public Uno.Delegate CreateDelegate(Uno.Type type, object obj) [adapter]
...
// public object Invoke(object obj, object[] args) [adapter]
...
// public Uno.Type[] get_ParameterTypes() [adapter]
...
// public Uno.Delegate CreateDelegate(Uno.Type type, object obj)
...
// public Uno.Type[] get_ParameterTypes() [instance]
uArray* CppFunction::ParameterTypes(uFunction* __this)
{
    return uPtr(*&__this)->ParameterTypes;
}

// public static Uno.Reflection.CppFunction get_Null() [static]
...
// public sealed extern class CppReflection
// {
...
// public generated CppReflection()
void CppReflection__ctor__fn(CppReflection* __this)
{
    __this->ctor_();
}

// public static Uno.Reflection.CppField FindField(Uno.Type type, string name)
void CppReflection__FindField_fn(uType* type, uString* name, uField** __retval)
{
    *__retval = CppReflection::FindField(type, name);
}

// public static Uno.Reflection.CppField FindFieldFromObject(object obj, string name)
...
// public static Uno.Reflection.CppFunction FindFunction(Uno.Type type, string name, Uno.Type[] parameterTypes)
...
// public static Uno.Reflection.CppFunction FindFunctionFromObject(object obj, string name, Uno.Type[] parameterTypes)
...
// public static Uno.Reflection.CppFunction FindFunction(Uno.Type type, string name, Uno.Type[] parameterTypes) [static]
...
// public static Uno.Reflection.CppFunction FindFunctionFromObject(object obj, string name, Uno.Type[] parameterTypes) [static]
...
// public static Uno.Type[] GetTypes() [static]
uArray* CppReflection::GetTypes()
{
    return uReflection::GetTypes();
}

// public generated CppReflection New() [static]
