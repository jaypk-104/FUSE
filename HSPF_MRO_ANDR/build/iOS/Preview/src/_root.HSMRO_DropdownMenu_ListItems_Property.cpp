...
// public HSMRO_DropdownMenu_ListItems_Property(DropdownMenu obj, Uno.UX.Selector name)
void HSMRO_DropdownMenu_ListItems_Property__ctor_3_fn(HSMRO_DropdownMenu_ListItems_Property* __this, ::g::DropdownMenu* obj, ::g::Uno::UX::Selector* name)
{
...
{
    uStackFrame __("HSMRO_DropdownMenu_ListItems_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::DropdownMenu*>(obj, ::TYPES[0/*DropdownMenu*/]))->ListItems(), void();
}

// public HSMRO_DropdownMenu_ListItems_Property New(DropdownMenu obj, Uno.UX.Selector name)
void HSMRO_DropdownMenu_ListItems_Property__New1_fn(::g::DropdownMenu* obj, ::g::Uno::UX::Selector* name, HSMRO_DropdownMenu_ListItems_Property** __retval)
{
    *__retval = HSMRO_DropdownMenu_ListItems_Property::New1(obj, *name);
}
...
{
    uStackFrame __("HSMRO_DropdownMenu_ListItems_Property", "Set(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
...
// public HSMRO_DropdownMenu_ListItems_Property(DropdownMenu obj, Uno.UX.Selector name) [instance]
void HSMRO_DropdownMenu_ListItems_Property::ctor_3(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public HSMRO_DropdownMenu_ListItems_Property New(DropdownMenu obj, Uno.UX.Selector name) [static]
HSMRO_DropdownMenu_ListItems_Property* HSMRO_DropdownMenu_ListItems_Property::New1(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name)
{
    HSMRO_DropdownMenu_ListItems_Property* obj1 = (HSMRO_DropdownMenu_ListItems_Property*)uNew(HSMRO_DropdownMenu_ListItems_Property_typeof());
