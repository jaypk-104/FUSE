...
{
    uStackFrame __("HSMRO_FuseLayoutsColumn_Width_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseLayoutsColumn_Width_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
