// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/Confirm.g.uno.
...
static void Confirm_build(uType* type)
{
    ...
    type->SetFields(120,
        ...
        uObject_typeof(), offsetof(Confirm, _field_Handler), 0,
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_Handler", NULL, (void*)Confirm__get_Handler_fn, 0, false, uObject_typeof(), 0),
        new uFunction("set_Handler", NULL, (void*)Confirm__set_Handler_fn, 0, false, uVoid_typeof(), 1, uObject_typeof()),
        new uFunction(".ctor", NULL, (void*)Confirm__New4_fn, 0, true, type, 0),
        new uFunction("SetHandler", NULL, (void*)Confirm__SetHandler_fn, 0, false, uVoid_typeof(), 2, uObject_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetShow", NULL, (void*)Confirm__SetShow_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetText", NULL, (void*)Confirm__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Show", NULL, (void*)Confirm__get_Show_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_Show", NULL, (void*)Confirm__set_Show_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction("get_Text", NULL, (void*)Confirm__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)Confirm__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
void Confirm__get_Handler_fn(Confirm* __this, uObject** __retval)
{
    *__retval = __this->Handler();
}

// public void set_Handler(object value)
void Confirm__set_Handler_fn(Confirm* __this, uObject* value)
{
...
// public void SetHandler(object value, Uno.UX.IPropertyListener origin)
void Confirm__SetHandler_fn(Confirm* __this, uObject* value, uObject* origin)
{
    __this->SetHandler(value, origin);
}
...
void Confirm::ctor_7()
{
    uStackFrame __("Confirm", ".ctor()");
    ctor_6();
    InitializeUX();
}

// public object get_Handler() [instance]
uObject* Confirm::Handler()
{
    return _field_Handler;
}

// public void set_Handler(object value) [instance]
void Confirm::Handler(uObject* value)
{
    uStackFrame __("Confirm", "set_Handler(object)");
...
{
    uStackFrame __("Confirm", "InitializeUX()");
...
// public void SetHandler(object value, Uno.UX.IPropertyListener origin) [instance]
void Confirm::SetHandler(uObject* value, uObject* origin)
{
    uStackFrame __("Confirm", "SetHandler(object,Uno.UX.IPropertyListener)");

    if (value != _field_Handler)
    {
        _field_Handler = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[26/*"Handler"*/]), origin);
    }
}
...
{
    uStackFrame __("Confirm", "SetShow(bool,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Confirm", "SetText(string,Uno.UX.IPropertyListener)");

    if (::g::Uno::String::op_Inequality(value, _field_Text))
    {
        _field_Text = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[27/*"Text"*/]), origin);
    }
}
...
{
    uStackFrame __("Confirm", "set_Show(bool)");
    SetShow(value, NULL);
}
...
{
    uStackFrame __("Confirm", "set_Text(string)");
    SetText(value, NULL);
}
