...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/Observable.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/TreeObservable/TreeObservable.uno
// ------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ArrayMirror.uno
// ------------------------------------------------------------------------------
...
// protected ArrayMirror New(Fuse.Scripting.Array obj)
...
// protected ArrayMirror New(Fuse.Scripting.Array obj) [static]
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/TreeObservable/TreeArray.uno
// -------------------------------------------------------------------------------------------
...
// private void Fuse.Reactive.ISubscription.ClearExclusive()
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ClassInstance.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ThreadWorker.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/DateTimeConverterHelpers.uno
// -------------------------------------------------------------------------------------------
...
// public sealed class ThreadWorker.Fence
// {
...
// internal void Signal(Fuse.Scripting.Context context) [instance]
...
// public generated Fence New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/Context.uno
// --------------------------------------------------------------------------
...
void JSContext__FuseScriptingJavaScriptIMirrorReflect_fn(JSContext* __this, ::g::Fuse::Scripting::Context* context, uObject* obj, uObject** __retval)
{
    ...
    if (context != __this)
        ::g::Fuse::Diagnostics::InternalError(uString::Const("IMirror.Reflect with inconsistent context"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/Context.uno"), 94, uString::Const("Fuse.Scripting.JavaScript.IMirror.Reflect"));
...
uObject* JSContext::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/Context.uno"), 103, uString::Const("CreateMirror"));
        return NULL;
    }
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/TreeObservable/TreeObject.uno
// --------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ObservableProperty.uno
// -------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ModuleInstance.uno
// ---------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ObjectMirror.uno
// -------------------------------------------------------------------------------
...
// protected ObjectMirror New(Fuse.Scripting.Object obj)
...
// protected ObjectMirror New(Fuse.Scripting.Object obj) [static]
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/RootableScriptModule.uno
// ---------------------------------------------------------------------------------------
...
void Observable__Subscription__FuseReactiveISubscriptionSetExclusive_fn(Observable__Subscription* __this, uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/Observable.uno"), 132, uString::Const("Fuse.Reactive.ISubscription.SetExclusive"));
        return;
    }
...
void Observable__Subscription::SetExclusive(::g::Fuse::Scripting::Context* context, uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/Observable.uno"), 118, uString::Const("SetExclusive"));
        return;
    }
...
// public Fuse.Scripting.JavaScript.ThreadWorker.Fence PostFence()
...
// public Fuse.Scripting.JavaScript.ThreadWorker.Fence PostFence() [instance]
...
void ThreadWorker::Run()
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UnknownException(uString::Const("ThreadWorked failed"), e, this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/ThreadWorker.uno"), 64, uString::Const("Run"));
        DispatchException(e);
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.12.0/TypeWrapper.uno
// ------------------------------------------------------------------------------
