...
// {
// static Handler_return_inq()
static void Handler_return_inq__cctor_2_fn(uType* __type)
{
    Handler_return_inq::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Event_Handler"*/]);
}

static void Handler_return_inq_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Event_Handler");
    ::STRINGS[1] = uString::Const("Pages/Menu_Customer/Confirm_return_inq.ux");
    type->SetInterfaces(
    ...
    type->SetFields(44,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Handler_return_inq::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Handler_return_inq__New3_fn, 0, true, type, 0));
}
...
::g::Fuse::Triggers::Trigger_type* Handler_return_inq_typeof()
{
    ...
    options.ObjectSize = sizeof(Handler_return_inq);
    options.TypeSize = sizeof(::g::Fuse::Triggers::Trigger_type);
    type = (::g::Fuse::Triggers::Trigger_type*)uClassType::New("Handler_return_inq", options);
    type->fp_build_ = Handler_return_inq_build;
    type->fp_ctor_ = (void*)Handler_return_inq__New3_fn;
    type->fp_cctor_ = Handler_return_inq__cctor_2_fn;
...
// public Handler_return_inq New()
void Handler_return_inq__New3_fn(Handler_return_inq** __retval)
{
    *__retval = Handler_return_inq::New3();
}

::g::Uno::UX::Selector Handler_return_inq::__selector0_;

// public Handler_return_inq() [instance]
void Handler_return_inq::ctor_6()
{
    ctor_5();
    InitializeUX();
}
...
void Handler_return_inq::InitializeUX()
{
    EventName(Handler_return_inq::__selector0_);
    SourceLineNumber(47);
    SourceFileName(::STRINGS[1/*"Pages/Menu_...*/]);
}

// public Handler_return_inq New() [static]
Handler_return_inq* Handler_return_inq::New3()
{
    Handler_return_inq* obj1 = (Handler_return_inq*)uNew(Handler_return_inq_typeof());
    obj1->ctor_6();
    return obj1;
}
// }
