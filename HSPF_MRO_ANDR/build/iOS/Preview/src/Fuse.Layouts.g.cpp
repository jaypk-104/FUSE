...
// public generated CircleLayout() [instance]
...
// public float get_ItemSpacingDegrees() [instance]
float CircleLayout::ItemSpacingDegrees()
{
    return ::g::Uno::Math::RadiansToDegrees1(_itemSpacing);
}

// public void set_ItemSpacingDegrees(float value) [instance]
...
// public generated CircleLayout New() [static]
...
// public Column(float width, Fuse.Layouts.Metric metric)
void Column__ctor_5_fn(Column* __this, float* width, int32_t* metric)
{
    __this->ctor_5(*width, *metric);
}

// private Column(Fuse.Layouts.Column copy, Fuse.Layouts.DefinitionBase.CreationType creation)
...
// public Column New(float width, Fuse.Layouts.Metric metric)
void Column__New3_fn(float* width, int32_t* metric, Column** __retval)
{
    *__retval = Column::New3(*width, *metric);
}

// private Column New(Fuse.Layouts.Column copy, Fuse.Layouts.DefinitionBase.CreationType creation)
...
// public Column(float width, Fuse.Layouts.Metric metric) [instance]
void Column::ctor_5(float width, int32_t metric)
{
    ctor_2(width, metric);
}

// private Column(Fuse.Layouts.Column copy, Fuse.Layouts.DefinitionBase.CreationType creation) [instance]
...
// public Column New(float width, Fuse.Layouts.Metric metric) [static]
...
// private Column New(Fuse.Layouts.Column copy, Fuse.Layouts.DefinitionBase.CreationType creation) [static]
...
// public generated ColumnLayout New()
...
// public generated ColumnLayout() [instance]
...
// public generated ColumnLayout New() [static]
...
// protected DefinitionBase(float extent, Fuse.Layouts.Metric metric)
void DefinitionBase__ctor_2_fn(DefinitionBase* __this, float* extent, int32_t* metric)
{
    __this->ctor_2(*extent, *metric);
}

// internal DefinitionBase(Fuse.Layouts.DefinitionBase copy, Fuse.Layouts.DefinitionBase.CreationType creation)
...
// protected DefinitionBase(float extent, Fuse.Layouts.Metric metric) [instance]
...
// internal DefinitionBase(Fuse.Layouts.DefinitionBase copy, Fuse.Layouts.DefinitionBase.CreationType creation) [instance]
...
// public static void ResetDock(Fuse.Visual elm)
...
// public static void ResetDock(Fuse.Visual elm) [static]
...
// public static void SetRowSpan(Fuse.Visual elm, int span)
...
// public static void ResetColumn(Fuse.Visual elm) [static]
...
// public static void ResetColumnSpan(Fuse.Visual elm) [static]
...
// public static void ResetRow(Fuse.Visual elm) [static]
...
// public static void ResetRowSpan(Fuse.Visual elm) [static]
...
// public static void SetRowSpan(Fuse.Visual elm, int span) [static]
...
// private static Fuse.Controls.LayoutControl GetLayoutControl(Fuse.Visual elm)
...
// private static void InvalidateLayout(Fuse.Visual elm)
...
// public static void ResetFillPadding(Fuse.Visual n)
...
// public static void SetFillPadding(Fuse.Visual n, bool f)
...
// private static Fuse.Controls.LayoutControl GetLayoutControl(Fuse.Visual elm) [static]
...
// private static void InvalidateLayout(Fuse.Visual elm) [static]
...
// public static void ResetFillPadding(Fuse.Visual n) [static]
...
// public static void SetFillPadding(Fuse.Visual n, bool f) [static]
...
// public Row(float height, Fuse.Layouts.Metric metric)
void Row__ctor_5_fn(Row* __this, float* height, int32_t* metric)
{
    __this->ctor_5(*height, *metric);
}

// private Row(Fuse.Layouts.Row copy, Fuse.Layouts.DefinitionBase.CreationType creation)
...
// public Fuse.Layouts.Metric get_HeightMetric()
void Row__get_HeightMetric_fn(Row* __this, int32_t* __retval)
{
    *__retval = __this->HeightMetric();
}

// public void set_HeightMetric(Fuse.Layouts.Metric value)
...
// public Row New(float height, Fuse.Layouts.Metric metric)
void Row__New3_fn(float* height, int32_t* metric, Row** __retval)
{
    *__retval = Row::New3(*height, *metric);
}

// private Row New(Fuse.Layouts.Row copy, Fuse.Layouts.DefinitionBase.CreationType creation)
...
// public Row(float height, Fuse.Layouts.Metric metric) [instance]
void Row::ctor_5(float height, int32_t metric)
{
    ctor_2(height, metric);
}

// private Row(Fuse.Layouts.Row copy, Fuse.Layouts.DefinitionBase.CreationType creation) [instance]
...
// public Fuse.Layouts.Metric get_HeightMetric() [instance]
int32_t Row::HeightMetric()
{
    return Metric();
}

// public void set_HeightMetric(Fuse.Layouts.Metric value) [instance]
...
// public Row New(float height, Fuse.Layouts.Metric metric) [static]
...
// private Row New(Fuse.Layouts.Row copy, Fuse.Layouts.DefinitionBase.CreationType creation) [static]
...
// public void ResetOrientation() [instance]
...
// public generated string get_ID()
void WrapLayout__get_ID_fn(WrapLayout* __this, uString** __retval)
{
    *__retval = __this->ID();
}

// public generated void set_ID(string value)
...
// public generated string get_ID() [instance]
uString* WrapLayout::ID()
{
    return _ID;
}

// public generated void set_ID(string value) [instance]
