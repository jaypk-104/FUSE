...
{
    uStackFrame __("HSMRO_FuseRotation_Degrees_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseRotation_Degrees_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
