...
{
    uStackFrame __("HSMRO_FuseAnimationsChangefloat4_Value_Property", "Get(Uno.UX.PropertyObject)");
    ::g::Uno::Float4 ret2;
...
{
    uStackFrame __("HSMRO_FuseAnimationsChangefloat4_Value_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
