...
{
    uStackFrame __("HSMRO_ListType_inq_USR_ID_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_ListType_inq_USR_ID_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
