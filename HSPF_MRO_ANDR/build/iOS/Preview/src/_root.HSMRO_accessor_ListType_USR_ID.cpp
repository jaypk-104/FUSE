...
{
    uStackFrame __("HSMRO_accessor_ListType_USR_ID", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_accessor_ListType_USR_ID", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
