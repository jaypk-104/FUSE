...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.12.0/Internal/PatchList.uno
// ----------------------------------------------------------------------------------
...
// public generated PatchList()
void PatchList__ctor__fn(PatchList* __this)
{
    __this->ctor_();
}

// public static string Format(Uno.Collections.IList<Fuse.Reactive.Internal.PatchItem> list)
void PatchList__Format_fn(uObject* list, uString** __retval)
{
    *__retval = PatchList::Format(list);
}

// public generated PatchList New()
...
// public generated PatchList() [instance]
void PatchList::ctor_()
{
}

// public static string Format(Uno.Collections.IList<Fuse.Reactive.Internal.PatchItem> list) [static]
uString* PatchList::Format(uObject* list)
{
    ...
    for (int32_t i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(list), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Reactive.Internal.PatchItem>*/])); ++i)
    {
        if (i > 0)
            q = ::g::Uno::String::op_Addition2(q, ::STRINGS[0/*","*/]);

        ::g::Fuse::Reactive::Internal::PatchItem item = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(list), ::TYPES[1/*Uno.Collections.IList<Fuse.Reactive.Internal.PatchItem>*/]), uCRef<int32_t>(i), &ret2), ret2);

        switch (item.Op)
        {
            case 0:
            {
                q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition1(::STRINGS[2/*"R"*/], uBox<int32_t>(::g::Uno::Int_typeof(), item.A)));
                break;
            }
            case 1:
            {
                q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"I"*/], uBox<int32_t>(::g::Uno::Int_typeof(), item.A)), ::STRINGS[4/*"="*/]), uBox<int32_t>(::g::Uno::Int_typeof(), item.Data)));
                break;
            }
            case 2:
            {
                q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"U"*/], uBox<int32_t>(::g::Uno::Int_typeof(), item.A)), ::STRINGS[4/*"="*/]), uBox<int32_t>(::g::Uno::Int_typeof(), item.Data)));
                break;
            }
        }
    }
...
// public generated PatchList New() [static]
