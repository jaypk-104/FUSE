...
{
    uStackFrame __("HSMRO_accessor_DropdownOption_TextColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_accessor_DropdownOption_TextColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
