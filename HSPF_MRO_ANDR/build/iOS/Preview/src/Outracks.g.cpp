...
// public static extern Outracks.IBinaryMessage Compose(string type, Uno.Action<System.IO.BinaryWriter> write)
void BinaryMessage__Compose_fn(uString* type, uDelegate* write, uObject** __retval)
{
    *__retval = BinaryMessage::Compose(type, write);
}

// public static extern Outracks.IBinaryMessage ReadFrom(System.IO.BinaryReader reader)
...
// public static Outracks.Optional<T> TryParse<T>(Outracks.IBinaryMessage message, string type, Uno.Func<System.IO.BinaryReader, T> action)
...
// public static extern void WriteTo(Outracks.IBinaryMessage message, System.IO.BinaryWriter writer)
void BinaryMessage__WriteTo_fn(uObject* message, ::g::System::IO::BinaryWriter* writer)
{
    BinaryMessage::WriteTo(message, writer);
}

// public static extern Outracks.IBinaryMessage Compose(string type, Uno.Action<System.IO.BinaryWriter> write) [static]
...
// public static extern Outracks.IBinaryMessage ReadFrom(System.IO.BinaryReader reader) [static]
...
// public static T[] SubArray<T>(T[] data, int index, int length) [static]
...
// public static extern void WriteTo(Outracks.IBinaryMessage message, System.IO.BinaryWriter writer) [static]
...
// private sealed class BinaryMessage.ComposedMessage
// {
...
// public generated void set_Write(Uno.Action<System.IO.BinaryWriter> value)
...
// public generated ComposedMessage() [instance]
void BinaryMessage__ComposedMessage::ctor_()
{
}

// public generated string get_Type() [instance]
uString* BinaryMessage__ComposedMessage::Type()
{
    return _Type;
}

// public generated void set_Type(string value) [instance]
void BinaryMessage__ComposedMessage::Type(uString* value)
{
    _Type = value;
}

// public generated Uno.Action<System.IO.BinaryWriter> get_Write() [instance]
uDelegate* BinaryMessage__ComposedMessage::Write()
{
    return _Write;
}

// public generated void set_Write(Uno.Action<System.IO.BinaryWriter> value) [instance]
...
// public generated ComposedMessage New() [static]
...
// public abstract interface IBinaryMessage
// {
...
// public generated None()
void None__ctor__fn(None* __this)
{
    __this->ctor_();
}

// public generated None New()
void None__New1_fn(None** __retval)
{
    *__retval = None::New1();
}

// public generated None() [instance]
void None::ctor_()
{
}

// public generated None New() [static]
None* None::New1()
{
...
// public static Outracks.Optional<T> ToOptional<T>(T value)
...
// public static Outracks.None None()
void Optional__None_fn(::g::Outracks::None** __retval)
{
    *__retval = Optional::None();
}

// public static Outracks.Optional<T> None<T>()
...
// public static Outracks.Optional<T> Read<T>(System.IO.BinaryReader reader, Uno.Func<System.IO.BinaryReader, T> readSome)
...
// public static Outracks.Optional<T> Some<T>(T value)
...
// public static void Write<T>(System.IO.BinaryWriter writer, Outracks.Optional<T> optional, Uno.Action<System.IO.BinaryWriter, T> writeSome)
...
// public static void Write<T>(System.IO.BinaryWriter writer, Outracks.Optional<T> optional, Uno.Action<T, System.IO.BinaryWriter> writeSome)
...
// public static void Write<T>(System.IO.BinaryWriter writer, Outracks.Optional<T> optional, Uno.Action<T> writeSome)
...
// public static Outracks.None None() [static]
...
// public bool Equals(Outracks.Optional<T> other)
...
// internal Optional New(bool hasValue, [T value])
...
// public static implicit operator Outracks.Optional<T>(Outracks.None value)
...
// public static implicit operator Outracks.Optional<T>(T value)
...
// private sealed class BinaryMessage.WriteClosure
// {
...
// public generated WriteClosure()
void BinaryMessage__WriteClosure__ctor__fn(BinaryMessage__WriteClosure* __this)
{
    __this->ctor_();
}

// public void Execute(System.IO.BinaryWriter writer)
...
// public generated WriteClosure New() [static]
