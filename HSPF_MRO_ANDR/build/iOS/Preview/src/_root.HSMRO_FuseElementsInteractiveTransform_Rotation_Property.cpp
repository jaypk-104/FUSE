...
{
    uStackFrame __("HSMRO_FuseElementsInteractiveTransform_Rotation_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseElementsInteractiveTransform_Rotation_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
