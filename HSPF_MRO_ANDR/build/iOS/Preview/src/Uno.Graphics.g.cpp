...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/Enums.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/DeviceBuffer.uno
// ---------------------------------------------------------------------------------
...
static void DeviceBuffer_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        ...
        new uFunction("Update", NULL, (void*)DeviceBuffer__Update2_fn, 0, false, uVoid_typeof(), 4, ::g::Uno::Array_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof()),
        new uFunction("Update", NULL, (void*)DeviceBuffer__Update3_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Buffer_typeof()),
...
// public void Update(Uno.Buffer data)
void DeviceBuffer__Update3_fn(DeviceBuffer* __this, ::g::Uno::Buffer* data)
{
    __this->Update3(data);
}
...
{
    uStackFrame __("Uno.Graphics.DeviceBuffer", "Update(Uno.Array,int,int,int)");
    ...
    if (sizeInBytes <= SizeInBytes())
        ::g::OpenGL::GL::BufferSubData1(GLBufferTarget(), 0, sizeInBytes, addr);
    else
    {
        ::g::OpenGL::GL::BufferData2(GLBufferTarget(), sizeInBytes, addr, ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLInterop::ToGLBufferUsage(Usage()));
...
// public void Update(Uno.Buffer data) [instance]
void DeviceBuffer::Update3(::g::Uno::Buffer* data)
{
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/FormatHelpers.uno
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/Framebuffer.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/IndexBuffer.uno
// --------------------------------------------------------------------------------
...
static void IndexBuffer_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("Update", NULL, (void*)IndexBuffer__Update4_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::UShort_typeof()->Array()));
}
...
// public IndexBuffer(Uno.Buffer data, Uno.Graphics.BufferUsage usage)
...
// public IndexBuffer New(Uno.Buffer data, Uno.Graphics.BufferUsage usage)
void IndexBuffer__New3_fn(::g::Uno::Buffer* data, int32_t* usage, IndexBuffer** __retval)
{
    *__retval = IndexBuffer::New3(data, *usage);
}

// public IndexBuffer New(Uno.Graphics.BufferUsage usage)
...
void IndexBuffer__Update4_fn(IndexBuffer* __this, uArray* data)
{
    __this->Update4(data);
}
...
// public IndexBuffer(Uno.Buffer data, Uno.Graphics.BufferUsage usage) [instance]
...
void IndexBuffer::Update4(uArray* data)
{
...
// public IndexBuffer New(Uno.Buffer data, Uno.Graphics.BufferUsage usage) [static]
...
// public IndexBuffer New(Uno.Graphics.BufferUsage usage) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/RenderTarget.uno
// ---------------------------------------------------------------------------------
...
// public static Uno.Graphics.RenderTarget Create(textureCube texture, Uno.Graphics.CubeFace face, int mip, bool depth)
...
// public static Uno.Graphics.RenderTarget Create(textureCube texture, Uno.Graphics.CubeFace face, int mip, bool depth) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/SamplerState.uno
// ---------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/Texture2D.uno
// ------------------------------------------------------------------------------
...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/Texture2D.uno");
    ::STRINGS[11] = uString::Const("Texture2D");
    ::STRINGS[12] = uString::Const("Texture does not support mipmap");
    ::STRINGS[13] = uString::Const("Texture is immutable and cannot be updated");
    ::STRINGS[14] = uString::Const("GL_OES_texture_npot");
...
// public bool get_SupportsMipmap()
...
// public void Update(Uno.Buffer mip0)
void Texture2D__Update3_fn(Texture2D* __this, ::g::Uno::Buffer* mip0)
{
    __this->Update3(mip0);
}

// public void Update(Uno.IntPtr mip0)
...
void Texture2D::Dispose()
{
    ...
    if (IsDisposed())
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[11/*"Texture2D"*/]));
    else
...
void Texture2D::GenerateMipmap()
{
    ...
    if (!IsMipmap())
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[12/*"Texture doe...*/]));
    else
    {
...
// public bool get_SupportsMipmap() [instance]
...
void Texture2D::Update(uArray* mip0)
{
    ...
    if (Format() == 0)
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[13/*"Texture is ...*/]));
    else
    {
...
// public void Update(Uno.Buffer mip0) [instance]
...
// public void Update(Uno.IntPtr mip0) [instance]
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[8/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition2(::STRINGS[9/*"**** Invali...*/], versionString), 0, ::STRINGS[10/*"/usr/local/...*/], 69);
            }
            else             throw __t;
        }
    }
...
bool Texture2D::HaveNonPow2Support()
{
    ...
    {
        Texture2D::_haveNonPow2Support_ = (Texture2D::CheckGLES3Support() || Texture2D::CheckExtensionSupport(::STRINGS[14/*"GL_OES_text...*/]));
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/TextureCube.uno
// --------------------------------------------------------------------------------

// public intrinsic sealed class TextureCube
// {
static void TextureCube_build(uType* type)
{
    ::STRINGS[15] = uString::Const("TextureCube");
    type->SetInterfaces(
...
// public generated int get_Size()
void TextureCube__get_Size_fn(TextureCube* __this, int32_t* __retval)
{
    *__retval = __this->Size();
}

// private generated void set_Size(int value)
...
void TextureCube::Dispose()
{
    ...
    if (IsDisposed())
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[15/*"TextureCube"*/]));
    else
        ::g::OpenGL::GL::DeleteTexture(GLTextureHandle());
...
// public generated int get_Size() [instance]
int32_t TextureCube::Size()
{
    return _Size;
}

// private generated void set_Size(int value) [instance]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/TextureHelpers.uno
// -----------------------------------------------------------------------------------
...
// public static int2 GetMipSize(textureCube texture, int mip) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/VertexAttributeInfo.uno
// ----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/VertexBuffer.uno
// ---------------------------------------------------------------------------------
...
static void VertexBuffer_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("Update", NULL, (void*)VertexBuffer__Update5_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float2_typeof()->Array()),
        new uFunction("Update", NULL, (void*)VertexBuffer__Update6_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float3_typeof()->Array()),
        new uFunction("Update", NULL, (void*)VertexBuffer__Update7_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()->Array()));
}
...
void VertexBuffer__Update7_fn(VertexBuffer* __this, uArray* data)
{
    __this->Update7(data);
}
...
// public void Update(float4[] data) [instance]
void VertexBuffer::Update7(uArray* data)
{
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Graphics/VideoTexture.uno
// ---------------------------------------------------------------------------------
...
{
    ::STRINGS[16] = uString::Const("VideoTexture");
    type->SetInterfaces(
...
void VideoTexture::Dispose()
{
    ...
    if (IsDisposed())
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[16/*"VideoTexture"*/]));
    else
        ::g::OpenGL::GL::DeleteTexture(GLTextureHandle());
