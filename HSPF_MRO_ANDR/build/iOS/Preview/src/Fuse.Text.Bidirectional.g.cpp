...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Bidirectional.uno
// ----------------------------------------------------------------

// private sealed class Runs.Range
// {
...
// public Range(int level, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> left, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> right)
...
// public Range New(int level, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> left, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> right)
...
// public Range(int level, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> left, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> right) [instance]
...
// public Range New(int level, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> left, Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> right) [static]
...
// public Fuse.Text.TextDirection get_Direction() [instance]
int32_t Run::Direction()
{
    return IsLeftToRight() ? 0 : 1;
}

// public bool get_IsLeftToRight() [instance]
bool Run::IsLeftToRight()
{
    return (Level % 2) == 0;
}

// public bool get_IsRightToLeft() [instance]
bool Run::IsRightToLeft()
{
    return (Level % 2) != 0;
}

// internal int get_LogicalEnd() [instance]
...
// internal int get_LogicalStart() [instance]
...
// internal int get_VisualLeft() [instance]
...
// internal int get_VisualRight() [instance]
...
// public Run New(Fuse.Text.Substring str, int level) [static]
...
// public static Uno.Collections.List<Fuse.Text.Bidirectional.Run> GetLogical(Fuse.Text.Substring text)
void Runs__GetLogical_fn(::g::Fuse::Text::Substring* text, ::g::Uno::Collections::List** __retval)
{
    *__retval = Runs::GetLogical(text);
}

// private static Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> GetVisual(Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> run)
...
// public static Uno.Collections.List<Fuse.Text.ShapedRun> GetVisual(Uno.Collections.List<Fuse.Text.ShapedRun> runs)
void Runs__GetVisual1_fn(::g::Uno::Collections::List* runs, ::g::Uno::Collections::List** __retval)
{
    *__retval = Runs::GetVisual1(runs);
}

// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> GetVisual(Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines)
void Runs__GetVisual2_fn(::g::Uno::Collections::List* lines, ::g::Uno::Collections::List** __retval)
{
    *__retval = Runs::GetVisual2(lines);
}

// private static bool IsRightToLeft(int level)
void Runs__IsRightToLeft_fn(int32_t* level, bool* __retval)
{
    *__retval = Runs::IsRightToLeft(*level);
}

// private static void MergeRange(Uno.Collections.Stack<Fuse.Text.Bidirectional.Runs.Range> ranges, Fuse.Text.Bidirectional.Runs.Range range)
void Runs__MergeRange_fn(::g::Uno::Collections::Stack* ranges, Runs__Range* range)
{
    Runs::MergeRange(ranges, range);
}

// private static bool TryMergeRangeWithPrevious(Uno.Collections.Stack<Fuse.Text.Bidirectional.Runs.Range> ranges, int runLevel)
...
// public static Uno.Collections.List<Fuse.Text.Bidirectional.Run> GetLogical(Fuse.Text.Substring text) [static]
...
// private static Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> GetVisual(Fuse.Text.SinglyLinkedList<Fuse.Text.ShapedRun> run) [static]
::g::Fuse::Text::SinglyLinkedList* Runs::GetVisual(::g::Fuse::Text::SinglyLinkedList* run)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert4 >= 1, uString::Const("ranges.Count >= 1"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/Bidirectional.uno"), 98, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int32_t>(::g::Uno::Int_typeof(), assert4), uBox<int32_t>(::g::Uno::Int_typeof(), 1)));
...
// public static Uno.Collections.List<Fuse.Text.ShapedRun> GetVisual(Uno.Collections.List<Fuse.Text.ShapedRun> runs) [static]
::g::Uno::Collections::List* Runs::GetVisual1(::g::Uno::Collections::List* runs)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == assert2, uString::Const("result.Count == runs.Count"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/Bidirectional.uno"), 45, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int32_t>(::g::Uno::Int_typeof(), assert1), uBox<int32_t>(::g::Uno::Int_typeof(), assert2)));
    return result;
}

// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> GetVisual(Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) [static]
...
// private static bool IsRightToLeft(int level) [static]
bool Runs::IsRightToLeft(int32_t level)
{
    return (level % 2) != 0;
}

// private static void MergeRange(Uno.Collections.Stack<Fuse.Text.Bidirectional.Runs.Range> ranges, Fuse.Text.Bidirectional.Runs.Range range) [static]
void Runs::MergeRange(::g::Uno::Collections::Stack* ranges, Runs__Range* range)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert5 >= 1, uString::Const("ranges.Count >= 1"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/Bidirectional.uno"), 118, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int32_t>(::g::Uno::Int_typeof(), assert5), uBox<int32_t>(::g::Uno::Int_typeof(), 1)));
    Runs__Range* previous = (::g::Uno::Collections::Stack__Peek_fn(ranges, &ret12), ret12);
    ::g::Uno::Diagnostics::Debug::Assert(uPtr(previous)->Level < uPtr(range)->Level, uString::Const("previous.Level < range.Level"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.12.0/Bidirectional.uno"), 122, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int32_t>(::g::Uno::Int_typeof(), uPtr(previous)->Level), uBox<int32_t>(::g::Uno::Int_typeof(), uPtr(range)->Level)));
...
// private static bool TryMergeRangeWithPrevious(Uno.Collections.Stack<Fuse.Text.Bidirectional.Runs.Range> ranges, int runLevel) [static]
