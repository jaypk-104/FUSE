// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/ModeIndicator.g.uno.
...
static void ModeIndicator_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_IsActive", NULL, (void*)ModeIndicator__get_IsActive_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_IsActive", NULL, (void*)ModeIndicator__set_IsActive_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)ModeIndicator__New4_fn, 0, true, type, 0),
        new uFunction("SetIsActive", NULL, (void*)ModeIndicator__SetIsActive_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()));
}
...
{
    uStackFrame __("ModeIndicator", ".ctor()");
    ctor_8();
    InitializeUX();
}
...
{
    uStackFrame __("ModeIndicator", "InitializeUX()");
...
{
    uStackFrame __("ModeIndicator", "set_IsActive(bool)");
...
{
    uStackFrame __("ModeIndicator", "SetIsActive(bool,Uno.UX.IPropertyListener)");
