...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/Draggable.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/Body.uno
// ----------------------------------------------------------

// internal sealed class Body
// {
// static generated Body()
...
// internal Body(Fuse.Physics.World world, Fuse.Visual node)
...
// internal Body New(Fuse.Physics.World world, Fuse.Visual node)
void Body__New1_fn(::g::Fuse::Physics::World* world, ::g::Fuse::Visual* node, Body** __retval)
{
    *__retval = Body::New1(world, node);
}

// internal static Fuse.Physics.Body Pin(Fuse.Visual n)
void Body__Pin_fn(::g::Fuse::Visual* n, Body** __retval)
{
    *__retval = Body::Pin(n);
}

// internal static void SetFriction(Fuse.Visual n, float friction)
...
// internal float3 get_WorldPosition()
...
// internal Body(Fuse.Physics.World world, Fuse.Visual node) [instance]
...
// internal void ApplyForce(float3 force) [instance]
void Body::ApplyForce(::g::Uno::Float3 force)
{
    _velocity = ::g::Uno::Float3__op_Addition2(_velocity, force);
}

// private void ApplyFriction(double deltaTime) [instance]
...
// private void ApplyMotion(double deltaTime) [instance]
...
// internal float3 get_CenterPosition() [instance]
...
// internal void ConstrainToBounds(Fuse.Elements.Element elm) [instance]
...
// internal float get_Friction() [instance]
float Body::Friction()
{
...
// internal void set_Friction(float value) [instance]
...
// internal void Move(float3 delta) [instance]
void Body::Move(::g::Uno::Float3 delta)
{
    _position = ::g::Uno::Float3__op_Addition2(_position, delta);
}

// internal bool TryLockMotion(object owner) [instance]
...
// internal void UnlockMotion() [instance]
...
// internal void Update(double deltaTime) [instance]
...
// internal float3 get_WorldPosition() [instance]
...
// internal static float GetFriction(Fuse.Visual n) [static]
...
// internal Body New(Fuse.Physics.World world, Fuse.Visual node) [static]
...
// internal static Fuse.Physics.Body Pin(Fuse.Visual n) [static]
...
// internal static void SetFriction(Fuse.Visual n, float friction) [static]
...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/BodyAttr.uno
// --------------------------------------------------------------
...
// public static void SetFriction(Fuse.Visual n, float friction) [static]
...
// private float3 GetPointerPosition(Fuse.Input.PointerEventArgs args)
...
// public generated Draggable New()
void Draggable__New2_fn(Draggable** __retval)
{
    *__retval = Draggable::New2();
}

// private void OnMoved(object sender, Fuse.Input.PointerMovedArgs args)
...
// private void OnPressed(object sender, Fuse.Input.PointerPressedArgs args)
...
// private void OnReleased(object sender, Fuse.Input.PointerReleasedArgs args)
...
// public generated Draggable() [instance]
void Draggable::ctor_3()
{
    ctor_2();
}

// public generated Fuse.Physics.Axis2D get_Axis() [instance]
int32_t Draggable::Axis()
{
    return _Axis;
}

// public generated void set_Axis(Fuse.Physics.Axis2D value) [instance]
void Draggable::Axis(int32_t value)
{
    _Axis = value;
}

// public generated Fuse.Elements.Element get_Bounds() [instance]
::g::Fuse::Elements::Element* Draggable::Bounds()
{
    return _Bounds;
}

// public generated void set_Bounds(Fuse.Elements.Element value) [instance]
void Draggable::Bounds(::g::Fuse::Elements::Element* value)
{
    _Bounds = value;
}

// private float3 GetPointerPosition(Fuse.Input.PointerEventArgs args) [instance]
...
// private void OnMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance]
...
// private void OnPointerLost() [instance]
...
// private void OnPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance]
...
// private void OnReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance]
...
// public generated Draggable New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/ForceFieldTriggers.uno
// ------------------------------------------------------------------------
...
// public sealed class ExitedForceField
// {
...
// public generated ExitedForceField()
void ExitedForceField__ctor_7_fn(ExitedForceField* __this)
{
    __this->ctor_7();
}

// public generated ExitedForceField New()
...
// public generated ExitedForceField() [instance]
...
// public generated ExitedForceField New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/ForceField.uno
// ----------------------------------------------------------------
...
// protected generated ForceField()
...
// internal Fuse.Physics.World get_World()
void ForceField__get_World_fn(ForceField* __this, ::g::Fuse::Physics::World** __retval)
{
    *__retval = __this->World();
}

// protected generated ForceField() [instance]
void ForceField::ctor_3()
{
    ctor_2();
}

// internal Fuse.Physics.World get_World() [instance]
...
// public sealed class ForceFieldEventArgs
// {
...
// internal ForceFieldEventArgs(Fuse.Physics.Body body, Fuse.Physics.ForceField field)
...
// private generated void set_ForceField(Fuse.Physics.ForceField value)
...
// internal ForceFieldEventArgs New(Fuse.Physics.Body body, Fuse.Physics.ForceField field)
...
// public Fuse.Visual get_Visual()
void ForceFieldEventArgs__get_Visual_fn(ForceFieldEventArgs* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->Visual();
}

// internal ForceFieldEventArgs(Fuse.Physics.Body body, Fuse.Physics.ForceField field) [instance]
...
// internal generated Fuse.Physics.Body get_Body() [instance]
::g::Fuse::Physics::Body* ForceFieldEventArgs::Body()
{
    return _Body;
}

// private generated void set_Body(Fuse.Physics.Body value) [instance]
void ForceFieldEventArgs::Body(::g::Fuse::Physics::Body* value)
{
    _Body = value;
}

// internal generated Fuse.Physics.ForceField get_ForceField() [instance]
::g::Fuse::Physics::ForceField* ForceFieldEventArgs::ForceField()
{
    return _ForceField;
}

// private generated void set_ForceField(Fuse.Physics.ForceField value) [instance]
void ForceFieldEventArgs::ForceField(::g::Fuse::Physics::ForceField* value)
{
    _ForceField = value;
}

// public Fuse.Visual get_Visual() [instance]
...
// internal ForceFieldEventArgs New(Fuse.Physics.Body body, Fuse.Physics.ForceField field) [static]
...
// public delegate void ForceFieldEventHandler(object sender, Fuse.Physics.ForceFieldEventArgs args)
...
// public abstract class ForceFieldEventTrigger
// {
...
// public generated void remove_Handler(Fuse.Physics.ForceFieldEventHandler value) [instance]
...
// internal void OnTriggered(Fuse.Physics.Body body) [instance]
...
// public abstract class ForceFieldTrigger
// {
...
// protected generated ForceFieldTrigger() [instance]
void ForceFieldTrigger::ctor_5()
{
    ctor_4();
}

// public generated Fuse.Physics.ForceField get_ForceField() [instance]
::g::Fuse::Physics::ForceField* ForceFieldTrigger::ForceField()
{
    return _ForceField;
}

// public generated void set_ForceField(Fuse.Physics.ForceField value) [instance]
void ForceFieldTrigger::ForceField(::g::Fuse::Physics::ForceField* value)
{
    _ForceField = value;
}

// internal static void SetForce(Fuse.Physics.ForceField field, Fuse.Physics.Body body, float force) [static]
...
// public sealed class InForceFieldAnimation
// {
...
// public generated float get_From() [instance]
float InForceFieldAnimation::From()
{
    return _From;
}

// public generated void set_From(float value) [instance]
void InForceFieldAnimation::From(float value)
{
    _From = value;
}

// public generated float get_To() [instance]
float InForceFieldAnimation::To()
{
    return _To;
}

// public generated void set_To(float value) [instance]
void InForceFieldAnimation::To(float value)
{
    _To = value;
}

// public InForceFieldAnimation New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/World.uno
// -----------------------------------------------------------
...
uInterfaceType* IRule_typeof()
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("Update", NULL, NULL, offsetof(IRule, fp_Update), false, uVoid_typeof(), 2, ::g::Uno::Double_typeof(), ::g::Fuse::Physics::World_typeof()));
    return type;
}
// }

// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/PointAttractor.uno
// --------------------------------------------------------------------

// public sealed class PointAttractor
// {
...
// public generated PointAttractor()
void PointAttractor__ctor_4_fn(PointAttractor* __this)
{
    __this->ctor_4();
}

// private bool AnyStrongerForce(Fuse.Physics.Body b, float force, Fuse.Physics.World w)
...
// private float CalcForce(Fuse.Physics.Body b)
...
// private float3 DirectionTo(Fuse.Physics.Body b)
...
// private bool AnyStrongerForce(Fuse.Physics.Body b, float force, Fuse.Physics.World w) [instance]
...
// private float CalcForce(Fuse.Physics.Body b) [instance]
...
// private float Curve(float x) [instance]
float PointAttractor::Curve(float x)
{
    return (float)::g::Uno::Math::Sin((double)(x * x) * 3.1415926535897931);
}

// private float3 DirectionTo(Fuse.Physics.Body b) [instance]
...
// public generated bool get_Exclusive() [instance]
bool PointAttractor::Exclusive()
{
    return _Exclusive;
}

// public generated void set_Exclusive(bool value) [instance]
void PointAttractor::Exclusive(bool value)
{
    _Exclusive = value;
}

// public float3 get_Offset() [instance]
::g::Uno::Float3 PointAttractor::Offset()
{
    return _offset;
}

// public void set_Offset(float3 value) [instance]
...
// public float get_Strength() [instance]
float PointAttractor::Strength()
{
    return _strength;
}

// public void set_Strength(float value) [instance]
...
// private float3 get_TargetPoint() [instance]
...
// public generated PointAttractor New() [static]
...
// /usr/local/share/uno/Packages/Fuse.Physics/1.12.0/Spring.uno
// ------------------------------------------------------------
...
// public float get_Stiffness() [instance]
float Spring::Stiffness()
{
    return _stiffness;
}

// public void set_Stiffness(float value) [instance]
void Spring::Stiffness(float value)
{
    _stiffness = value;
}

// public Fuse.Visual get_Target() [instance]
::g::Fuse::Visual* Spring::Target()
{
    return _target;
}

// public void set_Target(Fuse.Visual value) [instance]
...
// public generated Spring New() [static]
Spring* Spring::New2()
{
...
// public sealed class WhileDragging
// {
...
// internal static void End(Fuse.Visual n) [static]
...
// public generated WhileDragging New() [static]
...
// internal void AddRule(Fuse.Physics.IRule rule)
void World__AddRule_fn(World* __this, uObject* rule)
{
    __this->AddRule(rule);
}

// internal Uno.Collections.List<Fuse.Physics.Body> get_Bodies()
...
// internal static Fuse.Physics.World FindWorld(Fuse.Visual n)
void World__FindWorld_fn(::g::Fuse::Visual* n, World** __retval)
{
    *__retval = World::FindWorld(n);
}

// public static bool GetIsPhysicsWorld(Fuse.Visual n)
...
// internal void AddRule(Fuse.Physics.IRule rule) [instance]
...
// internal Uno.Collections.List<Fuse.Physics.Body> get_Bodies() [instance]
::g::Uno::Collections::List* World::Bodies()
{
    return _bodies;
}

// private void EndSimulation() [instance]
...
// private void EnsureSimulation() [instance]
...
// internal Fuse.Physics.Body PinBody(Fuse.Visual node) [instance]
...
// internal void RemoveRule(Fuse.Physics.IRule rule) [instance]
...
// public Uno.Collections.IEnumerable<Fuse.Physics.IRule> get_Rules() [instance]
uObject* World::Rules()
{
...
// internal Fuse.Physics.Body TryGetBody(Fuse.Visual node) [instance]
...
// internal void UnpinBody(Fuse.Physics.Body body) [instance]
...
// internal static Fuse.Physics.World FindWorld(Fuse.Visual n) [static]
...
// public static bool GetIsPhysicsWorld(Fuse.Visual n) [static]
...
// public static void SetIsPhysicsWorld(Fuse.Visual n, bool isPhysicsWorld) [static]
...
// public static void SetIsPhysicsWorldStyle(Fuse.Visual n, bool isPhysicsWorld) [static]
