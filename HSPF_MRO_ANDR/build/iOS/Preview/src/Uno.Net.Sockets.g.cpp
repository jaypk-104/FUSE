...
// /usr/local/share/uno/Packages/Uno.Net.Sockets/1.12.0/Socket.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Sockets/1.12.0/NetworkStream.uno
// ----------------------------------------------------------------------
...
// public NetworkStream(Uno.Net.Sockets.Socket socket)
...
// public NetworkStream New(Uno.Net.Sockets.Socket socket)
...
// public NetworkStream(Uno.Net.Sockets.Socket socket) [instance]
...
// public NetworkStream New(Uno.Net.Sockets.Socket socket) [static]
...
// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType)
...
// public void Connect(Uno.Net.EndPoint endPoint)
...
// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType)
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode)
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how)
...
// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [instance]
...
// public void Connect(Uno.Net.EndPoint endPoint) [instance]
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) [instance]
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) [instance]
...
// private void UpdateLocalEndPoint() [instance]
...
// private void UpdateRemoteEndPoint() [instance]
...
// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [static]
...
// public static operator ==(Uno.Net.Sockets.Socket.SocketHandle left, Uno.Net.Sockets.Socket.SocketHandle right)
...
// public static operator ==(Uno.Net.Sockets.Socket.SocketHandle left, Uno.Net.Sockets.Socket.SocketHandle right) [static]
...
// internal sealed extern class SocketHelpers
// {
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port)
...
// public static int GetFamily(Uno.Net.Sockets.AddressFamily addressFamily)
void SocketHelpers__GetFamily_fn(int32_t* addressFamily, int32_t* __retval)
{
    *__retval = SocketHelpers::GetFamily(*addressFamily);
}

// public static Uno.Net.IPEndPoint GetLocalEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock)
...
// public static int GetProtocol(Uno.Net.Sockets.ProtocolType protocolType)
void SocketHelpers__GetProtocol_fn(int32_t* protocolType, int32_t* __retval)
{
    *__retval = SocketHelpers::GetProtocol(*protocolType);
}

// public static Uno.Net.IPEndPoint GetRemoteEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock)
...
// public static int GetSocketShudown(Uno.Net.Sockets.SocketShutdown socketShutdown)
...
// public static int GetType(Uno.Net.Sockets.SocketType socketType)
void SocketHelpers__GetType1_fn(int32_t* socketType, int32_t* __retval)
{
    *__retval = SocketHelpers::GetType1(*socketType);
}

// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode)
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how)
void SocketHelpers__Shutdown_fn(int* sock, int32_t* how, int32_t* __retval)
{
    *__retval = SocketHelpers::Shutdown(*sock, *how);
}

// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static]
...
// public static int GetFamily(Uno.Net.Sockets.AddressFamily addressFamily) [static]
...
// public static Uno.Net.IPEndPoint GetLocalEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) [static]
...
// public static int GetProtocol(Uno.Net.Sockets.ProtocolType protocolType) [static]
...
// public static Uno.Net.IPEndPoint GetRemoteEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) [static]
...
// public static int GetSocketShudown(Uno.Net.Sockets.SocketShutdown socketShutdown) [static]
...
// public static int GetType(Uno.Net.Sockets.SocketType socketType) [static]
...
// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) [static]
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) [static]
