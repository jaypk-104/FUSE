// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/MyToggle.g.uno.
...
static void MyToggle_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_IsActive", NULL, (void*)MyToggle__get_IsActive_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_IsActive", NULL, (void*)MyToggle__set_IsActive_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)MyToggle__New4_fn, 0, true, type, 0),
        new uFunction("get_PrimaryColor", NULL, (void*)MyToggle__get_PrimaryColor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_PrimaryColor", NULL, (void*)MyToggle__set_PrimaryColor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()),
        new uFunction("get_SecondaryColor", NULL, (void*)MyToggle__get_SecondaryColor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_SecondaryColor", NULL, (void*)MyToggle__set_SecondaryColor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()),
        new uFunction("SetIsActive", NULL, (void*)MyToggle__SetIsActive_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetPrimaryColor", NULL, (void*)MyToggle__SetPrimaryColor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetSecondaryColor", NULL, (void*)MyToggle__SetSecondaryColor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()));
}
...
{
    uStackFrame __("MyToggle", "InitializeUX()");
...
{
    uStackFrame __("MyToggle", "set_IsActive(bool)");
...
{
    uStackFrame __("MyToggle", "set_PrimaryColor(float4)");
...
{
    uStackFrame __("MyToggle", "set_SecondaryColor(float4)");
...
{
    uStackFrame __("MyToggle", "SetIsActive(bool,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("MyToggle", "SetPrimaryColor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("MyToggle", "SetSecondaryColor(float4,Uno.UX.IPropertyListener)");
