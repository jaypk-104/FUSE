...
// public sealed extern class ForeignDataView
// {
...
// private static ObjC.Object CreateNSDataFromByteArray(Uno.IntPtr rawUnoArray)
...
// private ForeignDataView(sbyte[] data) [instance]
...
// private ForeignDataView(Uno.Buffer buffer) [instance]
void ForeignDataView::ctor_5(::g::Uno::Buffer* buffer)
{
    ...
    Handle = uPtr(ForeignDataView::CreateNSDataFromByteArray(uPtr(buffer)->GetBytes()))->Handle;
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(byte[] unoArray) [static]
ForeignDataView* ForeignDataView::Create1(uArray* unoArray)
{
    return ForeignDataView::New4(unoArray);
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(sbyte[] unoArray) [static]
ForeignDataView* ForeignDataView::Create2(uArray* unoArray)
{
    return ForeignDataView::New5(unoArray);
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(Uno.Buffer unoBuffer) [static]
ForeignDataView* ForeignDataView::Create3(::g::Uno::Buffer* unoBuffer)
{
    return ForeignDataView::New6(unoBuffer);
}

// private static ObjC.Object CreateNSDataFromByteArray(Uno.IntPtr rawUnoArray) [static]
...
// private ForeignDataView New() [static]
...
// private ForeignDataView New(byte[] data) [static]
...
// private ForeignDataView New(sbyte[] data) [static]
...
// private ForeignDataView New(Uno.Buffer buffer) [static]
