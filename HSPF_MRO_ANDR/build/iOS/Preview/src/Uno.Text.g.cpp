...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Text/Ascii.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Text/Base64.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Text/Utf8.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Text/StringBuilder.uno
// ------------------------------------------------------------------------------
...
static void StringBuilder_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(8,
        ...
        new uFunction(".ctor", NULL, (void*)StringBuilder__New2_fn, 0, true, type, 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Uno.Text.StringBuilder", ".ctor(string)");
    _strings = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[2/*Uno.Collections.List<string>*/]));
    Append2(value);
}
