...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GL.uno
// -----------------------------------------------------------------
...
{
    type->Reflection.SetFunctions(78,
        ...
        new uFunction("BufferData", NULL, (void*)GL__BufferData2_fn, 0, true, uVoid_typeof(), 4, ::g::OpenGL::GLBufferTarget_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::IntPtr_typeof(), ::g::OpenGL::GLBufferUsage_typeof()),
        new uFunction("BufferData", NULL, (void*)GL__BufferData3_fn, 0, true, uVoid_typeof(), 3, ::g::OpenGL::GLBufferTarget_typeof(), ::g::Uno::Buffer_typeof(), ::g::OpenGL::GLBufferUsage_typeof()),
        new uFunction("BufferSubData", NULL, (void*)GL__BufferSubData1_fn, 0, true, uVoid_typeof(), 4, ::g::OpenGL::GLBufferTarget_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::IntPtr_typeof()),
        new uFunction("BufferSubData", NULL, (void*)GL__BufferSubData2_fn, 0, true, uVoid_typeof(), 3, ::g::OpenGL::GLBufferTarget_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Buffer_typeof()),
...
// public static void PixelStore(OpenGL.GLPixelStoreParameter pname, int param)
...
// public static void PixelStore(OpenGL.GLPixelStoreParameter pname, int param) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLEnums.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLBufferHandle.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLFramebufferHandle.uno
// ----------------------------------------------------------------------------------
...
// public extern enum GLPixelStoreParameter
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLProgramHandle.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLRenderbufferHandle.uno
// -----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLShaderHandle.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/OpenGL/GLTextureHandle.uno
// ------------------------------------------------------------------------------
