...
#include <Fuse.Controls.VideoImpl.VideoVisual.PlaybackTarget.h>
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/IVideoPlayer.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoContainer.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoVisual.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoDiskCache.uno
// ---------------------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoDiskCache.uno");
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoLoader.uno
// ------------------------------------------------------------------------
...
VideoVisual_type* VideoVisual_typeof()
{
    ...
    type->interface14.fp_get_Volume = (void(*)(uObject*, float*))VideoVisual__FuseTriggersIMediaPlaybackget_Volume_fn;
    type->interface14.fp_set_Volume = (void(*)(uObject*, float*))VideoVisual__FuseTriggersIMediaPlaybackset_Volume_fn;
    ...
    type->interface15.fp_get_CanPlayTo = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanPlayTo_fn;
    ...
    type->interface15.fp_get_CanStop = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanStop_fn;
    type->interface15.fp_get_CanPause = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanPause_fn;
    type->interface15.fp_get_CanResume = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanResume_fn;
...
void VideoVisual__Draw_fn(VideoVisual* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(uString::Const("StretchMode.Scale9 is deprecated for video-visual"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoVisual.uno"), 336, uString::Const("Draw"));
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(uString::Const("Video error"), e, __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoVisual.uno"), 116, uString::Const("Fuse.Controls.VideoImpl.IVideoCallbacks.OnError"));
}
...
// private float Fuse.Triggers.IMediaPlayback.get_Volume()
...
// private void Fuse.Triggers.IMediaPlayback.set_Volume(float value)
...
{
    ::g::Fuse::Diagnostics::Unsupported(uString::Const("IPlayback.PlayTo(double) not supported in Fuse.Controls.Video"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.12.0/VideoVisual.uno"), 186, uString::Const("Fuse.Triggers.IPlayback.PlayTo"));
}
