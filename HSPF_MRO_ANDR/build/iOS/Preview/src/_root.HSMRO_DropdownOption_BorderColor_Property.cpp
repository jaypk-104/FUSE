...
{
    uStackFrame __("HSMRO_DropdownOption_BorderColor_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_DropdownOption_BorderColor_Property", "Set(Uno.UX.PropertyObject,Fuse.Drawing.Brush,Uno.UX.IPropertyListener)");
