...
// /usr/local/share/uno/Packages/Uno.Testing/1.12.0/Assert.uno
// -----------------------------------------------------------

// public partial static class Assert
// {
// static generated Assert()
...
// public static void Fail(string message, [string filePath], [int lineNumber], [string memberName])
...
// public static void Fail(string message, [string filePath], [int lineNumber], [string memberName]) [static]
...
// private static void ReportFailure(string filePath, int lineNumber, string memberName, string expected, string actual) [static]
...
// /usr/local/share/uno/Packages/Uno.Testing/1.12.0/Exceptions/AssertionFailedException.uno
// ----------------------------------------------------------------------------------------

// internal sealed class AssertionFailedException
// {
...
// public AssertionFailedException New(string fileName, int line, string memberName, string expected, string actual)
...
// public AssertionFailedException(string fileName, int line, string memberName, string expected, string actual) [instance]
...
// public AssertionFailedException New(string fileName, int line, string memberName, string expected, string actual) [static]
...
// /usr/local/share/uno/Packages/Uno.Testing/1.12.0/NamedTestMethod.uno
// --------------------------------------------------------------------

// internal sealed class NamedTestMethod
// {
...
// /usr/local/share/uno/Packages/Uno.Testing/1.12.0/Registry.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Testing/1.12.0/Attributes/TestAttribute.uno
// -----------------------------------------------------------------------------
