...
// {
// static Handler_inq_appr()
static void Handler_inq_appr__cctor_2_fn(uType* __type)
{
    Handler_inq_appr::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Event_Handler"*/]);
}

static void Handler_inq_appr_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Event_Handler");
    ::STRINGS[1] = uString::Const("Pages/Menu_Customer/Confirm_inq_appr.ux");
    type->SetInterfaces(
    ...
    type->SetFields(44,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Handler_inq_appr::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Handler_inq_appr__New3_fn, 0, true, type, 0));
}
...
::g::Fuse::Triggers::Trigger_type* Handler_inq_appr_typeof()
{
    ...
    options.ObjectSize = sizeof(Handler_inq_appr);
    options.TypeSize = sizeof(::g::Fuse::Triggers::Trigger_type);
    type = (::g::Fuse::Triggers::Trigger_type*)uClassType::New("Handler_inq_appr", options);
    type->fp_build_ = Handler_inq_appr_build;
    type->fp_ctor_ = (void*)Handler_inq_appr__New3_fn;
    type->fp_cctor_ = Handler_inq_appr__cctor_2_fn;
...
// public Handler_inq_appr New()
void Handler_inq_appr__New3_fn(Handler_inq_appr** __retval)
{
    *__retval = Handler_inq_appr::New3();
}

::g::Uno::UX::Selector Handler_inq_appr::__selector0_;

// public Handler_inq_appr() [instance]
void Handler_inq_appr::ctor_6()
{
    ctor_5();
    InitializeUX();
}
...
void Handler_inq_appr::InitializeUX()
{
    EventName(Handler_inq_appr::__selector0_);
    SourceLineNumber(39);
    SourceFileName(::STRINGS[1/*"Pages/Menu_...*/]);
}

// public Handler_inq_appr New() [static]
Handler_inq_appr* Handler_inq_appr::New3()
{
    Handler_inq_appr* obj1 = (Handler_inq_appr*)uNew(Handler_inq_appr_typeof());
    obj1->ctor_6();
    return obj1;
}
// }
