...
{
    uStackFrame __("Fuse.Resources.HttpImageSourceImpl.BackgroundLoad", ".ctor(byte[],string,string,bool,Uno.Action<texture2D, Fuse.Resources.Exif.ImageOrientation>,Uno.Action<Uno.Exception>)");
    _data = data;
...
// public static void Remove(Fuse.Resources.ISoftDisposable item)
...
// public static void Remove(Fuse.Resources.ISoftDisposable item) [static]
...
// /usr/local/share/uno/Packages/Fuse.Common/1.12.0/Resources/DisposalPolicy.uno
// -----------------------------------------------------------------------------

// internal abstract class DisposalPolicy
// {
...
// protected generated DisposalPolicy()
void DisposalPolicy__ctor__fn(DisposalPolicy* __this)
{
    __this->ctor_();
}

// protected generated DisposalPolicy() [instance]
...
// internal sealed class ExpirationDisposalPolicy
// {
...
// public generated ExpirationDisposalPolicy()
void ExpirationDisposalPolicy__ctor_1_fn(ExpirationDisposalPolicy* __this)
{
    __this->ctor_1();
}

// public override sealed bool CanDispose(Fuse.Resources.DisposalRequest dr, bool pinned)
...
// public override sealed Fuse.Resources.DisposalPolicy Clone()
...
static void FileImageSource_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(9,
        ...
        new uFunction("get_File", NULL, (void*)FileImageSource__get_File_fn, 0, false, ::TYPES[6/*Uno.UX.FileSource*/], 0),
        new uFunction("set_File", NULL, (void*)FileImageSource__set_File_fn, 0, false, uVoid_typeof(), 1, ::TYPES[6/*Uno.UX.FileSource*/]),
        new uFunction(".ctor", NULL, (void*)FileImageSource__New2_fn, 0, true, type, 0),
        new uFunction(".ctor", NULL, (void*)FileImageSource__New3_fn, 0, true, type, 1, ::TYPES[6/*Uno.UX.FileSource*/]),
...
// public FileResource(Uno.UX.FileSource file)
void FileResource__ctor_1_fn(FileResource* __this, ::g::Uno::UX::FileSource* file)
{
    __this->ctor_1(file);
}

// public FileResource New(Uno.UX.FileSource file)
...
// public FileResource(Uno.UX.FileSource file) [instance]
...
// public FileResource New(Uno.UX.FileSource file) [static]
...
static void HttpImageSource_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(12,
        new uFunction("ClearCache", NULL, (void*)HttpImageSource__ClearCache_fn, 0, false, uVoid_typeof(), 0),
        ...
        new uFunction("get_DiskCache", NULL, (void*)HttpImageSource__get_DiskCache_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_DiskCache", NULL, (void*)HttpImageSource__set_DiskCache_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
...
// public HttpImageSource New(string url)
...
// public HttpImageSource(string url) [instance]
...
{
    uStackFrame __("Fuse.Resources.HttpImageSource", "ClearCache()");
...
// public HttpImageSource New(string url) [static]
...
{
    uStackFrame __("Fuse.Resources.HttpImageSourceCache", "GetCacheDirectory()");
...
{
    uStackFrame __("Fuse.Resources.HttpImageSourceCache", "GetFilenameBase(string)");
    HttpImageSourceCache_typeof()->Init();
...
{
    uStackFrame __("Fuse.Resources.HttpImageSourceCache", "GetUrl(string,bool)");
    HttpImageSourceCache_typeof()->Init();
    bool ret1;
    bool ret2;
    ::g::Uno::WeakReference* value = NULL;
...
{
    uStackFrame __("Fuse.Resources.HttpImageSourceImpl", "IsFileCacheExist(string&,string&)");
...
{
    uStackFrame __("Fuse.Resources.HttpImageSourceImpl", "SuccessCallback(texture2D,Fuse.Resources.Exif.ImageOrientation)");
    _loading = false;
    _orientation = orientation;
    SetTexture(texture);
}
...
// public void set_MatchDensity(float value)
...
// public float get_MatchDensity() [instance]
float MultiDensityImageSource::MatchDensity()
{
    return _matchDensity;
}

// public void set_MatchDensity(float value) [instance]
...
// internal abstract class PolicyDeferredDisposable
// {
...
// protected generated PolicyDeferredDisposable()
void PolicyDeferredDisposable__ctor__fn(PolicyDeferredDisposable* __this)
{
    __this->ctor_();
}

// public bool CanDispose(Fuse.Resources.DisposalRequest dr)
...
// protected generated PolicyDeferredDisposable() [instance]
void PolicyDeferredDisposable::ctor_()
{
}

// public bool CanDispose(Fuse.Resources.DisposalRequest dr) [instance]
...
// protected bool get_IsPinned() [instance]
bool PolicyDeferredDisposable::IsPinned()
{
    return false;
}

// public void MarkUsed() [instance]
...
// public sealed class ResourceBool
// {
...
// public sealed class ResourceFloat
// {
...
// public sealed class ResourceFloat2
// {
...
// public sealed class ResourceFloat3
// {
...
// protected generated ResourceSetter()
...
// protected generated ResourceSetter() [instance]
...
// public void set_Key(string value) [instance]
...
// internal sealed class RetainDisposalPolicy
// {
...
// public generated RetainDisposalPolicy()
...
// public generated RetainDisposalPolicy New()
void RetainDisposalPolicy__New1_fn(RetainDisposalPolicy** __retval)
{
    *__retval = RetainDisposalPolicy::New1();
}

// public generated RetainDisposalPolicy() [instance]
void RetainDisposalPolicy::ctor_1()
{
    ctor_();
}

// public generated RetainDisposalPolicy New() [static]
...
// public generated TextureImageSource()
...
// public generated TextureImageSource New()
...
// public generated TextureImageSource() [instance]
...
// public void set_Texture(texture2D value) [instance]
...
// public generated TextureImageSource New() [static]
