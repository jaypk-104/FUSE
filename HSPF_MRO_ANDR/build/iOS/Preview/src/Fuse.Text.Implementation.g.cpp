...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/BitArray.uno
// --------------------------------------------------------------------------
...
// private int Index(int i) [instance]
int32_t BitArray::Index(int32_t i)
{
    return i / 8;
}

// public bool get_Item(int i) [instance]
...
// public void set_Item(int i, bool value) [instance]
...
// private byte Mask(int i) [instance]
uint8_t BitArray::Mask(int32_t i)
{
    return (uint8_t)(1 << (i % 8));
}

// public BitArray New(int length) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/Util.uno
// ----------------------------------------------------------------------

// internal static extern class CString
// {
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/ICU.uno
// ---------------------------------------------------------------------

// public enum ICU.ErrorCode
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/FreeType.uno
// --------------------------------------------------------------------------

// internal static extern class FreeType
// {
...
// public static Uno.Content.Images.Bitmap Current_Glyph_Bitmap(Uno.IntPtr face)
...
// private static Uno.IntPtr Current_Glyph_Bitmap_Buffer(Uno.IntPtr face)
void FreeType__Current_Glyph_Bitmap_Buffer_fn(void** face, void** __retval)
{
    *__retval = FreeType::Current_Glyph_Bitmap_Buffer(*face);
}

// private static bool Current_Glyph_Bitmap_Buffer_Is_BGRA(Uno.IntPtr face)
...
// public static int2 Current_Glyph_Bitmap_Offset(Uno.IntPtr face)
...
// private static void Current_Glyph_Bitmap_Offset_Raw(Uno.IntPtr face, int& x, int& y)
...
// public static int2 Current_Glyph_Bitmap_Size(Uno.IntPtr face)
...
// private static void Current_Glyph_Bitmap_Size_Raw(Uno.IntPtr face, int& width, int& rows)
...
// public static void Load_Render_Glyph(Uno.IntPtr face, uint glyph)
void FreeType__Load_Render_Glyph_fn(void** face, uint32_t* glyph)
{
    FreeType::Load_Render_Glyph(*face, *glyph);
}

// private static int Load_Render_Glyph_Raw(Uno.IntPtr face, uint glyph)
...
// public static void New_Face(string fileName, int index, Uno.IntPtr& face)
void FreeType__New_Face_fn(uString* fileName, int32_t* index, void** face)
{
    FreeType::New_Face(fileName, *index, face);
}

// private static int New_Face_Raw(Uno.IntPtr library, byte[] fileName, int index, Uno.IntPtr& face)
...
// public static void New_Memory_Face(byte[] buffer, int index, Uno.IntPtr& face)
void FreeType__New_Memory_Face_fn(uArray* buffer, int32_t* index, void** face)
{
    FreeType::New_Memory_Face(buffer, *index, face);
}

// private static int New_Memory_Face_Raw(Uno.IntPtr library, byte[] buffer, int length, int index, Uno.IntPtr& face)
...
// public static string Style_Name(Uno.IntPtr face)
void FreeType__Style_Name_fn(void** face, uString** __retval)
{
    *__retval = FreeType::Style_Name(*face);
}

// private static Uno.IntPtr Style_Name_Raw(Uno.IntPtr face)
...
// public static void Activate_Size(Uno.IntPtr size) [static]
...
// public static Uno.Content.Images.Bitmap Current_Glyph_Bitmap(Uno.IntPtr face) [static]
...
// private static Uno.IntPtr Current_Glyph_Bitmap_Buffer(Uno.IntPtr face) [static]
void* FreeType::Current_Glyph_Bitmap_Buffer(void* face)
{
    return (void*)((FT_Face)face)->glyph->bitmap.buffer;
}

// private static bool Current_Glyph_Bitmap_Buffer_Is_BGRA(Uno.IntPtr face) [static]
...
// public static int2 Current_Glyph_Bitmap_Offset(Uno.IntPtr face) [static]
...
// private static void Current_Glyph_Bitmap_Offset_Raw(Uno.IntPtr face, int& x, int& y) [static]
...
// public static int2 Current_Glyph_Bitmap_Size(Uno.IntPtr face) [static]
...
// private static void Current_Glyph_Bitmap_Size_Raw(Uno.IntPtr face, int& width, int& rows) [static]
...
// public static int Descender(Uno.IntPtr face) [static]
int32_t FreeType::Descender(void* face)
{
    return (int)((FT_Face)face)->size->metrics.descender;
}

// public static void Done_Face(Uno.IntPtr face) [static]
...
// private static int Done_Face_Raw(Uno.IntPtr face) [static]
int32_t FreeType::Done_Face_Raw(void* face)
{
    return FT_Done_Face((FT_Face)face);
}

// public static void Done_Size(Uno.IntPtr size) [static]
...
// private static int Init_FreeType(Uno.IntPtr& library) [static]
int32_t FreeType::Init_FreeType(void** library)
{
    return FT_Init_FreeType((FT_Library*)library);
}

// public static void Load_Glyph(Uno.IntPtr face, uint glyph, int flags) [static]
...
// private static int Load_Glyph_Raw(Uno.IntPtr face, uint glyph, int flags) [static]
int32_t FreeType::Load_Glyph_Raw(void* face, uint32_t glyph, int32_t flags)
{
    return FT_Load_Glyph((FT_Face)face, glyph, flags);
}

// public static void Load_Render_Glyph(Uno.IntPtr face, uint glyph) [static]
...
// private static int Load_Render_Glyph_Raw(Uno.IntPtr face, uint glyph) [static]
...
// public static void New_Face(string fileName, int index, Uno.IntPtr& face) [static]
...
// private static int New_Face_Raw(Uno.IntPtr library, byte[] fileName, int index, Uno.IntPtr& face) [static]
...
// public static void New_Memory_Face(byte[] buffer, int index, Uno.IntPtr& face) [static]
...
// private static int New_Memory_Face_Raw(Uno.IntPtr library, byte[] buffer, int length, int index, Uno.IntPtr& face) [static]
...
// public static void New_Size(Uno.IntPtr face, Uno.IntPtr& size) [static]
...
// private static int New_Size_Raw(Uno.IntPtr face, Uno.IntPtr& size) [static]
int32_t FreeType::New_Size_Raw(void* face, void** size)
{
    return FT_New_Size((FT_Face)face, (FT_Size*)size);
}

// public static int Num_Faces(Uno.IntPtr face) [static]
int32_t FreeType::Num_Faces(void* face)
{
    return (int)((FT_Face)face)->num_faces;
}

// public static int Num_Glyphs(Uno.IntPtr face) [static]
int32_t FreeType::Num_Glyphs(void* face)
{
    return (int)((FT_Face)face)->num_glyphs;
}

// public static void Set_Pixel_Sizes(Uno.IntPtr face, int w, int h, float& scale) [static]
...
// private static int Set_Pixel_Sizes_Raw(Uno.IntPtr rawFace, int w, int h, float& scale) [static]
...
// public static string Style_Name(Uno.IntPtr face) [static]
uString* FreeType::Style_Name(void* face)
{
    uStackFrame __("Fuse.Text.Implementation.FreeType", "Style_Name(Uno.IntPtr)");
    return ::g::Fuse::Text::Implementation::CString::ToString(FreeType::Style_Name_Raw(face));
}

// private static Uno.IntPtr Style_Name_Raw(Uno.IntPtr face) [static]
void* FreeType::Style_Name_Raw(void* face)
{
    return ((FT_Face)face)->style_name;
}

// private static Uno.IntPtr get_Library() [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/FreeTypeFontFace.uno
// ----------------------------------------------------------------------------------

// internal sealed extern class FreeTypeFont
// {
...
// internal FreeTypeFont(Uno.IntPtr ftFace, Uno.IntPtr ftSize, int pixelSize, float scale)
...
// internal FreeTypeFont New(Uno.IntPtr ftFace, Uno.IntPtr ftSize, int pixelSize, float scale)
...
// internal FreeTypeFont(Uno.IntPtr ftFace, Uno.IntPtr ftSize, int pixelSize, float scale) [instance]
...
// internal FreeTypeFont New(Uno.IntPtr ftFace, Uno.IntPtr ftSize, int pixelSize, float scale) [static]
...
// internal sealed extern class FreeTypeFontFace
// {
// static generated FreeTypeFontFace()
...
// public FreeTypeFontFace(byte[] buffer, int index, Uno.Predicate<string> stylePredicate)
...
// public FreeTypeFontFace(string fileName, int index, Uno.Predicate<string> stylePredicate)
...
// public FreeTypeFontFace New(byte[] buffer, int index, Uno.Predicate<string> stylePredicate)
...
// public FreeTypeFontFace New(string fileName, int index, Uno.Predicate<string> stylePredicate)
...
// public FreeTypeFontFace(byte[] buffer, int index, Uno.Predicate<string> stylePredicate) [instance]
...
// public FreeTypeFontFace(string fileName, int index, Uno.Predicate<string> stylePredicate) [instance]
...
// public string get_FamilyName() [instance]
...
// public string get_StyleName() [instance]
...
// public FreeTypeFontFace New(byte[] buffer, int index, Uno.Predicate<string> stylePredicate) [static]
...
// public FreeTypeFontFace New(string fileName, int index, Uno.Predicate<string> stylePredicate) [static]
...
// internal static extern class FT_Error
// {
...
// private static Uno.IntPtr ErrorCString(int err)
...
// public static void Check(int err) [static]
...
// private static Uno.IntPtr ErrorCString(int err) [static]
...
// private static string ErrorString(int err) [static]
uString* FT_Error::ErrorString(int32_t err)
{
    uStackFrame __("Fuse.Text.Implementation.FT_Error", "ErrorString(int)");
    return ::g::Fuse::Text::Implementation::CString::ToString(FT_Error::ErrorCString(err));
}
// }

// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/Harfbuzz.uno
// --------------------------------------------------------------------------

// internal static extern class Harfbuzz
// {
...
// public static Uno.IntPtr buffer_create(Uno.IntPtr font, Fuse.Text.Substring text, bool ltr)
...
// private static Uno.IntPtr buffer_create_Raw(Uno.IntPtr font, string text, int offset, int length, bool ltr)
...
// public static void font_set_scale(Uno.IntPtr hbFont, int x_scale, int y_scale)
...
// private static Uno.IntPtr buffer_create_Raw(Uno.IntPtr font, string text, int offset, int length, bool ltr) [static]
...
// public static void buffer_destroy(Uno.IntPtr buffer) [static]
void Harfbuzz::buffer_destroy(void* buffer)
{
    hb_buffer_destroy((hb_buffer_t*)buffer);
}

// public static uint buffer_get_length(Uno.IntPtr buffer) [static]
uint32_t Harfbuzz::buffer_get_length(void* buffer)
{
    return hb_buffer_get_length((hb_buffer_t*)buffer);
}

// public static extern Uno.IntPtr ct_face_create(Uno.IntPtr cgFont) [static]
void* Harfbuzz::ct_face_create(void* cgFont)
{
    return hb_coretext_face_create((CGFontRef)cgFont);
}

// public static void face_destroy(Uno.IntPtr face) [static]
void Harfbuzz::face_destroy(void* face)
{
    hb_face_destroy((hb_face_t*)face);
}

// public static Uno.IntPtr font_create(Uno.IntPtr hbFace) [static]
void* Harfbuzz::font_create(void* hbFace)
{
    return hb_font_create((hb_face_t*)hbFace);
}

// public static void font_destroy(Uno.IntPtr font) [static]
void Harfbuzz::font_destroy(void* font)
{
    hb_font_destroy((hb_font_t*)font);
}

// public static void font_get_h_extents(Uno.IntPtr font, float& ascender, float& descender, float& lineGap) [static]
...
// public static void font_set_scale(Uno.IntPtr hbFont, int x_scale, int y_scale) [static]
...
// public static void ft_font_cached_set_funcs(Uno.IntPtr hbFont) [static]
void Harfbuzz::ft_font_cached_set_funcs(void* hbFont)
{
    hb_ft_font_cached_set_funcs((hb_font_t*)hbFont);
}

// public static Uno.IntPtr ft_font_create(Uno.IntPtr face) [static]
...
// public static void ft_font_set_default_load_flags(Uno.IntPtr hbFont) [static]
void Harfbuzz::ft_font_set_default_load_flags(void* hbFont)
{
    hb_ft_font_set_load_flags((hb_font_t*)hbFont, FT_LOAD_DEFAULT);
}

// public static void get_shape_data(Uno.IntPtr font, Uno.IntPtr buffer, byte[] output) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/HarfbuzzFont.uno
// ------------------------------------------------------------------------------

// internal abstract extern class HarfbuzzFont
// {
...
// public override float get_Descender()
...
// public override float get_LineHeight()
...
// protected virtual float get_Scale()
void HarfbuzzFont__get_Scale_fn(HarfbuzzFont* __this, float* __retval)
{
    return *__retval = 1.0f, void();
}

// public override Fuse.Text.PositionedGlyph[] Shape(Fuse.Text.Substring text, int fontIndex, Fuse.Text.TextDirection dir)
...
// internal HarfbuzzFont(Uno.IntPtr hbFont) [instance]
...
// internal static extern class ICU
// {
...
// public static void CheckError(Fuse.Text.Implementation.ICU.ErrorCode errorCode)
void ICU__CheckError_fn(int32_t* errorCode)
{
    ICU::CheckError(*errorCode);
}

// private static Uno.IntPtr ErrorCString(Fuse.Text.Implementation.ICU.ErrorCode errorCode)
void ICU__ErrorCString_fn(int32_t* errorCode, void** __retval)
{
    *__retval = ICU::ErrorCString(*errorCode);
}

// private static int IsFailure(Fuse.Text.Implementation.ICU.ErrorCode errorCode)
void ICU__IsFailure_fn(int32_t* errorCode, int32_t* __retval)
{
    *__retval = ICU::IsFailure(*errorCode);
}

// public static void CheckError(Fuse.Text.Implementation.ICU.ErrorCode errorCode) [static]
...
// private static Uno.IntPtr ErrorCString(Fuse.Text.Implementation.ICU.ErrorCode errorCode) [static]
void* ICU::ErrorCString(int32_t errorCode)
{
    return (void*)u_errorName((::UErrorCode)errorCode);
}

// private static int IsFailure(Fuse.Text.Implementation.ICU.ErrorCode errorCode) [static]
...
// internal static extern class Memory
// {
...
// public static void Copy(byte[] dst, Uno.IntPtr src, int len)
void Memory__Copy_fn(uArray* dst, void** src, int32_t* len)
{
    Memory::Copy(dst, *src, *len);
}

// public static void Copy(byte[] dst, Uno.IntPtr src, int len) [static]
...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/UBrk.uno
// ----------------------------------------------------------------------

// internal static extern class UBrk
// {
...
// public static Fuse.Text.Implementation.BitArray GetSoftLineBreaks(Fuse.Text.Substring text)
...
// public static Fuse.Text.Implementation.ICU.ErrorCode ubrk(string text, int offset, int length, byte[] outBitArray)
...
// public static Fuse.Text.Implementation.BitArray GetSoftLineBreaks(Fuse.Text.Substring text) [static]
...
// public static Fuse.Text.Implementation.ICU.ErrorCode ubrk(string text, int offset, int length, byte[] outBitArray) [static]
