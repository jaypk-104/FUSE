...
// /usr/local/share/uno/Packages/Fuse.iOS/1.12.0/Support.uno
// ---------------------------------------------------------
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale)
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale)
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale)
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale)
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale)
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale)
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale)
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale)
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale)
void Support__CGSizeToUnoInt2_fn(CGSize* size, float* scale, ::g::Uno::Int2* __retval)
{
    *__retval = Support::CGSizeToUnoInt2(*size, *scale);
}

// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image)
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image)
void Support__UIImageGetSize_fn(::UIImage ** image, ::g::Uno::Int2* __retval)
{
    *__retval = Support::UIImageGetSize(*image);
}

// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image)
void Support__UIImageToRGBA8888_fn(::UIImage ** _image, uArray** __retval)
{
    *__retval = Support::UIImageToRGBA8888(*_image);
}

// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) [static]
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) [static]
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) [static]
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) [static]
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) [static]
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) [static]
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) [static]
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) [static]
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) [static]
...
// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) [static]
::g::Uno::Graphics::Texture2D* Support::CreateTextureFromImage(::UIImage * image)
{
    ...
    texture->Update4(bitmap->Ptr());
    return texture;
}

// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) [static]
...
// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) [static]
