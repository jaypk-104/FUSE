...
{
    uStackFrame __("HSMRO_FuseTriggersPullToReload_IsLoading_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseTriggersPullToReload_IsLoading_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
