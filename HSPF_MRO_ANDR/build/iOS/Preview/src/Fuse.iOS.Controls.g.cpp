...
static void WebView_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/1.12.0/iOS/WebView.uno");
    ...
    type->Reflection.SetFunctions(40,
        ...
        new uFunction("Eval", NULL, (void*)WebView__Eval1_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::TYPES[1/*Uno.Action<string>*/]),
...
// private WebView(Fuse.Controls.WebView webViewHost, ObjC.Object wvHandle, string[] schemes)
...
// public static Fuse.iOS.Controls.WebView Create(Fuse.Controls.WebView webViewHost, string[] schemes)
...
// public void Eval(string js, Uno.Action<string> onResult)
...
// public void add_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value)
void WebView__add_HistoryChanged_fn(WebView* __this, uDelegate* value)
{
    __this->add_HistoryChanged(value);
}

// public void remove_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value)
...
// private WebView New(Fuse.Controls.WebView webViewHost, ObjC.Object wvHandle, string[] schemes)
...
// private void OnFinishNavigation()
...
// private WebView(Fuse.Controls.WebView webViewHost, ObjC.Object wvHandle, string[] schemes) [instance]
void WebView::ctor_5(::g::Fuse::Controls::WebView* webViewHost, ::g::ObjC::Object* wvHandle, uArray* schemes)
{
    uStackFrame __("Fuse.iOS.Controls.WebView", ".ctor(Fuse.Controls.WebView,ObjC.Object,string[])");
    ctor_4(wvHandle);
...
// public string get_DocumentTitle() [instance]
...
// public void Eval(string js, Uno.Action<string> onResult) [instance]
...
// public void add_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) [instance]
...
// public void remove_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) [instance]
...
// public bool get_Loading() [instance]
...
// private void OnBeginNavigation() [instance]
...
{
    uStackFrame __("Fuse.iOS.Controls.WebView", "OnCustomURI(string)");
...
// private void OnFinishNavigation() [instance]
...
void WebView::OnLowMemory()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[2/*"low mem in ...*/], 0, ::STRINGS[3/*"/usr/local/...*/], 205);
...
// private void StartProgressUpdate() [instance]
...
{
    uStackFrame __("Fuse.iOS.Controls.WebView", "add_URISchemeHandler(Uno.EventHandler)");
...
{
    uStackFrame __("Fuse.iOS.Controls.WebView", "remove_URISchemeHandler(Uno.EventHandler)");
...
// public static Fuse.iOS.Controls.WebView Create(Fuse.Controls.WebView webViewHost, string[] schemes) [static]
WebView* WebView::Create(::g::Fuse::Controls::WebView* webViewHost, uArray* schemes)
{
    uStackFrame __("Fuse.iOS.Controls.WebView", "Create(Fuse.Controls.WebView,string[])");
...
// private WebView New(Fuse.Controls.WebView webViewHost, ObjC.Object wvHandle, string[] schemes) [static]
