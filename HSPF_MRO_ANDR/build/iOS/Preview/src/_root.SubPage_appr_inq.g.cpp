...
// /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/SubPage_appr_inq.g.uno
// -------------------------------------------------------------------------------------
...
static void SubPage_appr_inq_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SubPage_appr_inq__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
{
    uStackFrame __("SubPage_appr_inq", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
{
    uStackFrame __("SubPage_appr_inq", "InitializeUX()");
...
static void SubPage_appr_inq__Template_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SubPage_appr_inq__Template__New2_fn, 0, true, type, 2, ::g::SubPage_appr_inq_typeof(), ::g::SubPage_appr_inq_typeof()));
}
...
{
    uStackFrame __("SubPage_appr_inq.Template", "New()");
...
static void SubPage_appr_inq__Template1_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SubPage_appr_inq__Template1__New2_fn, 0, true, type, 2, ::g::SubPage_appr_inq_typeof(), ::g::SubPage_appr_inq_typeof()));
}
...
{
    uStackFrame __("SubPage_appr_inq.Template1", "New()");
    ::g::Fuse::Controls::DockPanel* __self1 = ::g::Fuse::Controls::DockPanel::New4();
...
static void SubPage_appr_inq__Template2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SubPage_appr_inq__Template2__New2_fn, 0, true, type, 2, ::g::SubPage_appr_inq_typeof(), ::g::SubPage_appr_inq_typeof()));
}
...
{
    uStackFrame __("SubPage_appr_inq.Template2", "New()");
    ::g::Fuse::Controls::DockPanel* __self1 = ::g::Fuse::Controls::DockPanel::New4();
