// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/Confirm_inq_appr.g.uno.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.Confirm_inq_appr.h>
#include <_root.HSMRO_accessor_Confirm_inq_appr_Show.h>
#include <_root.HSMRO_accessor_Confirm_inq_appr_Text.h>
...
// public partial sealed class Confirm_inq_appr
// {
// static Confirm_inq_appr()
static void Confirm_inq_appr__cctor_4_fn(uType* __type)
{
    Confirm_inq_appr::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Show"*/]);
    Confirm_inq_appr::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
    Confirm_inq_appr::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"Offset"*/]);
    Confirm_inq_appr::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"Color"*/]);
    Confirm_inq_appr::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"HitTestMode"*/]);
    Confirm_inq_appr::__selector5_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Opacity"*/]);
    Confirm_inq_appr::__selector6_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[6/*"root"*/]);
    Confirm_inq_appr::__selector7_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[7/*"AddToBasket...*/]);
    Confirm_inq_appr::__selector8_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[8/*"addTaskButt...*/]);
    Confirm_inq_appr::__selector9_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[9/*"text"*/]);
    Confirm_inq_appr::__selector10_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[10/*"ButtonsPanel"*/]);
    Confirm_inq_appr::__selector11_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[11/*"Event_Handler"*/]);
    Confirm_inq_appr::__selector12_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[12/*"show"*/]);
}

static void Confirm_inq_appr_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("Pages/Menu_Customer/Confirm_inq_appr.ux");
    ::STRINGS[14] = uString::Const("Yes");
    ::STRINGS[15] = uString::Const("No");
    ::STRINGS[16] = uString::Const("Handler_inq_appr");
    ...
    type->SetDependencies(
        ...
        ::g::HSMRO_accessor_Confirm_inq_appr_Show_typeof(),
        ::g::HSMRO_accessor_Confirm_inq_appr_Text_typeof(),
        ::g::MainView_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(120,
        ::g::Uno::Bool_typeof(), offsetof(Confirm_inq_appr, _field_Show), 0,
        uObject_typeof(), offsetof(Confirm_inq_appr, _field_Handler_inq_appr), 0,
        ::g::Uno::String_typeof(), offsetof(Confirm_inq_appr, _field_Text), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL), offsetof(Confirm_inq_appr, this_Show_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Confirm_inq_appr, text_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::UX::Size2_typeof(), NULL), offsetof(Confirm_inq_appr, text_Offset_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(Confirm_inq_appr, addTaskButtons_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::UX::Size2_typeof(), NULL), offsetof(Confirm_inq_appr, ButtonsPanel_Offset_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Elements::HitTestMode_typeof(), NULL), offsetof(Confirm_inq_appr, AddToBasketPanel_HitTestMode_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float_typeof(), NULL), offsetof(Confirm_inq_appr, AddToBasketPanel_Opacity_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL), offsetof(Confirm_inq_appr, show_Value_inst), 0,
        ::g::Fuse::Controls::Panel_typeof(), offsetof(Confirm_inq_appr, AddToBasketPanel), 0,
        ::g::Fuse::Controls::Rectangle_typeof(), offsetof(Confirm_inq_appr, addTaskButtons), 0,
        ::g::Fuse::Controls::Text_typeof(), offsetof(Confirm_inq_appr, text), 0,
        ::g::Fuse::Controls::StackPanel_typeof(), offsetof(Confirm_inq_appr, ButtonsPanel), 0,
        ::g::Fuse::Triggers::WhileTrue_typeof(), offsetof(Confirm_inq_appr, show), 0,
        ::g::Fuse::UserEvent_typeof(), offsetof(Confirm_inq_appr, Event_Handler), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector2_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector3_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector4_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector5_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector6_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector7_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector8_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector9_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector10_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector11_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Confirm_inq_appr::__selector12_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(10,
        new uFunction("get_Handler_inq_appr", NULL, (void*)Confirm_inq_appr__get_Handler_inq_appr_fn, 0, false, uObject_typeof(), 0),
        new uFunction("set_Handler_inq_appr", NULL, (void*)Confirm_inq_appr__set_Handler_inq_appr_fn, 0, false, uVoid_typeof(), 1, uObject_typeof()),
        new uFunction(".ctor", NULL, (void*)Confirm_inq_appr__New4_fn, 0, true, type, 0),
        new uFunction("SetHandler_inq_appr", NULL, (void*)Confirm_inq_appr__SetHandler_inq_appr_fn, 0, false, uVoid_typeof(), 2, uObject_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetShow", NULL, (void*)Confirm_inq_appr__SetShow_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetText", NULL, (void*)Confirm_inq_appr__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Show", NULL, (void*)Confirm_inq_appr__get_Show_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_Show", NULL, (void*)Confirm_inq_appr__set_Show_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction("get_Text", NULL, (void*)Confirm_inq_appr__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)Confirm_inq_appr__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}

::g::Fuse::Controls::Panel_type* Confirm_inq_appr_typeof()
{
    ...
    options.ObjectSize = sizeof(Confirm_inq_appr);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("Confirm_inq_appr", options);
    type->fp_build_ = Confirm_inq_appr_build;
    type->fp_ctor_ = (void*)Confirm_inq_appr__New4_fn;
    type->fp_cctor_ = Confirm_inq_appr__cctor_4_fn;
...
void Confirm_inq_appr__ctor_7_fn(Confirm_inq_appr* __this)
{
    __this->ctor_7();
}

// public object get_Handler_inq_appr()
void Confirm_inq_appr__get_Handler_inq_appr_fn(Confirm_inq_appr* __this, uObject** __retval)
{
    *__retval = __this->Handler_inq_appr();
}

// public void set_Handler_inq_appr(object value)
void Confirm_inq_appr__set_Handler_inq_appr_fn(Confirm_inq_appr* __this, uObject* value)
{
    __this->Handler_inq_appr(value);
}

// private void InitializeUX()
void Confirm_inq_appr__InitializeUX_fn(Confirm_inq_appr* __this)
{
    __this->InitializeUX();
}

// public Confirm_inq_appr New()
void Confirm_inq_appr__New4_fn(Confirm_inq_appr** __retval)
{
    *__retval = Confirm_inq_appr::New4();
}

// public void SetHandler_inq_appr(object value, Uno.UX.IPropertyListener origin)
void Confirm_inq_appr__SetHandler_inq_appr_fn(Confirm_inq_appr* __this, uObject* value, uObject* origin)
{
    __this->SetHandler_inq_appr(value, origin);
}

// public void SetShow(bool value, Uno.UX.IPropertyListener origin)
void Confirm_inq_appr__SetShow_fn(Confirm_inq_appr* __this, bool* value, uObject* origin)
{
    __this->SetShow(*value, origin);
}

// public void SetText(string value, Uno.UX.IPropertyListener origin)
void Confirm_inq_appr__SetText_fn(Confirm_inq_appr* __this, uString* value, uObject* origin)
{
    __this->SetText(value, origin);
}

// public bool get_Show()
void Confirm_inq_appr__get_Show_fn(Confirm_inq_appr* __this, bool* __retval)
{
    *__retval = __this->Show();
}

// public void set_Show(bool value)
void Confirm_inq_appr__set_Show_fn(Confirm_inq_appr* __this, bool* value)
{
    __this->Show(*value);
}

// public string get_Text()
void Confirm_inq_appr__get_Text_fn(Confirm_inq_appr* __this, uString** __retval)
{
    *__retval = __this->Text();
}

// public void set_Text(string value)
void Confirm_inq_appr__set_Text_fn(Confirm_inq_appr* __this, uString* value)
{
    __this->Text(value);
}

::g::Uno::UX::Selector Confirm_inq_appr::__selector0_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector1_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector2_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector3_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector4_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector5_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector6_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector7_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector8_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector9_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector10_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector11_;
::g::Uno::UX::Selector Confirm_inq_appr::__selector12_;

// public Confirm_inq_appr() [instance]
void Confirm_inq_appr::ctor_7()
{
    uStackFrame __("Confirm_inq_appr", ".ctor()");
    ctor_6();
    InitializeUX();
}

// public object get_Handler_inq_appr() [instance]
uObject* Confirm_inq_appr::Handler_inq_appr()
{
    return _field_Handler_inq_appr;
}

// public void set_Handler_inq_appr(object value) [instance]
void Confirm_inq_appr::Handler_inq_appr(uObject* value)
{
    uStackFrame __("Confirm_inq_appr", "set_Handler_inq_appr(object)");
    SetHandler_inq_appr(value, NULL);
}

// private void InitializeUX() [instance]
void Confirm_inq_appr::InitializeUX()
{
    uStackFrame __("Confirm_inq_appr", "InitializeUX()");
    this_Show_inst = ::g::HSMRO_Confirm_inq_appr_Show_Property::New1(this, Confirm_inq_appr::__selector0_);
    ::g::Fuse::Reactive::Constant* temp = ::g::Fuse::Reactive::Constant::New1(this);
    text = ::g::Fuse::Controls::Text::New3();
    text_Value_inst = ::g::HSMRO_FuseControlsTextControl_Value_Property::New1(text, Confirm_inq_appr::__selector1_);
    ::g::Fuse::Reactive::Property* temp1 = ::g::Fuse::Reactive::Property::New1(temp, ::g::HSMRO_accessor_Confirm_inq_appr_Text::Singleton());
    text_Offset_inst = ::g::HSMRO_FuseElementsElement_Offset_Property::New1(text, Confirm_inq_appr::__selector2_);
    addTaskButtons = ::g::Fuse::Controls::Rectangle::New3();
    addTaskButtons_Color_inst = ::g::HSMRO_FuseControlsShape_Color_Property::New1(addTaskButtons, Confirm_inq_appr::__selector3_);
    ButtonsPanel = ::g::Fuse::Controls::StackPanel::New4();
    ButtonsPanel_Offset_inst = ::g::HSMRO_FuseElementsElement_Offset_Property::New1(ButtonsPanel, Confirm_inq_appr::__selector2_);
    AddToBasketPanel = ::g::Fuse::Controls::Panel::New3();
    AddToBasketPanel_HitTestMode_inst = ::g::HSMRO_FuseElementsElement_HitTestMode_Property::New1(AddToBasketPanel, Confirm_inq_appr::__selector4_);
    AddToBasketPanel_Opacity_inst = ::g::HSMRO_FuseElementsElement_Opacity_Property::New1(AddToBasketPanel, Confirm_inq_appr::__selector5_);
    ::g::Fuse::Reactive::Constant* temp2 = ::g::Fuse::Reactive::Constant::New1(this);
    show = ::g::Fuse::Triggers::WhileTrue::New2();
    show_Value_inst = ::g::HSMRO_FuseTriggersWhileBool_Value_Property::New1(show, Confirm_inq_appr::__selector1_);
    ::g::Fuse::Reactive::Property* temp3 = ::g::Fuse::Reactive::Property::New1(temp2, ::g::HSMRO_accessor_Confirm_inq_appr_Show::Singleton());
    ...
    Name(Confirm_inq_appr::__selector6_);
    SourceLineNumber(1);
    ...
    uPtr(AddToBasketPanel)->Name(Confirm_inq_appr::__selector7_);
    ...
    uPtr(addTaskButtons)->Name(Confirm_inq_appr::__selector8_);
    ...
    uPtr(text)->Name(Confirm_inq_appr::__selector9_);
    ...
    uPtr(ButtonsPanel)->Name(Confirm_inq_appr::__selector10_);
    ...
    temp12->EventName(Confirm_inq_appr::__selector11_);
    ...
    uPtr(show)->Name(Confirm_inq_appr::__selector12_);
    ...
    uPtr(Event_Handler)->Name(Confirm_inq_appr::__selector11_);
...
// public void SetHandler_inq_appr(object value, Uno.UX.IPropertyListener origin) [instance]
void Confirm_inq_appr::SetHandler_inq_appr(uObject* value, uObject* origin)
{
    uStackFrame __("Confirm_inq_appr", "SetHandler_inq_appr(object,Uno.UX.IPropertyListener)");

    if (value != _field_Handler_inq_appr)
    {
        _field_Handler_inq_appr = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[16/*"Handler_inq...*/]), origin);
    }
}

// public void SetShow(bool value, Uno.UX.IPropertyListener origin) [instance]
void Confirm_inq_appr::SetShow(bool value, uObject* origin)
{
    uStackFrame __("Confirm_inq_appr", "SetShow(bool,Uno.UX.IPropertyListener)");
...
void Confirm_inq_appr::SetText(uString* value, uObject* origin)
{
    uStackFrame __("Confirm_inq_appr", "SetText(string,Uno.UX.IPropertyListener)");

    if (::g::Uno::String::op_Inequality(value, _field_Text))
    {
        _field_Text = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[17/*"Text"*/]), origin);
    }
}

// public bool get_Show() [instance]
bool Confirm_inq_appr::Show()
{
    return _field_Show;
}

// public void set_Show(bool value) [instance]
void Confirm_inq_appr::Show(bool value)
{
    uStackFrame __("Confirm_inq_appr", "set_Show(bool)");
    SetShow(value, NULL);
}

// public string get_Text() [instance]
uString* Confirm_inq_appr::Text()
{
    return _field_Text;
}

// public void set_Text(string value) [instance]
void Confirm_inq_appr::Text(uString* value)
{
    uStackFrame __("Confirm_inq_appr", "set_Text(string)");
    SetText(value, NULL);
}

// public Confirm_inq_appr New() [static]
Confirm_inq_appr* Confirm_inq_appr::New4()
{
    Confirm_inq_appr* obj1 = (Confirm_inq_appr*)uNew(Confirm_inq_appr_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
