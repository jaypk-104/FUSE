...
// /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/CycleButton2.g.uno
// ---------------------------------------------------------------------------------
...
static void CycleButton2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        new uFunction("get_CurrentType", NULL, (void*)CycleButton2__get_CurrentType_fn, 0, false, ::g::Uno::Int_typeof(), 0),
        new uFunction("set_CurrentType", NULL, (void*)CycleButton2__set_CurrentType_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Int_typeof()),
        new uFunction(".ctor", NULL, (void*)CycleButton2__New4_fn, 0, true, type, 0),
        new uFunction("SetCurrentType", NULL, (void*)CycleButton2__SetCurrentType_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Int_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetTypes", NULL, (void*)CycleButton2__SetTypes_fn, 0, false, uVoid_typeof(), 2, uObject_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Types", NULL, (void*)CycleButton2__get_Types_fn, 0, false, uObject_typeof(), 0),
        new uFunction("set_Types", NULL, (void*)CycleButton2__set_Types_fn, 0, false, uVoid_typeof(), 1, uObject_typeof()));
}
...
{
    uStackFrame __("CycleButton2", ".ctor()");
    ctor_7();
    InitializeUX();
}
...
{
    uStackFrame __("CycleButton2", "set_CurrentType(int)");
...
{
    uStackFrame __("CycleButton2", "InitializeUX()");
...
{
    uStackFrame __("CycleButton2", "SetCurrentType(int,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("CycleButton2", "SetTypes(object,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("CycleButton2", "set_Types(object)");
    SetTypes(value, NULL);
}
...
static void CycleButton2__Template_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)CycleButton2__Template__New2_fn, 0, true, type, 2, ::g::CycleButton2_typeof(), ::g::CycleButton2_typeof()));
}
...
{
    uStackFrame __("CycleButton2.Template", "New()");
