...
// /usr/local/share/uno/Packages/Fuse.Testing/1.12.0/JavaScriptTest.uno
// --------------------------------------------------------------------
...
// public JavaScriptTest New(Uno.UX.NameTable nameTable) [static]
...
// /usr/local/share/uno/Packages/Fuse.Testing/1.12.0/TestRootPanel.uno
// -------------------------------------------------------------------

// private enum TestRootPanel.StepFlags
...
// public sealed class TestRootPanel
// {
...
// private Fuse.Testing.TestFailedException FindTestFailedException(Uno.Exception e)
...
// private void IncrementFrameImpl([float elapsedTime], [Fuse.Testing.TestRootPanel.StepFlags flags])
...
// private Fuse.Testing.TestFailedException FindTestFailedException(Uno.Exception e) [instance]
...
// private void IncrementFrameImpl([float elapsedTime], [Fuse.Testing.TestRootPanel.StepFlags flags]) [instance]
...
// private void OnDiagnostic(Fuse.Diagnostic d) [instance]
...
// internal Fuse.Testing.TestRootViewport get_RootViewport() [instance]
::g::Fuse::Testing::TestRootViewport* TestRootPanel::RootViewport()
{
    return _rootViewport;
}

// public void RunTest() [instance]
        ...
        {
            {
                ...
                catch (const uThrowable& __t)
                {
                    ...
                    if (testFailedException != NULL)
                        ::g::Uno::Testing::Assert::Fail(uPtr(testFailedException)->Message(), uString::Const("/usr/local/share/uno/Packages/Fuse.Testing/1.12.0/TestRootPanel.uno"), 115, uString::Const("RunTest"));
                    else
                        throw __t;
                }
            }
        ...
        {
            {
                while (enum2.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Diagnostic_typeof(), NULL)))
                {
                    ...
                    ::g::Uno::Testing::Assert::Fail(uPtr(e1)->ToString(), uString::Const("/usr/local/share/uno/Packages/Fuse.Testing/1.12.0/TestRootPanel.uno"), 127, uString::Const("RunTest"));
                }
            }
        }
...
// internal void StepFrameJS() [instance]
...
// public TestRootPanel New() [static]
...
// internal sealed class TestRootSingletonsGuard
// {
...
// internal TestRootSingletonsGuard(Fuse.Testing.TestRootPanel trp)
...
// internal TestRootSingletonsGuard New(Fuse.Testing.TestRootPanel trp)
...
// internal TestRootSingletonsGuard(Fuse.Testing.TestRootPanel trp) [instance]
...
// internal TestRootSingletonsGuard New(Fuse.Testing.TestRootPanel trp) [static]
...
// public extern TestRootViewport(Uno.Platform.Window window, [float pixelsPerPoint])
...
// public extern TestRootViewport New(Uno.Platform.Window window, [float pixelsPerPoint])
...
// public extern TestRootViewport(Uno.Platform.Window window, [float pixelsPerPoint]) [instance]
...
// internal void Resize(float2 size) [instance]
...
// public extern TestRootViewport New(Uno.Platform.Window window, [float pixelsPerPoint]) [static]
