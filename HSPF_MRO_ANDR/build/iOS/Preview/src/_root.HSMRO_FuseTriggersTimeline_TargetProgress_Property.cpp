...
{
    uStackFrame __("HSMRO_FuseTriggersTimeline_TargetProgress_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseTriggersTimeline_TargetProgress_Property", "Set(Uno.UX.PropertyObject,double,Uno.UX.IPropertyListener)");
    double v_ = *v;
