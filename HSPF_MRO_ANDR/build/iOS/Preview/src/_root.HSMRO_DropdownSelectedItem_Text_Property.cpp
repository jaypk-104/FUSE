...
// public HSMRO_DropdownSelectedItem_Text_Property(DropdownSelectedItem obj, Uno.UX.Selector name)
...
{
    uStackFrame __("HSMRO_DropdownSelectedItem_Text_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::DropdownSelectedItem*>(obj, ::TYPES[0/*DropdownSelectedItem*/]))->Text(), void();
}

// public HSMRO_DropdownSelectedItem_Text_Property New(DropdownSelectedItem obj, Uno.UX.Selector name)
...
{
    *__retval = HSMRO_DropdownSelectedItem_Text_Property::New1(obj, *name);
}
...
{
    uStackFrame __("HSMRO_DropdownSelectedItem_Text_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
// public HSMRO_DropdownSelectedItem_Text_Property(DropdownSelectedItem obj, Uno.UX.Selector name) [instance]
void HSMRO_DropdownSelectedItem_Text_Property::ctor_3(::g::DropdownSelectedItem* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public HSMRO_DropdownSelectedItem_Text_Property New(DropdownSelectedItem obj, Uno.UX.Selector name) [static]
HSMRO_DropdownSelectedItem_Text_Property* HSMRO_DropdownSelectedItem_Text_Property::New1(::g::DropdownSelectedItem* obj, ::g::Uno::UX::Selector name)
{
    HSMRO_DropdownSelectedItem_Text_Property* obj1 = (HSMRO_DropdownSelectedItem_Text_Property*)uNew(HSMRO_DropdownSelectedItem_Text_Property_typeof());
