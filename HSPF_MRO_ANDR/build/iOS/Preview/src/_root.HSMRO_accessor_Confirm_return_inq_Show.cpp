...
{
    uStackFrame __("HSMRO_accessor_Confirm_return_inq_Show", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_accessor_Confirm_return_inq_Show", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
