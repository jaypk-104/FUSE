...
// internal Uno.Time.Instant GetInstant(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute)
...
// internal Uno.Time.Instant GetInstant(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond)
...
// internal int GetMillisecondOfSecond(Uno.Time.Instant instant)
...
// internal Uno.Time.Instant GetInstant(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute) [instance]
...
// internal Uno.Time.Instant GetInstant(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) [instance]
...
// internal int GetMillisecondOfSecond(Uno.Time.Instant instant) [instance]
...
// public Uno.Time.ZonedDateTime AtStrictly(Uno.Time.LocalDateTime localDateTime)
...
// public static Uno.Time.DateTimeZone ForOffset(Uno.Time.Offset offset)
...
// public Uno.Time.ZonedDateTime AtStrictly(Uno.Time.LocalDateTime localDateTime) [instance]
...
// internal DeviceTimeZone New(string id)
...
// internal DeviceTimeZone New(string id) [static]
...
static void LocalDateTime_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(16,
        ...
        new uFunction("get_Date", NULL, (void*)LocalDateTime__get_Date_fn, 0, false, ::g::Uno::Time::LocalDate_typeof(), 0),
        ...
        new uFunction("get_TickOfDay", NULL, (void*)LocalDateTime__get_TickOfDay_fn, 0, false, ::g::Uno::Long_typeof(), 0),
        new uFunction("get_TimeOfDay", NULL, (void*)LocalDateTime__get_TimeOfDay_fn, 0, false, ::g::Uno::Time::LocalTime_typeof(), 0),
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond, int tickWithinMillisecond, Uno.Time.CalendarSystem calendar)
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, Uno.Time.CalendarSystem calendar)
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second)
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second, int millisecond)
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second) [instance]
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond) [instance]
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond, int tickWithinMillisecond, Uno.Time.CalendarSystem calendar) [instance]
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, Uno.Time.CalendarSystem calendar) [instance]
...
{
    uStackFrame __("Uno.Time.LocalDateTime", "get_Date()");
...
{
    uStackFrame __("Uno.Time.LocalDateTime", "get_TickOfDay()");
...
{
    uStackFrame __("Uno.Time.LocalDateTime", "get_TimeOfDay()");
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second) [static]
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second, int millisecond) [static]
...
static void LocalTime_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction(".ctor", NULL, (void*)LocalTime__New1_fn, 0, true, type, 2, ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof()),
...
// public LocalTime New(int hour, int minute, int second, int millisecond)
...
{
    uStackFrame __("Uno.Time.LocalTime", ".ctor(int,int)");
...
// public LocalTime(int hour, int minute, int second, int millisecond) [instance]
...
// public LocalTime New(int hour, int minute, int second, int millisecond) [static]
...
// public static Uno.Time.Offset FromTicks(long ticks)
...
// public static Uno.Time.Offset FromTicks(long ticks) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Time/OffsetDateTime.uno
// -------------------------------------------------------------------------------
...
// public OffsetDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset)
...
// public bool Equals(Uno.Time.OffsetDateTime other)
...
// public OffsetDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset)
...
// public static operator ==(Uno.Time.OffsetDateTime left, Uno.Time.OffsetDateTime right)
...
// public OffsetDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset) [instance]
...
// public bool Equals(Uno.Time.OffsetDateTime other) [instance]
...
// public OffsetDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset) [static]
...
// public static operator ==(Uno.Time.OffsetDateTime left, Uno.Time.OffsetDateTime right) [static]
...
// internal static void CheckArgumentRange(string paramName, long value, long minInclusive, long maxInclusive) [static]
...
static void ZonedDateTime_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(18,
        new uFunction("get_Date", NULL, (void*)ZonedDateTime__get_Date_fn, 0, false, ::g::Uno::Time::LocalDate_typeof(), 0),
        ...
        new uFunction("get_TimeOfDay", NULL, (void*)ZonedDateTime__get_TimeOfDay_fn, 0, false, ::g::Uno::Time::LocalTime_typeof(), 0),
...
// public ZonedDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone)
...
// public ZonedDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone)
...
// public ZonedDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone) [instance]
...
{
    uStackFrame __("Uno.Time.ZonedDateTime", "get_Date()");
    ::g::Uno::Time::LocalDateTime ind2;
...
{
    uStackFrame __("Uno.Time.ZonedDateTime", "get_TimeOfDay()");
...
// public ZonedDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone) [static]
