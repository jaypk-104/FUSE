...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/TextControls/FallbackTextEdit/Helpers.uno
// -------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/TextControls/FallbackTextEdit/LineCache.uno
// ---------------------------------------------------------------------------------------------------------
...
// public LineCache(Uno.Action onTextChanged, Uno.Action invalideLayout, bool isMultiline)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition BoundsToTextPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p)
...
// private Uno.Collections.List<Fuse.Controls.FallbackTextEdit.LineCacheLine> DecomposeLines(string text)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition DeleteSpan(Fuse.Controls.FallbackTextEdit.TextSpan s)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public float2 GetBoundsSize(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo)
...
// public Fuse.Controls.FallbackTextEdit.TextSpan GetFullTextSpan()
...
// public Fuse.Controls.FallbackTextEdit.TextPosition GetLastTextPos()
...
// public string GetString(Fuse.Controls.FallbackTextEdit.TextSpan s)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertChar(Fuse.Controls.FallbackTextEdit.TextPosition p, char c)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertNewline(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// private void InvalidateText([bool noChange])
...
// private bool IsWordBreaker(char c)
void LineCache__IsWordBreaker_fn(LineCache* __this, char16_t* c, bool* __retval)
{
    *__retval = __this->IsWordBreaker(*c);
}

// public Uno.Collections.List<Fuse.Controls.FallbackTextEdit.LineCacheLine> get_Lines()
void LineCache__get_Lines_fn(LineCache* __this, ::g::Uno::Collections::List** __retval)
{
    *__retval = __this->Lines();
}

// public LineCache New(Uno.Action onTextChanged, Uno.Action invalideLayout, bool isMultiline)
...
// private int NextWordLeft(string str, int startIdx)
...
// private int NextWordRight(string str, int startIdx)
...
// public float2 TextPosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.LineCacheTransform get_Transform()
void LineCache__get_Transform_fn(LineCache* __this, uObject** __retval)
{
    *__retval = __this->Transform();
}

// public void set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform value)
void LineCache__set_Transform_fn(LineCache* __this, uObject* value)
{
    __this->Transform(value);
}

// public Fuse.Controls.FallbackTextEdit.TextPosition TryBackspace(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryDelete(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveDown(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveLeft(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordLeft(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordRight(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveRight(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveUp(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public LineCache(Uno.Action onTextChanged, Uno.Action invalideLayout, bool isMultiline) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition BoundsToTextPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p) [instance]
...
// private Uno.Collections.List<Fuse.Controls.FallbackTextEdit.LineCacheLine> DecomposeLines(string text) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition DeleteSpan(Fuse.Controls.FallbackTextEdit.TextSpan s) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public float2 GetBoundsSize(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextSpan GetFullTextSpan() [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition GetLastTextPos() [instance]
...
// public string GetString(Fuse.Controls.FallbackTextEdit.TextSpan s) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertChar(Fuse.Controls.FallbackTextEdit.TextPosition p, char c) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertNewline(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// private void InvalidateLayout() [instance]
...
// private void InvalidateText([bool noChange]) [instance]
...
// private bool IsWordBreaker(char c) [instance]
bool LineCache::IsWordBreaker(char16_t c)
{
    return (((((c == ' ') || (c == 9)) || (c == 10)) || (c == '.')) || (c == ',')) || (c == ';');
}

// public Uno.Collections.List<Fuse.Controls.FallbackTextEdit.LineCacheLine> get_Lines() [instance]
...
// private int NextWordLeft(string str, int startIdx) [instance]
...
// private int NextWordRight(string str, int startIdx) [instance]
...
// public float2 TextPosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.LineCacheTransform get_Transform() [instance]
uObject* LineCache::Transform()
{
    return _transform;
}

// public void set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform value) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryBackspace(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryDelete(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveDown(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordRight(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveRight(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveUp(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public LineCache New(Uno.Action onTextChanged, Uno.Action invalideLayout, bool isMultiline) [static]
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/TextControls/FallbackTextEdit/LineCacheLine.uno
// -------------------------------------------------------------------------------------------------------------

// internal sealed class LineCacheLine
// {
...
// public LineCacheLine(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform)
...
// public int BoundsToPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p)
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine BoundsToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, float2 p)
...
// public int End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p)
...
// public float GetTotalHeight(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo)
...
// public Fuse.Controls.FallbackTextRenderer.WrappedLine[] GetWrappedLines(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo)
...
// public int Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p)
...
// public LineCacheLine New(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform)
...
// public float2 PosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, int p)
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine PosToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p)
...
// public LineCacheLine(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform) [instance]
...
// public int Backspace(int p) [instance]
...
// public int BoundsToPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p) [instance]
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine BoundsToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, float2 p) [instance]
...
// public void Delete(int p) [instance]
...
// public int End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance]
...
// public float GetTotalHeight(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) [instance]
...
// public Fuse.Controls.FallbackTextRenderer.WrappedLine[] GetWrappedLines(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) [instance]
...
// public int Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance]
...
// public void InsertChar(int p, char c) [instance]
...
// public float2 PosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, int p) [instance]
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine PosToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance]
...
// public string get_VisualText() [instance]
...
// public LineCacheLine New(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform) [static]
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/TextControls/FallbackTextEdit/LineCacheTransform.uno
// ------------------------------------------------------------------------------------------------------------------

// internal sealed class LineCachePasswordTransform
// {
...
// public generated LineCachePasswordTransform()
void LineCachePasswordTransform__ctor__fn(LineCachePasswordTransform* __this)
{
    __this->ctor_();
}

// public generated LineCachePasswordTransform New()
...
// public generated LineCachePasswordTransform() [instance]
void LineCachePasswordTransform::ctor_()
{
    _reveal = -1;
}

// public bool SetReveal(int r) [instance]
...
// public string Transform(string text) [instance]
...
// public generated LineCachePasswordTransform New() [static]
...
// internal abstract interface LineCacheTransform
// {
...
// public SwipeGestureHelper(float lengthThreshold, Fuse.Controls.FallbackTextEdit.DegreeSpan[] spans)
...
// public SwipeGestureHelper New(float lengthThreshold, Fuse.Controls.FallbackTextEdit.DegreeSpan[] spans)
...
// public SwipeGestureHelper(float lengthThreshold, Fuse.Controls.FallbackTextEdit.DegreeSpan[] spans) [instance]
...
// public SwipeGestureHelper New(float lengthThreshold, Fuse.Controls.FallbackTextEdit.DegreeSpan[] spans) [static]
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/TextControls/FallbackTextEdit/TextPosition.uno
// ------------------------------------------------------------------------------------------------------------

// internal sealed class TextPosition
// {
// static generated TextPosition()
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Max(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b)
void TextPosition__Max_fn(TextPosition* a, TextPosition* b, TextPosition** __retval)
{
    *__retval = TextPosition::Max(a, b);
}

// public static Fuse.Controls.FallbackTextEdit.TextPosition Min(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b)
void TextPosition__Min_fn(TextPosition* a, TextPosition* b, TextPosition** __retval)
{
    *__retval = TextPosition::Min(a, b);
}

// public TextPosition New(int l, int c)
void TextPosition__New1_fn(int32_t* l, int32_t* c, TextPosition** __retval)
{
    *__retval = TextPosition::New1(*l, *c);
}

// public static operator ==(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b)
...
// public TextPosition(int l, int c) [instance]
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Max(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static]
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Min(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static]
...
// public TextPosition New(int l, int c) [static]
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static]
...
// public TextSpan(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end)
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p)
...
// public static Fuse.Controls.FallbackTextEdit.TextSpan Intersection(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b)
void TextSpan__Intersection_fn(TextSpan* a, TextSpan* b, TextSpan** __retval)
{
    *__retval = TextSpan::Intersection(a, b);
}

// public static bool Intersects(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b)
void TextSpan__Intersects_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::Intersects(a, b);
}

// public TextSpan New(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end)
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b)
...
// public TextSpan(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) [instance]
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance]
...
// public static Fuse.Controls.FallbackTextEdit.TextSpan Intersection(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static]
...
// public static bool Intersects(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static]
...
// public TextSpan New(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) [static]
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static]
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.12.0/TextControls/FallbackTextEdit/TextWindow.uno
// ----------------------------------------------------------------------------------------------------------
...
// public TextWindow(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache)
...
// public void Draw(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Controls.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc)
...
// public TextWindow New(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache)
...
// public TextWindow(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [instance]
...
// public void Draw(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Controls.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) [instance]
...
// public TextWindow New(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [static]
