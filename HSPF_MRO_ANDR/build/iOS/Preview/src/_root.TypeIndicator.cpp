// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/TypeIndicator.g.uno.
...
static void TypeIndicator__cctor_5_fn(uType* __type)
{
    TypeIndicator::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Color"*/]);
    TypeIndicator::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
}

static void TypeIndicator_build(uType* type)
{
    ...
    type->SetDependencies(
        ::g::HSMRO_accessor_TypeIndicator_IsActive_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(126,
        ::g::Uno::Bool_typeof(), offsetof(TypeIndicator, _field_IsActive), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(TypeIndicator, this_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL), offsetof(TypeIndicator, temp_Value_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&TypeIndicator::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&TypeIndicator::__selector1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(4,
        new uFunction("get_IsActive", NULL, (void*)TypeIndicator__get_IsActive_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_IsActive", NULL, (void*)TypeIndicator__set_IsActive_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)TypeIndicator__New4_fn, 0, true, type, 0),
        new uFunction("SetIsActive", NULL, (void*)TypeIndicator__SetIsActive_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()));
}
...
::g::Fuse::Controls::Shape_type* TypeIndicator_typeof()
{
    ...
    options.ObjectSize = sizeof(TypeIndicator);
    options.TypeSize = sizeof(::g::Fuse::Controls::Shape_type);
    type = (::g::Fuse::Controls::Shape_type*)uClassType::New("TypeIndicator", options);
    type->fp_build_ = TypeIndicator_build;
    type->fp_ctor_ = (void*)TypeIndicator__New4_fn;
    type->fp_cctor_ = TypeIndicator__cctor_5_fn;
...
// public TypeIndicator New()
void TypeIndicator__New4_fn(TypeIndicator** __retval)
{
    *__retval = TypeIndicator::New4();
}
...
::g::Uno::UX::Selector TypeIndicator::__selector0_;
::g::Uno::UX::Selector TypeIndicator::__selector1_;

// public TypeIndicator() [instance]
void TypeIndicator::ctor_9()
{
    uStackFrame __("TypeIndicator", ".ctor()");
    ctor_8();
    InitializeUX();
}

// private void InitializeUX() [instance]
void TypeIndicator::InitializeUX()
{
    uStackFrame __("TypeIndicator", "InitializeUX()");
    this_Color_inst = ::g::HSMRO_FuseControlsShape_Color_Property::New1(this, TypeIndicator::__selector0_);
    ...
    temp_Value_inst = ::g::HSMRO_FuseTriggersWhileBool_Value_Property::New1(temp, TypeIndicator::__selector1_);
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::HSMRO_accessor_TypeIndicator_IsActive::Singleton());
    ...
    ::g::Fuse::Animations::Change__set_Value_fn(temp3, uCRef(::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 0.372549f)));
...
bool TypeIndicator::IsActive()
{
    return _field_IsActive;
}

// public void set_IsActive(bool value) [instance]
void TypeIndicator::IsActive(bool value)
{
    uStackFrame __("TypeIndicator", "set_IsActive(bool)");
    SetIsActive(value, NULL);
}

// public void SetIsActive(bool value, Uno.UX.IPropertyListener origin) [instance]
void TypeIndicator::SetIsActive(bool value, uObject* origin)
{
    uStackFrame __("TypeIndicator", "SetIsActive(bool,Uno.UX.IPropertyListener)");
...
// public TypeIndicator New() [static]
TypeIndicator* TypeIndicator::New4()
{
    TypeIndicator* obj1 = (TypeIndicator*)uNew(TypeIndicator_typeof());
    obj1->ctor_9();
    return obj1;
}
// }
