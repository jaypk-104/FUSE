...
{
    uStackFrame __("HSMRO_CycleButton2_Types_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_CycleButton2_Types_Property", "Set(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
