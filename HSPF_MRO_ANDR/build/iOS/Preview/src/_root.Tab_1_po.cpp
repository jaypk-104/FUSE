...
// {
// static Tab_1_po()
static void Tab_1_po__cctor_4_fn(uType* __type)
{
    Tab_1_po::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Value"*/]);
    Tab_1_po::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Color"*/]);
}

static void Tab_1_po_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Value");
    ::STRINGS[1] = uString::Const("Color");
    ::STRINGS[2] = uString::Const("Pages/Menu_Customer/c_po.ux");
    ::STRINGS[3] = uString::Const("Text");
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetDependencies(
        ::g::HSMRO_accessor_Tab_1_po_Color_typeof(),
        ::g::HSMRO_accessor_Tab_1_po_Text_typeof(),
        ::g::MainView_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(120,
        ::g::Uno::String_typeof(), offsetof(Tab_1_po, _field_Text), 0,
        ::g::Uno::String_typeof(), offsetof(Tab_1_po, _field_Color), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Tab_1_po, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(Tab_1_po, temp_Color_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Tab_1_po::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Tab_1_po::__selector1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(7,
        new uFunction("get_Color", NULL, (void*)Tab_1_po__get_Color1_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Color", NULL, (void*)Tab_1_po__set_Color1_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction(".ctor", NULL, (void*)Tab_1_po__New4_fn, 0, true, type, 0),
        new uFunction("SetColor", NULL, (void*)Tab_1_po__SetColor1_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetText", NULL, (void*)Tab_1_po__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Text", NULL, (void*)Tab_1_po__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)Tab_1_po__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
::g::Fuse::Controls::Panel_type* Tab_1_po_typeof()
{
    ...
    options.ObjectSize = sizeof(Tab_1_po);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("Tab_1_po", options);
    type->fp_build_ = Tab_1_po_build;
    type->fp_ctor_ = (void*)Tab_1_po__New4_fn;
    type->fp_cctor_ = Tab_1_po__cctor_4_fn;
...
::g::Uno::UX::Selector Tab_1_po::__selector0_;
::g::Uno::UX::Selector Tab_1_po::__selector1_;

// public Tab_1_po() [instance]
void Tab_1_po::ctor_7()
{
    uStackFrame __("Tab_1_po", ".ctor()");
    ctor_6();
    InitializeUX();
}

// public string get_Color() [instance]
uString* Tab_1_po::Color1()
{
    return _field_Color;
}

// public void set_Color(string value) [instance]
void Tab_1_po::Color1(uString* value)
{
    uStackFrame __("Tab_1_po", "set_Color(string)");
    SetColor1(value, NULL);
}

// private void InitializeUX() [instance]
void Tab_1_po::InitializeUX()
{
    uStackFrame __("Tab_1_po", "InitializeUX()");
    ::g::Fuse::Reactive::Constant* temp1 = ::g::Fuse::Reactive::Constant::New1(this);
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    temp_Value_inst = ::g::HSMRO_FuseControlsTextControl_Value_Property::New1(temp, Tab_1_po::__selector0_);
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::HSMRO_accessor_Tab_1_po_Text::Singleton());
    ::g::Fuse::Reactive::Constant* temp3 = ::g::Fuse::Reactive::Constant::New1(this);
    temp_Color_inst = ::g::HSMRO_FuseControlsTextControl_Color_Property::New1(temp, Tab_1_po::__selector1_);
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::HSMRO_accessor_Tab_1_po_Color::Singleton());
...
void Tab_1_po::SetColor1(uString* value, uObject* origin)
{
    uStackFrame __("Tab_1_po", "SetColor(string,Uno.UX.IPropertyListener)");
...
void Tab_1_po::SetText(uString* value, uObject* origin)
{
    uStackFrame __("Tab_1_po", "SetText(string,Uno.UX.IPropertyListener)");
...
uString* Tab_1_po::Text()
{
    return _field_Text;
}

// public void set_Text(string value) [instance]
void Tab_1_po::Text(uString* value)
{
    uStackFrame __("Tab_1_po", "set_Text(string)");
    SetText(value, NULL);
}

// public Tab_1_po New() [static]
Tab_1_po* Tab_1_po::New4()
{
    Tab_1_po* obj1 = (Tab_1_po*)uNew(Tab_1_po_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
