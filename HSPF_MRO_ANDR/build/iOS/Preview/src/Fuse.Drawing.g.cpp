...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Enums.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Brush.uno
// -----------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Brush.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Colors.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/CoreGraphics/CoreGraphicsSurface.uno
// ----------------------------------------------------------------------------------------------

// internal abstract extern class CoreGraphicsSurface
// {
static void CoreGraphicsSurface_build(uType* type)
{
    ::STRINGS[3] = uString::Const("Non CoreGraphicSurfacePath used");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/CoreGraphics/CoreGraphicsSurface.uno");
...
// private float2 AddSegments(Uno.IntPtr path, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments, float2 prevPoint)
...
// private static Uno.IntPtr CreateLinearGradient(Uno.IntPtr cp, Uno.IntPtr colors, Uno.IntPtr stops, int count)
...
// private static Uno.IntPtr CreateStrokedPath(Uno.IntPtr path, float width, int fjoin, int fcap, float miterLimit)
...
// private static void DeleteContext(Uno.IntPtr cp)
...
// private static void FillPathImage(Uno.IntPtr cp, Uno.IntPtr path, Uno.IntPtr image, float originX, float originY, float tileSizeX, float tileSizeY, bool eoFill)
...
// private void FillPathImpl(Uno.IntPtr path, Fuse.Drawing.Brush fill, Fuse.Drawing.FillRule fillRule)
...
// private static void FillPathLinearGradient(Uno.IntPtr cp, Uno.IntPtr path, Uno.IntPtr gradient, float sx, float sy, float ex, float ey, bool eoFill)
...
// private static void FillPathSolidColor(Uno.IntPtr cp, Uno.IntPtr path, float r, float g, float b, float a, bool eoFill)
...
// public CoreGraphicsSurface() [instance]
...
// private float2 AddSegments(Uno.IntPtr path, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments, float2 prevPoint) [instance]
...
// private void FillPathImpl(Uno.IntPtr path, Fuse.Drawing.Brush fill, Fuse.Drawing.FillRule fillRule) [instance]
...
// protected void VerifyCreated() [instance]
...
// private static void CGFloatDeleteArray(Uno.IntPtr a) [static]
void CoreGraphicsSurface::CGFloatDeleteArray(void* a)
{
    return delete[]((CGFloat*)a);
}

// private static Uno.IntPtr CGFloatNewArray(int size) [static]
void* CoreGraphicsSurface::CGFloatNewArray(int32_t size)
{
    return new CGFloat[size];
}

// private static void CGFloatSet(Uno.IntPtr a, int index, double value) [static]
void CoreGraphicsSurface::CGFloatSet(void* a, int32_t index, double value)
{
    ((CGFloat*)a)[index] = (CGFloat)value;
}

// private static void ConcatTransform(Uno.IntPtr cp, float m11, float m12, float m21, float m22, float m31, float m32) [static]
...
// private static Uno.IntPtr CreateLinearGradient(Uno.IntPtr cp, Uno.IntPtr colors, Uno.IntPtr stops, int count) [static]
...
// private static Uno.IntPtr CreateStrokedPath(Uno.IntPtr path, float width, int fjoin, int fcap, float miterLimit) [static]
...
// private static void DeleteContext(Uno.IntPtr cp) [static]
...
// private static void FillPathImage(Uno.IntPtr cp, Uno.IntPtr path, Uno.IntPtr image, float originX, float originY, float tileSizeX, float tileSizeY, bool eoFill) [static]
...
// private static void FillPathLinearGradient(Uno.IntPtr cp, Uno.IntPtr path, Uno.IntPtr gradient, float sx, float sy, float ex, float ey, bool eoFill) [static]
...
// private static void FillPathSolidColor(Uno.IntPtr cp, Uno.IntPtr path, float r, float g, float b, float a, bool eoFill) [static]
...
// private static Uno.IntPtr NewContext() [static]
...
// private static void PathClose(Uno.IntPtr path) [static]
void CoreGraphicsSurface::PathClose(void* path)
{
    CGPathCloseSubpath( (CGMutablePathRef)path );
}

// private static Uno.IntPtr PathCreateMutable() [static]
void* CoreGraphicsSurface::PathCreateMutable()
{
    return CGPathCreateMutable();
}

// private static void PathCurveTo(Uno.IntPtr path, float x, float y, float ax, float ay, float bx, float by) [static]
...
// private static void SaveContextState(Uno.IntPtr cp) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/DotNetSurface.uno
// ---------------------------------------------------------------------------
...
// public static float4 AdjustedEndPoints(float4 area, float2 start, float2 end)
...
// public static float2 AdjustedOffsets(float2 start, float2 end, float2& adjStart, float2& adjEnd)
...
// public static float4 AdjustedEndPoints(float4 area, float2 start, float2 end) [static]
...
// public static float2 AdjustedOffsets(float2 start, float2 end, float2& adjStart, float2& adjEnd) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/DrawObjectWatcher.uno
// -------------------------------------------------------------------------------
...
void DrawObjectWatcher::Sync()
{
    ...
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Sync while not rooted"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/DrawObjectWatcher.uno"), 39, uString::Const("Sync"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.12.0/Drawing/ImageFill.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Brushes/LinearGradient.uno
// ----------------------------------------------------------------------------
...
// public GradientStop(float4 color, float offset) [instance]
...
// public GradientStop New() [static]
...
// public GradientStop New(float4 color, float offset) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/CoreGraphics/GraphicsSurface.uno
// ------------------------------------------------------------------------------------------
...
// private static bool BeginImpl(Uno.IntPtr cp, int width, int height, int glTexture)
...
// private static void EndImpl(Uno.IntPtr cp)
void GraphicsSurface__EndImpl_fn(void** cp)
{
    GraphicsSurface::EndImpl(*cp);
}

// private static Uno.IntPtr LoadImagePoor(Uno.IntPtr cp, int width, int height)
...
// protected override sealed void PrepareImageFill(Fuse.Drawing.ImageFill img)
...
// private static bool BeginImpl(Uno.IntPtr cp, int width, int height, int glTexture) [static]
...
// private static void EndImpl(Uno.IntPtr cp) [static]
...
// private static Uno.IntPtr LoadImagePoor(Uno.IntPtr cp, int width, int height) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/SurfaceManager.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Brushes/SolidColor.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/Surface.uno
// ---------------------------------------------------------------------
...
// public LinearGradient(Fuse.Drawing.GradientStop[] stops)
...
// public LinearGradient New()
void LinearGradient__New2_fn(LinearGradient** __retval)
{
    *__retval = LinearGradient::New2();
}

// public LinearGradient New(Fuse.Drawing.GradientStop[] stops)
...
// public Uno.Collections.IList<Fuse.Drawing.GradientStop> get_Stops()
...
// public LinearGradient() [instance]
...
// public LinearGradient(Fuse.Drawing.GradientStop[] stops) [instance]
...
// public float get_AngleDegrees() [instance]
float LinearGradient::AngleDegrees()
{
    return ::g::Uno::Math::RadiansToDegrees1(_angle);
}

// public void set_AngleDegrees(float value) [instance]
...
// public Uno.Collections.IList<Fuse.Drawing.GradientStop> get_Stops() [instance]
...
// public LinearGradient New() [static]
...
// public LinearGradient New(Fuse.Drawing.GradientStop[] stops) [static]
...
// private static generated float4[] FillBuffer_Colors_ae3a1d65_1_6_6(int Colors_1_6_4, Fuse.Drawing.GradientStop[] Colors_1_6_5)
...
// private static generated float[] FillBuffer_Offsets_ae3a1d65_1_5_4(int Offsets_1_5_1, Fuse.Drawing.GradientStop[] Offsets_1_5_2)
...
// private static generated float4[] FillBuffer_Colors_ae3a1d65_1_6_6(int Colors_1_6_4, Fuse.Drawing.GradientStop[] Colors_1_6_5) [static]
...
// private static generated float[] FillBuffer_Offsets_ae3a1d65_1_5_4(int Offsets_1_5_1, Fuse.Drawing.GradientStop[] Offsets_1_5_2) [static]
...
// public static float LinearStep(float edge0, float edge1, float x) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/LineMetrics.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/LineParser.uno
// ------------------------------------------------------------------------
...
static void LineParser_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/LineParser.uno");
...
// public generated LineParser()
void LineParser__ctor__fn(LineParser* __this)
{
    __this->ctor_();
}

// public generated LineParser New()
void LineParser__New1_fn(LineParser** __retval)
{
    *__retval = LineParser::New1();
}

// public static void ParseSVGPath(string data, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments)
void LineParser__ParseSVGPath_fn(uString* data, uObject* segments)
{
    LineParser::ParseSVGPath(data, segments);
}

// public generated LineParser() [instance]
void LineParser::ctor_()
{
}

// public generated LineParser New() [static]
...
// public static void ParseSVGPath(string data, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/LineSegment.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/LineSegments.uno
// --------------------------------------------------------------------------
...
// public LineSegments(Uno.Collections.IList<Fuse.Drawing.LineSegment> segments)
...
// public Fuse.Drawing.LineSegment get_Last()
...
// public LineSegments New(Uno.Collections.IList<Fuse.Drawing.LineSegment> segments)
...
// public LineSegments(Uno.Collections.IList<Fuse.Drawing.LineSegment> segments) [instance]
...
// public void BezierCurveToRel(float2 pt, float2 controlA, float2 controlB) [instance]
...
// public float2 get_CurPos() [instance]
...
// public void EllipticArcToRel(float2 pt, float2 radius, float xAngle, bool large, bool sweep) [instance]
...
// public void LineToRel(float2 pt) [instance]
...
// public void MoveToRel(float2 pt) [instance]
...
// public void QuadraticCurveTo(float2 pt, float2 control) [instance]
...
// public void QuadraticCurveToRel(float2 pt, float2 control) [instance]
...
// public float2 get_StartPos() [instance]
...
// public void VertLineTo(float y) [instance]
...
// public void VertLineToRel(float y) [instance]
...
// public LineSegments New(Uno.Collections.IList<Fuse.Drawing.LineSegment> segments) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/LineSplitter.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/CoreGraphics/NativeSurface.uno
// ----------------------------------------------------------------------------------------
...
// public void Begin(Uno.IntPtr cgContext, float pixelsPerPoint)
...
// private static void SetCGContext(Uno.IntPtr cp, Uno.IntPtr cgContext)
...
// public void Begin(Uno.IntPtr cgContext, float pixelsPerPoint) [instance]
...
// private static void SetCGContext(Uno.IntPtr cp, Uno.IntPtr cgContext) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/Stroke.uno
// ------------------------------------------------------------
...
// public Stroke(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin])
...
// public Stroke New(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin])
...
// public Stroke(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin]) [instance]
...
// public Stroke New(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin]) [static]
...
static void Surface_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/Surface.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.12.0/SurfaceUtil.uno
// -------------------------------------------------------------------------
...
// public SVGPathParser(string data, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments)
void SVGPathParser__ctor__fn(SVGPathParser* __this, uString* data, uObject* segments)
{
    __this->ctor_(data, segments);
}

// private void Execute(char c, char prev)
void SVGPathParser__Execute_fn(SVGPathParser* __this, char16_t* c, char16_t* prev)
{
    __this->Execute(*c, *prev);
}

// public SVGPathParser New(string data, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments)
...
// public SVGPathParser(string data, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments) [instance]
...
// private void Execute(char c, char prev) [instance]
...
// private float ReadFloat() [instance]
...
// private float2 ReadFloat2() [instance]
...
// private void StartNewToken(int prevLastChar, int nextFirstChar, [bool hasAction]) [instance]
...
// public SVGPathParser New(string data, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments) [static]
...
// public Token New(int first, bool hasAction) [static]
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.12.0/WindingRules.uno
// ------------------------------------------------------------------
...
// public static bool AbsoluteGreaterOrEqualsTwo(int n) [static]
bool WindingRules::AbsoluteGreaterOrEqualsTwo(int32_t n)
{
    return (n >= 2) || (n <= -2);
}

// public static bool Negative(int n) [static]
bool WindingRules::Negative(int32_t n)
{
    return n < 0;
}

// public static bool NonZero(int n) [static]
bool WindingRules::NonZero(int32_t n)
{
    return n != 0;
}

// public static bool Odd(int n) [static]
bool WindingRules::Odd(int32_t n)
{
    return (n & 1) != 0;
}

// public static bool Positive(int n) [static]
