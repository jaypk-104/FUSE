...
// {
// static ListType()
static void ListType__cctor_4_fn(uType* __type)
{
    ListType::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Value"*/]);
    ListType::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Color"*/]);
    ListType::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"Visibility"*/]);
    ListType::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"theBack"*/]);
    ListType::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"theCheck"*/]);
    ListType::__selector5_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"chk_line_usr"*/]);
}

static void ListType_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("Pages/Menu_Customer/SubPage_appr.ux");
    ...
    type->SetDependencies(
        ::g::HSMRO_accessor_ListType_USR_ID_typeof(),
        ::g::HSMRO_accessor_ListType_USR_NM_typeof(),
    ...
    type->SetFields(121,
        ::g::Uno::String_typeof(), offsetof(ListType, _field_USR_NM), 0,
        ::g::Uno::String_typeof(), offsetof(ListType, _field_USR_ID), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ListType, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ListType, temp1_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ListType, temp2_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ListType, chk_line_usr_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(ListType, theBack_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Elements::Visibility_typeof(), NULL), offsetof(ListType, theCheck_Visibility_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ListType, temp3_Value_inst), 0,
        ::g::Fuse::Controls::Rectangle_typeof(), offsetof(ListType, theBack), 0,
        ::g::Fuse::Controls::Image_typeof(), offsetof(ListType, theCheck), 0,
        ::g::Fuse::Controls::Text_typeof(), offsetof(ListType, chk_line_usr), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ListType::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ListType::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ListType::__selector2_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ListType::__selector3_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ListType::__selector4_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ListType::__selector5_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(7,
        new uFunction(".ctor", NULL, (void*)ListType__New5_fn, 0, true, type, 0),
        new uFunction("SetUSR_ID", NULL, (void*)ListType__SetUSR_ID_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetUSR_NM", NULL, (void*)ListType__SetUSR_NM_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_USR_ID", NULL, (void*)ListType__get_USR_ID_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_USR_ID", NULL, (void*)ListType__set_USR_ID_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("get_USR_NM", NULL, (void*)ListType__get_USR_NM_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_USR_NM", NULL, (void*)ListType__set_USR_NM_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
::g::Fuse::Controls::Panel_type* ListType_typeof()
{
    ...
    options.ObjectSize = sizeof(ListType);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("ListType", options);
    type->fp_build_ = ListType_build;
    type->fp_ctor_ = (void*)ListType__New5_fn;
    type->fp_cctor_ = ListType__cctor_4_fn;
...
::g::Uno::UX::Selector ListType::__selector0_;
::g::Uno::UX::Selector ListType::__selector1_;
::g::Uno::UX::Selector ListType::__selector2_;
::g::Uno::UX::Selector ListType::__selector3_;
::g::Uno::UX::Selector ListType::__selector4_;
::g::Uno::UX::Selector ListType::__selector5_;

// public ListType() [instance]
void ListType::ctor_8()
{
    uStackFrame __("ListType", ".ctor()");
    ctor_7();
    InitializeUX();
}

// private void InitializeUX() [instance]
void ListType::InitializeUX()
{
    uStackFrame __("ListType", "InitializeUX()");
    ...
    temp_Value_inst = ::g::HSMRO_FuseSelectionSelectable_Value_Property::New1(temp, ListType::__selector0_);
    ::g::Fuse::Reactive::Property* temp5 = ::g::Fuse::Reactive::Property::New1(temp4, ::g::HSMRO_accessor_ListType_USR_NM::Singleton());
    ::g::Fuse::Reactive::Constant* temp6 = ::g::Fuse::Reactive::Constant::New1(this);
    ::g::Fuse::Controls::Text* temp1 = ::g::Fuse::Controls::Text::New3();
    temp1_Value_inst = ::g::HSMRO_FuseControlsTextControl_Value_Property::New1(temp1, ListType::__selector0_);
    ::g::Fuse::Reactive::Property* temp7 = ::g::Fuse::Reactive::Property::New1(temp6, ::g::HSMRO_accessor_ListType_USR_NM::Singleton());
    ::g::Fuse::Reactive::Constant* temp8 = ::g::Fuse::Reactive::Constant::New1(this);
    ::g::Fuse::Controls::Text* temp2 = ::g::Fuse::Controls::Text::New3();
    temp2_Value_inst = ::g::HSMRO_FuseControlsTextControl_Value_Property::New1(temp2, ListType::__selector0_);
    ::g::Fuse::Reactive::Property* temp9 = ::g::Fuse::Reactive::Property::New1(temp8, ::g::HSMRO_accessor_ListType_USR_ID::Singleton());
    chk_line_usr = ::g::Fuse::Controls::Text::New3();
    chk_line_usr_Value_inst = ::g::HSMRO_FuseControlsTextControl_Value_Property::New1(chk_line_usr, ListType::__selector0_);
    ::g::Fuse::Reactive::Data* temp10 = ::g::Fuse::Reactive::Data::New1(::STRINGS[5/*"chk_line_usr"*/]);
    theBack = ::g::Fuse::Controls::Rectangle::New3();
    theBack_Color_inst = ::g::HSMRO_FuseControlsShape_Color_Property::New1(theBack, ListType::__selector1_);
    theCheck = ::g::Fuse::Controls::Image::New3();
    theCheck_Visibility_inst = ::g::HSMRO_FuseElementsElement_Visibility_Property::New1(theCheck, ListType::__selector2_);
    ...
    temp3_Value_inst = ::g::HSMRO_FuseAnimationsChangestring_Value_Property::New1(temp3, ListType::__selector0_);
    ::g::Fuse::Reactive::Property* temp12 = ::g::Fuse::Reactive::Property::New1(temp11, ::g::HSMRO_accessor_ListType_USR_ID::Singleton());
    ...
    uPtr(theBack)->Name(ListType::__selector3_);
    uPtr(theBack)->SourceLineNumber(23);
    ...
    uPtr(theCheck)->Name(ListType::__selector4_);
    uPtr(theCheck)->SourceLineNumber(25);
    ...
    uPtr(chk_line_usr)->Name(ListType::__selector5_);
    uPtr(chk_line_usr)->SourceLineNumber(29);
...
void ListType::SetUSR_ID(uString* value, uObject* origin)
{
    uStackFrame __("ListType", "SetUSR_ID(string,Uno.UX.IPropertyListener)");
...
void ListType::SetUSR_NM(uString* value, uObject* origin)
{
    uStackFrame __("ListType", "SetUSR_NM(string,Uno.UX.IPropertyListener)");
...
uString* ListType::USR_ID()
{
    return _field_USR_ID;
}

// public void set_USR_ID(string value) [instance]
void ListType::USR_ID(uString* value)
{
    uStackFrame __("ListType", "set_USR_ID(string)");
    SetUSR_ID(value, NULL);
}

// public string get_USR_NM() [instance]
uString* ListType::USR_NM()
{
    return _field_USR_NM;
}

// public void set_USR_NM(string value) [instance]
void ListType::USR_NM(uString* value)
{
    uStackFrame __("ListType", "set_USR_NM(string)");
    SetUSR_NM(value, NULL);
}

// public ListType New() [static]
ListType* ListType::New5()
{
    ListType* obj1 = (ListType*)uNew(ListType_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
