// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/Confirm_inq.g.uno.
...
static void Confirm_inq_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("Handler_inq");
    ...
    type->SetFields(120,
        ...
        uObject_typeof(), offsetof(Confirm_inq, _field_Handler_inq), 0,
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_Handler_inq", NULL, (void*)Confirm_inq__get_Handler_inq_fn, 0, false, uObject_typeof(), 0),
        new uFunction("set_Handler_inq", NULL, (void*)Confirm_inq__set_Handler_inq_fn, 0, false, uVoid_typeof(), 1, uObject_typeof()),
        new uFunction(".ctor", NULL, (void*)Confirm_inq__New4_fn, 0, true, type, 0),
        new uFunction("SetHandler_inq", NULL, (void*)Confirm_inq__SetHandler_inq_fn, 0, false, uVoid_typeof(), 2, uObject_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetShow", NULL, (void*)Confirm_inq__SetShow_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetText", NULL, (void*)Confirm_inq__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Show", NULL, (void*)Confirm_inq__get_Show_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_Show", NULL, (void*)Confirm_inq__set_Show_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction("get_Text", NULL, (void*)Confirm_inq__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)Confirm_inq__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
// public object get_Handler_inq()
void Confirm_inq__get_Handler_inq_fn(Confirm_inq* __this, uObject** __retval)
{
    *__retval = __this->Handler_inq();
}

// public void set_Handler_inq(object value)
void Confirm_inq__set_Handler_inq_fn(Confirm_inq* __this, uObject* value)
{
    __this->Handler_inq(value);
}
...
// public void SetHandler_inq(object value, Uno.UX.IPropertyListener origin)
void Confirm_inq__SetHandler_inq_fn(Confirm_inq* __this, uObject* value, uObject* origin)
{
    __this->SetHandler_inq(value, origin);
}
...
{
    uStackFrame __("Confirm_inq", ".ctor()");
    ctor_6();
    InitializeUX();
}

// public object get_Handler_inq() [instance]
uObject* Confirm_inq::Handler_inq()
{
    return _field_Handler_inq;
}

// public void set_Handler_inq(object value) [instance]
void Confirm_inq::Handler_inq(uObject* value)
{
    uStackFrame __("Confirm_inq", "set_Handler_inq(object)");
    SetHandler_inq(value, NULL);
}

// private void InitializeUX() [instance]
void Confirm_inq::InitializeUX()
{
    uStackFrame __("Confirm_inq", "InitializeUX()");
...
// public void SetHandler_inq(object value, Uno.UX.IPropertyListener origin) [instance]
void Confirm_inq::SetHandler_inq(uObject* value, uObject* origin)
{
    uStackFrame __("Confirm_inq", "SetHandler_inq(object,Uno.UX.IPropertyListener)");

    if (value != _field_Handler_inq)
    {
        _field_Handler_inq = value;
...
{
    uStackFrame __("Confirm_inq", "SetShow(bool,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Confirm_inq", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Confirm_inq", "set_Show(bool)");
    SetShow(value, NULL);
}
...
{
    uStackFrame __("Confirm_inq", "set_Text(string)");
    SetText(value, NULL);
}
