...
// {
// static Handler_msg()
static void Handler_msg__cctor_2_fn(uType* __type)
{
    Handler_msg::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Event_Handler"*/]);
}

static void Handler_msg_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Event_Handler");
    ::STRINGS[1] = uString::Const("Pages/Menu_Supplier/Confirm_Msg.ux");
    type->SetInterfaces(
    ...
    type->SetFields(44,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Handler_msg::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Handler_msg__New3_fn, 0, true, type, 0));
}
...
::g::Fuse::Triggers::Trigger_type* Handler_msg_typeof()
{
    ...
    options.ObjectSize = sizeof(Handler_msg);
    options.TypeSize = sizeof(::g::Fuse::Triggers::Trigger_type);
    type = (::g::Fuse::Triggers::Trigger_type*)uClassType::New("Handler_msg", options);
    type->fp_build_ = Handler_msg_build;
    type->fp_ctor_ = (void*)Handler_msg__New3_fn;
    type->fp_cctor_ = Handler_msg__cctor_2_fn;
...
// public Handler_msg New()
void Handler_msg__New3_fn(Handler_msg** __retval)
{
    *__retval = Handler_msg::New3();
}

::g::Uno::UX::Selector Handler_msg::__selector0_;

// public Handler_msg() [instance]
void Handler_msg::ctor_6()
{
    ctor_5();
    InitializeUX();
}
...
void Handler_msg::InitializeUX()
{
    EventName(Handler_msg::__selector0_);
    SourceLineNumber(44);
    SourceFileName(::STRINGS[1/*"Pages/Menu_...*/]);
}

// public Handler_msg New() [static]
Handler_msg* Handler_msg::New3()
{
    Handler_msg* obj1 = (Handler_msg*)uNew(Handler_msg_typeof());
    obj1->ctor_6();
    return obj1;
}
// }
