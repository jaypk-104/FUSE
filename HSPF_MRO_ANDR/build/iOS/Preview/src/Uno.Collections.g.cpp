...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/Dictionary.uno
// ----------------------------------------------------------------------------------
...
// public Dictionary(Uno.Collections.IDictionary<TKey, TValue> dictionary)
...
// public Dictionary New(Uno.Collections.IDictionary<TKey, TValue> dictionary)
...
// public Dictionary(Uno.Collections.IDictionary<TKey, TValue> dictionary) [instance]
...
// public Dictionary New(Uno.Collections.IDictionary<TKey, TValue> dictionary) [static]
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/Extensions/EmptyEnumerable.uno
// -----------------------------------------------------------------------------------
...
// public generated EmptyEnumerable()
...
// public generated EmptyEnumerable New() [static]
...
// internal sealed class EmptyEnumerator<T>
// {
...
// public generated EmptyEnumerator()
...
// public generated EmptyEnumerator New()
...
// public generated EmptyEnumerator() [instance]
...
// public generated EmptyEnumerator New() [static]
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/Extensions/EnumerableExtensions.uno
// ----------------------------------------------------------------------------------------
...
// public static bool All<T>(Uno.Collections.IEnumerable<T> self, Uno.Predicate<T> where)
...
// public static Uno.Collections.IEnumerable<T> AsEnumerable<T>(T[] self)
...
// public static int Count<T>(Uno.Collections.IEnumerable<T> self)
...
// public static T First<T>(Uno.Collections.IEnumerable<T> self)
...
// public static Uno.Collections.List<T> ToList<T>(Uno.Collections.IEnumerable<T> self)
...
// public static Uno.Collections.IEnumerable<T> Union<T>(Uno.Collections.IEnumerable<T> self, Uno.Collections.IEnumerable<T> other)
...
// public static bool All<T>(Uno.Collections.IEnumerable<T> self, Uno.Predicate<T> where) [static]
...
// public static Uno.Collections.IEnumerable<T> AsEnumerable<T>(T[] self) [static]
...
// public static int Count<T>(Uno.Collections.IEnumerable<T> self) [static]
...
// public static Uno.Collections.List<T> ToList<T>(Uno.Collections.IEnumerable<T> self) [static]
...
// public static Uno.Collections.IEnumerable<T> Union<T>(Uno.Collections.IEnumerable<T> self, Uno.Collections.IEnumerable<T> other) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/Stack.uno
// -----------------------------------------------------------------------------
...
// internal Enumerator(Uno.Collections.Stack<T> source)
...
// internal Enumerator New(Uno.Collections.Stack<T> source)
void Stack__Enumerator__New1_fn(uType* __type, ::g::Uno::Collections::Stack* source, uTRef __retval)
{
    ...
    Stack__Enumerator__ctor_1_fn(&obj1, __type, source);
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/HashSet.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/List.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/LinkedList.uno
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/Queue.uno
// -----------------------------------------------------------------------------
...
// public HashSet(Uno.Collections.IEnumerable<T> items)
...
// public HashSet New(Uno.Collections.IEnumerable<T> items)
...
// public bool SetEquals(Uno.Collections.IEnumerable<T> that)
...
// public HashSet(Uno.Collections.IEnumerable<T> items) [instance]
...
// public bool SetEquals(Uno.Collections.IEnumerable<T> that) [instance]
...
// public HashSet New(Uno.Collections.IEnumerable<T> items) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/ICollection.uno
// -----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/IDictionary.uno
// -----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/IEnumerable.uno
// -----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/IEnumerator.uno
// -----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/IList.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/Extensions/IListExtensions.uno
// -----------------------------------------------------------------------------------
...
// public static void AddRange<T>(Uno.Collections.IList<T> self, Uno.Collections.IEnumerable<T> collection)
...
// public static void AddRange<T>(Uno.Collections.IList<T> self, Uno.Collections.IEnumerable<T> collection) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/KeyValuePair.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/ObservableList.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/Extensions/OfType.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.12.0/Internal/PriorityQueue.uno
// ---------------------------------------------------------------------------
...
// public Queue(int capacity) [instance]
...
// public Queue New(int capacity) [static]
...
// /usr/local/share/uno/Packages/UnoCore/1.12.0/Source/Uno/Collections/ReadOnlyCollection.uno
// ------------------------------------------------------------------------------------------
...
// public ReadOnlyCollection(Uno.Collections.IList<T> list)
...
// public ReadOnlyCollection New(Uno.Collections.IList<T> list)
...
// public ReadOnlyCollection(Uno.Collections.IList<T> list) [instance]
...
// public ReadOnlyCollection New(Uno.Collections.IList<T> list) [static]
...
// /usr/local/share/uno/Packages/Fuse.Common/1.12.0/Internal/RootableList.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/Extensions/Select.uno
// --------------------------------------------------------------------------
...
// public Stack(int capacity) [instance]
...
// public Stack New(int capacity) [static]
...
// /usr/local/share/uno/Packages/Uno.Collections/1.12.0/Extensions/Union.uno
// -------------------------------------------------------------------------

// internal sealed class UnionEnumerable<T>
// {
...
// public UnionEnumerable(Uno.Collections.IEnumerable<T> first, Uno.Collections.IEnumerable<T> second)
...
// public UnionEnumerable New(Uno.Collections.IEnumerable<T> first, Uno.Collections.IEnumerable<T> second)
...
// public UnionEnumerable(Uno.Collections.IEnumerable<T> first, Uno.Collections.IEnumerable<T> second) [instance]
...
// public UnionEnumerable New(Uno.Collections.IEnumerable<T> first, Uno.Collections.IEnumerable<T> second) [static]
...
// internal sealed class UnionEnumerator<T>
// {
...
// public UnionEnumerator(Uno.Collections.IEnumerator<T> first, Uno.Collections.IEnumerator<T> second)
...
// public UnionEnumerator New(Uno.Collections.IEnumerator<T> first, Uno.Collections.IEnumerator<T> second)
...
// public UnionEnumerator(Uno.Collections.IEnumerator<T> first, Uno.Collections.IEnumerator<T> second) [instance]
...
// public UnionEnumerator New(Uno.Collections.IEnumerator<T> first, Uno.Collections.IEnumerator<T> second) [static]
