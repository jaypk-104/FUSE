...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/DrawRectVisualizer.uno
// ----------------------------------------------------------------------
...
// public DrawRect(float4 a, float4 b, float4 c, float4 d, Uno.Recti scissor)
...
// public DrawRect(float4[] verts, Uno.Recti scissor)
void DrawRect__ctor_2_fn(DrawRect* __this, uArray* verts, ::g::Uno::Recti* scissor)
{
    __this->ctor_2(verts, *scissor);
}

// public DrawRect New(float4 a, float4 b, float4 c, float4 d, Uno.Recti scissor)
...
// public DrawRect New(float4[] verts, Uno.Recti scissor)
void DrawRect__New2_fn(uArray* verts, ::g::Uno::Recti* scissor, DrawRect* __retval)
{
    *__retval = DrawRect__New2(verts, *scissor);
}

// public DrawRect(float4 a, float4 b, float4 c, float4 d, Uno.Recti scissor) [instance]
...
// public DrawRect(float4[] verts, Uno.Recti scissor) [instance]
...
// public DrawRect New(float4 a, float4 b, float4 c, float4 d, Uno.Recti scissor) [static]
...
// public DrawRect New(float4[] verts, Uno.Recti scissor) [static]
...
// internal sealed class DrawRectVisualizer
// {
// static generated DrawRectVisualizer()
...
// public generated DrawRectVisualizer()
void DrawRectVisualizer__ctor__fn(DrawRectVisualizer* __this)
{
    __this->ctor_();
}

// public static void Capture(float2 position, float2 size, float4x4 worldTransform, Fuse.DrawContext dc)
...
// public static void EndFrameAndVisualize(Fuse.DrawContext dc)
void DrawRectVisualizer__EndFrameAndVisualize_fn(::g::Fuse::DrawContext* dc)
{
    DrawRectVisualizer::EndFrameAndVisualize(dc);
}

// private void EndFrameAndVisualizeImpl(Fuse.DrawContext dc)
...
// public generated DrawRectVisualizer() [instance]
...
// private void EndFrameAndVisualizeImpl(Fuse.DrawContext dc) [instance]
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[3/*Uno.Collections.List<Fuse.Nodes.DrawRect>.Enumerator*/]))
                {
                    ...
                    uPtr(EndFrameAndVisualizeImpl_p_c7ca0230_1_3_1)->Update7(uArray::Init< ::g::Uno::Float4>(::TYPES[2/*float4[]*/], 6, r.A, r.B, r.C, r.C, r.D, r.A));
...
// private void StartFrameImpl(Uno.Graphics.RenderTarget rt) [instance]
...
// public static void Capture(float2 position, float2 size, float4x4 worldTransform, Fuse.DrawContext dc) [static]
...
// public static void EndFrameAndVisualize(Fuse.DrawContext dc) [static]
...
// public generated DrawRectVisualizer New() [static]
...
// public static void StartFrame(Uno.Graphics.RenderTarget rt) [static]
...
// public static bool get_IsCaptureEnabled() [static]
...
// public static void set_IsCaptureEnabled(bool value) [static]
