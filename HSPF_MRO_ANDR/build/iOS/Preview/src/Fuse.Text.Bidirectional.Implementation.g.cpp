...
// /usr/local/share/uno/Packages/Fuse.Text/1.12.0/Implementation/UBidi.uno
// -----------------------------------------------------------------------

// internal static extern class UBidiRuns
// {
...
// private static void Close(Uno.IntPtr ubidi)
void UBidiRuns__Close_fn(void** ubidi)
{
    UBidiRuns::Close(*ubidi);
}

// private static Fuse.Text.Implementation.ICU.ErrorCode GetLevels(Uno.IntPtr ubidi, byte[] outLevels, int length)
...
// private static Uno.Collections.List<Fuse.Text.Bidirectional.Run> GetLevels(Uno.IntPtr ubidi, Fuse.Text.Substring text)
...
// private static Uno.IntPtr Open()
void UBidiRuns__Open_fn(void** __retval)
{
    *__retval = UBidiRuns::Open();
}

// private static void SetPara(Uno.IntPtr ubidi, Fuse.Text.Substring text)
void UBidiRuns__SetPara_fn(void** ubidi, ::g::Fuse::Text::Substring* text)
{
    UBidiRuns::SetPara(*ubidi, text);
}

// private static Fuse.Text.Implementation.ICU.ErrorCode SetPara_Raw(Uno.IntPtr ubidi, string text, int offset, int length)
...
// private static void Close(Uno.IntPtr ubidi) [static]
void UBidiRuns::Close(void* ubidi)
{
    return ubidi_close((UBiDi*)ubidi);
}

// private static Fuse.Text.Implementation.ICU.ErrorCode GetLevels(Uno.IntPtr ubidi, byte[] outLevels, int length) [static]
...
// private static Uno.Collections.List<Fuse.Text.Bidirectional.Run> GetLevels(Uno.IntPtr ubidi, Fuse.Text.Substring text) [static]
...
// private static Uno.IntPtr Open() [static]
void* UBidiRuns::Open()
{
    return ubidi_open();
}

// private static void SetPara(Uno.IntPtr ubidi, Fuse.Text.Substring text) [static]
...
// private static Fuse.Text.Implementation.ICU.ErrorCode SetPara_Raw(Uno.IntPtr ubidi, string text, int offset, int length) [static]
