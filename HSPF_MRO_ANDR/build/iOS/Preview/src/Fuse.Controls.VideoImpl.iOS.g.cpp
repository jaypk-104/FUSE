...
// internal sealed extern class VideoPlayer
// {
...
VideoPlayer_type* VideoPlayer_typeof()
{
    ...
    type->interface0.fp_get_RotationDegrees = (void(*)(uObject*, int32_t*))VideoPlayer__get_RotationDegrees_fn;
...
// public VideoPlayer(string uri, Uno.Action onLoaded, Uno.Action onLoadError)
...
// public VideoPlayer New(string uri, Uno.Action onLoaded, Uno.Action onLoadError)
...
// private void PlayerErrorHandler()
...
void VideoPlayer__get_RotationDegrees_fn(VideoPlayer* __this, int32_t* __retval)
{
...
// private OpenGL.GLTextureHandle get_TextureHandle()
...
// public VideoPlayer(string uri, Uno.Action onLoaded, Uno.Action onLoadError) [instance]
...
// private void PlayerErrorHandler() [instance]
...
int32_t VideoPlayer::RotationDegrees()
{
...
// private OpenGL.GLTextureHandle get_TextureHandle() [instance]
...
// public VideoPlayer New(string uri, Uno.Action onLoaded, Uno.Action onLoadError) [static]
...
// private void OnLoaded() [instance]
...
// private void OnLoadError() [instance]
