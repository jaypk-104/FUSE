// This file was generated based on /Users/jay/Dev/Fuse/HSPF_MRO_ANDR/build/iOS/Preview/cache/ux15/HS.MenuButton.g.uno.
...
static void MenuButton_build(uType* type)
{
    ...
    type->SetFields(120,
        ...
        ::g::Uno::String_typeof(), offsetof(MenuButton, _field_FontSize), 0,
        ::g::Uno::String_typeof(), offsetof(MenuButton, _field_Id), 0,
    ...
    type->Reflection.SetFunctions(13,
        new uFunction("get_FontSize", NULL, (void*)MenuButton__get_FontSize_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_FontSize", NULL, (void*)MenuButton__set_FontSize_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("get_Id", NULL, (void*)MenuButton__get_Id_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Id", NULL, (void*)MenuButton__set_Id_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction(".ctor", NULL, (void*)MenuButton__New4_fn, 0, true, type, 0),
        new uFunction("SetFontSize", NULL, (void*)MenuButton__SetFontSize_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetId", NULL, (void*)MenuButton__SetId_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        ...
        new uFunction("SetValue", NULL, (void*)MenuButton__SetValue_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        ...
        new uFunction("get_Value", NULL, (void*)MenuButton__get_Value_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Value", NULL, (void*)MenuButton__set_Value_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
void MenuButton__get_FontSize_fn(MenuButton* __this, uString** __retval)
{
    *__retval = __this->FontSize();
}

// public void set_FontSize(string value)
void MenuButton__set_FontSize_fn(MenuButton* __this, uString* value)
{
    __this->FontSize(value);
}

// public string get_Id()
void MenuButton__get_Id_fn(MenuButton* __this, uString** __retval)
{
    *__retval = __this->Id();
}

// public void set_Id(string value)
void MenuButton__set_Id_fn(MenuButton* __this, uString* value)
{
    __this->Id(value);
}
...
void MenuButton__SetFontSize_fn(MenuButton* __this, uString* value, uObject* origin)
{
    __this->SetFontSize(value, origin);
}

// public void SetId(string value, Uno.UX.IPropertyListener origin)
void MenuButton__SetId_fn(MenuButton* __this, uString* value, uObject* origin)
{
...
{
    uStackFrame __("HS.MenuButton", ".ctor()");
    ctor_6();
    InitializeUX();
}

// public string get_FontSize() [instance]
uString* MenuButton::FontSize()
{
    return _field_FontSize;
}

// public void set_FontSize(string value) [instance]
void MenuButton::FontSize(uString* value)
{
    uStackFrame __("HS.MenuButton", "set_FontSize(string)");
    SetFontSize(value, NULL);
}

// public string get_Id() [instance]
uString* MenuButton::Id()
{
    return _field_Id;
}

// public void set_Id(string value) [instance]
void MenuButton::Id(uString* value)
{
    uStackFrame __("HS.MenuButton", "set_Id(string)");
    SetId(value, NULL);
}
...
{
    uStackFrame __("HS.MenuButton", "InitializeUX()");
...
void MenuButton::SetFontSize(uString* value, uObject* origin)
{
    uStackFrame __("HS.MenuButton", "SetFontSize(string,Uno.UX.IPropertyListener)");
...
void MenuButton::SetId(uString* value, uObject* origin)
{
    uStackFrame __("HS.MenuButton", "SetId(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("HS.MenuButton", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("HS.MenuButton", "SetValue(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("HS.MenuButton", "set_Text(string)");
    SetText(value, NULL);
}
...
{
    uStackFrame __("HS.MenuButton", "set_Value(string)");
    SetValue(value, NULL);
}
