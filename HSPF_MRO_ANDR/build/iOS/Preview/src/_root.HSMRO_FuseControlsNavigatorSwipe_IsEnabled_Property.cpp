...
{
    uStackFrame __("HSMRO_FuseControlsNavigatorSwipe_IsEnabled_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseControlsNavigatorSwipe_IsEnabled_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
