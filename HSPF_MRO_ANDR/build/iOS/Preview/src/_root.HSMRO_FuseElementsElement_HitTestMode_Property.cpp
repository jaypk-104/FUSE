...
{
    uStackFrame __("HSMRO_FuseElementsElement_HitTestMode_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseElementsElement_HitTestMode_Property", "Set(Uno.UX.PropertyObject,Fuse.Elements.HitTestMode,Uno.UX.IPropertyListener)");
    int32_t v_ = *v;
