...
// public HSMRO_DropdownMenu_BorderColor_Property(DropdownMenu obj, Uno.UX.Selector name)
...
{
    uStackFrame __("HSMRO_DropdownMenu_BorderColor_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::DropdownMenu*>(obj, ::TYPES[0/*DropdownMenu*/]))->BorderColor(), void();
}

// public HSMRO_DropdownMenu_BorderColor_Property New(DropdownMenu obj, Uno.UX.Selector name)
...
{
    *__retval = HSMRO_DropdownMenu_BorderColor_Property::New1(obj, *name);
}
...
{
    uStackFrame __("HSMRO_DropdownMenu_BorderColor_Property", "Set(Uno.UX.PropertyObject,Fuse.Drawing.Brush,Uno.UX.IPropertyListener)");
...
// public HSMRO_DropdownMenu_BorderColor_Property(DropdownMenu obj, Uno.UX.Selector name) [instance]
void HSMRO_DropdownMenu_BorderColor_Property::ctor_3(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public HSMRO_DropdownMenu_BorderColor_Property New(DropdownMenu obj, Uno.UX.Selector name) [static]
HSMRO_DropdownMenu_BorderColor_Property* HSMRO_DropdownMenu_BorderColor_Property::New1(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name)
{
    HSMRO_DropdownMenu_BorderColor_Property* obj1 = (HSMRO_DropdownMenu_BorderColor_Property*)uNew(HSMRO_DropdownMenu_BorderColor_Property_typeof());
