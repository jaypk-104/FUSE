...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Gesture.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Pointer.uno
// -----------------------------------------------------------------
...
static void Pointer__CaptureLockImpl_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Pointer.uno");
...
// public static bool BecameHard(Fuse.Input.CaptureType prev, Fuse.Input.CaptureType next)
...
// public static bool GainedCapture(Fuse.Input.CaptureType prev, Fuse.Input.CaptureType next)
...
// public static bool BecameHard(Fuse.Input.CaptureType prev, Fuse.Input.CaptureType next) [static]
bool CaptureTypeHelper::BecameHard(int32_t prev, int32_t next)
{
    return !((prev & 2) == 2) && ((next & 2) == 2);
}

// public static bool GainedCapture(Fuse.Input.CaptureType prev, Fuse.Input.CaptureType next) [static]
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/PointerEvents.uno
// -----------------------------------------------------------------------

// public abstract class CustomPointerEventArgs
// {
...
// protected CustomPointerEventArgs(Fuse.Input.PointerEventArgs args, Fuse.Visual visual)
...
// protected CustomPointerEventArgs(Fuse.Input.PointerEventArgs args, Fuse.Visual visual) [instance]
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Focus.uno
// ---------------------------------------------------------------
...
// public static Fuse.VisualEvent<Fuse.Input.IsFocusableChangedHandler, Fuse.Input.IsFocusableChangedArgs> get_IsFocusableChanged()
void Focus__get_IsFocusableChanged_fn(::g::Fuse::VisualEvent** __retval)
{
    *__retval = Focus::IsFocusableChanged();
}

// public static bool IsWithin(Fuse.Visual n)
...
// public static void Obtained(Fuse.Visual n)
...
// public static bool IsWithin(Fuse.Visual n) [static]
...
// public static void Obtained(Fuse.Visual n) [static]
...
// public static void ReleaseFrom(Fuse.Visual n) [static]
...
// public static void ResetFocusDelegate(Fuse.Visual n) [static]
...
// public static void ResetIsFocusable(Fuse.Visual n) [static]
...
// public static void SetDelegator(Fuse.Visual n, Fuse.Input.FocusDelegator delegator) [static]
...
// public static void SetFocusDelegate(Fuse.Visual n, Fuse.Visual d) [static]
...
// public static void SetIsFocusable(Fuse.Visual n, bool focusable) [static]
...
// public static Fuse.VisualEvent<Fuse.Input.IsFocusableChangedHandler, Fuse.Input.IsFocusableChangedArgs> get_IsFocusableChanged() [static]
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/FocusEvents.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Focus.Prediction.uno
// --------------------------------------------------------------------------
...
::g::Fuse::Visual* FocusPrediction::NextSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    ...
    int32_t index = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL), parent->Children(), child, &ret1), ret1);
...
::g::Fuse::Visual* FocusPrediction::PreviousSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    ...
    int32_t ret5;
    ::g::Fuse::Node* ret6;
    int32_t offset = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL), uPtr(parent)->Children(), child, &ret5), ret5) - 1;
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Gesture.uno");
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/HitTestHelpers.uno
// ------------------------------------------------------------------------
...
// public IsFocusableChangedArgs(Fuse.Visual visual)
void IsFocusableChangedArgs__ctor_2_fn(IsFocusableChangedArgs* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_2(visual);
}

// public IsFocusableChangedArgs New(Fuse.Visual visual)
...
// public IsFocusableChangedArgs(Fuse.Visual visual) [instance]
...
// public IsFocusableChangedArgs New(Fuse.Visual visual) [static]
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/Keyboard.uno
// ------------------------------------------------------------------
...
// public static void AddHandlers(Fuse.Visual visual, [Fuse.Input.KeyPressedHandler pressed], [Fuse.Input.KeyReleasedHandler released])
...
// private static void DispatchEmulateBackButtonTap()
...
// public static void RemoveHandlers(Fuse.Visual visual, [Fuse.Input.KeyPressedHandler pressed], [Fuse.Input.KeyReleasedHandler released])
...
// public static void AddHandlers(Fuse.Visual visual, [Fuse.Input.KeyPressedHandler pressed], [Fuse.Input.KeyReleasedHandler released]) [static]
...
// private static void DispatchEmulateBackButtonTap() [static]
...
// public static void EmulateBackButtonTap() [static]
...
// public static bool IsKeyPressed(Uno.Platform.Key key) [static]
...
// public static void RemoveHandlers(Fuse.Visual visual, [Fuse.Input.KeyPressedHandler pressed], [Fuse.Input.KeyReleasedHandler released]) [static]
...
// public static void AddHandlers(Fuse.Visual node, [Fuse.Input.PointerPressedHandler pressed], [Fuse.Input.PointerMovedHandler moved], [Fuse.Input.PointerReleasedHandler released], [Fuse.Input.PointerEnteredHandler entered], [Fuse.Input.PointerLeftHandler left], [Fuse.Input.PointerWheelMovedHandler wheelMoved])
...
// public static float2[] get_Coords()
...
// private static Fuse.Input.Capture GetFirstCapture(Fuse.Input.CaptureType type, int pointIndex, object identity)
...
// public static bool IsCaptured(Fuse.Input.CaptureType type, int pointIndex, object identity)
...
void Pointer__LoseCapture_fn(int32_t* pointIndex)
{
...
// public static void RemoveHandlers(Fuse.Visual node, [Fuse.Input.PointerPressedHandler pressed], [Fuse.Input.PointerMovedHandler moved], [Fuse.Input.PointerReleasedHandler released], [Fuse.Input.PointerEnteredHandler entered], [Fuse.Input.PointerLeftHandler left], [Fuse.Input.PointerWheelMovedHandler wheelMoved])
...
// public static void AddHandlers(Fuse.Visual node, [Fuse.Input.PointerPressedHandler pressed], [Fuse.Input.PointerMovedHandler moved], [Fuse.Input.PointerReleasedHandler released], [Fuse.Input.PointerEnteredHandler entered], [Fuse.Input.PointerLeftHandler left], [Fuse.Input.PointerWheelMovedHandler wheelMoved]) [static]
...
// private static Fuse.Input.Capture GetFirstCapture(Fuse.Input.CaptureType type, int pointIndex, object identity) [static]
...
// public static bool IsCaptured(Fuse.Input.CaptureType type, int pointIndex, object identity) [static]
...
// public static bool IsCaptured(int pointIndex, object identity) [static]
...
// public static bool IsPressed() [static]
...
// internal static void LoseCapture(int pointIndex) [static]
void Pointer::LoseCapture(int32_t pointIndex)
{
    uStackFrame __("Fuse.Input.Pointer", "LoseCapture(int)");
    Pointer_typeof()->Init();
        ...
        {
            {
                ...
                {
                    ::g::Fuse::Input::Capture* c = (::g::Uno::Collections::List__get_Item_fn(uPtr(Pointer::_captures_), uCRef<int32_t>(i), &ret12), ret12);
...
// public static float2[] get_Coords() [static]
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/PointerEventArgs.uno
// --------------------------------------------------------------------------
...
static void PointerEventArgs_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/PointerEventArgs.uno");
...
// public Uno.Platform.WheelDeltaMode get_WheelDeltaMode()
...
// internal Fuse.Input.PointerEventData get_Data() [instance]
::g::Fuse::Input::PointerEventData* PointerEventArgs::Data()
{
    return _data;
}

// private void DeprecatedReleaseCapture(object behavior) [instance]
void PointerEventArgs::DeprecatedReleaseCapture(uObject* behavior)
{
    if (!PointerEventArgs::_drcWarn_)
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[13/*"The capture...*/], this, ::STRINGS[14/*"/usr/local/...*/], 98, ::STRINGS[15/*"DeprecatedR...*/]);
...
// public bool IsCapturedTo(object behavior) [instance]
...
// public bool IsHardCapturedTo(object behavior) [instance]
...
// public bool IsSoftCapturedTo(object behavior) [instance]
...
// public void ReleaseCapture(object behavior) [instance]
...
// public void ReleaseHardCapture(object behavior) [instance]
void PointerEventArgs::ReleaseHardCapture(uObject* behavior)
{
    DeprecatedReleaseCapture(behavior);
}

// public void ReleaseSoftCapture(object behavior) [instance]
...
// public Uno.Platform.WheelDeltaMode get_WheelDeltaMode() [instance]
...
// public PointerWheelMovedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual)
...
// public PointerWheelMovedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual)
...
// public PointerWheelMovedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) [instance]
...
// public PointerWheelMovedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) [static]
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.12.0/Input/TextService.uno
// ---------------------------------------------------------------------
...
// public generated TextEntered New()
void TextEntered__New1_fn(TextEntered** __retval)
{
    *__retval = TextEntered::New1();
}

// public generated TextEntered() [instance]
void TextEntered::ctor_1()
{
    ctor_();
}

// public generated TextEntered New() [static]
...
// public TextEnteredArgs(string text, Fuse.Visual visual) [instance]
...
// public TextEnteredArgs New(string text, Fuse.Visual visual) [static]
...
// public static Fuse.VisualEvent<Fuse.Input.TextEnteredHandler, Fuse.Input.TextEnteredArgs> get_TextEntered()
...
// internal static bool RaiseTextEntered(string text) [static]
...
// public static Fuse.VisualEvent<Fuse.Input.TextEnteredHandler, Fuse.Input.TextEnteredArgs> get_TextEntered() [static]
