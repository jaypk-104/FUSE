...
{
    uStackFrame __("HSMRO_FuseResourcesHttpImageSource_Url_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseResourcesHttpImageSource_Url_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
