...
{
    uStackFrame __("HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("HSMRO_FuseControlsEllipticalShape_LengthAngleDegrees_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
