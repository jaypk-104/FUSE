#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.12.0/Targets/iOS/build.sh.
...
##else
    xcodebuild -project "HS MRO.xcodeproj" "$@" | tee >(checkForError)
##endif
